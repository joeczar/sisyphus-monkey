// Auto-generated dictionary file for letter 'e'
...
const dictionary: AlphabeticalDictionary = {
  ...
  "encomiastic": "Bestowing praise; praising; eulogistic; laudatory; as, an encomiastic address or discourse. -- En*co`mi*as\"tic*al*ly, adv.\n\nA panegyric. B. Jonson.",
  "estranger": "One who estranges.",
  "eighteenth": "1. Next in order after the seventeenth. 2. Consisting of one of eighteen equal parts or divisions of a thing.\n\n1. The quotient of a unit divided by eighteen; one of eighteen equal parts or divisions. 2. The eighth after the tenth.",
  "ensurer": "See Insurer.",
  ...
  "euclidian": "Related to Euclid, or to the geometry of Euclid. Euclidian space (Geom.), the kind of space to which the axioms and definitions of Euclid, relative to straight lines and parallel lines, apply; -- called also flat space, and homaloidal space.",
  ...
  "electro-biology": "1. That branch of biology which treats of the electrical phenomena of living organisms. 2. That phase of mesmerism or animal magnetism, the phenomena of which are supposed to be produced by a form of electricity.",
  ...
  "ethylate": "A compound derived from ethyl alcohol by the replacement of the hydroxyl hydrogen, after the manner of a hydrate; an ethyl alcoholate; as, potassium ethylate, C2H5.O.K.",
  ...
  "experimentarian": "Relying on experiment or experience. \"an experimentarian philosopher.\" Boyle. -- n.  One who relies on experiment or experience. [Obs.]",
  ...
  "economist": "1. One who economizes, or manages domestic or other concerns with frugality; one who expends money, time, or labor, judiciously, and without waste. \"Economists even to parsimony.\" Burke. 2. One who is conversant with political economy; a student of economics.",
  "expone": "To expound; to explain; also, to expose; to imperil. [Old Eng. & Scotch] Drummond.",
  "experimental": "1. Pertaining to experiment; founded on, or derived from, experiment or trial; as, experimental science; given to, or skilled in, experiment; as, an experimental philosopher. 2. Known by, or derived from, experience; as, experimental religion.",
  "ebb tide": "The reflux of tide water; the retiring tide; -- opposed to flood tide.",
  "exhale": "1. To breathe out. Hence: To emit, as vapor; to send out, as an odor; to evaporate; as, the earth exhales vapor; marshes exhale noxious effluvia. Less fragrant scents the unfolding rose exhales. Pope. 2. To draw out; to cause to be emitted in vapor; as, the sum exhales the moisture of the earth.\n\nTo rise or be given off, as vapor; to pass off, or vanish. Their inspiration exhaled in elegies. Prescott.",
  "ecboline": "An alkaloid constituting the active principle of ergot; -- so named from its power of producing abortion.",
  "evensong": "A song for the evening; the evening service or form of worship (in the Church of England including vespers and compline); also, the time of evensong. Wyclif. Milton.",
  ...
  "ebullient": "Boiling up or over; hence, manifesting exhilaration or excitement, as of feeling; effervescing. \"Ebullient with subtlety.\" De Quincey. The ebullient enthusiasm of the French. Carlyle.",
  ...
  "excurrent": "1. Running or flowing out; as: (Bot.)  Running or extending out; as, an excurrent midrib, one which projects beyond the apex of a leaf; an excurrent steam or trunk, one which continues to the top. 2. (Zoöl)  Characterized by a current which flows outward; as, an excurrent orifice or tube.",
  ...
  "embowel": "1. To disembowel. The barbarous practice of emboweling. Hallam. The boar . . . makes his trough In your emboweled bosoms. Shak. Note: Disembowel is the preferable word in this sense. 2. To imbed; to hide in the inward parts; to bury. Or deep emboweled in the earth entire. Spenser.",
  "ethylamine": "A colorless, mobile, inflammable liquid, C2H5.NH2, very volatile and with an ammoniacal odor. It is a strong base, and is a derivative of ammonia. Called also ethyl carbamine, and amido ethane.",
  "exostosis": "1. (Med.)  Any protuberance of a bone which is not natural; an excrescence or morbid enlargement of a bone. Coxe. 2. (Bot.)  A knot formed upon or in the wood of trees by disease.",
  "encindered": "Burnt to cinders. [R.]",
  "ejectment": "1. A casting out; a dispossession; an expulsion; ejection; as, the ejectment of tenants from their homes. 2. (Law)  A species of mixed action, which lies for the recovery of possession of real property, and damages and costs for the wrongful withholding of it. Wharton.",
  ...
  "embrasure": "An embrace. [Obs.] \"Our locked embrasures.\"\" Shak.\n\n1. (Arch.)  A splay of a door or window. Apart, in the twilight gloom of a window's embrasure, Sat the lovers. Longfellow. 2. (Fort.)  An aperture with slant sides in a wall or parapet, through which cannon are pointed and discharged; a crenelle. See Illust. of Casemate.",
  "eirenic": "Pacific. See Irenic.",
  "enfect": "Contaminated with illegality. [Obs.] Chaucer.",
  "emongst": ", (prep. Among. [Obs.]",
  ...
  "egg-bird": "A species of tern, esp. the sooty tern (Sterna fuliginosa) of the West Indies. In the Bahama Islands the name is applied to the tropic bird, Phaëthon flavirostris.",
  ...
  "eloign": "1. To remove afar off; to withdraw. [Obs.] From worldly cares he did himself eloign. Spenser. 2. (Law)  To convey to a distance, or beyond the jurisdiction, or to conceal, as goods liable to distress. The sheriff may return that the goods or beasts are eloigned. Blackstone.",
  "estaminet": "A café, or room in a café, in which smoking is allowed.",
  "eyghen": "Eyes. [Obs.] Chaucer.",
  "epocha": "See Epoch. J. Adams.",
  "eudoxian": "A follower of Eudoxius, patriarch of Antioch and Constantinople in the 4th century, and a celebrated defender of the doctrines of Arius.",
  ...
  "elapse": "To slip or glide away; to pass away silently, as time; -- used chiefly in reference to time. Eight days elapsed; at length a pilgrim came. Hoole.",
  ...
  "electro-dynamics": "1. The phenomena of electricity in motion. 2. The branch of science which treats of the properties of electric currents; dynamical electricity.",
  "extractive": "1. Capable of being extracted. \"Thirty grains of extractive matter.\" Kirwan. 2. Tending or serving to extract or draw out. Certain branches of industry are conveniently designated extractive: e.g., agriculture, pastoral and mining pursuits, cutting of lumber, etc. Cairnes.\n\n1. Anything extracted; an extract. Extractives, of which the most constant are urea, kreatin, and grape sugar. H. N. Martin. 2. (Chem.) (a) A chemical principle once supposed to exist in all extracts. [Obs.] (b) Any one of a large class of substances obtained by extraction, and consisting largely of nitrogenous hydrocarbons, such as xanthin, hypoxanthin, and creatin extractives from muscle tissue.",
  ...
  "elsewhere": "1. In any other place; as, these trees are not to be found elsewhere. 2. In some other place; in other places, indefinitely; as, it is reported in town and elsewhere.",
  "eyesaint": "An object of interest to the eye; one wirehaired with the eyes. [Obs.] That's the eye-saint, I know, Among young gallants. Beau. & Fl.",
  "existency": "Existence. [R.] Sir M. Hale.",
  "embassador": "1. A minister of the highest rank sent a foreign court to represent there his sovereign or country. Note: Ambassador are either ordinary [or resident] or extraordinary, that is, sent upon some special or unusual occasion or errand. Abbott. 2. An official messenger and representative.\n\nSame as Ambassador. Stilbon, that was a wise embassadour, Was sent to Corinth. Chaucer. Myself my king's embassador will go. Dryden.",
  ...
  "embar": "1. To bar or shut in; to inclose securely, as with bars. Where fast embarred in mighty brazen wall. Spenser. 2. To stop; to hinder by prohibition; to block up. He embarred all further trade. Bacon.",
  "enation": "Any unusual outgrowth from the surface of a thing, as of a petal; also, the capacity or act of producing such an outgrowth.",
  ...
  "etaac": "The blue buck.",
  "eyeservice": "Service performed only under inspection, or the eye of an employer. Not with eyeservice, as menpleasers. Col. iii. 22.",
  "eye-saint": "An object of interest to the eye; one wirehaired with the eyes. [Obs.] That's the eye-saint, I know, Among young gallants. Beau. & Fl.",
  ...
  "enarthrosis": "A ball and socket joint, or the kind of articulation represented by such a joint. See Articulation.",
  "espouser": "One who espouses; one who embraces the cause of another or makes it his own.",
  "emancipation": "The act of setting free from the power of another, from slavery, subjection, dependence, or controlling influence; also, the state of being thus set free; liberation; as, the emancipation of slaves; the emancipation of minors; the emancipation of a person from prejudices; the emancipation of the mind from superstition; the emancipation of a nation from tyranny or subjection. Syn. -- Deliverance; liberation; release; freedom; manumission; enfranchisement.",
  ...
  "expropriation": "The act of expropriating; the surrender of a claim to exclusive property; the act of depriving of ownership or proprietary rights. W. Montagu. The expropriation of bad landlords. M. Arnold.",
  "emotionalism": "The cultivation of an emotional state of mind; tendency to regard things in an emotional manner.",
  "enthrallment": "The act of enthralling, or state of being enthralled. See Inthrallment.",
  "electro-motion": "The motion of electricity or its passage from one metal to another in a voltaic circuit; mechanical action produced by means of electricity.",
  ...
  "everglade": "A swamp or low tract of land inundated with water and interspersed with hummocks, or small islands, and patches of high grass; as, the everglades of Florida. [U. S.]",
  "etagere": "A piece of furniture having a number of uninclosed shelves or stages, one above another, for receiving articles of elegance or use. Fairholt.",
  ...
  "evocative": "Calling forth; serving to evoke; developing. Evocative power over all that is eloquent and expressive in the better soul of man. W. Pater.",
  "extra-uterine": "Outside of the uterus, or womb. Extra-uterine pregnancy (Med.), a condition of pregnancy in which the fetus is not in the uterus, but in the Fallopian tube or in the abdominal cavity.",
  "erke": "ASlothful. [Obs.] Rom. of R.",
  "esthetical": "Same as Æsthete, Æsthetic, Æsthetical, Æsthetics, etc.",
  ...
  "eyne": "Plural of eye; obsolete, or used only in poetry. Shak. With such a plaintive gaze their eyne Are fastened upwardly on mine. Mrs. Browning.",
  "embroidery": "1. Needlework used to enrich textile fabrics, leather, etc.; also, the art of embroidering. 2. Diversified ornaments, especially by contrasted figures and colors; variegated decoration. Fields in spring's embroidery are dressed. Addison. A mere rhetorical embroidery of phrases. J. A. Symonds.",
  ...
  "encroachment": "1. The act of entering gradually or silently upon the rights or possessions of another; unlawful intrusion. An unconstitutional encroachment of military power on the civil establishment. Bancroft. 2. That which is taken by encroaching on another. 3. (Law)  An unlawful diminution of the possessions of another.",
  ...
  "enchorial": "Belonging to, or used in, a country; native; domestic; popular; common; -- said especially of the written characters employed by the common people of ancient Egypt, in distinction from the hieroglyphics. See Demotic.",
  "evanesce": "To vanish away; to because dissipated and disappear, like vapor. I believe him to have evanesced or evaporated. De Quincey.",
  "empugn": "See Impugn.",
  "externalize": "To make external; to manifest by outward form. Thought externalizes itself in language. Soyce.",
  "emasculate": "1. To deprive of virile or procreative power; to castrate power; to castrate; to geld. 2. To deprive of masculine vigor or spirit; to weaken; to render effeminate; to vitiate by unmanly softness. Luxury had not emasculated their minds. V. Knox.\n\nDeprived of virility or vigor; unmanned; weak. \"Emasculate slave.\" Hammond.",
  ...
  "ectoparasite": "Any parasite which lives on the exterior of animals; -- opposed to endoparasite. -- Ec`to*par`a*sit\"ic, a.",
  ...
  "extraterritoriality": "The state of being beyond the limits of a particular territory; esp. (Internat. Law),  a fiction by which a public minister, though actually in a foreign country, is supposed still to remain within the territory of his own sovereign or nation. Wheaton.",
  ...
  "embroyde": "To embroider; to adorn. [Obs.] Embrowded was he, as it were a mead All full of fresshe flowers, white and red. Chaucer.",
  ...
  "extinction": "1. The act of extinguishing or making extinct; a putting an end to; the act of putting out or destroying light, fire, life, activity, influence, etc. 2. State of being extinguished or of ceasing to be; destruction; suppression; as, the extinction of life, of a family, of a quarrel, of claim.",
  ...
  "exterritoriality": "1. The state of being beyond the limits of a country. 2. The state of being free from the jurisdiction of a country when within its territorial limits.",
  "embodiment": "1. The act of embodying; the state of being embodied. 2. That which embodies or is embodied; representation in a physical body; a completely organized system, like the body; as, the embodiment of courage, or of courtesy; the embodiment of true piety.",
  ...
  "eurafric": "1. (Geog.)  Of, pertaining to, or designating, the continents of Europe and Africa combined. 2.  (Zoögeography) Pert. to or designating a region including most of Europe and northern Africa south to the Sahara. 3.  Of European and African descent.",
  "exhaustibility": "Capability of being exhausted. I was seriously tormented by the thought of the exhaustibility of musical combinations. J. S. Mill.",
  "elaborative": "Serving or tending to elaborate; constructing with labor and minute attention to details. Elaborative faculty (Metaph.), the intellectual power of discerning relations and of viewing objects by means of, or in, relations; the discursive faculty; thought.",
  "emphatically": "1. With emphasis; forcibly; in a striking manner or degree; preëminently. He was indeed emphatically a popular writer. Macaulay. 2. Not really, but apparently. [Obs.] Sir T. Browne.",
  ...
  "edify": "1. To build; to construct. [Archaic] There was a holy chapel edified. Spenser. 2. To instruct and improve, especially in moral and religious knowledge; to teach. It does not appear probable that our dispute [about miracles] would either edify or enlighten the public. Gibbon. 3. To teach or persuade. [Obs.] Bacon.\n\nTo improve. [R.] Swift.",
  "eggler": "One who gathers, or deals in, eggs.",
  "exclusive": "1. Having the power of preventing entrance; debarring from participation or enjoyment; possessed and enjoyed to the exclusion of others; as, exclusive bars; exclusive privilege; exclusive circles of society. 2. Not taking into the account; excluding from consideration; -- opposed to inclusive; as, five thousand troops, exclusive of artillery.\n\nOne of a coterie who exclude others; one who from real of affected fastidiousness limits his acquaintance to a select few.",
  ...
  "exorcist": "1. One who expels evil spirits by conjuration or exorcism. Certain of the vagabond Jews, exorcists. Acts xix. 13. 2. A conjurer who can raise spirits. [R.] Thou, like an exorcist, hast conjured up My mortified spirit. Shak.",
  ...
  "eozoic": "Of or pertaining to rocks or strata older than the Paleozoic, in many of which the eozoön has been found. Note: This term has been proposed for the strata formerly called Azoic, and is preferred especially by those geologists who regard the eozoön as of organic origin. See Archæan.",
  ...
  "embolic": "1. Embolismic. 2. (Med.)  Pertaining to an embolism; produced by an embolism; as, an embolic abscess. 3. (Biol.)  Pushing or growing in; -- said of a kind of invagination. See under Invagination.",
  ...
  "egotistic": "Addicted to, or manifesting, egotism. Syn. -- Conceited; vain; self-important; opinionated.",
  ...
  "ecbatic": "Denoting a mere result or consequence, as distinguished from telic, which denotes intention or purpose; thus the phrase so that it was fulfilled,\" is ecbatic; if rendered \"in order that it might be.\" etc., is telic.",
  ...
  "elfish": "Of or relating to the elves; elflike; implike; weird; scarcely human; mischievous, as though caused by elves. \"Elfish light.\" Coleridge. The elfish intelligence that was so familiar an expression on her small physiognomy. Hawthorne.",
  "expectingly": "In state of expectation.",
  "extemporization": "The act of extemporizing; the act of doing anything extempore.",
  "ekaluminium": "The name given to a hypothetical element, -- later discovered and called gallium. See Gallium, and cf. Ekabor.",
  ...
  "excuser": "1. One who offers excuses or pleads in extenuation of the fault of another. Swift. 2. One who excuses or forgives another. Shelton.",
  "eking": "(a) A lengthening or filling piece to make good a deficiency in length. (b) The carved work under the quarter piece at the aft part of the quarter gallery. [Written also eiking.]",
  ...
  "ethological": "treating of, or pertaining to, ethnic or morality, or the science of character. J. S. Mill.",
  ...
  "euphrasy": "The plant eyesight (euphrasia officionalis), formerly regarded as beneficial in disorders of the eyes. Then purged with euphrasy and rue The visual nerve, for he had much to see. Milton.",
  ...
  "extrorsal": "Extrorse.",
  "eyesplice": "A splice formed by bending a rope's and back, and fastening it into the rope, forming a loop or eye. See Illust. under Splice.",
  "empyreumatic": "Of or pertaining to empyreuma; as, an empyreumatic odor. Empyreumatic oils, oils obtained by distilling various organic substances at high temperatures. Brande & C.",
  "elliptic": "1. Of or pertaining to an ellipse; having the form of an ellipse; oblong, with rounded ends. The planets move in elliptic orbits. Cheyne. 2. Having a part omitted; as, an elliptical phrase. Elliptic chuck. See under Chuck. -- Elliptic compasses, an instrument arranged for drawing ellipses. -- Elliptic function. (Math.) See Function. -- Elliptic integral. (Math.) See Integral. -- Elliptic polarization. See under Polarization.",
  "effervescent": "Gently boiling or bubbling, by means of the disengagement of gas",
  "elayl": "Olefiant gas or ethylene; -- so called by Berzelius from its forming an oil combining with chlorine. [Written also elayle.] See Ethylene.",
  ...
  "evermore": "During eternity; always; forever; for an indefinite period; at all times; -- often used substantively with for. Seek the Lord . . . Seek his face evermore. Ps. cv. 4. And, behold, I am alive for evermore. Rev. i. 18. Which flow from the presence of God for evermore. Tillotson. I evermore did love you, Hermia. Shak.",
  ...
  "eternize": "1. To make eternal or endless. This other [gift] served but to eternize woe. Milton. 2. To make forever famous; to immortalize; as, to eternize one's self, a name, exploits. St. Alban's battle won by famous York, Shall be eternized in all age to come. Shak.",
  ...
  "euterpe": "1. (Class. Myth.)  The Muse who presided over music. 2. (Bot.)  A genus of palms, some species of which are elegant trees.",
  ...
  "estoile": "A six-pointed star whose rays are wavy, instead of straight like those of a mullet. [Written also étoile.] Estoile of eight points, a star which has four straight and four wavy rays. -- Estoile of four points. Same as Cross estoilé, under Cross.",
  "ectozoon": "See Epizoön.",
  "effigies": "See Effigy. Dryden.",
  "electre": "1. Amber. See Electrum. [Obs.] 2. A metallic substance compounded of gold and silver; an alloy. [Obs.] Wyclif.",
  ...
  "elastin": "A nitrogenous substance, somewhat resembling albumin, which forms the chemical basis of elastic tissue. It is very insoluble in most fluids, but is gradually dissolved when digested with either pepsin or trypsin.",
  ...
  "etherization": "(a) The administration of ether to produce insensibility. (b) The state of the system under the influence of ether.",
  ...
  "ecthyma": "A cutaneous eruption, consisting of large, round pustules, upon an indurated and inflamed base. Dunglison.",
  ...
  "excoriation": "1. The act of excoriating or flaying, or state of being excoriated, or stripped of the skin; abrasion. 2. Stripping of possession; spoliation. [Obs.] A pitiful excoriation of the poorer sort. Howell.",
  "estivation": "Same as Æstival, Æstivate, etc.",
  ...
  "edgeways": "With the edge towards anything; in the direction of the edge. Glad to get in a word, as they say, edgeways. Sir W. Scott.",
  ...
  "eftsoons": "Again; anew; a second time; at once; speedily. [Archaic] And, if he fall from his capel [horse] eftsone. Chaucer. The champion stout eftsoons dismounted. Spenser.",
  "empassionate": "Strongly affected. [Obs.] The Briton Prince was sore empassionate. Spenser.",
  "eolipile": "Same as Æolipile.",
  "estuary": "1. A place where water boils up; a spring that wells forth. [Obs.] Boyle. 2. A passage, as the mouth of a river or lake, where the tide meets the current; an arm of the sea; a frith. it to the sea was often by long and wide estuaries. Dana.\n\nBelonging to, or formed in, an estuary; as, estuary strata. Lyell.",
  "eurasian": "1. A child of a European parent on the one side and an Asiatic on the other. 2. One born of European parents in Asia.\n\nOf European and Asiatic descent; of or pertaining to both Europe and Asia; as, the great Eurasian plain.",
  "exhaustive": "Serving or tending to exhaust; exhibiting all the facts or arguments; as, an exhaustive method. Ex*haust\"ive*ly, adv.",
  "exorhizal": "Having a radicle which is not inclosed by the cotyledons or plumule; of or relating to an exorhiza.",
  "expiscate": "To fish out; to find out by skill or laborious investigation; to search out. \"To expiscate principles.\" [R.] Nichol. Dr.Burton has with much ingenuity endeavord to expiscate the truth which may be involved in them. W. L. Alexander.",
  ...
  "effusive": "Pouring out; pouring forth freely. \"Washed with the effusive wave.\" Pope. Effusive rocks (Geol.), volcanic rocks, in distinction from so-called intrusive, or plutonic, rocks. -- Ef*fu\"sive*ly, adv. -- Ef*fu\"sive*ness, n.",
  "eviscerate": "To take out the entrails of; to disembowel; to gut.",
  "elaterium": "A cathartic substance obtained, in the form of yellowish or greenish cakes, as the dried residue of the juice of the wild or squirting cucumber (Ecballium agreste, formerly called Momordica Elaterium).",
  ...
  "ellipsis": "1. (Gram.)  Omission; a figure of syntax, by which one or more words, which are obviously understood, are omitted; as, the virtues I admire, for, the virtues which I admire. 2. (Geom.)  An ellipse. [Obs.]",
  ...
  "ejaculate": "1. To throw out suddenly and swiftly, as if a dart; to dart; to eject. [Archaic or Technical] Its active rays ejaculated thence. Blackmore. 2. To throw out, as an exclamation; to utter by a brief and sudden impulse; as, to ejaculate a prayer.\n\nTo utter ejaculations; to make short and hasty exclamations. [R.] \"Ejaculating to himself.\" Sir W. Scott.",
  ...
  "elude": "To avoid slyly, by artifice, stratagem, or dexterity; to escape from in a covert manner; to mock by an unexpected escape; to baffle; as, to elude an officer; to elude detection, inquiry, search, comprehension; to elude the force of an argument or a blow. Me gentle Delia beckons from the plain, Then, hid in shades, eludes he eager swain. Pope. The transition from fetichism to polytheism seems a gradual process of which the stages elude close definition. Tylor. Syn. -- To evade; avoid; escape; shun; eschew; flee; mock; baffle; frustrate; foil.",
  "endoblast": "Entoblast; endoplast. See Nucleus,",
  "erastianism": "The principles of the Erastains.",
  "etiolation": "1. The operation of blanching plants, by excluding the light of the sun; the condition of a blanched plant. 2. (Med.)  Paleness produced by absence of light, or by disease. Dunglison.",
  ...
  "excrescence": "An excrescent appendage, as, a wart or tumor; anything growing out unnaturally from anything else; a preternatural or morbid development; hence, a troublesome superfluity; an incumbrance; as, an excrescence on the body, or on a plant. \"Excrescences of joy.\" Jer. Taylor. The excrescences of the Spanish monarchy. Addison.",
  ...
  "eating": "1. The act of tasking food; the act of consuming or corroding. 2. Something fit to be eaten; food; as, a peach is good eating. [Colloq.] Eating house, a house where cooked provisions are sold, to be eaten on the premises.",
  ...
  "epos": "An epic.",
  "expectative": "Constituting an object of expectation; contingent. Expectative grace, a mandate given by the pope or a prince appointing a successor to any benefice before it becomes vacant. Foxe.\n\nSomething in expectation; esp., an expectative grace. Milman.",
  ...
  "efferent": "(a) Conveying outward, or discharging; -- applied to certain blood vessels, lymphatics, nerves, etc. (b) Conveyed outward; as, efferent impulses, i. e., such as are conveyed by the motor or efferent nerves from the central nervous organ outwards; -- opposed to afferent.\n\nAn efferent duct or stream.",
  ...
  "emulsive": "1. Softening; milklike. 2. Yielding oil by expression; as, emulsive seeds. 3. Producing or yielding a milklike substance; as, emulsive acids.",
  "extravagant": "1. Wandering beyond one's bounds; roving; hence, foreign. [Obs.] The extravagant and erring spirit hies To his confine. Shak. 2. Exceeding due bounds; wild; excessive; unrestrained; as, extravagant acts, wishes, praise, abuse. There appears something nobly wild and extravagant in great natural geniuses. Addison. 3. Profuse in expenditure; prodigal; wasteful; as, an extravagant man. \"Extravagant expense.\" Bancroft.\n\n1. One who is confined to no general rule. L'Estrange. 2. pl. (Eccl. Hist.)  Certain constitutions or decretal epistles, not at first included with others, but subsequently made a part of the canon law.",
  ...
  "exode": "1. Departure; exodus; esp., the exodus of the Israelites from Egypt. [Obs.] L. Coleman. Bolingbroke. 2. (Gr. Drama)  The final chorus; the catastrophe. 3. (Rom. Antig.)  An afterpiece of a comic description, either a farce or a travesty.",
  ...
  "electrotonus": "The modified condition of a nerve, when a constant current of electricity passes through any part of it. See Anelectrotonus, and Catelectrotonus.",
  "emanation": "1. The act of flowing or proceeding from a fountain head or origin. South. Those profitable and excellent emanations from God. Jer. Taylor. 2. That which issues, flows, or proceeds from any object as a source; efflux; an effluence; as, perfume is an emanation from a flower. An emanation of the indwelling life. Bryant.",
  "endoctrine": "To teach; to indoctrinate. [Obs.] Donne.",
  "echinid": "Same as Echinoid.",
  "endogenetic": "Endogenous.",
  "elastical": "Elastic. [R.] Bentley.",
  "exanimate": "1. Lifeless; dead. [R.] \"Carcasses exanimate.\" Spenser. 2. Destitute of animation; spiritless; disheartened. [R.] \"Pale . . . wretch, exanimate by love.\" Thomson.\n\nTo deprive of animation or of life. [Obs.]",
  ...
  "exosmose": "The passage of gases, vapors, or liquids thought membranes or porous media from within outward, in the phenomena of osmose; -- opposed to endosmose. See Osmose.",
  "expeditious": "Possessed of, or characterized by, expedition, or efficiency and rapidity in action; performed with, or acting with, expedition; quick; having celerity; speedily; as, an expeditious march or messenger. -- Ex`pe*di\"tious*ly, adv. -- Ex`pe*di\"tious*ness, n. Syn. -- Prompt; ready; speedy; alert. See Prompt.",
  ...
  "exfoliate": "1. To separate and come off in scales or laminæ, as pieces of carious bone or of bark. 2. (Min.)  To split into scales, especially to become converted into scales at the result of heat or decomposition.\n\nTo remove scales, laminæ, or splinters from the surface of.",
  ...
  "embracement": "1. A clasp in the arms; embrace. Dear though chaste embracements. Sir P. Sidney. 2. State of being contained; inclosure. [Obs.] In the embracement of the parts hardly reparable, as bones. Bacon. 3. Willing acceptance. [Obs.] A ready embracement of . . . his kindness. Barrow.",
  ...
  "excentrical": "1. Same as Eccentric, Eccentrical. 2. (Bot.)  One-sided; having the normally central portion not in the true center. Gray.",
  ...
  "extraprofessional": "Foreign to a profession; not within the ordinary limits of professional duty or business.",
  ...
  "eagerness": "1. The state or quality of being eager; ardent desire. \"The eagerness of love.\" Addison. 2. Tartness; sourness. [Obs.] Syn. -- Ardor; vehemence; earnestness; impetuosity; heartiness; fervor; fervency; avidity; zeal; craving; heat; passion; greediness.",
  "extensibility": "The quality of being extensible; the capacity of being extended; as, the extensibility of a fiber, or of a plate of metal.",
  ...
  "eusebian": "A follower of Eusebius, bishop of Cæsarea, who was a friend and protector of Arius.",
  ...
  "emersion": "1. The act of emerging, or of rising out of anything; as, emersion from the sea; emersion from obscurity or difficulties. Their immersion into water and their emersion out of the same. Knatchbull. 2. (Astron.)  The reappearance of a heavenly body after an eclipse or occultation; as, the emersion of the moon from the shadow of the earth; the emersion of a star from behind the moon.",
  ...
  "ep": "See Epi-.",
  "expunge": "1. To blot out, as with pen; to rub out; to efface designedly; to obliterate; to strike out wholly; as, to expunge words, lines, or sentences. 2. To strike out; to wipe out or destroy; to annihilate; as, to expugne an offense. Sandys. Expugne the whole, or lop th' excrescent parts. Pope. Syn. -- To efface; erase; obliterate; strike out; destroy; annihilate; cancel.",
  "esophagean": "Esophageal.",
  "elaps": "A genus of venomous snakes found both in America and the Old World. Many species are known. See Coral snake, under Coral.",
  "edibility": "Suitableness for being eaten; edibleness.",
  "etherin": "A white, crystalline hydrocarbon, regarded as a polymeric variety of ethylene, obtained in heavy oil of wine, the residue left after making ether; -- formerly called also concrete oil of wine.",
  ...
  "embayment": "A bay. [R.] The embayment which is terminated by the land of North Berwick. Sir W. Scott.",
  "epicerastic": "Lenient; assuaging. [Obs.]",
  "eigh": "An exclamation expressing delight.",
  "elasipoda": "An order of holothurians mostly found in the deep sea. They are remarkable for their bilateral symmetry and curious forms. [Written also Elasmopoda.]",
  ...
  "euphemistic": "Pertaining to euphemism; containing a euphemism; softened in expression. -- Eu`phe*mis\"tic*al*ly, adv.",
  "everyday": "Used or fit for every day; common; usual; as, an everyday suit or clothes. The mechanical drudgery of his everyday employment. Sir. J. Herchel.",
  "egad": "An exclamation expressing exultation or surprise, etc.",
  "exsiccator": "An apparatus for drying substances or preserving them from moisture; a desiccator; also, less frequently, an agent employed to absorb moisture, as calcium chloride, or concentrated sulphuric acid.",
  "extraction": "1. The act of extracting, or drawing out; as, the extraction of a tooth, of a bone or an arrow from the body, of a stump from earth, of a passage from a book, of an essence or tincture. 2. Derivation from a stock or family; lineage; descent; birth; the stock from which one has descended. \"A family of ancient extraction.\" Clarendon. 3. That which is extracted; extract; essence. They [books] do preserve as in a vial the purest efficacy and extraction of that living intellect that bred them. Milton. The extraction of roots. (Math.) (a) The operation of finding the root of a given number or quantity. (b) The method or rule by which the operation is performed; evolution.",
  "embouchure": "1. The mouth of a river; also, the mouth of a cannon. 2. (Mus.) (a) The mouthpiece of a wind instrument. (b) The shaping of the lips to the mouthpiece; as, a flute player has a good embouchure.",
  ...
  "eardrop": "1. A pendant for the ear; an earring; as, a pair of eardrops. 2. (Bot.)  A species of primrose. See Auricula.",
  ...
  "exmoor": "1. One of a breed of horned sheep of Devonshire, England, having white legs and face and black nostrils. They are esp. valuable for mutton. 2.  A breed of ponies native to the Exmoor district.",
  "eyewink": "A wink; a token. Shak.",
  "eglantine": "(a) A species of rose (Rosa Eglanteria), with fragrant foliage and flowers of various colors. (b) The sweetbrier (R. rubiginosa). Note: Milton, in the following lines, has applied the name to some twinning plant, perhaps the honeysuckle. Through the sweetbrier, or the vine, Or the twisted eglantine. L'Allegro, 47. \"In our early writers and in Gerarde and the herbalists, it was a shrub with white flowers.\" Dr. Prior.",
  "ealdorman": "An alderman. [Obs.]",
  ...
  "eulogistic": "Of or pertaining to eulogy; characterized by eulogy; bestowing praise; panegyrical; commendatory; laudatory; as, eulogistic speech or discourse. -- Eu\"lo*gis\"tic*al*ly, adv.",
  "exanthematic": "Of, relating to, or characterized by, exanthema; efflorescent; as, an exanthematous eruption.",
  ...
  "estival": "Same as Æstival, Æstivate, etc.",
  ...
  "ethology": "1. A treatise on morality; ethics. 2. The science of the formation of character, national and collective as well as individual. J. S. Mill.",
  ...
  "eurhipidurous": "Having a fanlike tail; belonging to the Eurhipiduræ, a division of Aves which includes all living birds.",
  ...
  "economizer": "1. One who, or that which, economizes. 2. Specifically: (Steam Boilers) An arrangement of pipes for heating feed water by waste heat in the gases passing to the chimney.",
  ...
  "externe": "An officer in attendance upon a hospital, but not residing in it; esp., one who cares for the out-patients.",
  "evade": "To get away from by artifice; to avoid by dexterity, subterfuge, address, or ingenuity; to elude; to escape from cleverly; as, to evade a blow, a pursuer, a punishment; to evade the force of an argument. The heathen had a method, more truly their own, of evading the Christian miracles. Trench.\n\n1. To escape; to slip away; -- sometimes with from. \"Evading from perils.\" Bacon. Unarmed they might Have easily, as spirits evaded swift By quick contraction or remove. Milton. 2. To attempt to escape; to practice artifice or sophistry, for the purpose of eluding. The ministers of God are not to evade and take refuge any of these . . . ways. South. Syn. - To equivocate; shuffle. See Prevaricate.",
  ...
  "enameled": "Coated or adorned with enamel; having a glossy or variegated surface; glazed. [Written also enamelled.]",
  "epicedian": "Epicedial. -- n.  An epicede.",
  "extrinsic": "1. Not contained in or belonging to a body; external; outward; unessential; -- opposed to intrinsic. The extrinsic aids of education and of artificial culture. I. Taylor. 2. (Anat.)  Attached partly to an organ or limb and partly to some other partintrinsic.",
  "elops": "1. (Zoöl.)  A genus of fishes. See Saury. 2. A mythical serpent. [Obs.] Milton.",
  "exampler": "A pattern; an exemplar. [Obs.]",
  "ethnological": "Of or pertaining to ethnology.",
  "employment": "1. The act of employing or using; also, the state of being employed. 2. That which engages or occupies; that which consumes time or attention; office or post of business; service; as, agricultural employments; mechanical employments; public employments; in the employment of government. Cares are employments, and without employ The soul is on a rack. Young. Syn. -- Work; business; occupation; vocation; calling; office; service; commission; trade; profession.",
  ...
  "expectant": "Waiting in expectation; looking for; (Med.)  waiting for the efforts of nature, with little active treatment. Expectant estate (Law), an estate in expectancy. See under Expectancy.\n\nOne who waits in expectation; one held in dependence by hope of receiving some good. An expectant of future glory. South. Those who had employments, or were expectants. Swift.",
  "effet": "The common newt; -- called also asker, eft, evat, and ewt.",
  "embloom": "To emblossom. Savage.",
  "effluxion": "1. The act of flowing out; effusion. 2. That which flows out; effluvium; emanation. Some light effluxions from spirit to spirit. Bacon.",
  ...
  "exocardial": "Situated or arising outside of the heat; as, exocardial murmurs; -- opposed to endocardiac.",
  ...
  "eger": "Sharp; bitter; acid; sour. [Obs.] The egre words of thy friend. Chaucer.\n\nAn impetuous flood; a bore. See Eagre.",
  "eyas": "A nesting or unfledged Lird; in falconry, a young hawk from the nest, not able to pr Shak J. H. Walsh\n\nUnfledged, or newly fledged. [Obs.] Like eyas hawk up mounts unto the skies, His newly budded pinions assay. Spebser.",
  ...
  "expectorate": "To eject from the trachea or lungs; to discharge, as phlegm or other matter, by coughing, hawking, and spitting; to spit forth.\n\nTo discharge matter from the lungs or throat bu hawking and spitting; to spit.",
  ...
  "eudemonics": "That part of moral philosophy which treats of happiness; the science of happiness; -- contrasted with aretaics. J. Grote.",
  ...
  "edulcoration": "1. The act of sweetening or edulcorating. 2. (Chem.)  The act of freeing from acids or any soluble substances, by affusions of water. [R.] Ure.",
  ...
  "excide": "To cut off. [R.]",
  "ebon": "1. Consisting of ebony. 2. Like ebony, especially in color; black; dark. Night, sable goddess! from her ebon throne. Young.\n\nEbony. [Poetic] \"Framed of ebon and ivory.\" Sir W. Scott.",
  ...
  "exedra": "1. (Class. Antiq.)  A room in a public building, furnished with seats. 2. (Arch.) (a) The projection of any part of a building in a rounded form. (b) Any out-of-door seat in stone, large enough for several persons; esp., one of curved form.",
  ...
  "empyreuma": "The peculiar smell and taste arising from products of decomposition of animal or vegetable substances when burnt in close vessels.",
  ...
  "empyreumatical": "Of or pertaining to empyreuma; as, an empyreumatic odor. Empyreumatic oils, oils obtained by distilling various organic substances at high temperatures. Brande & C.",
  ...
  "euphuist": "One who affects excessive refinement and elegance of language; -- applied esp. to a class of writers, in the age of Elizabeth, whose productions are marked by affected conceits and high-flown diction.",
  ...
  "encrinoidea": "That order of the Crinoidea which includes most of the living and many fossil forms, having jointed arms around the margin of the oral disk; -- also called Brachiata and Articulata. See Illusts. under Comatula and Crinoidea.",
  ...
  "exequatur": "1. A written official recognition of a consul or commercial agent, issued by the government to which he is accredited, and authorizing him to exercise his powers in the place to which he is assigned. 2. Official recognition or permission. Prescott.",
  ...
  "embronze": "1. To embody in bronze; to set up a bronze representation of, as of a person. [Poetic] 2. To color in imitation of bronze. See Bronze, v. t.",
  ...
  "exegetic": "Pertaining to exegesis; tending to unfold or illustrate; explanatory; expository. Walker. Ex`e*get\"ic*al*ly, adv.",
  ...
  "eland": "1. (Zoöl.)  A species of large South African antelope (Oreas canna). It is valued both for its hide and flesh, and is rapidly disappearing in the settled districts; -- called also Cape elk. 2. (Zoöl.)  The elk or moose.",
  "expurgation": "The act of expurgating, purging, or cleansing; purification from anything noxious, offensive, sinful, or erroneous. Milton.",
  "embrangle": "To confuse; to entangle. I am lost and embrangled in inextricable difficulties. Berkeley.",
  "ear-minded": "Thinking chiefly or most readily through, or in terms related to, the sense of hearing; specif., thinking words as spoken, as a result of familiarity with speech or of mental peculiarity; -- opposed to eye-minded.",
  "embassage": "1. An embassy. \"He sent a solemn embassage.\" Bacon. Except your embassages have better success. Motley. 2. Message; errand. Shak.",
  "eluctation": "A struggling out of any difficulty. [Obs.] Bp. Hall.",
  "earpick": "An instrument for removing wax from the ear.",
  "elzevir": "Applied to books or editions (esp. of the Greek New Testament and the classics) printed and published by the Elzevir family at Amsterdam, Leyden, etc., from about 1592 to 1680; also, applied to a round open type introduced by them. The Elzevir editions are valued for their neatness, and the elegant small types used. Brande & C. 'EM 'Em.  An obsolete or colloquial contraction of the old form hem, them. Addison.",
  ...
  "emeute": "A seditious tumult; an outbreak. E. M. F. E. M. F. (Physics)  An abbreviation for electro-motive force.",
  "epidotic": "Related to, resembling, or containing epidote; as, an epidotic granite.",
  "elixir": "1. (Med.)  A tincture with more than one base; a compound tincture or medicine, composed of various substances, held in solution by alcohol in some form. 2. (Alchemy)  An imaginary liquor capable of transmuting metals into gold; also, one for producing life indefinitely; as, elixir vitæ, or the elixir of life. 3. The refined spirit; the quintessence. The . . . elixir of worldly delights. South. 4. Any cordial or substance which invigorates. The grand elixir, to support the spirits of human nature. Addison.",
  "endozoa": "See Entozoa.",
  ...
  "expulsion": "1. The act of expelling; a driving or forcing out; summary removal from membership, association, etc. The expulsion of the Tarquins. Shak. 2. The state of being expelled or driven out.",
  ...
  "expostfacto": "From or by an after act, or thing done afterward; in consequence of a subsequent act; retrospective. Ex post facto law, a law which operates by after enactment. The phrase is popularly applied to any law, civil or criminal, which is enacted with a retrospective effect, and with intention to produce that effect; but in its true application, as employed in American law, it relates only to crimes, and signifies a law which retroacts, by way of criminal punishment, upon that which was not a crime before its passage, or which raises the grade of an offense, or renders an act punishable in a more severe manner that it was when committed. Ex post facto laws are held to be contrary to the fundamental principles of a free government, and the States are prohibited from passing such laws by the Constitution of the United States. Burrill. Kent.",
  ...
  "edgewise": "With the edge towards anything; in the direction of the edge. Glad to get in a word, as they say, edgeways. Sir W. Scott.",
  ...
  "excitability": "1. The quality of being readily excited; proneness to be affected by exciting causes. 2. (Physiol.)  The property manifested by living organisms, and the elements and tissues of which they are constituted, of responding to the action of stimulants; irritability; as, nervous excitability.",
  "eskar": "See Eschar.",
  "eavesdrop": "To stand under the eaves, near a window or at the door, of a house, to listen and learn what is said within doors; hence, to listen secretly to what is said in private. To eavesdrop in disguises. Milton.\n\nThe water which falls in drops from the eaves of a house.",
  ...
  "elytron": "(a) One of the anterior pair of wings in the Coleoptera and some other insects, when they are thick and serve only as a protection for the posterior pair. See Coleoptera. (b) One of the shieldlike dorsal scales of certain annelids. See Chætopoda.",
  ...
  "edh": "The name of the Anglo-Saxon letter edh, capital form th in a similar word: oedher, other, dôedh, doth.\" March.",
  ...
  "eldest": "1. Oldest; longest in duration. Shak. 2. Born or living first, or before the others, as a son, daughter, brother, etc.; first in origin. See Elder. \"My lady's eldest son.\" Shak. Their eldest historians are of suspected credit. Bp. Stillingfleet. Eldest hand (Card Playing), the player on the dealer's left hand. R. A. Proctor.",
  "earthnut": "A name given to various roots, tubers, or pods grown under or on the ground; as to: (a) The esculent tubers of the umbelliferous plants Bunium flexuosum and Carum Bulbocastanum. (b) The peanut. See Peanut.",
  "empurple": "To tinge or dye of a purple color; to color with purple; to impurple. \"The deep empurpled ran.\" Philips.",
  ...
  "exserted": "Standing out; projecting beyond some other part; as, exsert stamens. A small portion of the basal edge of the shell exserted. D. H. Barnes.",
  ...
  "emotionalize": "To give an emotional character to. Brought up in a pious family where religion was not talked about emotionalized, but was accepted as the rule of thought and conduct. Froude.",
  "eunomian": "A follower of Eunomius, bishop of Cyzicus (4th century A. D.), who held that Christ was not God but a created being, having a nature different from that of the Father. -- a.  Of or pertaining to Eunomius or his doctrine.",
  ...
  "etheostomoid": "Pertaining to, or like, the genus Etheostoma. -- n.  Any fish of the genus Etheostoma and related genera, allied to the perches; -- also called darter. The etheostomoids are small and often bright-colored fishes inhabiting the fresh waters of North America. About seventy species are known. See Darter.",
  ...
  "exoterical": "External; public; suitable to be imparted to the public; hence, capable of being readily or fully comprehended; -- opposed to esoteric, or secret. The foppery of an exoteric and esoteric doctrine. De Quincey.",
  ...
  "eventual": "1. Coming or happening as a consequence or result; consequential. Burke. 2. Final; ultimate. \"Eventual success.\" Cooper. 3. (Law)  Dependent on events; contingent. Marshall.",
  "ewt": "The newt.",
  ...
  "examinant": "1. One who examines; an examiner. Sir W. Scott. 2. One who is to be examined. [Obs.] H. Prideaux.",
  ...
  "earthborn": "1. Born of the earth; terrigenous; springing originally from the earth; human. Some earthborn giant. Milton. 2. Relating to, or occasioned by, earthly objects. All earthborn cares are wrong. Goldsmith.",
  ...
  "emerited": "Considered as having done sufficient public service, and therefore honorably discharged. [Obs.] Evelyn.",
  ...
  "exanthematous": "Of, relating to, or characterized by, exanthema; efflorescent; as, an exanthematous eruption.",
  ...
  "extremely": "In an extreme manner or state; in the utmost degree; to the utmost point; exceedingly; as, extremely hot or cold.",
  "embassadress": "Same as Ambassadress.",
  "embathe": "To bathe; to imbathe.",
  "excerption": "1. The act of excerpting or selecting. [R.] 2. That which is selected or gleaned; an extract. [R.] His excerptions out of the Fathers. Fuller.",
  ...
  "elocation": "1. A removal from the usual place of residence. [Obs.] 2. Departure from the usual state; an ecstasy. [Obs.]",
  ...
  "emulsin": "(a) The white milky pulp or extract of bitter almonds. [R.] (b) An unorganized ferment (contained in this extract and in other vegetable juices), which effects the decomposition of certain glucosides.",
  ...
  "effeminately": "1. In an effeminate or womanish manner; weakly; softly; delicately. \"Proud and effeminately gay.\" Fawkes. 2. By means of a woman; by the power or art of a woman. [R.] \"Effeminately vanquished.\" Milton.",
  "epagoge": "The adducing of particular examples so as to lead to a universal conclusion; the argument by induction.",
  "ethyl": "A monatomic, hydrocarbon radical, C2H5 of the paraffin series, forming the essential radical of ethane, and of common alcohol and ether. Ethyl aldehyde. (Chem.) See Aldehyde.",
  ...
  "expectoration": "1. The act of ejecting phlegm or mucus from the throat or lungs, by coughing, hawking, and spitting. 2. That which is expectorated, as phlegm or mucus.",
  "explicate": "Evolved; unfolded. Jer. Taylor.\n\n1. To unfold; to expand; to lay open. [Obs.] \"They explicate the leaves.\" Blackmore. 2. To unfold the meaning or sense of; to explain; to clear of difficulties or obscurity; to interpret. The last verse of his last satire is not yet sufficiently explicated. Dryden.",
  "embattle": "To arrange in order of battle; to array for battle; also, to prepare or arm for battle; to equip as for battle. One in bright arms embattled full strong. Spenser. Here once the embattled farmers stood And fired the shot heard round the world. Emerson.\n\nTo be arrayed for battle. [Obs.]\n\nTo furnish with battlements. \"Embattled house.\" Wordsworth.",
  "endostoma": "A plate which supports the labrum in certain Crustacea.",
  "expiatist": "An expiator. [R.]",
  "echidnine": "The clear, viscid fluid secreted by the poison glands of certain serpents; also, a nitrogenous base contained in this, and supposed to be the active poisonous principle of the virus. Brande & C.",
  "expost facto": "From or by an after act, or thing done afterward; in consequence of a subsequent act; retrospective. Ex post facto law, a law which operates by after enactment. The phrase is popularly applied to any law, civil or criminal, which is enacted with a retrospective effect, and with intention to produce that effect; but in its true application, as employed in American law, it relates only to crimes, and signifies a law which retroacts, by way of criminal punishment, upon that which was not a crime before its passage, or which raises the grade of an offense, or renders an act punishable in a more severe manner that it was when committed. Ex post facto laws are held to be contrary to the fundamental principles of a free government, and the States are prohibited from passing such laws by the Constitution of the United States. Burrill. Kent.",
  "estrepement": "A destructive kind of waste, committed by a tenant for life, in lands, woods, or houses. Cowell.",
  ...
  "excretion": "1. The act of excreting. To promote secretion and excretion. Pereira. 2. That which is excreted; excrement. Bacon.",
  ...
  "exoskeleton": "The hardened parts of the external integument of an animal, including hair, feathers, nails, horns, scales, etc.,as well as the armor of armadillos and many reptiles, and the shells or hardened integument of numerous invertebrates; external skeleton; dermoskeleton.",
  ...
  "european": "Of or pertaining to Europe, or to its inhabitants. On the European plain, having rooms to let, and leaving it optional with guests whether they will take meals in the house; -- said of hotels. [U. S.]\n\nA native or an inhabitant of Europe.",
  "elaborated": "developed or executed with care and in minute detail; as, the carefully elaborated theme. Syn. -- detailed, elaborate. [WordNet 1.5]",
  ...
  "extempore": "Without previous study or meditation; without preparation; on the spur of the moment; suddenly; extemporaneously; as, to write or speak extempore. Shak. -- a.  Done or performed extempore. \"Extempore dissertation.\" Addison. \"Extempore poetry.\" Dryden. -- n.  Speaking or writing done extempore. [Obs.] Bp. Fell.",
  ...
  "evert": "1. To overthrow; to subvert. [R.] Ayliffe. 2. To turn outwards, or inside out, as an intestine.",
  "exceptionable": "Liable to exception or objection; objectionable. -- Ex*cep\"tion*a*ble*ness, n. This passage I look upon to be the most exceptionable in the whole poem. Addison.",
  ...
  "estramacon": "1. A straight, heavy sword with two edges, used in the 16th and 17th centuries. 2. A blow with edge of a sword. Farrow.",
  ...
  "exuberant": "Characterized by abundance or superabundance; plenteous; rich; overflowing; copious or excessive in production; as, exuberant goodness; an exuberant intellect; exuberant foliage. \"Exuberant spring.\" Thomson. -- Ex*u\"ber*ant*ly, adv.",
  "echinococcus": "A parasite of man and of many domestic and wild animals, forming compound cysts or tumors (called hydatid cysts) in various organs, but especially in the liver and lungs, which often cause death. It is the larval stage of the Tænia echinococcus, a small tapeworm peculiar to the dog.",
  "erigible": "Capable of being erected. [Obs.]",
  "eh": "An expression of inquiry or slight surprise.",
  "ethylsulphuric": "Pertaining to, or containing, ethyl and sulphuric acid. Ethylsulphuric acid (Chem.), an acid sulphate of ethyl, H.C2H5.SO4, produced as a thick liquid by the action of sulphiric acid on alcohol. It appears to be the active catalytic agent in the process of etherification.",
  ...
  "eolic": "See Æolic.",
  "ecstatic": "1. Pertaining to, or caused by, ecstasy or excessive emotion; of the nature, or in a state, of ecstasy; as, ecstatic gaze; ecstatic trance. This ecstatic fit of love and jealousy. Hammond. 2. Delightful beyond measure; rapturous; ravishing; as, ecstatic bliss or joy.\n\nAn enthusiast. [R.] Gauden.",
  ...
  "expiring": "1. Breathing out air from the lungs; emitting fluid or volatile matter; exhaling; breathing the last breath; dying; ending; terminating. 2. Pertaining to, or uttered at, the time of dying; as, expiring words; expiring groans.",
  "embodier": "One who embodies.",
  "expurge": "To purge away. [Obs.] Milton.",
  "elusive": "Tending to elude; using arts or deception to escape; adroitly escaping or evading; eluding the grasp; fallacious. Elusive of the bridal day, she gives Fond hopes to all, and all with hopes deceives. Pope. -- E*lu\"sive*ly, adv. -- E*lu\"sive*ness, n.",
  "exceptionless": "Without exception. A universal, . . . exceptionless disqualification. Bancroft.",
  "exuviate": "To shed an old covering or condition preliminary to taking on a new one; to molt. There is reason to suppose that very old crayfish do not exuviate every year. Huxley.",
  ...
  "emblematic": "Pertaining to, containing, or consisting in, an emblem; symbolic; typically representative; representing as an emblem; as, emblematic language or ornaments; a crown is emblematic of royalty; white is emblematic of purity. -- Em`blem*at\"ic*al*ly, adv.",
  "exudation": "The act of exuding; sweating; a discharge of humors, moisture, juice, or gum, as through pores or incisions; also, the substance exuded. Resins, a class of proximate principles, existing in almost all plants and appearing on the external surface of many of them in the form of exudations. Am. Cyc.",
  ...
  "elytrum": "(a) One of the anterior pair of wings in the Coleoptera and some other insects, when they are thick and serve only as a protection for the posterior pair. See Coleoptera. (b) One of the shieldlike dorsal scales of certain annelids. See Chætopoda.",
  ...
  "exactness": "1. The condition of being exact; accuracy; nicety; precision; regularity; as, exactness of jurgement or deportment. 2. Careful observance of method and conformity to truth; as, exactness in accounts or business. He had . . . that sort of exactness which would have made him a respectable antiquary. Macaulay.",
  ...
  "embale": "1. To make up into a bale or pack. Johnson. 2. To bind up; to inclose. Legs . . . embaled in golden buskins. Spenser.",
  ...
  "effort": "1. An exertion of strength or power, whether physical or mental, in performing an act or aiming at an object; more or less strenuous endeavor; struggle directed to the accomplishment of an object; as, an effort to scale a wall. We prize the stronger effort of his power. Pope. 2. (Mech.)  A force acting on a body in the direction of its motion. Rankine. Syn. -- Endeavor; exertion; struggle; strain; straining; attempt; trial; essay. See Attempt.\n\nTo stimulate. [Obs.] \"He efforted his spirits.\" Fuller.",
  ...
  "ecthoreum": "The slender, hollow thread of a nettling cell or cnida. See Nettling cell. [Written also ecthoræum.]",
  ...
  "emblement": "The growing crop, or profits of a crop which has been sown or planted; -- used especially in the plural. The produce of grass, trees, and the like, is not emblement. Wharton's Law Dict.",
  ...
  "euxanthic": "Having a yellow color; pertaining to, derived from, or resembling, euxanthin. Euxanthic acid (Chem.), a yellow, crystalline, organic acid, extracted from euxanthin.",
  ...
  "eolis": "A genus of nudibranch mollusks having clusters of branchial papillæ along the back. See Ceratobranchia. [Written also Æolis.]",
  ...
  "emprise": "1. An enterprise; endeavor; adventure. Chaucer. In brave pursuit of chivalrous emprise. Spenser. The deeds of love and high emprise. Longfellow. 2. The qualifies which prompt one to undertake difficult and dangerous exploits. I love thy courage yet and bolt emprise; But here thy sword can do thee little stead. Milton.\n\nTo undertake. [Obs.] Sackville.",
  ...
  "eyed": "Heaving (such or so many) eyes; -- used in composition; as sharp-eyed; dull-eyed; sad-eyed; ox-eyed Juno; myriad-eyed.",
  "eye-spotted": "Marked with spots like eyes. Junno's bird, in her eye-spotted train. Spenser.",
  "elevatory": "Tending to raise, or having power to elevate; as, elevatory forces.\n\nSee Elevator, n. (e). Dunglison.",
  "episternum": "1. (Anat.) (a) A median bone connected with the sternum, in many vertebrates; the interclavicle. (b) Same as Epiplastron. 2. (Zoöl.)  One of the lateral pieces next to the sternum in the thorax of insects.",
  ...
  "exactor": "One who exacts or demands by authority or right; hence, an extortioner; also, one unreasonably severe in injunctions or demands. Jer. Taylor.",
  ...
  "extrajudicial": "Out of or beyond the proper authority of a court or judge; beyond jurisdiction; not legally required. \"An extrajudicial opinion.\" Hallam. -- Ex`tra*ju*di\"cial*ly, adv.",
  ...
  "executant": "One who executes or performs; esp., a performer on a musical instrument. Great executants on the organ. De Quincey.",
  ...
  "eudiometry": "The art or process of determining he constituents of a gaseous mixture by means of the eudiometer, or for ascertaining the purity of the air or the amount of oxygen in it.",
  "educational": "Of or pertaining to education. \"His educational establishment.\" J. H. Newman.",
  "epicedium": "An epicede.",
  "evangile": "Good tidings; evangel. [R.] Above all, the Servians . . . read, with much avidity, the evangile of their freedom. Londor.",
  "exagitate": "1. To stir up; to agitate. [Obs.] Arbuthnot. 2. To satirize; to censure severely. [Obs.] Hooker.",
  ...
  "ectoderm": "(a) The outer layer of the blastoderm; epiblast. (b) The external skin or outer layer of an animal or plant, this being formed in an animal from the epiblast. See Illust. of Blastoderm.",
  "enshield": "To defend, as with a shield; to shield. [Archaic] Shak.\n\nShielded; enshielded. [Obs.] Shak.",
  "edifier": "1. One who builds. [Obs.] 2. One who edifies, builds up, or strengthens another by moral or religious instruction.",
  "epigraphy": "The science of inscriptions; the art of engraving inscriptions or of deciphering them.",
  "errata": "See Erratum.",
  "emargination": "The act of notching or indenting the margin, or the state of being so notched; also, a notch or shallow sinus in a margin.",
  ...
  "exalted": "Raised to lofty height; elevated; extolled; refined; dignified; sublime. Wiser far than Solomon, Of more exalted mind. Milton. Time never fails to bring every exalted reputation to a strict scrutiny. Ames. -- Ex*alt\"ed*ly, adv. -- Ex*alt\"ed*ness, n. \"The exaltedness of some minds.\" T. Gray.",
  ...
  "eupnaea": "Normal breathing where arterialization of the blood is normal, in distinction from dyspnæa, in which the blood is insufficiently arterialized. Foster.",
  ...
  "exacting": "Oppressive or unreasonably severe in making demands or requiring the exact fulfillment of obligations; harsh; severe. \"A temper so exacting.\" T. Arnold -- Ex*act\"ing*ly, adv. -- Ex*act\"ing*ness, n.",
  "exuvial": "Of or pertaining to exuviæ. \"Exuvial layers.\" \"Exuvial deposits.\"",
  "elasmobranchii": "A subclass of fishes, comprising the sharks, the rays, and the Chimæra. The skeleton is mainly cartilaginous.",
  ...
  "exceptive": "That excepts; including an exception; as, an exceptive proposition. I. Watts. A particular and exceptive law. Milton.",
  "exorcism": "1. The act of exorcising; the driving out of evil spirits from persons or places by conjuration; also, the form of conjuration used. 2. Conjuration for raising spirits. [R.] Shak.",
  ...
  "endoparasite": "Any parasite which lives in the internal organs of an animal, as the tapeworms, Trichina, etc.; -- opposed to ectoparasite. See Entozoön. -- En`do*par`a*sit\"ic, a.",
  "ectosteal": "Of or pertaining to ectostosis; as, ectosteal ossification.",
  "electro-magnetism": "The magnetism developed by a current of electricity; the science which treats of the development of magnetism by means of voltaic electricity, and of the properties or actions of the currents evolved.",
  ...
  "ekaboron": "The name given by Mendelejeff in accordance with the periodic law, and by prediction, to a hypothetical element then unknown, but since discovered and named scandium; -- so called because it was a missing analogue of the boron group. See Scandium.",
  ...
  "eyeglass": "1. A lens of glass to assist the sight. Eyeglasses are used singly or in pairs. 2. Eyepiece of a telescope, microscope, etc. 3. The retina. [Poetic] 4. A glass eyecup. See Eyecup.",
  ...
  "eversion": "1. The act of eversing; destruction. Jer. Taylor. 2. The state of being turned back or outward; as, eversion of eyelids; ectropium.",
  "exceed": "To go beyond; to proceed beyond the given or supposed limit or measure of; to outgo; to surpass; -- used both in a good and a bad sense; as, one man exceeds another in bulk, stature, weight, power, skill, etc. ; one offender exceeds another in villainy; his rank exceeds yours. Name the time, but let it not Exceed three days. Shak. Observes how much a chintz exceeds mohair. Pope. Syn. -- To outdo; surpass; excel; transcend; outstrip; outvie; overtop.\n\n1. To go too far; to pass the proper bounds or measure. \"In our reverence to whom, we can not possibly exceed.\" Jer. Taylor. Forty stripes he may give him, and not exceed. Deut. xxv. 3. 2. To be more or greater; to be paramount. Shak.",
  "encheason": "Occasion, cause, or reason. [Obs.] Chaucer.",
  "estimative": "1. Inclined, or able, to estimate; serving for, or capable of being used in, estimating. We find in animals an estimative or judicial faculty. Sir M. Hale. 2. Pertaining to an estimate. [R.]",
  "experimenter": "One who makes experiments; one skilled in experiments. Faraday.",
  "enamor": "To inflame with love; to charm; to captivate; -- with of, or with, before the person or thing; as, to be enamored with a lady; to be enamored of books or science. [Written also enamour.] Passionately enamored of this shadow of a dream. W. Irving.",
  ...
  "euxanthin": "A yellow pigment imported from India and China. It has a strong odor, and is said to be obtained from the urine of herbivorous animals when fed on the mango. It consists if a magnesium salt of euxanthic acid. Called also puri, purree, and Indian yellow.",
  ...
  "elemental": "1. Pertaining to the elements, first principles, and primary ingredients, or to the four supposed elements of the material world; as, elemental air. \"Elemental strife.\" Pope. 2. Pertaining to rudiments or first principles; rudimentary; elementary. \"The elemental rules of erudition.\" Cawthorn.",
  ...
  "escouade": "See Squad,",
  "egoistic": "Pertaining to egoism; imbued with egoism or excessive thoughts of self; self-loving. Ill-natured feeling, or egoistic pleasure in making men miserable. G. Eliot.",
  ...
  "eozooen": "A peculiar structure found in the Archæan limestones of Canada and other regions. By some geologists it is believed to be a species of gigantic Foraminifera, but others consider it a concretion, without organic structure.",
  ...
  "eclampsia": "A fancied perception of flashes of light, a symptom of epilepsy; hence, epilepsy itself; convulsions. Note: The term is generally restricted to a convulsive affection attending pregnancy and parturition, and to infantile convulsions.",
  ...
  "ethmoidal": "(a) Like a sieve; cribriform. (b) Pertaining to, or in the region of, the ethmoid bone. Ethmoid bone (Anat.), a bone of complicated structure through which the olfactory nerves pass out of the cranium and over which they are largely distributed.",
  ...
  "elation": "A lifting up by success; exaltation; inriation with pride of prosperity. \"Felt the elation of triumph.\" Sir W. Scott.",
  "emberizidae": "a natural subfamily including buntings and some New World sparrows. Syn. -- subfamily Emberizidae, subfamily Emberizinae. [WordNet 1.5]",
  ...
  "el dorado": "1. A name given by the Spaniards in the 16th century to an imaginary country in the interior of South America, reputed to abound in gold and precious stones. 2. Any region of fabulous wealth; exceeding richness. The whole comedy is a sort of El Dorado of wit. T. Moore.",
  ...
  "emollescence": "That degree of softness in a body beginning to melt which alters its shape; the first or lowest degree of fusibility.",
  "exemplary": "1. Serving as a pattern; deserving to be proposed for imitation; commendable; as, an exemplary person; exemplary conduct. [Bishops'] lives and doctrines ought to be exemplary. Bacon. 2. Serving as a warning; monitory; as, exemplary justice, punishment, or damages. 3. Illustrating as the proof of a thing. Fuller. Exemplary damages. (Law) See under Damage.\n\nAn exemplar; also, a copy of a book or writing. [Obs.] Donne.",
  "elohist": "The writer, or one of the writers, of the passages of the Old Testament, notably those of Elohim instead of Jehovah, as the name of the Supreme Being; -- distinguished from Jehovist. S. Davidson.",
  "eyry": "The nest of a bird of prey or other large bird that builds in a lofty place; aerie. The eagle and the stork On cliffs and cedar tops their eyries build. Milton.",
  ...
  "epinikian": "Epinicial.",
  "elope": "To run away, or escape privately, from the place or station to which one is bound by duty; -- said especially of a woman or a man, either married or unmarried, who runs away with a paramour or a sweetheart. Great numbers of them [the women] have eloped from their allegiance. Addison.",
  ...
  "electrocute": "To execute or put to death by electricity. -- E*lec`tro*cu\"tion, n. Note: [Recent; Newspaper words]",
  ...
  "expedite": "1. Free of impediment; unimpeded. To make the way plain and expedite. Hooker. 2. Expeditious; quick; speedily; prompt. Nimble and expedite . . . in its operation. Tollotson. Speech is a very short and expedite way of conveying their thoughts. Locke.\n\n1. To relieve of impediments; to facilitate; to accelerate the process or progress of; to hasten; to quicken; as, to expedite the growth of plants. To expedite your glorious march. Milton. 2. To despatch; to send forth; to issue officially. Such charters be expedited of course. Bacon.",
  ...
  "eucalyptus": "A myrtaceous genus of trees, mostly Australian. Many of them grow to an immense height, one or two species exceeding the height even of the California Sequoia. Note: They have rigid, entire leaves with one edge turned toward the zenith. Most of them secrete resinous gums, whence they called gum trees, and their timber is of great value. Eucalyptus Globulus is the blue gum; E. aigantea, the stringy bark: E. amygdalina, the peppermint tree. E. Gunnii, the Tasmanian cider tree, yields a refreshing drink from wounds made in the bark in the spring. Center species yield oils, tars, acids, dyes and tans. It is said that miasmatic valleys in Algeria and Portugal, and a part of the unhealthy Roman Campagna, have been made more salubrious by planting groves of these trees.",
  "encroach": "To enter by gradual steps or by stealth into the possessions or rights of another; to trespass; to intrude; to trench; -- commonly with on or upon; as, to encroach on a neighbor; to encroach on the highway. No sense, faculty, or member must encroach upon or interfere with the duty and office of another. South. Superstition, . . . a creeping and encroaching evil. Hooker. Exclude the encroaching cattle from thy ground. Dryden. Syn. -- To intrude; trench; infringe; invade; trespass.\n\nEncroachment. [Obs.] South.",
  "ethmotrubinal": "See Turbinal. -- n.  An ethmoturbinal bone.",
  "endamnify": "To damnify; to injure. [R.] Sandys.",
  "exsufflation": "1. A blast from beneath. [Obs.] Bacon. 2. (Eccles.)  A kind of exorcism by blowing with the breath. Jer. Taylor. 3. (Physiol.)  A strongly forced expiration of air from the lungs.",
  "excessive": "Characterized by, or exhibiting, excess; overmuch. Excessive grief [is] the enemy to the living. Shak. Syn. -- Undue; exorbitant; extreme; overmuch; enormous; immoderate; monstrous; intemperate; unreasonable. See Enormous --Ex*cess*ive*ly, adv. -Ex*cess\"ive*ness, n.",
  ...
  "eurypteroidea": "An extinct order of Merostomata, of which the genus Eurypterus is the type. They are found only in Paleozoic rocks. [Written also Eurypterida.]",
  ...
  "expand": "1. To lay open by extending; to open wide; to spread out; to diffuse; as, a flower expands its leaves. Then with expanded wings he steers his flight. Milton. 2. To cause the particles or parts of to spread themselves or stand apart, thus increasing bulk without addition of substance; to make to occupy more space; to dilate; to distend; to extend every way; to enlarge; -- opposed to Ant: contract; as, to expand the chest; heat expands all bodies; to expand the sphere of benevolence. 3. (Math.)  To state in enlarged form; to develop; as, to expand an equation. See Expansion, 5.\n\nTo become widely opened, spread apart, dilated, distended, or enlarged; as, flowers expand in the spring; metals expand by heat; the heart expands with joy. Dryden.",
  ...
  "efflorescent": "1. That effloresces, or is liable to effloresce on exposure; as, an efflorescent salt. 2. Covered with an efflorescence.",
  "elysium": "1. A dwelling place assigned to happy souls after death; the seat of future happiness; Paradise. 2. Hence, any delightful place. An Elysian more pure and bright than that pf the Greeks. I. Taylor.",
  ...
  "epipodial": "1. (Anat.)  Pertaining to the epipodialia or the parts of the limbs to which they belong. 2. (Zoöl.)  Pertaining to the epipodium of Mollusca.",
  ...
  "expiratory": "Pertaining to, or employed in, the expiration or emission of air from the lungs; as, the expiratory muscles.",
  ...
  "explication": "1. The act of opening, unfolding, or explaining; explanation; exposition; interpretation. The explication of our Savior's parables. Atterbury. 2. The sense given by an expositor. Bp. Burnet.",
  ...
  "eclat": "1. Brilliancy of success or effort; splendor; brilliant show; striking effect; glory; renown. \"The eclat of Homer's battles.\" Pope. 2. Demonstration of admiration and approbation; applause. Prescott.",
  ...
  "elbowroom": "Room to extend the elbows on each side; ample room for motion or action; free scope. \"My soul hath elbowroom.\" Shak. Then came a stretch of grass and a little more elbowroom. W. G. Norris.",
  ...
  "elegiac": "1. Belonging to elegy, or written in elegiacs; plaintive; expressing sorrow or lamentation; as, an elegiac lay; elegiac strains. Elegiac griefs, and songs of love. Mrs. Browning. 2. Used in elegies; as, elegiac verse; the elegiac distich or couplet, consisting of a dactylic hexameter and pentameter.\n\nElegiac verse.",
  ...
  "exuviation": "The rejecting or casting off of some part, more particularly, the outer cuticular layer, as the shells of crustaceans, skins of snakes, etc.; molting; ecdysis.",
  "easternmost": "Most eastern.",
  "extra-ocular": "Inserted exterior to the eyes; -- said of the antennæ of certain insects.",
  ...
  "emblazon": "1. To depict or represent; -- said of heraldic bearings. See Blazon. 2. To deck in glaring colors; to set off conspicuously; to display pompously; to decorate. The walls were . . . emblazoned with legends in commemoration of the illustrious pair. Prescott.",
  "elinguation": "Punishment by cutting out the tongue.",
  "excrescent": "Growing out in an abnormal or morbid manner or as a superfluity. Expunge the whole, or lip the excrescent parts. Pope. Excrescent letter (Philol.), a letter which has been added to a root; as, the d in alder (AS. alr) is an excrescent letter.",
  ...
  "elaterite": "A mineral resin, of a blackish brown color, occurring in soft, flexible masses; -- called also mineral caoutchouc, and elastic bitumen.",
  ...
  "everichon": "Every one. [Obs.] Chaucer.",
  ...
  "exergue": "The small space beneath the base line of a subject engraved on a coin or medal. It usually contains the date, place, engraver's name, etc., or other subsidiary matter. Fairholt.",
  ...
  "encomiastical": "Bestowing praise; praising; eulogistic; laudatory; as, an encomiastic address or discourse. -- En*co`mi*as\"tic*al*ly, adv.",
  ...
  "embolismical": "Pertaining to embolism or intercalation; intercalated; as, an embolismic year, i. e., the year in which there is intercalation.",
  "eyesalve": "Ointment for the eye.",
  "evangely": "Evangel. [Obs.] The sacred pledge of Christ's evangely. Spenser.",
  "emetine": "A white crystalline bitter alkaloid extracted from ipecacuanha root, and regarded as its peculiar emetic principle.",
  ...
  "execute": "1. To follow out or through to the end; to carry out into complete effect; to complete; to finish; to effect; to perform; Why delays His hand to execute what his decree Fixed on this day Milton. 2. To complete, as a legal instrument; to perform what is required to give validity to, as by signing and perhaps sealing and delivering; as, to execute a deed, lease, mortgage, will, etc. 3. To give effect to; to do what is provided or required by; to perform the requirements or stimulations of; as, to execute a decree, judgment, writ, or process. 4. To infect capital punishment on; to put to death in conformity to a legal sentence; as, to execute a traitor. 5. Too put to death illegally; to kill. [Obs.] Shak. 6. (Mus.)  To perform, as a piece of music, either on an instrument or with the voice; as, to execute a difficult part brilliantly. Syn. -- To accomplish; effect; fulfill; achieve; consummate; finish; complete. See Accomplish.\n\n1. To do one's work; to act one's part of purpose. [R.] Hayward. 2. To perform musically.",
  ...
  "enclosure": "Inclosure. See Inclosure. Note: The words enclose and enclosure are written indiscriminately enclose or inclose and enclosure or inclosure.",
  ...
  "ethnic": "1. Belonging to races or nations; based on distinctions of race; ethnological. 2. Pertaining to the gentiles, or nations not converted to Christianity; heathen; pagan; -- opposed to Jewish and Christian.\n\nA heathen; a pagan. [Obs.] No better reported than impure ethnic and lay dogs. Milton.",
  ...
  "exsiccant": "Having the quality of drying up; causing a drying up. -- n. (Med.)  An exsiccant medicine.",
  ...
  "ectoblast": "(a) The outer layer of the blastoderm; the epiblast; the ectoderm. (b) The outer envelope of a cell; the cell wall. Agassiz.",
  ...
  "emarginate": "To take away the margin of.\n\n1. Having the margin interrupted by a notch or shallow sinus. 2. (Bot.)  Notched at the summit. 3. (Cryst.)  Having the edges truncated.",
  ...
  "eldership": "1. The state of being older; seniority. \"Paternity an eldership.\" Sir W. Raleigh. 2. Office of an elder; collectively, a body of elders.",
  ...
  "enactment": "1. The passing of a bill into a law; the giving of legislative sanction and executive approval to a bill whereby it is established as a law. 2. That which is enacted or passed into a law; a law; a decree; a statute; a prescribed requirement; as, a prohibitory enactment; a social enactment.",
  ...
  "ewe-necked": "Having a neck like a ewe; -- said of horses in which the arch of the neck is deficent, being somewhat hollowed out. Youwatt.",
  ...
  "encrinite": "A fossil crinoid, esp. one belonging to, or resembling, the genus Encrinus. Sometimes used in a general sense for any crinoid.",
  ...
  "enamelist": "One who enamels; a workman or artist who applies enamels in ornamental work. [Written also enameller, enamellist.]",
  "encaenia": "= Encenia.",
  ...
  "epicranium": "1. (Anat.)  The upper and superficial part of the head, including the scalp, muscles, etc. 2. (Zoöl.)  The dorsal wall of the head of insects.",
  ...
  "embolus": "1. Something inserted, as a wedge; the piston or sucker of a pump or syringe. 2. (Med.)  A plug of some substance lodged in a blood vessel, being brought thither by the blood current. It consists most frequently of a clot of fibrin, a detached shred of a morbid growth, a globule of fat, or a microscopic organism.",
  ...
  "embattled": "1. Having indentations like a battlement. [Obs.] Chaucer. 2. (Her.)  Having the edge broken like battlements; -- said of a bearing such as a fess, bend, or the like. 3. Having been the place of battle; as, an embattled plain or field. J. Baillie.",
  ...
  "exigent": "Exacting or requiring immediate aid or action; pressing; critical. \"At this exigent moment.\" Burke.\n\n1. Exigency; pressing necessity; decisive moment. [Obs.] Why do you cross me in this exigent Shak. 2. (o. Eng. Law)  The name of a writ in proceedings before outlawry. Abbott.",
  "exhibitive": "Serving for exhibition; representative; exhibitory. Norris. -- Ex*hib\"it*ive*ly, adv.",
  "edile": "See Ædile.",
  "euphorbium": "An inodorous exudation, usually in the form of yellow tears, produced chiefly by the African Euphorbia resinifrea. It was formerly employed medicinally, but was found so violent in its effects that its use is nearly abandoned.",
  "elflock": "Hair matted, or twisted into a knot, as if by elves.",
  "evacuation": "1. The act of emptying, clearing of the contents, or discharging. Specifically: (a) (Mil.) Withdrawal of troops from a town, fortress, etc. (b) (Med.) Voidance of any matter by the natural passages of the body or by an artificial opening; defecation; also, a diminution of the fluids of an animal body by cathartics, venesection, or other means. 2. That which is evacuated or discharged; especially, a discharge by stool or other natural means. Quincy. 3. Abolition; nullification. [Obs.] Hooker. Evacuation day, the anniversary of the day on which the British army evacuated the city of New York, November 25, 1783.",
  ...
  "echidna": "1. (Gr. Myth.)  A monster, half maid and half serpent. 2. (Zoöl.)  A genus of Monotremata found in Australia, Tasmania, and New Guinea. They are toothless and covered with spines; -- called also porcupine ant-eater, and Australian ant-eater.",
  "ecurie": "A stable.",
  "etiolate": "1. To become white or whiter; to be whitened or blanched by excluding the light of the sun, as, plants. 2. (Med.)  To become pale through disease or absence of light.\n\n1. To blanch; to bleach; to whiten by depriving of the sun's rays. 2. (Med.)  To cause to grow pale by disease or absence of light.\n\nHaving a blanched or faded appearance, as birds inhabiting desert regions.",
  "eudemonistical": "Eudemonistic.",
  ...
  "elwand": "See Ellwand.",
  "evasive": "Tending to evade, or marked by evasion; elusive; shuffling; avoiding by artifice. Thus he, though conscious of the ethereal guest, Answered evasive of the sly request. Pope. Stammered out a few evasive phrases. Macaulay. -- E*va\"sive*ly , adv. -- E*va\"sive*ness, n.",
  ...
  "electrometer": "An instrument for measuring the quantity or intensity of electricity; also, sometimes, and less properly, applied to an instrument which indicates the presence of electricity (usually called an electroscope). Balance electrometer. See under Balance.",
  ...
  "exsanguious": "1. Destitute of blood. Sir T. Browne. 2. (Zoöl.)  Destitute of true, or red, blood, as insects.",
  ...
  "echometer": "A graduated scale for measuring the duration of sounds, and determining their different, and the relation of their intervals. J. J. Rousseau.",
  ...
  "exemption": "The act of exempting; the state of being exempt; freedom from any charge, burden, evil, etc., to which others are subject; immunity; privilege; as, exemption of certain articles from seizure; exemption from military service; exemption from anxiety, suffering, etc.",
  ...
  "evangel": "Good news; announcement of glad tidings; especially, the gospel, or a gospel. Milton. Her funeral anthem is a glad evangel. Whittier.",
  ...
  "encyclic": "Sent to many persons or places; intended for many, or for a whole order of men; general; circular; as, an encyclical letter of a council, of a bishop, or the pope.\n\nAn encyclical letter, esp. one from a pope. Shipley.",
  ...
  "embolismic": "Pertaining to embolism or intercalation; intercalated; as, an embolismic year, i. e., the year in which there is intercalation.",
  "endurably": "In an endurable manner.",
  "exspuition": "A discharge of saliva by spitting. [R.] E. Darwin.",
  "elsewhither": "To some, or any, other place; as, you will have to go elsewhither for it. R. of Gloucester.\"For elsewhither was I bound.\" Carlyle.",
  "exorcise": "1. To cast out, as a devil, evil spirits, etc., by conjuration or summoning by a holy name, or by certain ceremonies; to expel (a demon) or to conjure (a demon) to depart out of a person possessed by one. He impudently excorciseth devils in the church. Prynne. 2. To deliver or purify from the influence of an evil spirit or demon. Exorcise the beds and cross the walls. Dryden. Mr. Spectator . . . do all you can to exorcise crowds who are . . . processed as I am. Spectator.",
  "exscript": "A copy; a transcript. [Obs.] Bailey.",
  "electrum": "1. Amber. 2. An alloy of gold and silver, of an amber color, used by the ancients. 3. German-silver plate. See German silver, under German.",
  ...
  "eulogistical": "Of or pertaining to eulogy; characterized by eulogy; bestowing praise; panegyrical; commendatory; laudatory; as, eulogistic speech or discourse. -- Eu\"lo*gis\"tic*al*ly, adv.",
  "exaration": "Act of plowing; also, act of writing. [Obs.] Bailey.",
  "egress": "1. The act of going out or leaving, or the power to leave; departure. Embarred from all egress and regress. Holland. Gates of burning adamant, Barred over us, prohibit all egress. Milton. 2. (Astron.)  The passing off from the sun's disk of an inferior planet, in a transit.\n\nTo go out; to depart; to leave.",
  "extenuation": "The act of axtenuating or the state of being extenuated; the act of making thin, slender, or lean, or of palliating; diminishing, or lessening; palliation, as of a crime; mitigation, as of punishment. To listen . . . to every extenuation of what is evil. I. Taylor.",
  ...
  "euplastic": "Having the capacity of becoming organizable in a high degree, as the matter forming the false membranes which sometimes result from acute inflammation in a healthy person. Dunglison.\n\nOrganizable substance by which the tissues of an animal body are renewed.",
  ...
  "eye-minded": "Having one's mental imagery prevailingly of the visual type; having one's thoughts and memories mainly in the form of visual images. -- Eye\"-mind`ed*ness, n.",
  ...
  "eftsoon": "Again; anew; a second time; at once; speedily. [Archaic] And, if he fall from his capel [horse] eftsone. Chaucer. The champion stout eftsoons dismounted. Spenser.",
  ...
  "ecaudate": "1. (Bot.)  Without a tail or spur. 2. (Zoöl.)  Tailless.",
  "emendation": "1. The act of altering for the better, or correcting what is erroneous or faulty; correction; improvement. \"He lies in his sin without repentance or emendation.\" Jer. Taylor. 2. Alteration by editorial criticism, as of a text so as to give a better reading; removal of errors or corruptions from a document; as, the book might be improved by judicious emendations.",
  "embezzle": "1. To appropriate fraudulently to one's own use, as property intrusted to one's care; to apply to one's private uses by a breach of trust; as, to embezzle money held in trust. 2. To misappropriate; to waste; to dissipate in extravagance. [Obs.] To embezzle our money in drinking or gaming. Sharp.",
  "earthbred": "Low; grovelling; vulgar.",
  "eupittone": "A yellow, crystalline substance, resembling aurin, and obtained by the oxidation of pittacal; -- called also eupittonic acid. [Written also eupitton.]",
  "exolution": "See Exsolution. [Obs.] Sir T. Browne.",
  "electro-etching": "A mode of etching upon metals by electrolytic action.",
  "extrude": "To thrust out; to force, press, or push out; to expel; to drive off or away. \"Parentheses thrown into notes or extruded to the margin.\" Coleridge.",
  ...
  "expatriation": "The act of banishing, or the state of banishment; especially, the forsaking of one's own country with a renunciation of allegiance. Expatriation was a heavy ransom to pay for the rights of their minds and souls. Palfrey.",
  "extensionist": "One who favors or advocates extension.",
  "elucidative": "Making clear; tending to elucidate; as, an elucidative note.",
  "extravascular": "(a) Outside the vessels; -- said of the substance of all the tissues. (b) Destitute of vessels; non-vascular.",
  "estiferous": "Producing heat. [R.] Smart.",
  "elogium": "The praise bestowed on a person or thing; panegyric; eulogy.",
  "eosin": "A yellow or brownish red dyestuff obtained by the action of bromine on fluoresceïn, and named from the fine rose-red which it imparts to silk. It is also used for making a fine red ink. Its solution is fluorescent.",
  "etude": "1. A composition in the fine arts which is intended, or may serve, for a study. 2. (Mus.)  A study; an exercise; a piece for practice of some special point of technical execution.",
  "ejoo": "Gomuti fiber. See Gomuti.",
  "en": "1. Etym: [F. en-, L. in.]  A prefix signifying in or into, used in many English words, chiefly those borrowed from the French. Some English words are written indifferently with en- or in-. For ease of pronunciation it is commonly changed to em- before p, b, and m, as in employ, embody, emmew. It is sometimes used to give a causal force, as in enable, enfeeble, to cause to be, or to make, able, or feeble; and sometimes merely gives an intensive force, as in enchasten. See In-. 2. A prefix from Gr. in; as, encephalon, entomology. See In-.\n\n1. A suffix from AS. -an, formerly used to form the plural of many nouns, as in ashen, eyen, oxen, all obs. except oxen. In some cases, such as children and brethren, it has been added to older plural forms. 2. A suffix corresponding to AS. -en and -on, formerly used to form the plural of verbs, as in housen, escapen. 3. A suffix signifying to make, to cause, used to form verbs from nouns and adjectives; as in strengthen, quicken, frighten. This must not be confused with -en corresponding in Old English to the AS. infinitive ending -an. 4. Etym: [AS. -en; akin to Goth. -eins, L. -inus, Gr.  An adjectival suffix, meaning made of; as in golden, leaden, wooden. 5. Etym: [AS. -en; akin to Skr. -na.]  The termination of the past participle of many strong verbs; as, in broken, gotten, trodden.\n\nHalf an em, that is, half of the unit of space in measuring printed matter. See Em.",
  "eupatorine": "A principle or mixture of principles extracted from various species of Eupatorium.",
  "effusion": "1. The act of pouring out; as, effusion of water, of blood, of grace, of words, and the like. To save the effusion of my people's blood. Dryden. 2. That which is poured out, literally or figuratively. Wash me with that precious effusion, and I shall be whiter than sow. Eikon Basilike. The light effusions of a heedless boy. Byron. 3. (Pathol.) (a) The escape of a fluid out of its natural vessel, either by rupture of the vessel, or by exudation through its walls. It may pass into the substance of an organ, or issue upon a free surface. (b) The liquid escaping or exuded.",
  ...
  "euphonon": "An instrument resembling the organ in tine and the upright piano in form. It is characterized by great strength and sweetness of tone.",
  ...
  "eurafrican": "1. (Geog.)  Of, pertaining to, or designating, the continents of Europe and Africa combined. 2.  (Zoögeography) Pert. to or designating a region including most of Europe and northern Africa south to the Sahara. 3.  Of European and African descent.",
  ...
  "et cetera": "Others of the like kind; and the rest; and so on; -- used to point out that other things which could be mentioned are to be understood. Usually abbreviated into etc. or &c. (&c). Shak.",
  ...
  "elong": "1. To lengthen out; to prolong. [Obs.] 2. To put away; to separate; to keep off. [Obs.] Wyatt.",
  ...
  "examiner": "One who examines, tries, or inspects; one who interrogates; an officer or person charged with the duty of making an examination; as, an examiner of students for a degree; an examiner in chancery, in the patent office, etc.",
  ...
  "electro-negative": "(a) Having the property of being attracted by an electro-positive body, or a tendency to pass to the positive pole in electrolysis, by the law that opposite electricities attract each other. (b) Negative; nonmetallic; acid; -- opposed to positive, metallic, or basic.\n\nA body which passes to the positive pole in electrolysis.",
  ...
  "eyrie": "The nest of a bird of prey or other large bird that builds in a lofty place; aerie. The eagle and the stork On cliffs and cedar tops their eyries build. Milton.",
  ...
  "efflation": "The act of filling with wind; a breathing or puffing out; a puff, as of wind. A soft efflation of celestial fire. Parnell.",
  ...
  "exposure": "1. The act of exposing or laying open, setting forth, laying bare of protection, depriving of care or concealment, or setting out to reprobation or contempt. The exposure of Fuller . . . put an end to the practices of that vile tribe. Macaulay. 2. The state of being exposed or laid open or bare; openness to danger; accessibility to anything that may affect, especially detrimentally; as, exposure to observation, to cold to inconvenience. When we have our naked frailties hid, That suffer in exposure. Shak. 3. Position as to points of compass, or to influences of climate, etc. \"Under a southern exposure. Evelyn. The best exposure of the two for woodcocks. Sir. W. Scott. 4. (Photog.)  The exposing of a sensitized plate to the action of light.",
  "egre": "Sharp; bitter; acid; sour. [Obs.] The egre words of thy friend. Chaucer.\n\nSee Eager, and Eagre. [Obs.]",
  "elimination": "1. The act of expelling or throwing off; (Physiol.)  the act of discharging or excreting waste products or foreign substances through the various emunctories. 2. (Alg.)  Act of causing a quantity to disappear from an equation; especially, in the operation of deducing from several equations containing several unknown quantities a less number of equations containing a less number of unknown quantities. 3. The act of obtaining by separation, or as the result of eliminating; deduction. [See Eliminate, 4.]",
  "emeu": "See Emu.",
  ...
  "electer": "1. Amber. See Electrum. [Obs.] 2. A metallic substance compounded of gold and silver; an alloy. [Obs.] Wyclif.",
  ...
  "ecphractic": "Serving to dissolve or attenuate viscid matter, and so to remove obstructions; deobstruent. -- n.  An ecphractic medicine. Harvey.",
  ...
  "ekabor": "The name given by Mendelejeff in accordance with the periodic law, and by prediction, to a hypothetical element then unknown, but since discovered and named scandium; -- so called because it was a missing analogue of the boron group. See Scandium.",
  ...
  "encumbrance": "1. That which encumbers; a burden which impedes action, or renders it difficult and laborious; a clog; an impediment. See Incumbrance. 2. (Law)  Same as Incumbrance. Syn. -- Burden; clog; impediment; check; hindrance.",
  ...
  "expensive": "1. Occasioning expense; calling for liberal outlay; costly; dear; liberal; as, expensive dress; an expensive house or family. War is expensive, and peace desirable. Burke. 2. Free in expending; very liberal; especially, in a bad scene; extravagant; lavish. [R.] An active, expensive, indefatigable goodness. Sprat. The idle and expensive are dangerous. Sir W. Temple. Syn. -- Costly; dear; high-priced; lavish; extravagant. -- Ex*pen\"sive*ly, adv. -- Ex*pen\"sive*ness, n.",
  "extrication": "1. The act or process of extricating or disentangling; a freeing from perplexities; disentanglement. 2. The act of sending out or evolving.",
  ...
  "exchangeability": "The quality or state of being exchangeable. The law ought not be contravened by an express article admitting the exchangeability of such persons. Washington.",
  ...
  "exult": "To be in high spirits; figuratively, to leap for joy; to rejoice in triumph or exceedingly; to triumph; as, an exulting heart. \"An exulting countenance.\" Bancroft. The dumb shall sing, the lame his crutch forego, And leap exulting like the bounding roe. Pope.",
  ...
  "exuviae": "1. (Zoöl)  Cast skins, shells, or coverings of animals; any parts of animals which are shed or cast off, as the skins of snakes, the shells of lobsters, etc. 2. (Geol.)  The fossil shells and other remains which animals have left in the strata of the earth.",
  ...
  "electuary": "A medicine composed of powders, or other ingredients, incorporated with some convserve, honey, or sirup; a confection. See the note under Confection.",
  ...
  "extraditable": "1. Subject, or liable, to extradition, as a fugitive from justice. 2. Making liable to extradition; as, extraditable offenses.",
  "edulcorate": "1. To render sweet; to sweeten; to free from acidity. Succory . . . edulcorated with sugar and vinegar. Evelyn. 2. (Chem.)  To free from acids, salts, or other soluble substances, by washing; to purify. [R.]",
  ...
  "ethereality": "The state of being ethereal; etherealness. Something of that ethereality of thought and manner which belonged to Wordsworth's earlier lyrics. J. C. Shairp.",
  ...
  "editorial": "Of or pertaining to an editor; written or sanctioned by an editor; as, editorial labors; editorial remarks. editorial content\n\nA leading article in a newspaper or magazine; an editorial article; an article published as an expression of the views of the editor.",
  ...
  "expense": "1. A spending or consuming; disbursement; expenditure. Husband nature's riches from expense. Shak. 2. That which is expended, laid out, or consumed; cost; outlay; charge; -- sometimes with the notion of loss or damage to those on whom the expense falls; as, the expenses of war; an expense of time. Courting popularity at his party's expense. Brougham. 3. Loss. [Obs.] Shak. And moan the expense of many a vanished sight. Spenser. Expense magazine (Mil.), a small magazine containing ammunition for immediate use. H. L. Scott.",
  "earthy": "1. Consisting of, or resembling, earth; terrene; earthlike; as, earthy matter. How pale she looks, And of an earthy cold! Shak. All over earthy, like a piece of earth. Tennyson. 2. Of or pertaining to the earth or to, this world; earthly; terrestrial; carnal. [R.] \"Their earthy charge.\" Milton. The first man is of the earth, earthy; the second man is from heaven. As is the earthy, such are they also that are earthy. 1 Cor. xv. 47, 48 (Rev. Ver. ) Earthy spirits black and envious are. Dryden. 3. Gross; low; unrefined. \"Her earthy and abhorred commands.\" Shak. 4. (Min.)  Without luster, or dull and roughish to the touch; as, an earthy fracture.",
  "exemplarily": "In a manner fitted or designed to be an example for imitation or for warning; by way of example. She is exemplarily loyal. Howell. Some he punisheth exemplarily. Hakewill.",
  "enantiopathy": "1. An opposite passion or affection. Sir W. Hamilton. 2. (Med.)  Allopathy; -- a term used by followers of Hahnemann, or homeopathists.",
  "eschewment": "The act of eschewing. [R.]",
  "euganoidei": "A group which includes the bony ganoids, as the gar pikes.",
  "eery": "1. Serving to inspire fear, esp. a dread of seeing ghosts; wild; weird; as, eerie stories. She whose elfin prancer springs By night to eery warblings. Tennyson. 2. Affected with fear; affrighted. Burns.",
  ...
  "excipient": "Taking an exception.\n\n1. An exceptor. [R.] 2. (Med.)  An inert or slightly active substance used in preparing remedies as a vehicle or medium of administration for the medicinal agents. Chambers.",
  ...
  "eudemon": "A good angel. Southey.",
  "excrete": "To separate and throw off; to excrete urine. \"The mucus thus excreted.\" Hooper.",
  "economize": "To manage with economy; to use with prudence; to expend with frugality; as, to economize one's income. [Written also economise.] Expenses in the city were to be economized. Jowett (Thucyd. ). Calculating how to economize time. W. Irving.\n\nTo be prudently sparing in expenditure; to be frugal and saving; as, to economize in order to grow rich. [Written also economise.] Milton.",
  "etym": "See Etymon. H. F. Talbot.",
  "eucharistic": "1. Giving thanks; expressing thankfulness; rejoicing. [Obs.] The eucharistical part of our daily devotions. Ray. 2. Pertaining to the Lord's Supper. \"The eucharistic sacrament.\" Sir. G. C. Lewis.",
  ...
  "evasion": "The act of eluding or avoiding, particularly the pressure of an argument, accusation, charge, or interrogation; artful means of eluding. Thou . . . by evasions thy crime uncoverest more. Milton. Syn. -- Shift; subterfuge; shuffling; prevarication; equivocation.",
  "emulge": "To milk out; to drain. [Obs.] Bailey.",
  "earwig": "1. (Zoöl.)  Any insect of the genus Forticula and related genera, belonging to the order Euplexoptera. 2. (Zoöl.)  In America, any small chilopodous myriapod, esp. of the genus Geophilus. Note: Both insects are so called from the supposition that they creep into the human ear. 3. A whisperer of insinuations; a secret counselor. Johnson.\n\nTo influence, or attempt to influence, by whispered insinuations or private talk. \"No longer was he earwigged by the Lord Cravens.\" Lord Campbell.",
  "expenditor": "A disburser; especially, one of the disbursers of taxes for the repair of sewers. Mozley & W.",
  ...
  "engraved": "1. Made by engraving or ornamented with engraving. 2. (Zoöl.)  Having the surface covered with irregular, impressed lines.",
  ...
  "ember-goose": "The loon or great northern diver. See Loon. [Written also emmer-goose and imber-goose.]",
  "excreta": "Matters to be excreted.",
  "elemi figs": "A kind of figs of superior quality.",
  "elaeoptene": "The more liquid or volatile portion of certain oily substance, as distinguished from stearoptene, the more solid parts. [Written also elaoptene.]",
  ...
  "eventration": "(a) A tumor containing a large portion of the abdominal viscera, occasioned by relaxation of the walls of the abdomen. (b) A wound, of large extent, in the abdomen, through which the greater part of the intestines protrude. (c) The act af disemboweling.",
  "embossment": "1. The act of forming bosses or raised figures, or the state of being so formed. 2. A bosslike prominence; figure in relief; raised work; jut; protuberance; esp., a combination of raised surfaces having a decorative effect. \"The embossment of the figure.\" Addison.",
  ...
  "eucharistical": "1. Giving thanks; expressing thankfulness; rejoicing. [Obs.] The eucharistical part of our daily devotions. Ray. 2. Pertaining to the Lord's Supper. \"The eucharistic sacrament.\" Sir. G. C. Lewis.",
  ...
  "exodic": "Conducting influences from the spinal cord outward; -- said of the motor or efferent nerves. Opposed to esodic.",
  ...
  "everywhen": "At any or all times; every instant. [R.] \"Eternal law is silently present everywhere and everywhen.\" Carlyle.",
  ...
  "expectance": "1. The act of expecting ; expectation. Milton. 2. That which is expected, or looked or waited for with interest; the object of expectation or hope. The expectancy and rose of the fair state. Shak. Estate in expectancy (Law), one the possession of which a person is entitled to have at some future time, either as a remainder or reversion, or on the death of some one. Burrill.",
  ...
  "ectental": "Relating to, or connected with, the two primitive germ layers, the ectoderm and ectoderm; as, the \"ectental line\" or line of juncture of the two layers in the segmentation of the ovum. C. S. Minot.",
  "electant": "One who has the power of choosing; an elector. [R.]",
  "elumbated": "Weak or lame in the loins. [Obs.]",
  "exogamy": "The custom, or tribal law, which prohibits marriage between members of the same tribe; marriage outside of the tribe; -- opposed to endogamy. Lubbock.",
  ...
  "egotistical": "Addicted to, or manifesting, egotism. Syn. -- Conceited; vain; self-important; opinionated.",
  ...
  "embrave": "1. To inspire with bravery. [Obs.] Beaumont. 2. To decorate; to make showy and fine. [Obs.] And with sad cypress seemly it embraves. Spenser.",
  ...
  "estop": "To impede or bar by estoppel. A party will be estopped by his admissions, where his intent is to influence another, or derive an advantage to himself. Abbott.",
  "euthiochroic": "Pertaining to, or denoting, an acid so called. Euthiochroic acid (Chem.), a complex derivative of hydroquinone and sulphonic (thionic) acid. -- so called because it contains sulphur, and forms brilliantly colored (yellow) salts.",
  ...
  "exodus": "1. A going out; particularly (the Exodus), the going out or journey of the Israelites from Egypt under the conduct of Moses; and hence, any large migration from a place. 2. The second of the Old Testament, which contains the narrative of the departure of the Israelites from Egypt.",
  ...
  "easel": "A frame (commonly) of wood serving to hold a canvas upright, or nearly upright, for the painter's convenience or for exhibition. Easel picture, Easel piece, a painting of moderate size such as is made while resting on an easel, as distinguished from a painting on a wall or ceiling.",
  "eiking": "See Eking.",
  "extirp": "To extirpate. [Obs.] It is impossible to extirp it quite, friar. Shak .",
  "ethnology": "The science which treats of the division of mankind into races, their origin, distribution, and relations, and the peculiarities which characterize them.",
  ...
  "ephemeral": "1. Beginning and ending in a day; existing only, or no longer than, a day; diurnal; as, an ephemeral flower. 2. Short-lived; existing or continuing for a short time only. \"Ephemeral popularity.\" V. Knox. Sentences not of ephemeral, but of eternal, efficacy. Sir J. Stephen. Ephemeral fly (Zoöl.), one of a group of neuropterous insects, belonging to the genus Ephemera and many allied genera, which live in the adult or winged state only for a short time. The larvæ are aquatic; -- called also day fly and May fly.\n\nAnything lasting but a day, or a brief time; an ephemeral plant, insect, etc.",
  ...
  "elevated": "Uplifted; high; lofty; also, animated; noble; as, elevated thoughts. Elevated railway, one in which the track is raised considerably above the ground, especially a city railway above the line of street travel.",
  ...
  "empalement": "1. A fencing, inclosing, or fortifying with stakes. 2. A putting to death by thrusting a sharpened stake through the body. 3. (Her.)  Same as Impalement.",
  "exister": "One who exists.",
  "expilator": "One who pillages; a plunderer; a pillager. [Obs.] Sir T. Browne.",
  "encarpus": "An ornament on a frieze or capital, consisting of festoons of fruit, flowers, leaves, etc. [Written also encarpa.]",
  ...
  "exigenter": "An officer in the Court of King's Bench and Common Pleas whose duty it was make out exigents. The office in now abolished. Cowell.",
  ...
  "execrative": "Cursing; imprecatory; vilifying. Carlyle. -- Ex\"e*cra*tive*ly, adv.\n\nA word used for cursing; an imprecatory word or expression. Earle.",
  "effrontit": "Marked by impudence. [Obs.] Jer. Taylor.",
  "embush": "To place or hide in a thicket; to ambush. [Obs.] Shelton.",
  "emetic": "Inducing to vomit; exciting the stomach to discharge its contents by the mouth. -- n.  A medicine which causes vomiting.",
  ...
  "embrocation": "(a) The act of moistening and rubbing a diseased part with spirit, oil, etc. (b) The liquid or lotion with which an affected part is rubbed.",
  ...
  "eject": "1. To expel; to dismiss; to cast forth; to thrust or drive out; to discharge; as, to eject a person from a room; to eject a traitor from the country; to eject words from the language. \"Eyes ejecting flame.\" H. Brooke. 2. (Law)  To cast out; to evict; to dispossess; as, to eject tenants from an estate. Syn. -- To expel; banish; drive out; discharge; oust; evict; dislodge; extrude; void.",
  "eightetethe": "Eighteenth. [Obs.]",
  "electromotor": "1. (Physics)  A mover or exciter of electricity; as apparatus for generating a current of electricity. 2. (Mech.)  An apparatus or machine for producing motion and mechanical effects by the action of electricity; an electro-magnetic engine.",
  ...
  "exchangeable": "1. Capable of being exchanged; fit or proper to be exchanged. The officers captured with Burgoyne were exchangeable within the powers of General Howe. Marshall. 2. Available for making exchanges; ratable. \"An exchangeable value.\" J. S. Mill.",
  ...
  "excel": "1. To go beyond or surpass in good qualities or laudable deeds; to outdo or outgo, in a good sense. Excelling others, these were great; Thou, greater still, must these excel. Prior. I saw that wisdom excelleth folly, as far as light excelleth darkness. Eccl. ii. 13. 2. To exceed or go beyond; to surpass. She opened; but to shut Excelled her power; the gates wide open stood. Milton.\n\nTo surpass others in good qualities, laudable actions, or acquirements; to be distinguished by superiority; as, to excel in mathematics, or classics. Unstable as water, thou shalt not excel. Gen. xlix. 4. Then peers grew proud in horsemanship t' excel. Pope.",
  ...
  "encyclical": "Sent to many persons or places; intended for many, or for a whole order of men; general; circular; as, an encyclical letter of a council, of a bishop, or the pope.\n\nAn encyclical letter, esp. one from a pope. Shipley.",
  ...
  "ecclesia": "1. (Gr. Antiq.)  The public legislative assembly of the Athenians. 2. (Eccl.)  A church, either as a body or as a building.",
  ...
  "everliving": "1. Living always; immoral; eternal; as, the everliving God. 2. Continual; incessant; unintermitted.",
  ...
  "exterritorial": "Beyond the territorial limits; foreign to, or exempt from, the territorial jurisdiction. -- Ex*ter`ri*to\"ri*al*ly(#),adv.",
  ...
  "eudaemonist": "One who believes in eudemonism. I am too much of a eudæmonist; I hanker too much after a state of happiness both for myself and others. De Quincey.",
  "embody": "To form into a body; to invest with a body; to collect into a body, a united mass, or a whole; to incorporate; as, to embody one's ideas in a treatise. [Written also imbody.] Devils embodied and disembodied. Sir W. Scott. The soul, while it is embodied, can no more be divided from sin. South.\n\nTo unite in a body, a mass, or a collection; to coalesce. [Written also imbody.] Firmly to embody against this court party. Burke.",
  ...
  "ecthlipsis": "1. The dropping out or suppression from a word of a consonant, with or without a vowel. 2. (Lat. Pros.)  The elision of a final m, with the preceding vowel, before a word beginning with a vowel.",
  ...
  "extensible": "Capable of being extended, whether in length or breadth; susceptible of enlargement; extensible; extendible; -- the opposite of contractible or compressible. \"An extensible membrane\" Holder.",
  ...
  "execration": "1. The act of cursing; a curse dictated by violent feelings of hatred; imprecation; utter detestation expressed. Cease, gentle, queen, these execrations. Shak. 2. That which is execrated; a detested thing. Ye shall be an execration and . . . a curse. Jer. xlii. 18. Syn. -- See Malediction.",
  ...
  "everychon": "Every one. [Obs.] Chaucer.",
  ...
  "ethenyl": "(a) A trivalent hydrocarbon radical, CH3.C. (b) A univalent hydrocarbon radical of the ethylene series, CH2:CH; - - called also vinyl. See Vinyl.",
  ...
  "exotheca": "The tissue which fills the interspaces between the costæ of many madreporarian corals, usually consisting of small transverse or oblique septa.",
  ...
  "exporter": "One who exports; the person who sends goods or commodities to a foreign country, in the way of commerce; -- opposed to importer.",
  ...
  "extrastapedial": "Pertaining to a part of the columella of the ear, which, in many animals, projects beyond the connection with the stapes. -- n.  The extrastapedial part of columella.",
  ...
  "ethmovomerine": "Pertaining to the region of the vomer and the base of the ethmoid in the skull. Ethmovomerine plate (Anat.), a cartilaginous plate beneath the front of the fetal brain which the ethmoid region of the skull is developed.",
  ...
  "etui": "A case for one several small articles; esp., a box in which scissors, tweezers, and other articles of toilet or of daily use are carried.",
  "extradictionary": "Consisting not in words, but in realities. [Obs.] Of these extradictionary and real fallacies, Aristotle and logicians make in number six. Sir T. Browne.",
  "electrizer": "One who, or that which, electrizes.",
  "equitancy": "Horsemanship.",
  "economical": "1. Pertaining to the household; domestic. \"In this economical misfortune [of ill-assorted matrimony.]\" Milton. 2. Relating to domestic economy, or to the management of household affairs. And doth employ her economic art And busy care, her household to preserve. Sir J. Davies. 3. Managing with frugality; guarding against waste or unnecessary expense; careful and frugal in management and in expenditure; -- said of character or habits. Just rich enough, with economic care, To save a pittance. Harte. 4. Managed with frugality; not marked with waste or extravagance; frugal; -- said of acts; saving; as, an economical use of money or of time. 5. Relating to the means of living, or the resources and wealth of a country; relating to political economy; as, economic purposes; economical truths. These matters economical and political. J. C. Shairp. There was no economical distress in England to prompt the enterprises of colonization. Palfrey. Economic questions, such as money, usury, taxes, lands, and the employment of the people. H. C. Baird. 6. Regulative; relating to the adaptation of means to an end. Grew. Note: Economical is the usual form when meaning frugal, saving; economic is the form commonly used when meaning pertaining to the management of a household, or of public affairs.",
  ...
  "exocardiac": "Situated or arising outside of the heat; as, exocardial murmurs; -- opposed to endocardiac.",
  ...
  "effuse": "1. Poured out freely; profuse. [Obs.] So should our joy be very effuse. Barrow. 2. Disposed to pour out freely; prodigal. [Obs.] Young. 3. (Bot.)  Spreading loosely, especially on one side; as, an effuse inflorescence. Loudon. 4. (Zoöl.)  Having the lips, or edges, of the aperture abruptly spreading; -- said of certain shells.\n\nEffusion; loss. \"Much effuse of blood.\" Shak.\n\nTo pour out like a stream or freely; to cause to exude; to shed. [R.] With gushing blood effused. Milton.\n\nTo emanate; to issue. Thomson.",
  ...
  "ejection": "1. The act of ejecting or casting out; discharge; expulsion; evacuation. \"Vast ejection of ashes.\" Eustace. \"The ejection of a word.\" Johnson. 2. (Physiol.)  The act or process of discharging anything from the body, particularly the excretions. 3. The state of being ejected or cast out; dispossession; banishment.",
  ...
  "exile": "1. Forced separation from one's native country; expulsion from one's home by the civil authority; banishment; sometimes, voluntary separation from one's native country. Let them be recalled from their exile. Shak. 2. The person expelled from his country by authority; also, one who separates himself from his home. Thou art in exile, and thou must not stay. Shak. Syn. -- Banishment; proscription; expulsion.\n\nTo banish or expel from one's own country or home; to drive away. \"Exiled from eternal God.\" Tennyson. Calling home our exiled friends abroad. Shak. Syn. -- See Banish.\n\nSmall; slender; thin; fine. [Obs.] \"An exile sound.\" Bacon.",
  "epiglottidean": "Same as Epiglottic.",
  "electro-positive": "1. (Physics)  Of such a nature relatively to some other associated body or bodies, as to tend to the negative pole of a voltaic battery, in electrolysis, while the associated body tends to the positive pole; - - the converse or correlative of electro-negative. Note: An element that is electro-positive in one compound may be electro-negative in another, and vice versa. 2. (Chem.)  Hence: Positive; metallic; basic; -- distinguished from negative, nonmetallic, or acid.\n\nA body which passes to the negative pole in electrolysis.",
  ...
  "eft": "(a) A European lizard of the genus Seps. (b) A salamander, esp. the European smooth newt (Triton punctatus).\n\nAgain; afterwards; soon; quickly. [Obs.] I wold never eft comen into the snare. Spenser.",
  "evomit": "To vomit. [Obs.]",
  ...
  "emotional": "Pertaining to, or characterized by, emotion; excitable; easily moved; sensational; as, an emotional nature.",
  ...
  "euryale": "1. (Bot.)  A genus of water lilies, growing in India and China. The only species (E. ferox) is very prickly on the peduncles and calyx. The rootstocks and seeds are used as food. 2. (Zoöl)  A genus of ophiurans with much-branched arms.",
  "enmesh": "To catch or entangle in, or as in, meshes. Shak. My doubts enmesh me if I try. Lowell.",
  "ernestful": "Serious. [Obs.] Chaucer.",
  "ersh": "See Arrish.",
  "eaglestone": "A concretionary nodule of clay ironstone, of the size of a walnut or larger, so called by the ancients, who believed that the eagle transported these stones to her nest to facilitate the laying of her eggs; aëtites.",
  ...
  "etherification": "The act or process of making ether; specifically, the process by which a large quantity of alcohol is transformed into ether by the agency of a small amount of sulphuric, or ethyl sulphuric, acid.",
  ...
  "excitation": "1. The act of exciting or putting in motion; the act of rousing up or awakening. Bacon. 2. (Physiol.)  The act of producing excitement (stimulation); also, the excitement produced.",
  "expedient": "1. Hastening or forward; hence, tending to further or promote a proposed object; fit or proper under the circumstances; conducive to self-interest; desirable; advisable; advantageous; -- sometimes contradistinguished from right. It is expedient for you that I go away. John xvi. 7. Nothing but the right can ever be expedient, since that can never be true expediency which would sacrifice a greater good to a less. Whately. 2. Quick; expeditious. [Obs.] His marches are expedient to this town. Shak.\n\n1. That which serves to promote or advance; suitable means to accomplish an end. What sure expedient than shall Juno find, To calm her fears and ease her boding mind Philips. 2. Means devised in an exigency; shift. Syn. -- Shift; contrivance; resource; substitute.",
  ...
  "eolian": "1. Æolian. 2. (Geol.)  Formed, or deposited, by the action of wind, as dunes. Eolian attachment, Eolian harp. See Æolian.",
  ...
  "europium": "A metallic element of the rare-earth group, discovered spectroscopically by Demarcay in 1896. Symbol, Eu; at. wt., 152.0.",
  "enjoyable": "Capable of being enjoyed or of giving joy; yielding enjoyment. Milton.",
  "evidential": "Relating to, or affording, evidence; indicative; especially, relating to the evidences of Christianity. Bp. Fleetwood. \"Evidential tracks.\" Earle.. -- Ev`i*den\"tial*ly, adv.",
  "embattlement": "1. An intended parapet; a battlement. 2. The fortifying of a building or a wall by means of battlements.",
  "embolismatical": "Embolismic.",
  "exanthema": "An efflorescence or discoloration of the skin; an eruption or breaking out, as in measles, smallpox, scarlatina, and the like diseases; -- sometimes limited to eruptions attended with fever. Dunglison.",
  ...
  "encapsulation": "The act of inclosing in a capsule; the growth of a membrane around (any part) so as to inclose it in a capsule.",
  "enlarged": "Made large or larger; extended; swollen. -- En*lar\"ged*ly, adv. -- En*lar\"ged*ness, n.",
  "earning": "That which is earned; wages gained by work or services; money earned; -- used commonly in the plural. As to the common people, their stock is in their persons and in their earnings. Burke.",
  ...
  "expediential": ". Governed by expediency; seeking advantage; as an expediential policy. \"Calculating, expediential understanding.\" Hare. -- Ex*pe`di*en\"tial*ly , adv.",
  ...
  "email ombrant": "An art or process of flooding transparent colored glaze over designs stamped or molded on earthenware or porcelain. Ure.",
  "emancipatory": "Pertaining to emancipation, or tending to effect emancipation. \"Emancipatory laws.\" G. Eliot.",
  "elaeis": "A genus of palms. Note: Elæis Guineensis, the African oil palm, is a tree twenty or thirty feet high, with immense pinnate leaves and large masses of fruit. The berries are rather larger than olives, and when boiled in water yield the orange-red palm oil.",
  ...
  "embarkation": "1. The act of putting or going on board of a vessel; as, the embarkation of troops. 2. That which is embarked; as, an embarkation of Jesuits. Smollett.",
  "exploder": "1. One who or that which explodes. 2. One who rejects an opinion or scheme with open contempt. South.",
  ...
  "ecumenic": "General; universal; in ecclesiastical usage, that which concerns the whole church; as, an ecumenical council. [Written also .] Ecumenical Bishop, a title assumed by the popes. -- Ecumenical council. See under Council.",
  ...
  "efficacious": "Possessing the quality of being effective; productive of, or powerful to produce, the effect intended; as, an efficacious law. Syn. -- See Effectual. -- Ef`fi*ca\"cious*ly, adv. -- Ef`fi*ca\"cious*ness, n.",
  "expugn": "To take by assault; to storm; to overcome; to vanquish; as, to expugn cities; to expugn a person by arguments.",
  "exquisitely": "In an exquisite manner or degree; as, lace exquisitely wrought. To a sensitive observer there was something exquisitely painful in it. Hawthorne.",
  ...
  "emication": "A flying off in small particles, as heated iron or fermenting liquors; a sparkling; scintillation. Sir T. Browne.",
  ...
  "eupepsia": "Soundness of the nutritive or digestive organs; good concoction or digestion; -- opposed to dyspepsia.",
  ...
  "edition": "1. A literary work edited and published, as by a certain editor or in a certain manner; as, a good edition of Chaucer; Chalmers' edition of Shakespeare. 2. The whole number of copies of a work printed and published at one time; as, the first edition was soon sold.",
  ...
  "enameler": "One who enamels; a workman or artist who applies enamels in ornamental work. [Written also enameller, enamellist.]",
  ...
  "exophthalmos": "Same as Exophthalmia.",
  ...
  "ethionic": "Pertaining to, derived from, or designating, an acid so called. Ethionic acid (Chem.), a liquid derivative of ethylsulphuric and sulphuric (thionic) acids, obtained by the action of sulphur trioxide on absolute alcohol.",
  "earable": "Arable; tillable. [Archaic]",
  "evolatic": "Apt to fly away. [Obs. or R.] Blount.",
  "expressive": "1. Serving to express, utter, or represent; indicative; communicative; -- followed by of; as, words expressive of his gratitude. Each verse so swells expressive of her woes. Tickell. 2. Full of expression; vividly representing the meaning or feeling meant to be conveyed; significant; emphatic; as, expressive looks or words. You have restrained yourself within the list of too cold an adieu; be more expressive to them. Shak. Through her expressive eyes her soul distinctly spoke. Littelton. -- Ex*press\"ive*ly,adv. -- Ex*press\"ive*ness,n.",
  "ell": "A measure for cloth; -- now rarely used. It is of different lengths in different countries; the English ell being 45 inches, the Dutch or Flemish ell 27, the Scotch about 37.\n\nSee L.",
  "enclothe": "To clothe.",
  "evergreen": "Remaining unwithered through the winter, or retaining unwithered leaves until the leaves of the next year are expanded, as pines cedars, hemlocks, and the like.\n\n1. (Bot.)  An evergreen plant. 2. pl.  Twigs and branches of evergreen plants used for decoration. \"The funeral evengreens entwine.\" Keble.",
  ...
  "excandescence": "1. A growing hot; a white or glowing heat; incandescence. [R.] 2. Violent anger; a growing angry. [Obs.] Blount.",
  ...
  "embosom": "1. To take into, or place in, the bosom; to cherish; to foster. Glad to embosom his affection. Spenser. 2. To inclose or surround; to shelter closely; to place in the midst of something. His house embosomed in the grove. Pope. Some tender flower . . . . Embosomed in the greenest glade. Keble.",
  ...
  "euryalida": "A tribe of Ophiuroidea, including the genera Euryale, Astrophyton, etc. They generally have the arms branched. See Astrophyton.",
  ...
  "ebullition": "1. A boiling or bubbling up of a liquid; the motion produced in a liquid by its rapid conversion into vapor. 2. Effervescence occasioned by fermentation or by any other process which causes the liberation of a gas or an aëriform fluid, as in the mixture of an acid with a carbonated alkali. [Formerly written bullition.] 3. A sudden burst or violent display; an outburst; as, an ebullition of anger or ill temper.",
  "exuviability": "Capability of shedding the skin periodically. Craig.",
  "enclitic": "Affixed; subjoined; -- said of a word or particle which leans back upon the preceding word so as to become a part of it, and to lose its own independent accent, generally varying also the accent of the preceding word.\n\nA word which is joined to another so closely as to lose its proper accent, as the pronoun thee in prithee (pray thee).",
  ...
  "eyelash": "1. The fringe of hair that edges the eyelid; -- usually in the pl. 2. A hair of the fringe on the edge of the eyelid.",
  "embryogenic": "Pertaining to the development of an embryo.",
  "explosively": "In an explosive manner.",
  "electro-metallurgy": "The act or art precipitating a metal electro-chemical action, by which a coating is deposited, on a prepared surface, as in electroplating and electrotyping; galvanoplasty.",
  "ectoplasm": "(a) The outer transparent layer of protoplasm in a developing ovum. (b) The outer hyaline layer of protoplasm in a vegetable cell. (c) The ectosarc of protozoan.",
  "emblazonry": "The act or art of an emblazoner; heraldic or ornamental decoration, as pictures or figures on shields, standards, etc.; emblazonment. Thine ancient standard's rich emblazonry. Trench.",
  ...
  "empress": "1. The consort of an emperor. Shak. 2. A female sovereign. 3. A sovereign mistress. \"Empress of my soul.\" Shak. Empress cloth, a cloth for ladies' dresses, either wholly of wool, or with cotton warp and wool weft. It resembles merino, but is not twilled.",
  ...
  "ekasilicon": "The name of a hypothetical element predicted and afterwards discovered and named germanium; -- so called because it was a missing analogue of the silicon group. See Germanium, and cf. Ekkabor.",
  ...
  "echometry": "1. The art of measuring the duration of sounds or echoes. 2. The art of constructing vaults to produce echoes.",
  "ercedeken": "An archdeacon. [Obs.]",
  "enjail": "To put into jail; to imprison. [R.] Donne.",
  "electro-dynamical": "Pertaining to the movements or force of electric or galvanic currents; dependent on electric force.",
  ...
  "explodent": "1. An instrument or agent causing explosion; an exploder; also, an explosive. 2. See Explosive, n., 2.",
  "eviction": "1. The act or process of evicting; or state of being evicted; the recovery of lands, tenements, etc., from another's possession by due course of law; dispossession by paramount title or claim of such title; ejectment; ouster. 2. Conclusive evidence; proof. [Obs.] Full eviction of this fatal truth. South.",
  "evangelism": "The preaching or promulgation of the gospel. Bacon.",
  "excerebration": "The act of removing or beating out the brains.",
  "expressman": "A person employed in the express business; also, the driver of a job wagon. W. D. Howells.",
  ...
  "en passant": "In passing; in the course of any procedure; -- said specif. (Chess),  of the taking of an adverse pawn which makes a first move of two squares by a pawn already so advanced as to threaten the first of these squares. The pawn which takes en passant is advanced to the threatened square.",
  "een": "The old plural of Eye. And eke with fatness swollen were his een. Spenser. E'ER E'er, adv.  A contraction for ever. See Ever.",
  ...
  "eugenia": "A genus of mytraceous plants, mostly of tropical countries, and including several aromatic trees and shrubs, among which are the trees which produce allspice and cloves of commerce.",
  "experiential": "Derived from, or pertaining to, experience. Coleridge. It is called empirical or experiential . . . because it is divan to us by experience or observation, and not obtained as the result of inference or reasoning. Sir. W. Hamiltion. -- Ex*pe`ri*en\"tial*ly, adv. DR. H. More.",
  "extravaganza": "1. A composition, as in music, or in the drama, designed to produce effect by its wild irregularity; esp., a musical caricature. 2. An extravagant flight of sentiment or language.",
  ...
  "elutriation": "The process of elutriating; a decanting or racking off by means of water, as finer particles from heavier.",
  ...
  "evict": "1. (Law)  To dispossess by a judicial process; to dispossess by paramount right or claim of such right; to eject; to oust. The law of England would speedily evict them out of their possession. Sir. J. Davies. 2. To evince; to prove. [Obs.] Cheyne.",
  ...
  "etiquette": "The forms required by good breeding, or prescribed by authority, to be observed in social or official life; observance of the proprieties of rank and occasion; conventional decorum; ceremonial code of polite society. The pompous etiquette to the court of Louis the Fourteenth. Prescott.",
  "efficient": "Causing effects; producing results; that makes the effect to be what it is; actively operative; not inactive, slack, or incapable; characterized by energetic and useful activity; as, an efficient officer, power. The efficient cause is the working cause. Wilson. Syn. -- Effective; effectual; competent; able; capable; material; potent.\n\nAn efficient cause; a prime mover. God . . . moveth mere natural agents as an efficient only. Hooker.",
  "eelspear": "A spear with barbed forks for spearing eels. E'EN E'en, adv.  A contraction for even. See Even. I have e'en done with you. L'Estrange.",
  "empressement": "Demonstrative warmth or cordiality of manner; display of enthusiasm. He grasped my hand with a nervous empressement. Poe.",
  ...
  "entrepot": "A warehouse; a magazine for depositing goods, stores, etc.; a mart or place where merchandise is deposited; as, an entrepôt for shipping goods in transit.",
  ...
  "ellagic": "Pertaining to, or derived from, gallnuts or gallic acid; as, ellagic acid. Ellagic acid (Chem.), a white crystalline substance, C14H8O9, found in bezoar stones, and obtained by the oxidation of gallic acid.",
  ...
  "extemporary": "1. Extemporaneous. \"In extemporary prayer.\" Fuller. 2. Made for the occasion; for the time being. [Obs.] \"Extemporary habitations.\" Maundrell.",
  ...
  "existence": "1. The state of existing or being; actual possession of being; continuance in being; as, the existence of body and of soul in union; the separate existence of the soul; immortal existence. The main object of our existence. Lubbock. 2. Continued or repeated manifestation; occurrence, as of events of any kind; as, the existence of a calamity or of a state of war. The existence therefore, of a phenomenon, is but another word for its being perceived, or for the inferred possibility of perceiving it. J. S. Mill. 3. That which exists; a being; a creature; an entity; as, living existences.",
  ...
  "eggshell": "1. The shell or exterior covering of an egg. Also used figuratively for anything resembling an eggshell. 2. (Zoöl.)  A smooth, white, marine, gastropod shell of the genus Ovulum, resembling an egg in form.",
  ...
  "electrode": "The path by which electricity is conveyed into or from a solution or other conducting medium; esp., the ends of the wires or conductors, leading from source of electricity, and terminating in the medium traversed by the current.",
  "extracapsular": "Situated outside of a capsule, esp. outside the capsular ligament of a joint.",
  "explicable": "Capable of being explicated; that may be explained or accounted for; admitting explanation. It is not explicable upon any grounds. Burke.",
  "embalmment": "The act of embalming. [R.] Malone.",
  "echinoidea": "The class Echinodermata which includes the sea urchins. They have a calcareous, usually more or less spheroidal or disk-shaped, composed of many united plates, and covered with movable spines. See Spatangoid, Clypeastroid. [Written also Echinidea, and Echinoida.]",
  "emblematical": "Pertaining to, containing, or consisting in, an emblem; symbolic; typically representative; representing as an emblem; as, emblematic language or ornaments; a crown is emblematic of royalty; white is emblematic of purity. -- Em`blem*at\"ic*al*ly, adv.",
  ...
  "ephemera": "1. (Med.)  A fever of one day's continuance only. 2. (Zoöl.)  A genus of insects including the day flies, or ephemeral flies. See Ephemeral fly, under Ephemeral.",
  ...
  "embiotocoid": "Belonging to, or resembling, the Embiotocidæ. -- n.  One of a family of fishes (Embiotocidæ) abundant on the coast of California, remarkable for being viviparous; -- also called surf fishes and viviparous fishes. See Illust. in Append.",
  ...
  "electro-telegraphy": "The art or science of constructing or using the electric telegraph; the transmission of messages by means of the electric telegraph.",
  ...
  "euthanasia": "An easy death; a mode of dying to be desired. \"An euthanasia of all thought.\" Hazlitt. The kindest wish of my friends is euthanasia. Arbuthnot.",
  "euphemistical": "Pertaining to euphemism; containing a euphemism; softened in expression. -- Eu`phe*mis\"tic*al*ly, adv.",
  ...
  "eventognathi": "An order of fishes including a vast number of freshwater species such as the carp, loach, chub, etc.",
  "elrich": "Ghastly; preternatural. Same as Eldritch. [Scot. & Local, Eng.]",
  "excalfaction": "A heating or warming; calefaction. [Obs.] Blount.",
  "evolutionist": "1. One skilled in evolutions. 2. one who holds the doctrine of evolution, either in biology or in metaphysics. Darwin.",
  ...
  "euthyneura": "A large division of gastropod molluske, including the Pulmonifera and Opisthobranchiata.",
  "embrowde": "To embroider; to adorn. [Obs.] Embrowded was he, as it were a mead All full of fresshe flowers, white and red. Chaucer.",
  ...
  "exogamous": "Relating to exogamy; marrying outside of the limits of one's own tribe; -- opposed to endogenous.",
  ...
  "evectics": "The branch of medical science which teaches the method of acquiring a good habit of body. [Obs.]",
  ...
  "ethmoid": "(a) Like a sieve; cribriform. (b) Pertaining to, or in the region of, the ethmoid bone. Ethmoid bone (Anat.), a bone of complicated structure through which the olfactory nerves pass out of the cranium and over which they are largely distributed.\n\nThe ethmoid bone.",
  ...
  "elvish": "1. Pertaining to elves; implike; mischievous; weird; also, vacant; absent in demeanor. See Elfish. He seemeth elvish by his countenance. Chaucer. 2. Mysterious; also, foolish. [Obs.]",
  ...
  "exscind": "To cut off; to separate or expel from union; to extirpate. Barrow. The second presbytery of Philadelphia was also exscinded by that Assembly. Am. Cyc.",
  ...
  "empyema": "A collection of blood, pus, or other fluid, in some cavity of the body, especially that of the pleura. Dunglison. Note: The term empyema is now restricted to a collection of pus in the cavity of the pleura.",
  ...
  "eozoon": "A peculiar structure found in the Archæan limestones of Canada and other regions. By some geologists it is believed to be a species of gigantic Foraminifera, but others consider it a concretion, without organic structure.",
  "edileship": "The office of ædile. T. Arnold.",
  "emperess": "See Empress. [Obs.]",
  "euchroic": "Having a fine color. Euchroic acid (Chem.), an organic, imide acid, obtained as a colorless crystalline substance, C12H4N2O8 by heating an ammonium salt of mellitic acid. By reduction it is changed to a dark blue substance (euchrone), -- hence its name.",
  ...
  "embark": "1. To cause to go on board a vessel or boat; to put on shipboard. 2. To engage, enlist, or invest (as persons, money, etc.) in any affair; as, he embarked his fortune in trade. It was the reputation of the sect upon which St. Paul embarked his salvation. South.\n\n1. To go on board a vessel or a boat for a voyage; as, the troops embarked for Lisbon. 2. To engage in any affair. Slow to embark in such an undertaking. Macaulay.",
  ...
  "earing": "(a) A line used to fasten the upper corners of a sail to the yard or gaff; -- also called head earing. (b) A line for hauling the reef cringle to the yard; -- also called reef earing. (c) A line fastening the corners of an awning to the rigging or stanchions.\n\nComing into ear, as corn.\n\nA plowing of land. [Archaic] Neither earing nor harvest. Gen. xlv. 6.",
  "epidermatoid": "Epidermoid. Owen.",
  "eteostic": "A kind of chronogram. [R.] B. Jonson.",
  "efflux": "1. The act or process of flowing out, or issuing forth; effusion; outflow; as, the efflux of matter from an ulcer; the efflux of men's piety. It is then that the devout affections . . . are incessantly in efflux. I. Taylor. 2. That which flows out; emanation; effluence. Prime cheerer, light! . . . Efflux divine. Thomson.\n\nTo run out; to flow forth; to pass away. [Obs.] Boyle.",
  ...
  "evection": "1. The act of carrying up or away; exaltation. [Obs.] Bp. Pearson. 2. (Astron.) (a) An inequality of the moon's motion is its orbit to the attraction of the sun, by which the equation of the center is diminished at the syzygies, and increased at the quadratures by about 1º 20'. (b) The libration of the moon. Whewell.",
  "expenditure": "1. The act of expending; a laying out, as of money; disbursement. our expenditure purchased commerce and conquest. Burke. 2. That which is expended or paid out; expense. The receipts and expenditures of this extensive country. A. Hamilton.",
  ...
  "elapine": "Like or pertaining to the Elapidæ, a family of poisonous serpents, including the cobras. See Ophidia.",
  ...
  "easterly": "1. Coming from the east; as, it was easterly wind. 2. Situated, directed, or moving toward the east; as, the easterly side of a lake; an easterly course or voyage.\n\nToward, or in the direction of, the east.",
  ...
  "earthpea": "A species of pea (Amphicarpæa monoica). It is a climbing leguminous plant, with hairy underground pods.",
  "eternify": "To make eternal. [Obs.] Fame . . . eternifies the name. Mir. for Mag.",
  "embellish": "To make beautiful or elegant by ornaments; to decorate; to adorn; as, to embellish a book with pictures, a garden with shrubs and flowers, a narrative with striking anecdotes, or style with metaphors. Syn. -- To adorn; beautify; deck; bedeck; decorate; garnish; enrich; ornament; illustrate. See Adorn.",
  ...
  "enlay": "See Inlay.",
  "enchanter": "One who enchants; a sorcerer or magician; also, one who delights as by an enchantment. Like ghosts from an enchanter fleeing. Shelley. Enchanter's nightshade (Bot.), a genus (Circæa) of low inconspicuous, perennial plants, found in damp, shady places.",
  "excentricity": ". (Math.) Same as Eccentricity.",
  "enslaver": "One who enslaves. Swift.",
  "extemporanean": "Extemporaneous. [Obs] Burton.",
  "emmetropic": "Pertaining to, or characterized by, emmetropia. The normal or emmetropic eye adjusts itself perfectly for all distances. J. Le Conte.",
  ...
  "etherize": "1. To convert into ether. 2. To render insensible by means of ether, as by inhalation; as, to etherize a patient.",
  "effulgence": "The state of being effulgent; extreme brilliancy; a flood of light; great luster or brightness; splendor. The effulgence of his glory abides. Milton. The bright and the balmy effulgence of morn. Beattie.",
  ...
  "estrade": "A portion of the floor of a room raised above the general level, as a place for a bed or a throne; a platform; a dais. He [the teacher] himself should have his desk on a mounted estrade or platform. J. G. Fitch.",
  "evacuator": "One who evacuates; a nullifier. \"Evacuators of the law.\" Hammond.",
  "elide": "1. To break or dash in pieces; to demolish; as, to elide the force of an argument. [Obs.] Hooker. 2. (Gram.)  To cut off, as a vowel or a syllable, usually the final one; to subject to elision.",
  "elohistic": "Relating to Elohim as a name of God; -- said of passages in the Old Testament.",
  "extinguishment": "1. The act of extinguishing, putting out, or quenching, or the state of being extinguished; extinction; suppression; destruction; nullification; as, the extinguishment of fire or flame, of discord, enmity, or jealousy, or of love or affection. 2. (Law)  The annihilation or extinction of a right or obligation. Abbott.",
  ...
  "eudemonist": "One who believes in eudemonism. I am too much of a eudæmonist; I hanker too much after a state of happiness both for myself and others. De Quincey.",
  ...
  "eugubian": "Of or pertaining to the ancient town of Eugubium (now Gubbio); as, the Eugubine tablets, or tables, or inscriptions.",
  ...
  "excision": "1. The act of excising or cutting out or off; extirpation; destruction. Such conquerors are the instruments of vengeance on those nations that have . . . grown ripe for excision. Atterbury. 2. (Eccl.)  The act of cutting off from the church; excommunication. 3. (Surg.)  The removal, especially of small parts, with a cutting instrument. Dunglison.",
  ...
  "electorate": "1. The territory, jurisdiction, or dignity of an elector, as in the old German empire. 2. The whole body of persons in a nation or state who are entitled to vote in an election, or any distinct class or division of them. The middle-class electorate of Great Britain. M. Arnold.",
  ...
  "eventuality": "1. The coming as a consequence; contingency; also, an event which comes as a consequence. 2. (Phren.)  Disposition to take cognizance of events.",
  "exorhizous": "Having a radicle which is not inclosed by the cotyledons or plumule; of or relating to an exorhiza.",
  ...
  "emigration": "1. The act of emigrating; removal from one country or state to another, for the purpose of residence, as from Europe to America, or, in America, from the Atlantic States to the Western. 2. A body emigrants; emigrants collectively; as, the German emigration.",
  "elastically": "In an elastic manner; by an elastic power; with a spring.",
  "erectly": "In an erect manner or posture.",
  "earthworm": "1. (Zoöl.)  Any worm of the genus Lumbricus and allied genera, found in damp soil. One of the largest and most abundant species in Europe and America is L. terrestris; many others are known; -- called also angleworm and dewworm. 2. A mean, sordid person; a niggard. Norris.",
  ...
  "excito-nutrient": "Exciting nutrition; said of the reflex influence by which the nutritional processes are either excited or modified.",
  ...
  "extinguish": "1. To quench; to put out, as a light or fire; to stifle; to cause to die out; to put an end to; to destroy; as, to extinguish a flame, or life, or love, or hope, a pretense or a right. A light which the fierce winds have no power to extinguish. Prescott. This extinguishes my right to the reversion. Blackstone. 2. To obscure; to eclipse, as by superior splendor. Natural graces that extinguish art. Shak .",
  ...
  "excusable": "That may be excused, forgiven, justified, or acquitted of blame; pardonable; as, the man is excusable; an excusable action. -- Ex*cus\"a*ble*ness, n. -- Ex*cus\"a*bly, adv. The excusableness of my dissatisfaction. Boyle.",
  ...
  "elatrometer": "An instrument for measuring the degree of rarefaction of air contained in the receiver of an air pump. [Spelt also elaterometer.]",
  ...
  "effervescence": "A kind of natural ebullition; that commotion of a fluid which takes place when some part of the mass flies off in a gaseous form, producing innumerable small bubbles; as, the effervescence of a carbonate with citric acid.",
  ...
  "exultation": "The act of exulting; lively joy at success or victory, or at any advantage gained; rapturous delight; triumph. His bosom swelled with exultation. Prescott.",
  "encomion": "Encomium; panegyric. [Obs.] B. Jonson.",
  "exotic": "Introduced from a foreign country; not native; extraneous; foreign; as, an exotic plant; an exotic term or word. Nothing was so splendid and exotic as the ambassador. Evelyn.\n\nAnything of foreign origin; something not of native growth, as a plant, a word, a custom. Plants that are unknown to Italy, and such as the gardeners call exotics. Addison.",
  ...
  "ex postfacto": "From or by an after act, or thing done afterward; in consequence of a subsequent act; retrospective. Ex post facto law, a law which operates by after enactment. The phrase is popularly applied to any law, civil or criminal, which is enacted with a retrospective effect, and with intention to produce that effect; but in its true application, as employed in American law, it relates only to crimes, and signifies a law which retroacts, by way of criminal punishment, upon that which was not a crime before its passage, or which raises the grade of an offense, or renders an act punishable in a more severe manner that it was when committed. Ex post facto laws are held to be contrary to the fundamental principles of a free government, and the States are prohibited from passing such laws by the Constitution of the United States.  Burrill.  Kent.",
  ...
  "exoteric": "External; public; suitable to be imparted to the public; hence, capable of being readily or fully comprehended; -- opposed to esoteric, or secret. The foppery of an exoteric and esoteric doctrine. De Quincey.",
  "eigne": "1. (Law)  Eldest; firstborn. Blackstone. 2. Entailed; belonging to the eldest son. [Obs.] Bastard eigne, a bastard eldest son whose parents afterwards intermarry.",
  ...
  "eozooenal": "Pertaining to the eozoön; containing eozoöns; as, eozoönal limestone.",
  ...
  "exenterate": "To take out the bowels or entrails of; to disembowel; to eviscerate; as, exenterated fishes. [R.] Exenterated rule-mongers and eviscerated logicians. Hare.",
  ...
  "exsiccation": "The act of operation of drying; evaporation or expulsion of moisture; state of being dried up; dryness. Sir T. Browne.",
  ...
  "enceinte": "1. (Fort.)  The line of works which forms the main inclosure of a fortress or place; -- called also body of the place. 2. The area or town inclosed by a line of fortification. The suburbs are not unfrequently larger than their enceinte. S. W. Williams.\n\nPregnant; with child.",
  "expatiation": "Act of expatiating.",
  "electively": "In an elective manner; by choice.",
  "elizabethan": "Pertaining to Queen Elizabeth or her times, esp. to the architecture or literature of her reign; as, the Elizabethan writers, drama, literature. -- n.  One who lived in England in the time of Queen Elizabeth. Lowell.",
  "eviternity": "Eternity. [Obs.]",
  "excerp": "To pick out. [Obs.] Hales.",
  "explorative": "Exploratory.",
  "ephippium": "1. (Anat.)  A depression in the sphenoid bone; the pituitary fossa. 2. (Zoöl.)  A saddle-shaped cavity to contain the winter eggs, situated on the back of Cladocera.",
  "electioneer": "To make interest for a candidate at an election; to use arts for securing the election of a candidate. A master of the whole art of electioneering. Macaulay.",
  ...
  "eyra": "A wild cat (Felis eyra) ranging from southern Brazil to Texas. It is reddish yellow and about the size of the domestic cat, but with a more slender body and shorter legs.",
  "evident": "Clear to the vision; especially, clear to the understanding, and satisfactory to the judgment; as, the figure or color of a body is evident to the senses; the guilt of an offender can not always be made evident. Your honor and your goodness is so evident. Shak. And in our faces evident the sings Of foul concupiscence. Milton. Syn. -- Manifest; plain; clear; obvious; visible; apparent; conclusive; indubitable; palpable; notorious. See Manifest.",
  ...
  "embossed": "1. Formed or covered with bosses or raised figures. 2. Having a part projecting like the boss of a shield. 3. Swollen; protuberant. [Obs.] \"An embossed carbuncle.\" Shak.",
  "enswathement": "The act of enswathing, or the state of being enswathed.",
  "excito-motory": "Exciting motion; -- said of that portion of the nervous system concerned in reflex action, by which impressions are transmitted to a nerve center and then reflected back so as to produce muscular contraction without sensation or volition.",
  "erugate": "Freed from wrinkles; smooth.",
  "entoplastron": "The median plate of the plastron of turtles; -- called also entosternum.",
  "expiation": "1. The act of making satisfaction or atonement for any crime or fault; the extinguishing of guilt by suffering or penalty. His liberality seemed to have something in it of self-abasement and expiation. W. Irving. 2. The means by which reparation or atonement for crimes or sins is made; an expiatory sacrifice or offering; an atonement. Those shadowy expiations weak, The blood of bulls and goats. Milton. 3. An act by which the treats of prodigies were averted among the ancient heathen. [Obs.] Hayward.",
  ...
  "emong": ", (prep. Among. [Obs.]",
  "enchoric": "Belonging to, or used in, a country; native; domestic; popular; common; -- said especially of the written characters employed by the common people of ancient Egypt, in distinction from the hieroglyphics. See Demotic.",
  ...
  "eudaemonics": "That part of moral philosophy which treats of happiness; the science of happiness; -- contrasted with aretaics. J. Grote.",
  ...
  "evil-minded": "Having evil dispositions or intentions; disposed to mischief or sin; malicious; malignant; wicked. -- E\"vil-mind`ed*ness, n.",
  "equivocally": "In an equivocal manner.",
  "erin": "An early, and now a poetic, name of Ireland.",
  "eurythmy": "1. (Fine Arts)  Just or harmonious proportion or movement, as in the composition of a poem, an edifice, a painting, or a statue. 2. (Med.)  Regularly of the pulse.",
  "ear-splitting": "Deafening; disagreeably loud or shrill; as, ear-splitting strains.",
  "excern": "To excrete; to throw off through the pores; as, fluids are excerned in perspiration. [R.] Bacon.",
  ...
  "externality": "State of being external; exteriority; (Metaph.)  separation from the perceiving mind. Pressure or resistance necessarily supposes externality in the thing which presses or resists. A. Smith.",
  "emollient": "Softening; making supple; acting as an emollient. \"Emollient applications.\" Arbuthnot.\n\nAn external something or soothing application to allay irritation, soreness, etc.",
  ...
  "eleventh": "1. Next after the tenth; as, the eleventh chapter. 2. Constituting one of eleven parts into which a thing is divided; as, the eleventh part of a thing. 3. (Mus.)  Of or pertaining to the interval of the octave and the fourth.\n\n1. The quotient of a unit divided by eleven; one of eleven equal parts. 2. (Mus.)  The interval consisting of ten conjunct degrees; the interval made up of an octave and a fourth.",
  ...
  "euphorbia": "Spurge, or bastard spurge, a genus of plants of many species, mostly shrubby, herbaceous succulents, affording an acrid, milky juice. Some of them are armed with thorns. Most of them yield powerful emetic and cathartic products.",
  ...
  "egilops": "See Ægilops.",
  "earldom": "1. The jurisdiction of an earl; the territorial possessions of an earl. 2. The status, title, or dignity of an earl. He [Pulteney] shrunk into insignificancy and an earldom. Chesterfield.",
  ...
  "exsert": "Standing out; projecting beyond some other part; as, exsert stamens. A small portion of the basal edge of the shell exserted. D. H. Barnes.",
  "ebrious": "Inclined to drink to excess; intoxicated; tipsy. [R.] M. Collins.",
  "elementarity": "Elementariness. [Obs.] Sir T. Browne.",
  "experientialism": "The doctrine that experience, either that ourselves or of others, is the test or criterion of general knowledge; -- opposed to intuitionists. Experientialism is in short, a philosophical or logical theory, not a philosophical one. G. C. Robertson.",
  ...
  "embargo": "An edict or order of the government prohibiting the departure of ships of commerce from some or all of the ports within its dominions; a prohibition to sail. Note: If the embargo is laid on an enemy's ships, it is called a hostile embargo; if on the ships belonging to citizens of the embargoing state, it is called a civil embargo.\n\nTo lay an embargo on and thus detain; to prohibit from leaving port; -- said of ships, also of commerce and goods.",
  "enwreathe": "See Inwreathe. Shelton.",
  "eumolpus": "A genus of small beetles, one species of which (E. viti) is very injurious to the vines in the wine countries of Europe.",
  "explicative": "Serving to unfold or explain; tending to lay open to the understanding; explanatory. Sir W. Hamilton.",
  ...
  "eclaircissement": "The clearing up of anything which is obscure or not easily understood; an explanation. The eclaircissement ended in the discovery of the informer. Clarendon.",
  ...
  "elul": "The sixth month of the Jewish year, by the sacred reckoning, or the twelfth, by the civil reckoning, corresponding nearly to the month of September.",
  "edgebone": "Same as Aitchbone.",
  "elaeolite": "A variety of hephelite, usually massive, of greasy luster, and gray to reddish color. Elæolite syenite, a kind of syenite characterized by the presence of elæolite.",
  "extractor": "One who, or that which, extracts; as: (a) (Surg.) A forceps or instrument for extracting substances. (b) (Breech-loading Firearms) A device for withdrawing a cartridge or spent cartridge shell from the chamber of the barrel.",
  "eau forte": "An etching or a print from an etched plate.",
  "ejecta": "Matter ejected; material thrown out; as, the ejecta of a volcano; the ejecta, or excreta, of the body.",
  ...
  "effectuate": "To bring to pass; to effect; to achieve; to accomplish; to fulfill. A fit instrument to effectuate his desire. Sir P. Sidney. In order to effectuate the thorough reform. G. T. Curtis.",
  ...
  "eudipleura": "The fundamental forms of organic life, that are composed of two equal and symmetrical halves. Syd. Soc. Lex.",
  ...
  "encouragement": "1. The act of encouraging; incitement to action or to practice; as, the encouragement of youth in generosity. All generous encouragement of arts. Otway. 2. That which serves to incite, support, promote, or advance, as favor, countenance, reward, etc.; incentive; increase of confidence; as, the fine arts find little encouragement among a rude people. To think of his paternal care, Is a most sweet encouragement to prayer. Byron.",
  ...
  "eupeptic": "Of or pertaining to good digestion; easy of digestion; having a good digestion; as, eupeptic food; an eupeptic man. Wrapt in lazy eupeptic fat. Carlyle.",
  ...
  "edental": "See Edentate, a. -- n. (Zoöl.)  One of the Edentata.",
  ...
  "emasculation": "1. The act of depriving of virility, or the state of being so deprived; castration. 2. The act of depriving, or state of being deprived, of vigor or strength; unmanly weakness.",
  ...
  "emarginated": "1. Having the margin interrupted by a notch or shallow sinus. 2. (Bot.)  Notched at the summit. 3. (Cryst.)  Having the edges truncated.",
  "exprobration": "Reproachful accusation; upbraiding. [Obs.] A fearful exprobration of our unworthiness. Jer. Taylor.",
  "endostome": "1. (Bot.)  The foramen or passage through the inner integument of an ovule. 2. (Zoöl.)  And endostoma.",
  "easy-chair": "An armichair for ease or repose. \"Laugh . . . in Rabelais' easy-chair.\" Pope.",
  "emphysema": "A swelling produced by gas or air diffused in the cellular tissue. Emphysema of the lungs, Pulmonary emphysema (Med.), a common disease of the lungs in which the air cells are distended and their partition walls ruptured by an abnormal pressure of the air contained in them.",
  "enseal": "To impress with a seal; to mark as with a seal; hence, to ratify. [Obs.] This deed I do enseal. Piers Plowman.",
  "eelpout": "(a) A European fish (Zoarces viviparus), remarkable for producing living young; -- called also greenbone, guffer, bard, and Maroona eel. Also, an American species (Z. anguillaris), -- called also mutton fish, and, erroneously, congo eel, ling, and lamper eel. Both are edible, but of little value. (b) A fresh-water fish, the burbot.",
  ...
  "expressional": "Of, or relating to, expression; phraseological; also, vividly representing or suggesting an idea sentiment. Fized. Hall. Ruskin.",
  "ephyra": "A stage in the development of discophorous medusæ, when they first begin to swim about after being detached from the strobila. See Strobila.",
  ...
  "executor": "1. One who executes or performs; a doer; as, an executor of baseness. Shak. 2. An executioner. [Obs.] Delivering o'er to executors pa . . . The lazy, yawning drone. Shak. 3. (Law)  The person appointed by a Executor de son tort Etym: [Of., executor of his own wrong] (Law), a stranger who intermeddles without authority in the distribution of the estate of a deceased person.",
  ...
  "exothermic": "Characterized by, or formed with, evolution of heat; as, an exothermic reaction; -- opposed to endothermic.",
  ...
  "emplecton": "A kind of masonry in which the outer faces of the wall are ashlar, the space between being filled with broken stone and mortar. Cross layers of stone are interlaid as binders. [R.] Weale.",
  "exegetical": "Pertaining to exegesis; tending to unfold or illustrate; explanatory; expository. Walker. Ex`e*get\"ic*al*ly, adv.",
  "enneandrian": "Having nine stamens.",
  "ecstatical": "1. Ecstatic. Bp. Stillingfleet. 2. Tending to external objects. [R.] Norris.",
  "evolutility": "The faculty possessed by all substances capable of self- nourishment of manifesting the nutritive acts by changes of form, of volume, or of structure. Syd. Soc. Lex.",
  "elaphure": "A species of deer (Elaphurus Davidianus) found in china. It about four feet high at the shoulder and has peculiar antlers.",
  "except": "1. To take or leave out (anything) from a number or a whole as not belonging to it; to exclude; to omit. Who never touched The excepted tree. Milton. Wherein (if we only except the unfitness of the judge) all other things concurred. Bp. Stillingfleet. 2. To object to; to protest against. [Obs.] Shak.\n\nTo take exception; to object; -- usually followed by to, sometimes by against; as, to except to a witness or his testimony. Except thou wilt except against my love. Shak.\n\nWith exclusion of; leaving or left out; excepting. God and his Son except, Created thing naught valued he nor . . . shunned. Milton. Syn. -- Except, Excepting, But, Save, Besides. Excepting, except, but, and save are exclusive. Except marks exclusion more pointedly. \"I have finished all the letters except one,\" is more marked than \"I have finished all the letters but one.\" Excepting is the same as except, but less used. Save is chiefly found in poetry. Besides (lit., by the side of) is in the nature of addition. \"There is no one here except or but him,\" means, take him away and there is nobody present. \"There is nobody here besides him,\" means, hi is present and by the side of, or in addition to, him is nobody. \"Few ladies, except her Majesty, could have made themselves heard.\" In this example, besides should be used, not except.\n\nUnless; if it be not so that. And he said, I will not let thee go, except thou bless me. Gen. xxxii. 26. But yesterday you never opened lip, Except, indeed, to drink. Tennyson. Note: As a conjunction unless has mostly taken the place of except.",
  ...
  "exordium": "A beginning; an introduction; especially, the introductory part of a discourse or written composition, which prepares the audience for the main subject; the opening part of an oration. \"The exordium of repentance.\" Jer. Taylor. \"Long prefaces and exordiums. \" Addison.",
  ...
  "emphyteusis": "A real right, susceptible of assignment and of descent, charged on productive real estate, the right being coupled with the enjoyment of the property on condition of taking care of the estate and paying taxes, and sometimes a small rent. Heumann.",
  ...
  "exactly": "In an exact manner; precisely according to a rule, standard, or fact; accurately; strictly; correctly; nicely. \"Exactly wrought.\" Shak. His enemies were pleased, for he had acted exactly as their interests required. Bancroft.",
  "encumberment": "Encumbrance. [R.]",
  "ethologic": "treating of, or pertaining to, ethnic or morality, or the science of character. J. S. Mill.",
  "electro-chronograph": "An instrument for obtaining an accurate record of the time at which any observed phenomenon occurs, or of its duration. It has an electro-magnetic register connected with a clock. See Chronograph.",
  ...
  "eavesdropping": "The habit of lurking about dwelling houses, and other places where persons meet fro private intercourse, secretly listening to what is said, and then tattling it abroad. The offense is indictable at common law. Wharton.",
  ...
  "etymon": "1. An original form; primitive word; root. 2. Original or fundamental signification. [R.] Given as the etymon or genuine sense of the word. Coleridge.",
  "encomberment": "Hindrance; molestation.[Obs.] Spenser.",
  "exploiture": "1. The act of exploiting or accomplishing; achievement. [Obs.] Udall. 2. Exploitation. Harper's Mag.",
  ...
  "elenchtic": "Same as Elenctic.",
  "exaggerate": "1. To heap up; to accumulate. [Obs.] \"Earth exaggerated upon them [oaks and firs].\" Sir M. Hale. 2. To amplify; to magnify; to enlarge beyond bounds or the truth ; to delineate extravagantly ; to overstate the truth concerning. A friend exaggerates a man's virtues. Addison.",
  ...
  "elicit": "Elicited; drawn out; made real; open; evident. [Obs.] \"An elicit act of equity.\" Jer. Taylor.\n\nTo draw out or entice forth; to bring to light; to bring out against the will; to deduce by reason or argument; as, to elicit truth by discussion.",
  "educated": "Formed or developed by education; as, an educated man.",
  "edentate": "1. Destitute of teeth; as, an edentate quadruped; an edentate leaf. 2. (Zoöl.)  Belonging to the Edentata.\n\nOne of the Edentata.",
  "electorality": "The territory or dignity of an elector; electorate. [R.] Sir H. Wotton.",
  "embower": "To cover with a bower; to shelter with trees. [Written also imbower.] [Poetic] Milton. -- v. i.  To lodge or rest in a bower. [Poetic] \"In their wide boughs embow'ring. \" Spenser.",
  ...
  "elvan": "1. Pertaining to elves; elvish. 2. (Mining)  Of or pertaining to certain veins of feldspathic or porphyritic rock crossing metalliferous veins in the mining districts of Cornwall; as, an elvan course.\n\nThe rock of an elvan vein, or the elvan vein itself; an elvan course.",
  "embryotic": "Embryonic.",
  ...
  "embankment": "1. The act of surrounding or defending with a bank. 2. A structure of earth, gravel, etc., raised to prevent water from overflowing a level tract of country, to retain water in a reservoir, or to carry a roadway, etc.",
  ...
  "effervesce": "1. To be in a state of natural ebullition; to bubble and hiss, as fermenting liquors, or any fluid, when some part escapes in a gaseous form. 2. To exhibit, in lively natural expression, feelings that can not be repressed or concealed; as, to effervesce with joy or merriment.",
  ...
  "ethnical": "1. Belonging to races or nations; based on distinctions of race; ethnological. 2. Pertaining to the gentiles, or nations not converted to Christianity; heathen; pagan; -- opposed to Jewish and Christian.",
  ...
  "exorbitance": "A going out of or beyond the usual or due limit; hence, enormity; extravagance; gross deviation from rule, right, or propriety; as, the exorbitances of the tongue or of deportment; exorbitance of demands. \"a curb to your exorbitancies.\" Dryden. The lamentable exorbitances of their superstitions. Bp. Hall.",
  "ecrasement": "The operation performed with an écraseur.",
  "eleusinian": "Pertaining to Eleusis, in Greece, or to secret rites in honor of Ceres, there celebrated; as, Eleusinian mysteries or festivals.",
  "etape": "1.  A public storehouse. 2.  Supplies issued to troops on the march; hence (Mil.),  the place where troops on the march halt over night; also, by extension, the distance marched during a day. 3.  In Russia, a prison or stockade for the confinement of prisoners in transit.",
  ...
  "eupione": "A limpid, oily liquid obtained by the destructive distillation of various vegetable and animal substances; -- specifically, an oil consisting largely of the higher hydrocarbons of the paraffin series. [Written also eupion.]",
  ...
  "excruciation": "The act of inflicting agonizing pain, or the state of being thus afflicted; that which excruciates; torture. Feltham.",
  "exeat": "1. A license for absence from a college or a religious house. [Eng.] Shipley. 2. A permission which a bishop grants to a priest to go out of his diocese. Wharton.",
  "exertion": "The act of exerting, or putting into motion or action; the active exercise of any power or faculty; an effort, esp. a laborious or perceptible effort; as, an exertion of strength or power; an exertion of the limbs or of the mind; it is an exertion for him to move, to-day. Syn. -- Attempt; endeavor; effort; essay; trial. See Attempt.",
  "eterminable": "Interminable. [Obs.] Skelton.",
  "exemplify": "1. To show or illustrate by example. He did but . . . exemplify the principles in which he had been brought up. Cowper. 2. To copy; to transcribe; to make an attested copy or transcript of, under seal, as of a record. Holland. 3. To prove or show by an attested copy.",
  ...
  "emplastration": "1. The act or process of grafting by inoculation; budding. [Obs.] Holland. 2. Etym: [See 1st Emplaster.] (Med.)  The application of a plaster or salve.",
  ...
  "exculpation": "The act of exculpating from alleged fault or crime; that which exculpates; excuse. These robbers, however, were men who might have made out a strong case in exculpation of themselves. Southey.",
  ...
  "extensometer": "An instrument for measuring the extension of a body, especially for measuring the elongation of bars of iron, steel, or other material, when subjected to a tensile force.",
  ...
  "effluence": "1. A flowing out, or emanation. 2. That which flows or issues from any body or substance; issue; efflux. Bright effluence of bright essence increate! Milton. And, as if the gloom of the earth and sky had been but the effluence of these two mortal hearts, it vanished with their sorrow. Hawthorne.",
  ...
  "expropriate": "To put out of one's possession; to surrender the ownership of; also, to deprive of possession or proprietary rights. Boyle. Expropriate these [bad landlords] as the monks were expropriated by Act of Parliament. M. Arnold.",
  "extricate": "1. To free, as from difficulties or perplexities; to disentangle; to disembarrass; as, to extricate a person from debt, peril, etc. We had now extricated ourselves from the various labyrinths and defiles. Eustance. 2. To cause to be emitted or evolved; as, to extricate heat or moisture. Syn. -- To disentangle; disembarrass; disengage; relieve; evolve; set free; liberate.",
  ...
  "eyre": "A journey in circuit of certain judges called justices in eyre (or in itinere). Note: They were itinerant judges, who rode the circuit, holding courts in the different counties.",
  ...
  "edriophthalma": "A group of Crustacea in which the eyes are without stalks; the Arthrostraca. [Written also Edriophthalmata.]",
  ...
  "edgelong": "In the direction of the edge. [Obs.] Three hundred thousand pieces have you stuck Edgelong into the ground. B. Jonson.",
  ...
  "emulsion": "Any liquid preparation of a color and consistency resembling milk; as: (a) In pharmacy, an extract of seeds, or a mixture of oil and water united by a mucilaginous substance. (b) In photography, a liquid preparation of collodion holding salt of silver, used in the photographic process.",
  "entrant": "1. One who enters; a beginner. \"The entrant upon life.\" Bp. Terrot. 2. An applicant for admission. Stormonth.",
  "epiphragm": "A membranaceous or calcareous septum with which some mollusks close the aperture of the shell during the time of hibernation, or æstivation.",
  "embreathement": "The act of breathing in; inspiration. [R.] The special and immediate suggestion, embreathement, and dictation of the Holy Ghost. W. Lee.",
  ...
  "esurient": "Inclined to eat; hungry; voracious. [R.] Bailey. \"Poor, but esurient.\" Carlyle.\n\nOne who is hungry or greedy. [R.] An insatiable esurient after riches. Wood.",
  ...
  "entomology": "1. That part of zoölogy which treats of insects. 2. A treatise on the science of entomology.",
  "ethereous": "1. Formed of ether; ethereal. [Obs.] This ethereous mold whereon we stand. Milton. 2. (Chem.)  Pertaining to, or resembling, either. Ethereous oil. See Ethereal oil, under Ethereal.",
  "espousage": "Espousal. [Obs.] Latimer.",
  "exemplification": "1. The act of exemplifying; a showing or illustrating by example. 2. That which exemplifies; a case in point; example. 3. (Law)  A copy or transcript attested to be correct by the seal of an officer having custody of the original.",
  ...
  "expansive": "Having a capacity or tendency to expand or dilate; diffusive; of much expanse; wide-extending; as, the expansive force of heat; the expansive quality of air. A more expansive and generous compassion. Eustace. His forehead was broad and expansive. Prescott. -- Ex*pan\"sive*ly, adv. -Ex*pan\"sive*ness, n.",
  "electric": "1. Pertaining to electricity; consisting of, containing, derived from, or produced by, electricity; as, electric power or virtue; an electric jar; electric effects; an electric spark. 2. Capable of occasioning the phenomena of electricity; as, an electric or electrical machine or substance. 3. Electrifying; thrilling; magnetic. \"Electric Pindar.\" Mrs. Browning. Electric atmosphere, or Electric aura. See under Aura. -- Electrical battery. See Battery. -- Electrical brush. See under Brush. -- Electric cable. See Telegraph cable, under Telegraph. -- Electric candle. See under Candle. -- Electric cat (Zoöl.), one of three or more large species of African catfish of the genus Malapterurus (esp. M. electricus of the Nile). They have a large electrical organ and are able to give powerful shocks; -- called also sheathfish. -- Electric clock. See under Clock, and see Electro-chronograph. -- Electric current, a current or stream of electricity traversing a closed circuit formed of conducting substances, or passing by means of conductors from one body to another which is in a different electrical state. -- Electric, or Electrical, eel (Zoöl.), a South American eel-like fresh-water fish of the genus Gymnotus (G. electricus), from two to five feet in length, capable of giving a violent electric shock. See Gymnotus. -- Electrical fish (Zoöl.), any fish which has an electrical organ by means of which it can give an electrical shock. The best known kinds are the torpedo, the gymnotus, or electrical eel, and the electric cat. See Torpedo, and Gymnotus. -- Electric fluid, the supposed matter of electricity; lightning. -- Electrical image (Elec.), a collection of electrical points regarded as forming, by an analogy with optical phenomena, an image of certain other electrical points, and used in the solution of electrical problems. Sir W. Thomson. -- Electrical light, the light produced by a current of electricity which in passing through a resisting medium heats it to incandescence or burns it. See under Carbon. -- Electric, or Electrical, machine, an apparatus for generating, collecting, or exciting, electricity, as by friction. -- Electric motor. See Electro-motor, 2. -- Electric osmose. (Physics) See under Osmose. -- Electric pen, a hand pen for making perforated stencils for multiplying writings. It has a puncturing needle driven at great speed by a very small magneto-electric engine on the penhandle. -- Electric railway, a railway in which the machinery for moving the cars is driven by an electric current. -- Electric ray (Zoöl.), the torpedo. -- Electric telegraph. See Telegraph.\n\nA nonconductor of electricity, as amber, glass, resin, etc., employed to excite or accumulate electricity.",
  ...
  "exoccipital": "Pertaining to a bone or region on each side of the great foremen of the skull. -- n.  The exoccipital bone, which often forms a part of the occipital in the adult, but is usually distinct in the young.",
  ...
  "eye-spot": "(a) A simple visual organ found in many invertebrates, consisting of pigment cells covering a sensory nerve termination. (b) An eyelike spot of color.",
  ...
  "excavator": "One who, or that which, excavates or hollows out; a machine, as a dredging machine, or a tool, for excavating.",
  ...
  "elegance": "1. The state or quality of being elegant; beauty as resulting from choice qualities and the complete absence of what deforms or impresses unpleasantly; grace given by art or practice; fine polish; refinement; -- said of manners, language, style, form, architecture, etc. That grace that elegance affords. Drayton. The endearing elegance of female friendship. Johnson. A trait of native elegance, seldom seen in the masculine character after childhood or early youth, was shown in the General's fondness for the sight and fragrance of flowers. Hawthorne. 2. That which is elegant; that which is tasteful and highly attractive. The beautiful wildness of nature, without the nicer elegancies of art. Spectator. Syn. -- Elegance, Grace. Elegance implies something of a select style of beauty, which is usually produced by art, skill, or training; as, elegance of manners, composition, handwriting, etc.; elegant furniture; an elegant house, etc. Grace, as the word is here used, refers to bodily movements, and is a lower order of beauty. It may be a natural gift; thus, the manners of a peasant girl may be graceful, but can hardly be called elegant.",
  ...
  "ethiopian": "A native or inhabitant of Ethiopia; also, in a general sense, a negro or black man.\n\nOf or relating to Ethiopia or the Ethiopians.",
  ...
  "extermination": "1. The act of exterminating; total destruction; eradication; excision; as, the extermination of inhabitants or tribes, of error or vice, or of weeds from a field. 2. (Math.)  Elimination. [R.]",
  ...
  "eerie": "1. Serving to inspire fear, esp. a dread of seeing ghosts; wild; weird; as, eerie stories. She whose elfin prancer springs By night to eery warblings. Tennyson. 2. Affected with fear; affrighted. Burns.",
  ...
  "earsh": "See Arrish.",
  "edible": "Fit to be eaten as food; eatable; esculent; as, edible fishes. Bacon. -- n.  Anything edible. Edible bird's nest. See Bird's nest, 2. -- Edible crab (Zoöl.), any species of crab used as food, esp. the American blue crab (Callinectes hastatus). See Crab. -- Edible frog (Zoöl.), the common European frog (Rana esculenta), used as food. -- Edible snail (Zoöl.), any snail used as food, esp. Helix pomatia and H. aspersa of Europe.",
  ...
  "establishmentarian": "One who regards the Church primarily as an establishment formed by the State, and overlooks its intrinsic spiritual character. Shipley.",
  "exploration": "The act of exploring, penetrating, or ranging over for purposes of discovery, especially of geographical discovery; examination; as, the exploration of unknown countries; (Med.)  physical examination. \"An exploration of doctrine.\" Bp. Hall.",
  ...
  "embarrassment": "1. A state of being embarrassed; perplexity; impediment to freedom of action; entanglement; hindrance; confusion or discomposure of mind, as from not knowing what to do or to say; disconcertedness. The embarrassment which inexperienced minds have often to express themselves upon paper. W. Irving. The embarrassments tom commerce growing out of the late regulations. Bancroft. 2. Difficulty or perplexity arising from the want of money to pay debts.",
  "ereptation": "A creeping forth. [Obs.]",
  "exsuscitation": "A stirring up; a rousing. [Obs.] Hallywell.",
  "eudemonism": "That system of ethics which defines and enforces moral obligation by its relation to happiness or personal well-being.",
  "elenctic": "Serving to refute; refutative; -- applied to indirect modes of proof, and opposed to deictic.",
  ...
  "extendible": "1. Capable of being extended, susceptible of being stretched, extended, enlarged, widened, or expanded. 2. (Law)  Liable to be taken by a writ of extent.",
  "effierce": "To make fierce. [Obs.] Spenser.",
  "excuss": "1. To shake off; to discard. [R.] To excuss the notation of a Geity out of their minds. Bp. Stillingfleet. 2. To inspect; to investigate; to decipher. [R.] To take some pains in excusing some old monuments. F. Junius (1654). 3. To seize and detain by law, as goods. [Obs.] Ayliffe.",
  ...
  "ejaculation": "1. The act of throwing or darting out with a sudden force and rapid flight. [Archaic or Technical] \"An ejaculation or irradiation of the eye.\" Bacon. 2. The uttering of a short, sudden exclamation or prayer, or the exclamation or prayer uttered. In your dressing, let there be jaculations fitted to the several actions of dressing. Jer. Taylor. 3. (Physiol.)  The act of ejecting or suddenly throwing, as a fluid from a duct.",
  ...
  "encharge": "To charge (with); to impose (a charge) upon. His countenance would express the spirit and the passion of the part he was encharged with. Jeffrey.\n\nA charge. [Obs.] A. Copley.",
  "embraid": "1. To braid up, as hair. [Obs.] Spenser. 2. To upbraid. [Obs.] Sir T. Elyot.",
  "earles penny": "Earnest money. Same as Arles penny. [Obs.]",
  "elaiometer": "An apparatus for determining the amount of oil contained in any substance, or for ascertaining the degree of purity of oil.",
  "economics": "1. The science of household affairs, or of domestic management. 2. Political economy; the science of the utilities or the useful application of wealth or material resources. See Political economy, under Political. \"In politics and economics.\" V. Knox.",
  "excommunicable": "Liable or deserving to be excommunicated; making excommunication possible or proper. \"Persons excommunicable .\" Bp. Hall. What offenses are excommunicable Kenle.",
  ...
  "excommunicate": "Excommunicated; interdicted from the rites of the church. -- n.  One excommunicated. Thou shalt stand cursed and excommunicate. Shak.\n\n1. To put out of communion; especially, to cut off, or shut out, from communion with the church, by an ecclesiastical sentence. 2. To lay under the ban of the church; to interdict. Martin the Fifth . . . was the first that excommunicated the reading of heretical books. Miltin.",
  "exportation": "1. The act of exporting; the act of conveying or sending commodities abroad or to another country, in the course of commerce. 2. Commodity exported; an export. 3. The act of carrying out. [R.] Bourne.",
  ...
  "embassade": "1. The mission of an ambassador. [Obs.] Carew. 2. An embassy. [Obs.] Strype.\n\nAn embassy. See Ambassade. [Obs.] Shak.",
  ...
  "emancipate": "To set free from the power of another; to liberate; as: (a) To set free, as a minor from a parent; as, a father may emancipate a child. (b) To set free from bondage; to give freedom to; to manumit; as, to emancipate a slave, or a country. Brasidas . . . declaring that he was sent to emancipate Hellas. Jowett (Thucyd. ). (c) To free from any controlling influence, especially from anything which exerts undue or evil influence; as, to emancipate one from prejudices or error. From how many troublesome and slavish impertinences . . . he had emancipated and freed himself. Evelyn. To emancipate the human conscience. A. W. Ward.\n\nSet at liberty.",
  ...
  "enchain": "1. To bind with a chain; to hold in chains. 2. To hold fast; to confine; as, to enchain attention. 3. To link together; to connect. Howell.",
  ...
  "expound": "1. To lay open; to expose to view; to examine. [Obs.] He expounded both his pockets. Hudibras. 2. To lay open the meaning of; to explain; to clear of obscurity; to interpret; as, to expound a text of Scripture, a law, a word, a meaning, or a riddle. Expound this matter more fully to me. Bunyan.",
  ...
  "etrurian": "Of or relating to ancient Etruria, in Italy. \"Etrurian Shades.\" Milton, -- n.  A native or inhabitant of ancient Etruria.",
  ...
  "egoistical": "Pertaining to egoism; imbued with egoism or excessive thoughts of self; self-loving. Ill-natured feeling, or egoistic pleasure in making men miserable. G. Eliot.",
  "expanse": "That which is expanded or spread out; a wide extent of space or body; especially, the arch of the sky. \"The green expanse.\" Savage. Lights . . . high in the expanse of heaven. Milton. The smooth expanse of crystal lakes. Pope.\n\nTo expand. [Obs.] That lies expansed unto the eyes of all. Sir. T. Browne.",
  ...
  "eternally": "In an eternal manner. That which is morally good or evil at any time or in any case, must be also eternally and unchangeably so. South. Where western gales eternally reside. Addison.",
  ...
  "extrafoliaceous": "Away from the leaves, or inserted in a different place from them; as, extrafoliaceous prickles. Loudon.",
  ...
  "exaggerative": "Tending to exaggerate; involving exaggeration. \"Exaggerative language.\" Geddes. \"Exaggerative pictures.\" W. J. Linton. -- Ex*ag\"ger*a*tive*ly, adv. Carlyle.",
  ...
  "easter lily": "(a) The common white lily (Lilium candidum), called also Annunciation lily. (b) The larger white lily (Lilium longiflorum eximium, syn. L. Harrisii) called also Bermuda lily. (c) The daffodil (Narcissus Pseudo-Narcissus). (d) The Atamasco lily.",
  ...
  "executioner": "1. One who executes; an executer. Bacon. 2. One who puts to death in conformity to legal warrant, as a hangman.",
  ...
  "exclaim": "To cry out from earnestness or passion; to utter with vehemence; to call out or declare loudly; to protest vehemently; to vociferate; to shout; as, to exclaim against oppression with wonder or astonishment; \"The field is won!\" he exclaimed.\n\nOutcry; clamor. [Archaic] Cursing cries and deep exclaims. Shak.",
  ...
  "expertness": "Skill derived from practice; readiness; as, expertness in seamanship, or in reasoning. Syn. -- Facility; readiness; dexterity; adroitness; skill. See Facility.",
  ...
  "edam": "A Dutch pressed cheese of yellow color and fine flavor, made in balls weighing three or four pounds, and usually colored crimson outside; -- so called from the village of Edam, near Amsterdam. Also, cheese of the same type, wherever made.",
  ...
  "elegit": "A judicial writ of execution, by which a defendant's goods are appraised and delivered to the plaintiff, and, if no sufficient to satisfy the debt, all of his lands are delivered, to be held till the debt is paid by the rents and profits, or until the defendant's interest has expired.",
  ...
  "emprosthotonos": "A drawing of the body forward, in consequence of the spasmodic action of some of the muscles. Gross.",
  ...
  "ejector": "1. One who, or that which, ejects or dispossesses. 2. (Mech.)  A jet jump for lifting water or withdrawing air from a space. Ejector condenser (Steam Engine), a condenser in which the vacuum is maintained by a jet pump.",
  ...
  "exequy": "A funeral rite (usually in the plural); the ceremonies of burial; obsequies; funeral procession. But see his exequies fulfilled in Rouen. Shak.",
  "esopic": "Same as Æsopian.\n\nSame as Æsopian, Æsopic.",
  "eloquently": "In an eloquent manner.",
  "ear-bored": "Having the ear perforated.",
  "elecampane": "1. (Bot.)  A large, coarse herb (Inula Helenium), with composite yellow flowers. The root, which has a pungent taste, is used as a tonic, and was formerly of much repute as a stomachic. 2. A sweetmeat made from the root of the plant.",
  ...
  "emaciation": "1. The act of making very lean. 2. The state of being emaciated or reduced to excessive leanness; an excessively lean condition.",
  "euphonic": "Pertaining to, or exhibiting, euphony; agreeable in sound; pleasing to the ear; euphonious; as, a euphonic expression; euphonical orthography.",
  ...
  "exemplar": "1. A model, original, or pattern, to be copied or imitated; a specimen; sometimes; an ideal model or type, as that which an artist conceives. Such grand exemplar as make their own abilities the sole measure of what is fit or unfit. South. 2. A copy of a book or writing. [Obs.] Udall.\n\nExemplary. [Obs.] The exemplar piety of the father of a family. Jer. Taylor.",
  "eridanus": "A long, winding constellation extending southward from Taurus and containing the bright star Achernar.",
  "ealderman": "An alderman. [Obs.]",
  ...
  "elementary": "1. Having only one principle or constituent part; consisting of a single element; simple; uncompounded; as, an elementary substance. 2. Pertaining to, or treating of, the elements, rudiments, or first principles of anything; initial; rudimental; introductory; as, an elementary treatise. 3. Pertaining to one of the four elements, air, water, earth, fire. \"Some luminous and fiery impressions in the elementary region.\" J. Spencer.",
  ...
  "electrology": "That branch of physical science which treats of the phenomena of electricity and its properties.",
  "emporium": "1. A place of trade; a market place; a mart; esp., a city or town with extensive commerce; the commercial center of a country. That wonderful emporium [Manchester] . . . was then a mean and ill- built market town. Macaulay. It is pride . . . which fills our streets, our emporiums, our theathers. Knox. 2. (Physiol.)  The brain. [Obs.]",
  ...
  "etymology": "1. That branch of philological science which treats of the history of words, tracing out their origin, primitive significance, and changes of from and meaning. 2. That pert of grammar which relates to the changes in the form of the words in a language; inflection.",
  ...
  "excellently": "1. In an excellent manner; well in a high degree. 2. In a high or superior degree; -- in this literal use, not implying worthiness. [Obs.] When the whole heart is excellently sorry. J. Fletcher.",
  "emulgent": "Pertaining to the kidneys; renal; as, emulgent arteries and veins. -- n.  An emulgent vessel, as a renal artery or vein.\n\nA medicine that excites the flow of bile. [Obs.] Hoblyn.",
  ...
  "eugenol": "A colorless, aromatic, liquid hydrocarbon, C10H12O2 resembling the phenols, and hence also called eugenic acid. It is found in the oils of pimento and cloves.",
  ...
  "euphoniad": "An instrument in which are combined the characteristic tones of the organ and various other instruments. [R.]",
  ...
  "expatriate": "1. To banish; to drive or force (a person) from his own country; to make an exile of. The expatriated landed interest of France. Burke. 2. Reflexively, as To expatriate one's self: To withdraw from one's native country; to renounce the rights and liabilities of citizenship where one is born, and become a citizen of another country.",
  ...
  "empyrean": "The highest heaven, where the pure element of fire was supposed by the ancients to subsist. The empyrean rung With hallelujahs. Milton.\n\nEmpyreal. Akenside.",
  "etna": "A kind of small, portable, cooking apparatus for which heat is furnished by a spirit lamp. There should certainly be an etna for getting a hot cup of coffee in a hurry. V. Baker.",
