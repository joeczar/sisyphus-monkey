// Auto-generated dictionary file for letter 'z'
...
const dictionary: AlphabeticalDictionary = {
  ...
  "zink": "See Zinc. [Obs.]",
  "zetetic": "Seeking; proceeding by inquiry. Zetetic method (Math.), the method used for finding the value of unknown quantities by direct search, in investigation, or in the solution of problems. [R.] Hutton.\n\nA seeker; -- a name adopted by some of the Pyrrhonists.",
  "zinziberaceous": "Same as Zingiberaceous.",
  "zoospore": "1. (Bot.)  A spore provided with one or more slender cilia, by the vibration of which it swims in the water. Zoöspores are produced by many green, and by some olive-brown, algæ. In certain species they are divided into the larger macrozoöspores and the smaller microzoöspores. Called also sporozoid, and swarmspore. 2. (Zoöl.)  See Swarmspore.",
  "zooechemistry": "Animal chemistry; particularly, the description of the chemical compounds entering into the composition of the animal body, in distinction from biochemistry.",
  "zealed": "Full of zeal; characterized by zeal. [Obs.] \"Zealed religion.\" Beau. & Fl.",
  "zamindari": "The jurisdiction of a zamindar; the land possessed by a zamindar. [Written also zemindary, zemindari.]",
  ...
  "zonal": "Of or pertaining to a zone; having the form of a zone or zones. Zonal equation (Crystallog.), the mathematical relation which belongs to all the planes of a zone, and expresses their common position with reference to the axes. -- Zonal structure (Crystallog.), a structure characterized by the arrangements of color, inclusions, etc., of a crystal in parallel or concentric layers, which usually follow the outline of the crystal, and mark the changes that have taken place during its growth. -- Zonal symmetry. (Biol.) See the Note under Symmetry.",
  ...
  "zooespore": "1. (Bot.)  A spore provided with one or more slender cilia, by the vibration of which it swims in the water. Zoöspores are produced by many green, and by some olive-brown, algæ. In certain species they are divided into the larger macrozoöspores and the smaller microzoöspores. Called also sporozoid, and swarmspore. 2. (Zoöl.)  See Swarmspore.",
  "zingaro": "A gypsy.",
  "zootomist": "One who dissects animals, or is skilled in zoötomy.",
  ...
  "zooephytological": "Of or pertaining to zoöphytology; as, zoöphytological observations.",
  ...
  "zoochemy": "Animal chemistry; zoöchemistry. Dunglison.",
  "zircon light": "A light, similar to the calcium light, produced by incandescent zirconia.",
  "zoopsychology": "Animal psychology.",
  "zooetomist": "One who dissects animals, or is skilled in zoötomy.",
  "zizel": "The suslik. [Written also zisel.]",
  "zinkenite": "A steel-gray metallic mineral, a sulphide of antimony and lead.",
  "zunyite": "A fluosilicate of alumina occurring in tetrahedral crystals at the Zuñi mine in Colorado.",
  "zoologist": "One who is well versed in zoölogy.",
  "zooegeography": "The study or description of the geographical distribution of animals.",
  "zoosporic": "Of or pertaining to zoöspores; of the nature of zoöspores.",
  ...
  "zany": "A merry-andrew; a buffoon. Then write that I may follow, and so be Thy echo, thy debtor, thy foil, thy zany. Donne. Preacher at once, and zany of thy age. Pope.\n\nTo mimic. [Obs.] Your part is acted; give me leave at distance To zany it. Massinger.",
  "zigzag": "1. Something that has short turns or angles. The fanatics going straight forward and openly, the politicians by the surer mode of zigzag. Burke. 2. (Arch.)  A molding running in a zigzag line; a chevron, or series of chevrons. See Illust. of Chevron, 3. 3. (Fort.)  See Boyau.\n\nHaving short, sharp turns; running this way and that in an onward course.\n\nTo form with short turns.\n\nTo move in a zigzag manner; also, to have a zigzag shape. R. Browning.",
  ...
  "zoogamous": "Of or pertaining zoögamy.",
  "zooelogical": "Of or pertaining to zoölogy, or the science of animals.",
  "zythem": "See Zythum.",
  "zooenomy": "The laws animal life, or the science which treats of the phenomena of animal life, their causes and relations.",
  ...
  "zoophoric": "Bearing or supporting the figure of an animal; as, a zoöphoric column.",
  ...
  "zizith": "The tassels of twisted cords or threads on the corners of the upper garment worn by strict Jews. The Hebrew for this word is translated in both the Authorized and Revised Versions (Deut. xxii. 12) by the word \"fringes.\"",
  "zebrine": "Pertaining to, or resembling, the zebra.",
  "zoochemical": "Pertaining to zoöchemistry.",
  "zither": "An instrument of music used in Austria and Germany. It has from thirty to forty wires strung across a shallow sounding-board, which lies horizontally on a table before the performer, who uses both hands in playing on it. Note: [Not to be confounded with the old lute-shaped cittern, or cithern.]",
  ...
  "zemstvo": "In Russia, an elective local district and provincial administrative assembly. Originally it was composed of representatives elected by the peasantry, the householders of the towns, and the landed proprietors. In the reign of Alexander III. the power of the noble landowners was increased, the peasants allowed only to elect candidates from whom the governor of the province nominated the deputy, and all acts of the zemstvo subjected to the approval of the governor. Theoretically the zemstvo has large powers relating to taxation, education, public health, etc., but practically these powers are in most cases limited to the adjustment of the state taxation.",
  ...
  "zooegloea": "A colony or mass of bacteria imbedded in a viscous gelatinous substance. The zoögloea is characteristic of a transitory stage through which rapidly multiplying bacteria pass in the course of their evolution. Also used adjectively.",
  ...
  "zoophytoid": "Pertaining to, or resembling, a zoöphyte.",
  ...
  "zoologically": "In a zoölogical manner; according to the principles of zoölogy.",
  "zooegony": "The doctrine of the formation of living beings.",
  "zooecyst": "A cyst formed by certain Protozoa and unicellular plants which the contents divide into a large number of granules, each of which becomes a germ.",
  ...
  "zoned": "1. Wearing a zone, or girdle. Pope. 2. Having zones, or concentric bands; striped. 3. (Bot.)  Zonate.",
  "zygospore": "(a) Same as Zygosperm. (b) A spore formed by the union of several zoöspores; -- called also zygozoöspore.",
  ...
  "zooephoric": "Bearing or supporting the figure of an animal; as, a zoöphoric column.",
  "zooephytoid": "Pertaining to, or resembling, a zoöphyte.",
  "zoomelanin": "A pigment giving the black color to the feathers of many birds.",
  "zygenid": "Any one of numerous species of moths of the family Zygænidæ, most of which are bright colored. The wood nymph and the vine forester are examples. Also used adjectively.",
  ...
  "zoophytological": "Of or pertaining to zoöphytology; as, zoöphytological observations.",
  ...
  "zoogloea": "A colony or mass of bacteria imbedded in a viscous gelatinous substance. The zoögloea is characteristic of a transitory stage through which rapidly multiplying bacteria pass in the course of their evolution. Also used adjectively.",
  "zincous": "1. (Chem.) (a) Of, pertaining to, or containing, zinc; zincic; as, zincous salts. (b) Hence, formerly, basic, basylous, as opposed to chlorous. 2. (Physics)  Of or pertaining to the positive pole of a galvanic battery; electro-positive.",
  "zoccolo": "Same as Socle.",
  "zooelogy": "1. That part of biology which relates to the animal kingdom, including the structure, embryology, evolution, classification, habits, and distribution of all animals, both living and extinct. 2. A treatise on this science.",
  ...
  "zooechlorella": "One of the small green granulelike bodies found in the interior of certain stentors, hydras, and other invertebrates.",
  "zooephaga": "An artificial group comprising various carnivorous and insectivorous animals.",
  "zirconic": "Pertaining to, containing, or resembling, zirconium; as, zirconic oxide; zirconic compounds. Zirconic acid, an acid of zirconium analogous to carbonic and silicic acids, known only in its salts.",
  "zooenule": "Same as Zoönite.",
  "zamang": "An immense leguminous tree (Pithecolobium Saman) of Venezuela. Its branches form a hemispherical mass, often one hundred and eighty feet across. The sweet pulpy pods are used commonly for feeding cattle. Also called rain tree. J. Smith (Dict. Econ. Plants).",
  "zymic": "Pertaining to, or produced by, fermentation; -- formerly, by confusion, used to designate lactic acid.",
  "zebrawood": "(a) A kind of cabinet wood having beautiful black, brown, and whitish stripes, the timber of a tropical American tree (Connarus Guianensis). (b) The wood of a small West Indian myrtaceous tree (Eugenia fragrans). (c) The wood of an East Indian tree of the genus Guettarda.",
  "zocco": "Same as Socle.",
  ...
  "zuian": "Of or pert. to the Zuñis, or designating their linguistic stock. --n.  A Zuñi.",
  "zincographer": "Am engraver on zinc.",
  "zouave": "(a) One of an active and hardy body of soldiers in the French service, originally Arabs, but now composed of Frenchmen who wear the Arab dress. (b) Hence, one of a body of soldiers who adopt the dress and drill of the Zouaves, as was done by a number of volunteer regiments in the army of the United States in the Civil War, 1861-65.",
  "zygapophysis": "One of the articular processes of a vertebra, of which there are usually four, two anterior and two posterior. See under Vertebra. -- Zyg`ap*o*phys\"i*al, a.",
  ...
  "zufolo": "A little flute or flageolet, especially that which is used to teach birds. [Written also zuffolo.]",
  ...
  "zoophyte": "(a) Any one of numerous species of invertebrate animals which more or less resemble plants in appearance, or mode of growth, as the corals, gorgonians, sea anemones, hydroids, bryozoans, sponges, etc., especially any of those that form compound colonies having a branched or treelike form, as many corals and hydroids. (b) Any one of the Zoöphyta.",
  "zoosporangium": "A spore, or conceptacle containing zoöspores.",
  "zillah": "A district or local division, as of a province. [India]",
  "zymosis": "(a) A fermentation; hence, an analogous process by which an infectious disease is believed to be developed. (b) A zymotic disease. [R.]",
  "zoon": "(a) An animal which is the sole product of a single egg; -- opposed to zooid. H. Spencer. (b) Any one of the perfectly developed individuals of a compound animal.",
  "zoo": "A combining form from Gr. zwo^,n an animal, as in zoögenic, zoölogy, etc.",
  ...
  "zephyrus": "The west wind, or zephyr; -- usually personified, and made the most mild and gentle of all the sylvan deities. Mild as when Zephyrus on Flora breathes. Milton.",
  ...
  "zincoid": "Pertaining to, or resembling, zinc; -- said of the electricity of the zincous plate in connection with a copper plate in a voltaic circle; also, designating the positive pole. [Obs.]",
  ...
  "zygodactyl": "Any zygodactylous bird.",
  "zax": "A tool for trimming and puncturing roofing states. [Written also sax.]",
  "zygosis": "Same as Conjugation.",
  "zoomorphism": "1. The transformation of men into beasts. [R.] Smart. 2. The quality of representing or using animal forms; as, zoömorphism in ornament. 3. The representation of God, or of gods, in the form, or with the attributes, of the lower animals. To avoid the error of anthropomorphism, we fall into the vastly greater, and more absurd, error of zoömorphism. Mivart.",
  "zerda": "The fennec.",
  ...
  "zoophytic": "Of or pertaining to zoöphytes.",
  ...
  "zygoma": "(a) The jugal, malar, or cheek bone. (b) The zygomatic process of the temporal bone. (c) The whole zygomatic arch.",
  "zubr": "The aurochs.",
  "zoonomy": "The laws animal life, or the science which treats of the phenomena of animal life, their causes and relations.",
  "zooegamy": "The sexual reproduction of animals.",
  "zoology": "1. That part of biology which relates to the animal kingdom, including the structure, embryology, evolution, classification, habits, and distribution of all animals, both living and extinct. 2. A treatise on this science.",
  ...
  "za": "An old solfeggio name for B flat; the seventh harmonic, as heard in the or æolian string; -- so called by Tartini. It was long considered a false, but is the true note of the chord of the flat seventh. H. W. Poole.",
  "zeppelin": "A dirigible balloon of the rigid type, consisting of a cylindrical trussed and covered frame supported by internal gas cells, and provided with means of propulsion and  control. It was first successfully used by Ferdinand Count von Zeppelin.",
  ...
  "zachun": "An oil pressed by the Arabs from the fruit of a small thorny tree (Balanites Ægyptiaca), and sold to piligrims for a healing ointment. J. Smith (Dict. Econ. Plants).",
  ...
  "zonar": "A belt or girdle which the Christians and Jews of the Levant were obliged to wear to distinguish them from Mohammedans. [Written also zonnar.]",
  "zincographic": "Of or pertaining to zincography; as, zincographic processes.",
  "zooepsychology": "Animal psychology.",
  "zooeloger": "A zoölogist. Boyle.",
  "zonate": "Divided by parallel planes; as, zonate tetraspores, found in certain red algæ.",
  ...
  "zoogenic": "Of or pertaining to zoögeny, animal production.",
  ...
  "zooephyta": "An extensive artificial and heterogeneous group of animals, formerly adopted by many zoölogists. It included the coelenterates, echinoderms, sponges, Bryozoa, Protozoa, etc. Note: Sometimes the name is restricted to the Coelentera, or to the Anthozoa.",
  ...
  "zolaism": "The literary theories and practices of the French novelist Emile Zola (1840-1902); naturalism, esp. in a derogatory sense. -- Zo\"la*ist, n. -- Zo`la*is\"tic (#), a. -- Zo\"la*ize (#), v. ZOLLNER'S LINES Zöll\"ner's lines`. [So called after Friedrich Zöllner, a German physicist.]  Parallel lines that are made to appear convergent or divergent by means of oblique intersections.",
  ...
  "zooen": "(a) An animal which is the sole product of a single egg; -- opposed to zooid. H. Spencer. (b) Any one of the perfectly developed individuals of a compound animal.",
  "zooephytology": "The natural history zoöphytes.",
  "ziega": "Curd produced from milk by adding acetic acid, after rennet has ceased to cause coagulation. Brande & C.",
  "zingiberaceous": "Of or pertaining to ginger, or to a tribe (Zingibereæ) of endogenous plants of the order Scitamineæ. See Scitamineous.",
  "zoographical": "Of or pertaining to the description of animals.",
  "zymology": "A treatise on the fermentation of liquors, or the doctrine of fermentation. [Written also zumology.]",
  "zigzaggy": "Having sharp turns. Barham.",
  "zygantrum": "See under Zygosphene.",
  "zoologer": "A zoölogist. Boyle.",
  "zoantharian": "Of or pertaining to the Zoantharia. -- n.  One of the Anthozoa.",
  "zooe": "A combining form from Gr. zwo^,n an animal, as in zoögenic, zoölogy, etc.",
  ...
  "zoophyta": "An extensive artificial and heterogeneous group of animals, formerly adopted by many zoölogists. It included the coelenterates, echinoderms, sponges, Bryozoa, Protozoa, etc. Note: Sometimes the name is restricted to the Coelentera, or to the Anthozoa.",
  "zootomical": "Of or pertaining to zoötomy.",
  "zamite": "A fossil cycad of the genus Zamia.",
  "zythum": "A kind of ancient malt beverage; a liquor made from malt and wheat. [Written also zythem.] wheat. [Written also zythem.]",
  "zoogeography": "The study or description of the geographical distribution of animals.",
  "zygomatic": "Of, pertaining to, or in the region of, the zygoma. Zygomatic arch, the arch of bone beneath the orbit, formed in most mammals by the union of the malar, or jugal, with the zygomatic process of the temporal bone. In the lower vertebrates other bones may help to form it, and there may be two arches on each side of the skull, as in some reptiles. -- Zygomatic process, a process of the temporal or squamosal bone helping to form the zygomatic arch.",
  "zygomorphic": "Symmetrical bilaterally; -- said of organisms, or parts of organisms, capable of division into two symmetrical halves only in a single plane.",
  "zooelogist": "One who is well versed in zoölogy.",
  "zoophytology": "The natural history zoöphytes.",
  ...
  "zibet": "A carnivorous mammal (Viverra zibetha) closely allied to the civet, from which it differs in having the spots on the body less distinct, the throat whiter, and the black rings on the tail more numerous. Note: It inhabits India, Southern China, and the East Indies. It yields a perfume similar to that of the civet. It is often domesticated by the natives, and then serves the same purposes as the domestic cat. Called also Asiatic, or Indian, civet.",
  "zoological": "Of or pertaining to zoölogy, or the science of animals.",
  ...
  "zein": "A nitrogenous substance of the nature of gluten, obtained from the seeds of Indian corn (Zea) as a soft, yellowish, amorphous substance. [Formerly written zeine.]",
  "zooepraxiscope": "An instrument similar to, or the same as, the, the phenakistoscope, by means of which pictures projected upon a screen are made to exhibit the natural movements of animals, and the like.",
  ...
  "zooesporic": "Of or pertaining to zoöspores; of the nature of zoöspores.",
  ...
  "zionism": "Among the Jews, a theory, plan, or movement for colonizing their own race in Palestine, the land of Zion, or, if that is impracticable, elsewhere, either for religious or nationalizing purposes; -- called also Zion movement. --Zi\"on*ist, n. -- Zi`on*is\"tic (#), a.",
  ...
  "zooelogically": "In a zoölogical manner; according to the principles of zoölogy.",
  ...
  "zemindary": "Same as Zamindary.",
  "zandmole": "The sand mole.",
  "zigger": "Same as Sicker. [Prov. Eng.] Raymond.",
  "zebec": "See Xebec.",
  "zocle": "Same as Socle.",
  "zoomorphic": "Of or pertaining to zoömorphism.",
  "zinsang": "The delundung.",
  "zoism": "1. Reverence for animal life or belief in animal powers and influences, as among savages. 2.  (Biol.) A doctrine, now discarded, that the phenomena of life are due to a peculiar vital principle; the theory of vital force.",
  "zygosphene": "A median process on the front part of the neural arch of the vertebræ of most snakes and some lizards, which fits into a fossa, called the zygantrum, on the back part of the arch in front.",
  ...
  "zohar": "A Jewish cabalistic book attributed by tradition to Rabbi Simon ben Yochi, who lived about the end of the 1st century, a. d. Modern critics believe it to be a compilation of the 13th century. Encyc. Brit.",
  "zumological": "See Zymic, Zymological, etc.",
  "zante": "See Zantewood.",
  "zamindar": "A landowner; also, a collector of land revenue; now, usually, a kind of feudatory recognized as an actual proprietor so long as he pays to the government a certain fixed revenue. [Written also zemindar.] [India]",
  "zastrugi": "Grooves or furrows formed in snow by the action of the wind, and running parallel with the direction of the wind. This formation results from the erosion of transverse waves previously formed.",
  ...
  "zampogna": "A sort of bagpipe formerly in use among Italian peasants. It is now almost obsolete. [Written also zampugna.]",
  ...
  "zygosperm": "A spore formed by the union of the contents of two similar cells, either of the same or of distinct individual plants. Zygosperms are found in certain orders of algæ and fungi.",
  "zollverein": "Literally, a customs union; specifically, applied to the several customs unions successively formed under the leadership of Prussia among certain German states for establishing liberty of commerce among themselves and common tariff on imports, exports, and transit. Note: In 1834 a zollverein was established which included most of the principal German states except Austria. This was terminated by the events of 1866, and in 1867 a more closely organized union was formed, the administration of which was ultimately merged in that of the new German empire, with which it nearly corresponds territorially.",
  "zoographic": "Of or pertaining to the description of animals.",
  "zooephite": "A zoöphyte. [R.]",
  "zooegraphy": "A description of animals, their forms and habits.",
  "zibeth": "A carnivorous mammal (Viverra zibetha) closely allied to the civet, from which it differs in having the spots on the body less distinct, the throat whiter, and the black rings on the tail more numerous. Note: It inhabits India, Southern China, and the East Indies. It yields a perfume similar to that of the civet. It is often domesticated by the natives, and then serves the same purposes as the domestic cat. Called also Asiatic, or Indian, civet.",
  ...
  "zooemorphism": "1. The transformation of men into beasts. [R.] Smart. 2. The quality of representing or using animal forms; as, zoömorphism in ornament. 3. The representation of God, or of gods, in the form, or with the attributes, of the lower animals. To avoid the error of anthropomorphism, we fall into the vastly greater, and more absurd, error of zoömorphism. Mivart.",
  ...
  "zantewood": "(a) A yellow dyewood; fustet; -- called also zante, and zante fustic. See Fustet, and the Note under Fustic. (b) Satinwood (Chloroxylon Swietenia).",
  "zooemorphic": "Of or pertaining to zoömorphism.",
  ...
  "zend": "Properly, the translation and exposition in the Huzvâresh, or literary Pehlevi, language, of the Avesta, the Zoroastrian sacred writings; as commonly used, the language (an ancient Persian dialect) in which the Avesta is written.",
  ...
  "zooetomical": "Of or pertaining to zoötomy.",
  ...
  "zooenite": "(a) One of the segments of the body of an articulate animal. (b) One of the theoretic transverse divisions of any segmented animal.",
  ...
  "zoilism": "Resemblance to Zoilus in style or manner; carping criticism; detraction. Bring candid eyes the perusal of men's works, and let not Zoilism or detraction blast well-intended labors. Sir T. Browne.",
  ...
  "zooephagous": "Feeding on animals. Note: This is a more general term than either sarcophagous or carnivorous.",
  "zooegenic": "Of or pertaining to zoögeny, animal production.",
  "zooesporangium": "A spore, or conceptacle containing zoöspores.",
  "zumometer": "See Zymic, Zymological, etc.",
  "zygodactylic": "Yoke-footed; having the toes disposed in pairs; -- applied to birds which have two toes before and two behind, as the parrot, cuckoo, woodpecker, etc.",
  ...
  "zamindary": "The jurisdiction of a zamindar; the land possessed by a zamindar. [Written also zemindary, zemindari.]",
  ...
  "zooechemy": "Animal chemistry; zoöchemistry. Dunglison.",
  "zooecytium": "The common support, often branched, of certain species of social Infusoria.",
  "zooephytical": "Of or pertaining to zoöphytes.",
  ...
  "zoogeographical": "Of or pertaining to zoögraphy.",
  "zumic": "See Zymic, Zymological, etc.",
  ...
  "zooephily": "Love of animals.",
  "zareba": "An improvised stockade; especially, one made of thorn bushes, etc. [Written also zareeba, and zeriba.] [Egypt] \"Ah,\" he moralizes, \"what wonderful instinct on the part of this little creature to surround itself with a zareba like the troops after Osman Digma.\" R. Jefferies.",
  "zoonite": "(a) One of the segments of the body of an articulate animal. (b) One of the theoretic transverse divisions of any segmented animal.",
  "zooephorous": "The part between the architrave and cornice; the frieze; -- so called from the figures of animals carved upon it.",
  "zend-avesta": "The sacred writings of the ancient Persian religion, attributed to Zoroaster, but chiefly of a later date.",
  "zoophytical": "Of or pertaining to zoöphytes.",
