// Auto-generated dictionary file for letter 'o'
...
const dictionary: AlphabeticalDictionary = {
  ...
  "octostyle": "Having eight columns in the front; -- said of a temple or portico. The Parthenon is octostyle, but most large Greek temples are hexastele. See Hexastyle. -- n.  An octostyle portico or temple.",
  ...
  "obtusion": "1. The act or process of making obtuse or blunt. 2. The state of being dulled or blunted; as, the obtusion of the senses. Harvey.",
  ...
  "ozone paper": "Paper coated with starch and potassium iodine. It turns blue when exposed to ozone.>-- also called starch-iodide paper --> P.",
  "ocellus": "(a) A little eye; a minute simple eye found in many invertebrates. (b) An eyelike spot of color, as those on the tail of the peacock.",
  ...
  "obtest": "1. To call to witness; to invoke as a witness. [R.] Dryden. 2. To beseech; to supplicate; to beg for. [R.]\n\nTo protest. [R.] E. Waterhouse.",
  ...
  "oaten": "1. Consisting of an oat straw or stem; as, an oaten pipe. Milton. 2. Made of oatmeal; as, oaten cakes.",
  "onomantic": "Of or pertaining to onomancy. [R.]",
  "outshut": "To shut out. [R.] Donne.",
  "ochraceous": "Ocherous.",
  "ostracize": "1. (Gr. Antiq.)  To exile by ostracism; to banish by a popular vote, as at Athens. Grote. 2. To banish from society; to put under the ban; to cast out from social, political, or private favor; as, he was ostracized by his former friends. Marvell.",
  "ornithologic": "Of or pertaining to ornithology.",
  "opuscle": "A small or petty work.",
  ...
  "orgal": "See Argol. [Obs.]",
  "overglaze": "(a) Applied over the glaze; -- said of enamel paintings, which sometimes are seen to project from the surface of the ware. (b) Suitable for applying upon the glaze; -- said of vitrifiable colors used in ceramic decoration.",
  ...
  "organum": "An organ or instrument; hence, a method by which philosophical or scientific investigation may be conducted; -- a term adopted from the Aristotelian writers by Lord Bacon, as the title (\"Novum Organon\") of part of his treatise on philosophical method. Sir. W. Hamilton.",
  ...
  "overstrain": "To strain one's self to excess. Dryden.\n\nTo stretch or strain too much; as to overstrain one's nerves. Ayliffe.",
  "orthoptera": "An order of mandibulate insects including grasshoppers, locusts, cockroaches, etc. See Illust. under Insect. Note: The anterior wings are usually thickened and protect the posterior wings, which are larger and fold longitudinally like a fan. The Orthoptera undergo no metamorphosis.",
  ...
  "oxyacid": "An acid containing oxygen, as chloric acid or sulphuric acid; - - contrasted with the hydracids, which contain no oxygen, as hydrochloric acid. See Acid, and Hydroxy-.",
  ...
  "overlap": "To lap over; to lap.\n\n1. The lapping of one thing over another; as, an overlap of six inches; an overlap of a slate on a roof. 2. (Geol.)  An extension of geological beds above and beyond others, as in a conformable series of beds, when the upper beds extend over a wider space than the lower, either in one or in all directions.",
  "orchis": "1. (Bot.)  A genus of endogenous plants growing in the North Temperate zone, and consisting of about eighty species. They are perennial herbs growing from a tuber (beside which is usually found the last year's tuber also), and are valued for their showy flowers. See Orchidaceous. 2. (Bot.)  Any plant of the same family with the orchis; an orchid. Note: The common names, such as bee orchis, fly orchis, butterfly orchis, etc., allude to the peculiar form of the flower.",
  ...
  "observing": "Giving particular attention; habitually attentive to what passes; as, an observing person; an observing mind. -- Ob*serv\"ing*ly, adv.",
  ...
  "orthopedic": "Pertaining to, or employed in, orthopedy; relating to the prevention or cure of deformities of children, or, in general, of the human body at any age; as, orthopedic surgery; an orthopedic hospital.",
  ...
  "oeiliad": "A glance of the eye; an amorous look. [Obs.] She gave strange oeillades and most speaking looks. Shak.",
  ...
  "ozonometric": "Pertaining to, or used for, the determination of the amount of ozone; of or relating to ozonometry.",
  ...
  "osteosarcoma": "A tumor having the structure of a sacroma in which there is a deposit of bone; sarcoma connected with bone.",
  "orisont": "Horizon. [Obs.] Chaucer.",
  "overloop": "See Orlop. [Obs.]",
  "otosteal": "An auditory ossicle. R. Owen.",
  "oarsman": "One who uses, or is skilled in the use of, an oar; a rower. At the prow of the boat, rose one of the oarsmen. Longfellow.",
  "ostensorium": "Same as Monstrance.",
  ...
  "out-herod": "To surpass (Herod) in violence or wickedness; to exceed in any vicious or offensive particular. \"It out-Herods Herod.\" Shak. Out-Heroding the preposterous fashions of the times. Sir W. Scott.",
  ...
  "oaken": "Made or consisting of oaks or of the wood of oaks. \"In oaken bower.\" Milton. Oaken timber, wherewith to build ships. Bacon.",
  "overfree": "Free to excess; too liberal; too familiar. -- O\"ver*free\"ly, adv.",
  "overluscious": "Excessively luscious.",
  "occidental": "1. Of, pertaining to, or situated in, the occident, or west; western; -- opposed to oriental; as, occidental climates, or customs; an occidental planet. 2. Possessing inferior hardness, brilliancy, or beauty; -- used of inferior precious stones and gems, because those found in the Orient are generally superior.",
  ...
  "overdevelop": "To develop excessively; specif. (Photog.),  to subject (a plate or film) too long to the developing process.",
  "ouze": "See Ooze. [Obs.]",
  "outlay": "To lay out; to spread out; to display. [R.] Drayton.\n\n1. A laying out or expending. 2. That which is expended; expenditure. 3. An outlying haunt. [Obs.] Beau. & Fl.",
  ...
  "ostent": "1. Appearance; air; mien. Shak. 2. Manifestation; token; portent. Dryden. We asked of God that some ostent might clear Our cloudy business, who gave us sign. Chapman.",
  "outblown": "Inflated with wind. Dryden.",
  "oxy": "A prefix, also used adjectively, designating: (a) A compound containing oxygen. (b) A compound containing the hydroxyl group, more properly designated by hydroxy-. See Hydroxy-. Oxy acid. See Oxyacid (below).",
  "optimist": "1. (Metaph.)  One who holds the opinion that all events are ordered for the best. 2. One who looks on the bright side of things, or takes hopeful views; -- opposed to pessimist.",
  ...
  "otiose": "Being at leisure or ease; unemployed; indolent; idle. \"Otiose assent.\" Paley. The true keeping of the Sabbath was not that otiose and unAlford.",
  "ooelitic": "Of or pertaining to oölite; composed of, or resembling, oölite.",
  "oxime": "One of a series of isonitroso derivatives obtained by the action of hydroxylamine on aldehydes or ketones.",
  ...
  "obstetrical": "Of or pertaining to midwifery, or the delivery of women in childbed; as, the obstetric art. Obstetrical toad (Zoöl.), a European toad of the genus Alytes, especially A. obstetricans. The eggs are laid in a string which the male winds around his legs, and carries about until the young are hatched.",
  "ondoyant": "Wavy; having the surface marked by waves or slightly depressed furrows; as, ondoyant glass.",
  "ordinance": "1. Orderly arrangement; preparation; provision. [Obs.] Spenser. They had made their ordinance Of victual, and of other purveyance. Chaucer. 2. A rule established by authority; a permanent rule of action; a statute, law, regulation, rescript, or accepted usage; an edict or decree; esp., a local law enacted by a municipal government; as, a municipal ordinance. Thou wilt die by God's just ordinance. Shak. By custom and the ordinance of times. Shak. Walking in all the commandments and ordinances of the Lord blameless. Luke i. 6. Note: Acts of Parliament are sometimes called ordinances; also, certain colonial laws and certain acts of Congress under Confederation; as, the ordinance of 1787 for the government of the territory of the United States northwest of the Ohio River; the colonial ordinance of 1641, or 1647. This word is often used in Scripture in the sense of a law or statute of sovereign power. Ex. xv. 25. Num. x. 8. Ezra iii. 10. Its most frequent application now in the United States is to laws and regulations of municipal corporations. Wharton (Law Dict.). 3. (Eccl.)  An established rite or ceremony. 4. Rank; order; station. [Obs.] Shak. 5. Etym: [See Ordnance.]  Ordnance; cannon. [Obs.] Shak.",
  ...
  "orthorhombic": "Noting the system of crystallization which has three unequal axes at right angles to each other; trimetric. See Crystallization.",
  ...
  "organization": "1. The act of organizing; the act of arranging in a systematic way for use or action; as, the organization of an army, or of a deliberative body. \"The first organization of the general government.\" Pickering. 2. The state of being organized; also, the relations included in such a state or condition. What is organization but the connection of parts in and for a whole, so that each part is, at once, end and means Coleridge. 3. That wich is organized; an organized existence; an organism; specif. (Biol.), an arrangement of parts for the performance of the functions necessary to life. The cell may be regarded as the most simple, the most common, and the earliest form of organization. McKendrick.",
  ...
  "objectiveness": "Objectivity. Is there such a motion or objectiveness of external bodies, which produceth light Sir M. Hale",
  ...
  "outterm": "An external or superficial thing; outward manner; superficial remark, etc. [Obs.] Not to bear cold forms, nor men's outterms. B. Jonson.",
  "overboard": "Over the side of a ship; hence, from on board of a ship, into the water; as, to fall overboard. To throw overboard, to discard; to abandon, as a dependent or friend.",
  ...
  "orthognathous": "Having the front of the head, or the skull, nearly perpendicular, not retreating backwards above the jaws; -- opposed to Ant: prognathous. See Gnathic index, under Gnathic.",
  ...
  "oxidizer": "An agent employed in oxidation, or which facilitates or brings about combination with oxygen; as, nitric acid, chlorine, bromine, etc., are strong oxidizers.",
  "ottar": "See Attar.",
  "osmite": "A salt of osmious acid.",
  "od": "An alleged force or natural power, supposed, by Reichenbach and others, to produce the phenomena of mesmerism, and to be developed by various agencies, as by magnets, heat, light, chemical or vital action, etc.; -- called also odyle or the odylic force. [Archaic] That od force of German Reichenbach Which still, from female finger tips, burnt blue. Mrs. Browning.",
  ...
  "occulted": "1. Hidden; secret. [Obs.] Shak. 2. (Astron.)  Concealed by the intervention of some other heavenly body, as a star by the moon.",
  ...
  "oxidator": "1. An oxidizer. [Obs.] 2. A contrivance for causing a current of air to impinge on the flame of the Argand lamp; -- called also oxygenator.",
  ...
  "ozonometer": "An instrument for ascertaining the amount of ozone in the atmosphere, or in any gaseous mixture. Faraday.",
  "obtend": "1. To oppose; to hold out in opposition. [Obs.] Dryden. 2. To offer as the reason of anything; to pretend. [Obs.] Dryden",
  ...
  "oilseed": "(a) Seed from which oil is expressed, as the castor bean; also, the plant yielding such seed. See Castor bean. (b) A cruciferous herb (Camelina sativa). (c) The sesame.",
  "oroheliograph": "A camera for obtaining a circular panoramic view of the horizon. The photographic plate is placed horizontally with a vertical lens above. A mirror of peculiar shape reflects light from the entire horizon to the lens, by means of which it is focused upon the plate.",
  "outbar": "To bar out. [R.] Spenser.",
  "overweary": "To weary too much; to tire out. Dryden.",
  "oinement": "Ointment. [Obs.] Chaucer.",
  "offcut": "1. That which is cut off. 2. (Bookbinding)  A portion ofthe printed sheet, in certain sizes of books, that is cut off before folding.",
  ...
  "occasionally": "In an occasional manner; on occasion; at times, as convenience requires or opportunity offers; not regularly. Stewart. The one, Wolsey, directly his subject by birth; the other, his subject occasionally by his preferment. Fuller.",
  ...
  "organist": "1. (Mus.)  One who plays on the organ. 2. (R. C. Ch.)  One of the priests who organized or sung in parts. [Obs.]",
  ...
  "obsequiously": "1. In an obsequious manner; compliantly; fawningly. Dryden. 2. In a manner appropriate to obsequies. [Obs.] Whilst I a while obsequiously lament The untimely fall of virtuous Lancaster. Shak.",
  ...
  "oblate": "1. (Geom.)  Flattened or depressed at the poles; as, the earth is an oblate spheroid. 2. Offered up; devoted; consecrated; dedicated; -- used chiefly or only in the titles of Roman Catholic orders. See Oblate, n. Oblate ellipsoid or spheroid (Geom.), a solid generated by the revolution of an ellipse about its minor axis; an oblatum. See Ellipsoid of revolution, under Ellipsoid.\n\n(a) One of an association of priests or religious women who have offered themselves to the service of the church. There are three such associations of priests, and one of women, called oblates. (b) One of the Oblati.",
  ...
  "ornate": "1. Adorned; decorated; beautiful. \"So bedecked, ornate, and gay.\" Milton. 2. Finely finished, as a style of composition. A graceful and ornate rhetoric. Milton.\n\nTo adorn; to honor. [R.] They may ornate and sanctify the name of God. Latimer.",
  ...
  "osmiamic": "Of, pertaining to, or designating, a nitrogenous acid of osmium, H2N2Os2O5, forming a well-known series of yellow salts.",
  "outrider": "1. A summoner whose office is to cite men before the sheriff. [Obs.] 2. One who rides out on horseback. [Obs.] Chaucer. 3. A servant on horseback attending a carriage.",
  "ordinarily": "According to established rules or settled method; as a rule; commonly; usually; in most cases; as, a winter more than ordinarily severe. Those who ordinarily pride themselves not a little upon their penetration. I. Taylor.",
  "outwit": "To surpass in wisdom, esp. in cunning; to defeat or overreach by superior craft. They did so much outwit and outwealth us ! Gauden.\n\nThe faculty of acquiring wesdom by observation and experience, or the wisdom so acquired; -- opposed to inwit. [Obs.] Piers Plowman.",
  "outprize": "To prize beyong value, or in excess; to exceed in value. [Obs.] Shak.",
  "optometry": "1. (Med.) Measurement of the range of vision, esp. by means of the optometer. 2.  As defined (with minor variations) in the statutes of various States of the United States: (a) \"The employment of subjective and objective mechanical means to determine the accomodative and refractive states of the eye and the scope of its function in general.\" (b) \"The employment of any means, other than the use of drugs, for the measurement of the powers of vision and adaptation of lenses for the aid thereof.\"",
  ...
  "orientalism": "1. Any system, doctrine, custom, expression, etc., peculiar to Oriental people. 2. Knowledge or use of Oriental languages, history, literature, etc. London Quart. Rev.",
  ...
  "objectize": "To make an object of; to regard as an object; to place in the position of an object. In the latter, as objectized by the former, arise the emotions and affections. Coleridge.",
  ...
  "obstetricate": "To perform the office of midwife. [Obs.] \"Nature does obstetricate.\" Evelyn.\n\nTo assist as a midwife. [Obs.] E. Waterhouse.",
  ...
  "ozonation": "The act of treating with ozone; also, the act of converting into, or producing, ozone; ozonization.",
  ...
  "ose": "1. A suffix denoting full of, containing, having the qualities of, like; as in verbose, full of words; pilose, hairy; globose, like a globe. 2. (Chem.)  A suffix indicating that the substance to the name of wich it is affixed is a member of the carbohydrate group; as in cellulose, sucrose, dextrose, etc.",
  "outgrowth": "That which grows out of, or proceeds from, anything; an excrescence; an offshoot; hence, a result or consequence.",
  "obtundent": "A substance which sheathes a part, or blunts irritation, usually some bland, oily, or mucilaginous matter; -- nearly the same as demulcent. Forsyth.",
  ...
  "optative": "Expressing desire or wish. Fuller. Optative mood (Gram.), that mood or form of a verb, as in Greek, Sanskrit, etc., in which a wish or desire is expressed.\n\n1. Something to be desired. [R.] Bacon. 2. (Gram.)  The optative mood; also, a verb in the optative mood.",
  ...
  "orthotomic": "Cutting at right angles. Orthotomic circle (Geom.), that circle which cuts three given circles at right angles.",
  ...
  "oxyopia": "Excessive acuteness of sight.",
  ...
  "ottoman": "Of or pertaining to the Turks; as, the Ottoman power or empire.\n\n1. A Turk. 2. Etym: [F. ottomane, from ottoman Turkish.]  A stuffed seat without a back, originally used in Turkey.",
  ...
  "ordovician": "Of or pertaining to a division of the Silurian formation, corresponding in general to the Lower Silurian of most authors, exclusive of the Cambrian. -- n.  The Ordovician formation.",
  ...
  "orangeism": "Attachment to the principles of the society of Orangemen; the tenets or practices of the Orangemen.",
  "outbleat": "To surpass in bleating.",
  "oersted": "The C.G.S. unit of magnetic reluctance or resistance, equal to the reluctance of a centimeter cube of air (or vacuum) between parallel faces. Also, a reluctance in which unit magnetomotive force sets up unit flux.",
  ...
  "orichalceous": "Pertaining to, or resembling, orichalch; having a color or luster like that of brass. Maunder.",
  "oubliette": "A dungeon with an opening only at the top, found in some old castles and other strongholds, into which persons condemned to perpetual imprisonment, or to perish secretly, were thrust, or lured to fall. Sudden in the sun An oubliette winks. Where is he Gone. Mrs. Browning.",
  "outright": "1. Immediately; without delay; at once; as, he was killed outright. 2. Completely; utterly. Cardinal Manning.",
  ...
  "organicism": "The doctrine of the localization of disease, or which refers it always to a material lesion of an organ. Dunglison.",
  ...
  "override": "1. To ride over or across; to ride upon; to trample down. The carter overridden with [i. e., by] his cart. Chaucer. 2. To suppress; to destroy; to supersede; to annul; as, one low overrides another; to override a veto. 3. To ride beyond; to pass; to outride. [Obs.] I overrode him on the way. Shak. 4. To ride too much; to ride, as a horse, beyond its strength.",
  ...
  "oeil-de-boeuf": "A circular or oval window; -- generally used of architecture of the 17th and 18th centuries. A famous room in the palace of Versailles bears this name, from the oval window opening into it.",
  ...
  "oidium": "A genus of minute fungi which form a floccose mass of filaments on decaying fruit, etc. Many forms once referred to this genus are now believed to be temporary conditions of fungi of other genera, among them the vine mildew (Oïdium Tuckeri), which has caused much injury to grapes.",
  "outline": "1. (a) The line which marks the outer limits of an object or figure; the exterior line or edge; contour. (b) In art: A line drawn by pencil, pen, graver, or the like, by which the boundary of a figure is indicated. (c) A sketch composed of such lines; the delineation of a figure without shading. Painters, by their outlines, colors, lights, and shadows, represent the same in their pictures. Dryden. 2. Fig.: A sketch of any scheme; a preliminary or general indication of a plan, system, course of thought, etc.; as, the outline of a speech. But that larger grief . . . Is given in outline and no more. Tennyson. Syn. -- Sketch; draught; delineation. See Sketch.\n\n1. To draw the outline of. 2. Fig.: To sketch out or indicate as by an outline; as, to outline an argument or a campaign.",
  "one-hand": "Employing one hand; as, the one-hand alphabet. See Dactylology.",
  "occultation": "1. (Astron.)  The hiding of a heavenly body from sight by the intervention of some other of the heavenly bodies; -- applied especially to eclipses of stars and planets by the moon, and to the eclipses of satellites of planets by their primaries. 2. Fig.: The state of being occult. The reappearance of such an author after those long periods of occultation. Jeffrey. Circle of perpetual occultation. See under Circle.",
  ...
  "outgeneral": "To exceed in generalship; to gain advantage over by superior military skill or executive ability; to outmaneuver. Chesterfield.",
  "oddly": "1. In an odd manner; unevently. [R.] 2. In a peculiar manner; strangely; queerly; curiously. \"A figure a little more oddly turned.\" Locke. A great black substance,... very oddly shaped. Swift. 3. (Math.)  In a manner measured by an odd number.",
  "oratorical": "Of or pertaining to an orator or to oratory; characterized by oratory; rhetorical; becoming to an orator; as, an oratorical triumph; an oratorical essay. -- Or`a*tor\"ic*al*ly, adv.",
  "ouistiti": "See Wistit.",
  ...
  "outlier": "1. One who does not live where his office, or business, or estate, is. Bentley. 2. That which lies, or is, away from the main body. 3. (Geol.)  A part of a rock or stratum lying without, or beyond, the main body, from which it has been separated by denudation.",
  ...
  "odyl": "See Od. [Archaic].",
  "organule": "One of the essential cells or elements of an organ. See Sense organule, under Sense. Huxley.",
  ...
  "ostiary": "1. The mouth of a river; an estuary. [R.] Sir T. Browne. 2. One who keeps the door, especially the door of a church; a porter. N. Bacon.",
  "overcoat": "A coat worn over the other clothing; a greatcoat; a topcoat.",
  "overcurious": "Too curious.",
  "outcrop": "(a) The coming out of a stratum to the surface of the ground. Lyell. (b) That part of inclined strata which appears at the surface; basset.\n\nTo come out to the surface of the ground; -- said of strata.",
  "orderer": "1. One who puts in order, arranges, methodizes, or regulates. 2. One who gives orders.",
  "oxyphenic": "Pertaining to, or designating, the phenol formerly called oxyphenic acid, and now oxyphenol and pyrocatechin. See Pyrocatechin.",
  ...
  "orograph": "A machine for use in making topographical maps. It is operated by being pushed across country, and not only records distances, like the perambulator, but also elevations.",
  "originate": "To give an origin or beginning to; to cause to be; to bring into existence; to produce as new. A decomposition of the whole civill and political mass, for the purpose of originating a new civil order. Burke.\n\nTo take first existence; to have origin or beginning; to begin to exist or act; as, the scheme originated with the governor and council.",
  ...
  "overlabor": "1. To cause to labor excessively; to overwork. Dryden. 2. To labor upon excessively; to refine unduly.",
  ...
  "overhaul": "1. To haul or drag over; hence, to turn over for examination; to inspect; to examine thoroughly with a view to corrections or repairs. 2. (Naut.)  To gain upon in a chase; to overtake. To overhaul a tackle, to pull on the leading parts so as to separate the blocks. -- To overhaul running rigging, to keep it clear, and see that no hitch occurs.\n\nA strict examination with a view to correction or repairs.",
  "overperch": "To perch upon; to fly over. [Obs.] Shak.",
  "obdiplostemonous": "Having twice as many stamens as petals, those of the outer set being opposite the petals; -- said of flowers. Gray.",
  ...
  "orpin": "1. A yellow pigment of various degrees of intensity, approaching also to red. 2. (Bot.)  The orpine.",
  ...
  "obsoleteness": "1. The state of being obsolete, or no longer used; a state of desuetude. 2. (Biol.)  Indistinctness; want of development.",
  ...
  "outfall": "1. The mouth of a river; the lower end of a water course; the open end of a drain, culvert, etc., where the discharge occurs. 2. A quarrel; a falling out. [Prov. Eng.]",
  ...
  "ouananiche": "A small landlocked variety of the Atlantic salmon (Salmo salar ounaniche) of Lake St. John, Canada, and neighboring waters, noted for its vigor and activity, and habit of leaping from the water when hooked.",
  ...
  "orthotropal": "Having the axis of an ovule or seed straight from the hilum and chalaza to the orifice or the micropyle; atropous. Note: This word has also been used (but improperly) to describe any embryo whose radicle points towards, or is next to, the hilum.",
  ...
  "ovenbird": "(a) Any species of the genus Furnarius, allied to the creepers. They inhabit South America and the West Indies, and construct curious oven-shaped nests. (b) In the United States, Seiurus aurocapillus; -- called also golden-crowned thrush. (c) In England, sometimes applied to the willow warbler, and to the long-tailed titmouse.",
  ...
  "ogle": "To view or look at with side glances, as in fondness, or with a design to attract notice. And ogling all their audience, ere they speak. Dryden.\n\nAn amorous side glance or look. Byron.",
  ...
  "olecranon": "The large process at the proximal end of the ulna which projects behind the articulation with the humerus and forms the bony prominence of the elbow.",
  "osteopathist": "One who practices osteopathy; an osteopath.",
  "outbrave": "1. To excel in bravery o 2. To excel in magnificence or comeliness. The basest weed outbraves his dignity. Shak.",
  ...
  "owing": "1. Had or held under obligation of paying; due. There is more owing her than is paid. Shak. 2. Had or experienced as a consequence, result, issue, etc.; ascribable; -- with to; as, misfortunes are often owing to vices; his failure was owing to speculations.",
  "owling": "The offense of transporting wool or sheep out of England contrary to the statute formerly existing. Blackstone.",
  "oxgang": "See Bovate.",
  ...
  "osteoplasty": "An operation or process by which the total or partial loss of a bone is remedied. Dunglison.",
  ...
  "ornithology": "1. That branch of zoölogy which treats of the natural history of birds and their classification. 2. A treatise or book on this science.",
  "oscinian": "One of the Oscines, or singing birds.\n\nAny one of numerous species of dipterous files of the family Oscinidæ. Note: Some, whose larvæ live in the stalks, are very destructive to barley, wheat, and rye; others, as the barley fly (Oscinis frit), destroy the heads of grain.",
  ...
  "overmatch": "1. To be more than equal to or a match for; hence, to vanquish. Drayton. 2. To marry (one) to a superior. [Obs.] Burton.\n\nOne superior in power; also, an unequal match; a contest in which one of the opponents is overmatched. Milton. D. Webster.",
  ...
  "ornamentation": "1. The act or art of ornamenting, or the state of being ornamented. 2. That which ornaments; ornament. C. Kingsley.",
  "overtake": "1. To come up with in a course, pursuit, progress, or motion; to catch up with. Follow after the men; and when thou dost overtake them, say . . . Wherefore have ye rewarded evil for good. Gen. xliv. 4. He had him overtaken in his flight. Spenser. 2. To come upon from behind; to discover; to surprise; to capture; to overcome. If a man be overtaken in a fault. Gal. vi. 1 I shall see The winged vengeance overtake such children. Shak. 3. Hence, figuratively, in the past participle (overtaken), drunken. [Obs.] Holland.",
  ...
  "october": "1. The tenth month of the year, containing thirty-one days. 2. Ale or cider made in that month. The country gentlemen had a posset or drink they called October. Emerson.",
  "outcry": "1. A vehement or loud cry; a cry of distress, alarm, opposition, or detestation; clamor. 2. Sale at public auction. Massinger. Thackeray.",
  ...
  "orthopedical": "Pertaining to, or employed in, orthopedy; relating to the prevention or cure of deformities of children, or, in general, of the human body at any age; as, orthopedic surgery; an orthopedic hospital.",
  ...
  "olay": "Palm leaves, prepared for being written upon with a style pointed with steel. [Written also ola.] Balfour (Cyc. of India).",
  ...
  "orthocarbonic": "Designating a complex ether, C.(OC2H5)4, which is obtained as a liquid of a pleasant ethereal odor by means of chlorpicrin, and is believed to be a derivative of the hypothetical normal carbonic acid, C.(OH)4.",
  "oscillaria": "A genus of dark green, or purplish black, filamentous, fresh- water algæ, the threads of which have an automatic swaying or crawling motion. Called also Oscillatoria.",
  ...
  "outwear": "1. To wear out; to consume or destroy by wearing. Milton. 2. To last longer than; to outlast; as, this cloth will outwear the other. \"If I the night outwear.\" Pope.",
  ...
  "ovisac": "(a) A Graafian follicle; any sac containing an ovum or ova. (b) The inner layer of the fibrous wall of a Graafian follicle.",
  ...
  "obligatory": "Binding in law or conscience; imposing duty or obligation; requiring performance or forbearance of some act; -- often followed by on or upon; as, obedience is obligatory on a soldier. As long as the law is obligatory, so long our obedience is due. Jer. Taylor.",
  "obrogate": "To annul indirectly by enacting a new and contrary law, instead of by expressly abrogating or repealing the old one. [Obs.] Bailey.",
  ...
  "overtrade": "To trade beyond one's capital; to buy goods beyond the means of paying for or seleng them; to overstock the market.",
  "outwell": "To pour out. [Obs.] Spenser.\n\nTo issue forth. Thomson.",
  "orthid": "A brachiopod shell of the genus Orthis, and allied genera, of the family Orthidæ.",
  ...
  "obtenebration": "The act of darkening; the state of being darkened; darkness. [Obs.] In every megrim or vertigo, there is an obtenebration joined with a semblance of turning round. Bacon.",
  ...
  "objectionable": "Liable to objection; likely to be objected to or disapproved of; offensive; as, objectionable words. -- Ob*jec\"tion*a*bly, adv.",
  ...
  "obversion": "1. The act of turning toward or downward. 2. (Logic)  The act of immediate inference, by which we deny the opposite of anything which has been affirmed; as, all men are mortal; then, by obversion, no men are immortal. This is also described as \"immediate inference by privative conception.\" Bain.",
  ...
  "octant": "1. (Geom.)  The eighth part of a circle; an arc of 45 degrees. 2. (Astron. & Astrol.)  The position or aspect of a heavenly body, as the moon or a planet, when half way between conjunction, or opposition, and quadrature, or distant from another body 45 degrees. 3. An instrument for measuring angles (generally called a quadrant), having an arc which measures up to 9Oº, but being itself the eighth part of a circle. Cf. Sextant. 4. (Math. & Crystallog.)  One of the eight parts into which a space is divided by three coördinate planes.",
  ...
  "oppugn": "To fight against; to attack; to be in conflict with; to oppose; to resist. They said the manner of their impeachment they could not but conceive did oppugn the rights of Parliament. Clarendon.",
  ...
  "obduracy": "The duality or state of being obdurate; invincible hardness of heart; obstinacy. \"Obduracy and persistency.\" Shak. The absolute completion of sin in final obduracy. South.",
  "orthometric": "Having the axes at right angles to one another; -- said of crystals or crystalline forms.",
  "oleomargarine": "1. A liquid oil made from animal fats (esp. beef fat) by separating the greater portion of the solid fat or stearin, by crystallization. It is mainly a mixture of olein and palmitin with some little stearin. 2. An artificial butter made by churning this oil with more or less milk. Note: Oleomargarine was wrongly so named, as it contains no margarin proper, but olein, palmitin, and stearin, a mixture of palmitin and stearin having formerly been called margarin by mistake.",
  ...
  "oddness": "1. The state of being odd, or not even. Take but one from three, and you not only destroy the oddness, but also the essence of that number. Fotherby. 2. Singularity; strangeness; eccentricity; irregularity; uncouthness; as, the oddness of dress or shape; the oddness of an event. Young.",
  ...
  "orthomorphic": "Having the right form. Orthomorphic projection, a projection in which the angles in the figure to be projected are equal to the corresponding angles in the projected figure.",
  ...
  "osteopathy": "(a) Any disease of the bones. [R.] (b) A system of treatment based on the theory that diseases are chiefly due to deranged mechanism of the bones, nerves, blood vessels, and other tissues, and can be remedied by manipulations of these parts.",
  ...
  "oratorio": "1. (Mus.)  A more or less dramatic text or poem, founded on some Scripture nerrative, or great divine event, elaborately set to music, in recitative, arias, grand choruses, etc., to be sung with an orchestral accompaniment, but without action, scenery, or costume, although the oratorio grew out of the Mysteries and the Miracle and Passion plays, which were acted. Note: There are instances of secular and mythological subjects treated in the form of the oratorios, and called oratorios by their composers; as Haydn's \"Seasons,\" Handel's \"Semele,\" etc. 2. Performance or rendering of such a composition.",
  "onliness": "The state of being alone. [Obs.]",
  "oculomotor": "Of or pertaining to the movement of the eye; -- applied especially to the common motor nerves (or third pair of cranial nerves) which supply many of the muscles of the orbit. -- n.  The oculomotor nerve.",
  "orthoepy": "The art of uttering words corectly; a correct pronunciation of words; also, mode of pronunciation.",
  ...
  "offtake": "1. Act of taking off; specif., the taking off or purchase of goods. 2.  Something taken off; a deduction. 3.  A channel for taking away air or water; also, the point of beginning of such a channel; a take-off.",
  ...
  "outdoor": "Being, or done, in the open air; being or done outside of certain buildings, as poorhouses, hospitals, etc.; as, outdoor exercise; outdoor relief; outdoor patients.",
  ...
  "obole": "A weight of twelve grains; or, according to some, of ten grains, or half a scruple. [Written also obol.]",
  "ornateness": "The quality of being ornate.",
  "oboval": "Obovate.",
  "outstand": "To stand out, or project, from a surface or mass; hence, to remain standing out.\n\n1. To resist effectually; to withstand; to sustain without yielding. [R.] Woodward. 2. To stay beyond. \"I have outstood my time.\" Shak.",
  ...
  "owner": "One who owns; a rightful proprietor; one who has the legal or rightful title, whether he is the possessor or not. Shak.",
  ...
  "orthodoxy": "1. Soundness of faith; a belief in the doctrines taught in the Scriptures, or in some established standard of faith; -- opposed to heterodoxy or to heresy. Basil himself bears full and clear testimony to Gregory's orthodoxy. Waterland. 2. Consonance to genuine Scriptural doctrines; -- said of moral doctrines and beliefs; as, the orthodoxy of a creed. 3. By extension, said of any correct doctrine or belief.",
  ...
  "ochre": "(a) A impure earthy ore of iron or a ferruginous clay, usually red (hematite) or yellow (limonite), -- used as a pigment in making paints, etc. The name is also applied to clays of other colors. (b) A metallic oxide occurring in earthy form; as, tungstic ocher or tungstite.\n\nSee Ocher.",
  ...
  "overshoot": "1. To shoot over or beyond. \"Not to overshoot his game.\" South. 2. To pass swiftly over; to fly beyond. Hartle. 3. To exceed; as, to overshoot the truth. Cowper. To overshoot one's self, to venture too far; to assert too much.\n\nTo fly beyond the mark. Collier.",
  "oxalurate": "A salt of oxaluric acid.",
  "ocherous": "Of or pertaining to ocher; containing or resembling ocher; as, ocherous matter; ocherous soil.",
  "ocreate": "Same as Ochreate, Ochreated.",
  ...
  "otherwhile": "At another time, or other times; sometimes; [Archaic] Weighing otherwhiles ten pounds and more. Holland.",
  ...
  "obeisance": "1. Obedience. [Obs.] Chaucer. 2. A manifestation of obedience; an expression of difference or respect; homage; a bow; a courtesy. Bathsheba bowed and did obeisance unto the king. 1 Kings i. 16.",
  "obstructive": "Tending to obstruct; presenting obstacles; hindering; causing impediment. -- Ob*struct\"ive*ly, adv.\n\nAn obstructive person or thing.",
  ...
  "oust": "See Oast.\n\n1. To take away; to remove. Multiplication of actions upon the case were rare, formerly, and thereby wager of law ousted. Sir M. Hale. 2. To eject; to turn out. Blackstone. From mine own earldom foully ousted me. Tennyson.",
  ...
  "ochlocratic": "Of or pertaining to ochlocracy; having the form or character of an ochlocracy; mobocratic. -- Och`lo*crat\"ic*al*ly, adv.",
  ...
  "oleander": "A beautiful evergreen shrub of the Dogbane family, having clusters of fragrant red or white flowers. It is native of the East Indies, but the red variety has become common in the south of Europe. Called also rosebay, rose laurel, and South-sea rose. Note: Every part of the plant is dangerously poisonous, and death has occured from using its wood for skewers in cooking meat.",
  ...
  "osteodentine": "A hard substance, somewhat like bone, which is sometimes deposited within the pulp cavity of teeth.",
  ...
  "outcome": "That which comes out of, or follows from, something else; issue; result; consequence; upshot. \"The logical outcome.\" H. Spenser. All true literature, all genuine poetry, is the direct outcome, the condensed essence, of actual life and thougth. J. C. Shairp.",
  "oxychloric": "(a) Of, pertaining to, or designating in general, certain compounds containing oxygen and chlorine. (b) Formerly designating an acid now called perchloric acid. See Perchloric.",
  "ochreate": "1. Wearing or furnished with an ochrea or legging; wearing boots; booted. A scholar undertook...to address himself ochreated unto the vice chancellor. Fuller. 2. (Bot.)  Provided with ochrea, or sheathformed stipules, as the rhubarb, yellow dock, and knotgrass.",
  ...
  "ornitholite": "(a) The fossil remains of a bird. (b) A stone of various colors bearing the figures of birds.",
  ...
  "ovaliform": "Having the form of an egg; having a figure such that any section in the direction of the shorter diameter will be circular, and any in the direction of the longer diameter will be oval.",
  ...
  "orbitolites": "A genus of living Foraminifera, forming broad, thin, circular disks, containing numerous small chambers.",
  ...
  "ortolan": "(a) A European singing bird (Emberiza hortulana), about the size of the lark, with black wings. It is esteemed delicious food when fattened. Called also bunting. (b) In England, the wheatear (Saxicola oenanthe). (c) In America, the sora, or Carolina rail (Porzana Carolina). See Sora.",
  "omphalic": "Of or pertaining to the umbilicus, or navel.",
  "omnific": "All-creating. \"The omnific word.\" Milton.",
  "osmaterium": "One of a pair of scent organs which the larvæ of certain butterflies emit from the first body segment, either above or below.",
  "oleaster": "(a) The wild olive tree (Olea Europea, var. sylvestris). (b) Any species of the genus Elæagus. See Eleagnus. The small silvery berries of the common species (Elæagnus hortensis) are called Trebizond dates, and are made into cakes by the Arabs.",
  ...
  "ophidious": "Ophidian.",
  "orthospermous": "Having the seeds straight, as in the fruits of some umbelliferous plants; -- opposed to coelospermous. Darwin.",
  ...
  "officiate": "To act as an officer in performing a duty; to transact the business of an office or public trust; to conduct a public service. Bp. Stillingfleet.\n\nTo discharge, perform, or supply, as an official duty or function. [Obs.] Merely to officiate light Round this opacous earth. Milton.",
  "ottawas": "A tribe of Indians who, when first known, lived on the Ottawa River. Most of them subsequently migrated to the southwestern shore of Lake Superior.",
  ...
  "orach": "A genus (Atriplex) of herbs or low shrubs of the Goosefoot family, most of them with a mealy surface. Garden orache, a plant (Atriplex hortensis), often used as a pot herb; -- also called mountain spinach.",
  ...
  "orthographize": "To spell correctly or according to usage; to correct in regard to spelling. In the coalesced into ith, which modern reaction has orthographized to i' th'. Earle.",
  ...
  "obsignation": "The act of sealing or ratifying; the state of being sealed or confirmed; confirmation, as by the Holy Spirit. The spirit of manifestation will but upbraid you in the shame and horror of a sad eternity, if you have not the spirit of obsignation. Jer. Taylor.",
  ...
  "otherwhiles": "At another time, or other times; sometimes; [Archaic] Weighing otherwhiles ten pounds and more. Holland.",
  "overbide": "To outlive. [Obs.] Chaucer.",
  "oversight": "1. Watchful care; superintendence; general supervision. 2. An overlooking; an omission; an error. Hooker. 3. Escape from an overlooked peril. [R.] \"His fool-happy oversight.\" Spenser. Syn. -- Superintendence; supervision; inspection; overlooking; inadvertence; neglect; mistake; error; omission.",
  "ogreism": "The character or manners of an ogre.",
  "orison": "A prayer; a supplication. [Poetic] Chaucer. Shak. Lowly they bowed, adoring, and began Their orisons, each morning duly paid. Milton.",
  ...
  "outgrow": "1. To surpass in growing; to grow more than. Shak. 2. To grow out of or away from; to grow too large, or too aged, for; as, to outgrow clothing; to outgrow usefulness; to outgrow an infirmity.",
  "olefine": "Olefiant gas, or ethylene; hence, by extension, any one of the series of unsaturated hydrocarbons of which ethylene is a type. See Ethylene.",
  "onethe": "Scarcely. See Unnethe. [Obs.] Chaucer.",
  "overtrading": "The act or practice of buying goods beyond the means of payment; a glutting of the market.",
  "oxalyl": "(a) A hydrocarbon radical (C2O2) regarded as a residue of oxalic acid and occurring in derivatives of it. (b) An old name for carbonyl. (c) An old name for carboxyl.",
  ...
  "ormolu": "A variety of brass made to resemble gold by the use of less zinc and more copper in its composition than ordinary brass contains. Its golden color is often heightened by means of lacquer of some sort, or by use of acids. Called also mosaic gold. Ormolu varnish, a varnish applied to metals, as brass, to give the appearance of gold.",
  "outstrip": "To go faster than; to outrun; to advance beyond; to leave behing. Appetites which . . . had outstripped the hours. Southey. He still outstript me in the race. Tennyson.",
  "obtund": "To reduce the edge, pungency, or violent action of; to dull; to blunt; to deaden; to quell; as, to obtund the acrimony of the gall. [Archaic] Harvey. They...have filled all our law books with the obtunding story of their suits and trials. Milton.",
  ...
  "outrance": "The utmost or last extremity. Combat à outrance, a fight to the end, or to the death.",
  "oscan": "Of or pertaining to the Osci, a primitive people of Campania, a province of ancient Italy. -- n.  The language of the Osci.",
  ...
  "orchestian": "Any species of amphipod crustacean of the genus Orchestia, or family Orchestidæ. See Beach flea, under Beach.",
  ...
  "obsidional": "Of or pertaining to a siege. Obsidional crown (Rom.Antiq.), a crown bestowed upon a general who raised the siege of a beleaguered place, or upon one who held out against a siege.",
  ...
  "ochimy": "See Occamy.",
  "occupant": "1. One who occupies, or takes possession; one who has the actual use or possession, or is in possession, of a thing. Note: This word, in law, sometimes signifies one who takes the first possession of a thing that has no owner. 2. A prostitute. [Obs.] Marston.",
  ...
  "overbearing": "1. Overpowering; subduing; repressing. I. Watts. 2. Aggressively haughty; arrogant; domineering; tyrannical; dictatorial; insolent. --O`ver*bear\"ing*ly, adv. -- O`ver*bear\"ing*ness, n.",
  "overcarry": "To carry too far; to carry beyond the proper point. Hayward.",
  "ortalidian": "Any one of numerous small two-winged flies of the family Ortalidæ. The larvæ of many of these flies live in fruit; those of others produce galls on various plants.",
  "obturation": "The act of stopping up, or closing, an opening. \"Deaf by an outward obturation.\" Bp. Hall.",
  ...
  "oscillatory": "Moving, or characterized by motion, backward and forward like a pendulum; swinging; oscillating; vibratory; as, oscillatory motion.",
  "overact": "1. To act or perform to excess; to exaggerate in acting; as, he overacted his part. 2. To act upon, or influence, unduly. [Obs.] The hope of inheritance overacts them. Milton.\n\nTo act more than is necessary; to go to excess in action. B. Jonson.",
  "osar": "See 3d Os.",
  ...
  "offal": "1. The rejected or waste parts of a butchered animal. 2. A dead body; carrion. Shak. 3. That which is thrown away as worthless or unfit for use; refuse; rubbish. The off als of other profession. South.",
  "obligatorily": "In an obligatory manner; by reason of obligation. Foxe.",
  "oby": "See Obi.",
  "ofter": "Compar. of Oft. [Obs.] Chaucer.",
  "olfaction": "The sense by which the impressions made on the olfactory organs by the odorous particles in the atmosphere are perceived.",
  "oscitantly": "In an oscitant manner.",
  "oedema": "A swelling from effusion of watery fluid in the cellular tissue beneath the skin or mucous membrance; dropsy of the subcutaneous cellular tissue. [Written also edema.]",
  "often": "Frequently; many times; not seldom.\n\nFrequent; common; repeated. [R.] \"Thine often infirmities.\" 1 Tim. v. 23. And weary thee with often welcomes. Beau. & Fl.",
  "osteologist": "One who is skilled in osteology; an osteologer.",
  "outface": "To face or look (one) out of countenance; to resist or bear down by bold looks or effrontery; to brave. Shak. Having outfaced all the world. South.",
  ...
  "octodont": "Of or pertaining to the Octodontidæ, a family of rodents which includes the coypu, and many other South American species.",
  ...
  "oriskany": "Designating, or pertaining to, certain beds, chiefly limestone, characteristic of the latest period of the Silurian age. Oriskany period, a subdivision of the American Paleozoic system intermediate or translational in character between the Silurian and Devonian ages. See Chart of Geology.",
  ...
  "outpost": "(a) A post or station without the limits of a camp, or at a distance from the main body of an army, for observation of the enemy. (b) The troops placed at such a station.",
  ...
  "optogram": "An image of external objects fixed on the retina by the photochemical action of light on the visual purple. See Optography.",
  ...
  "oxyhaemoglobin": "See Hemoglobin.",
  "obdureness": "Hardness. [Obs.] Bp. Hall.",
  ...
  "ordnance": "Heavy weapons of warfare; cannon, or great guns, mortars, and howitzers; artillery; sometimes, a general term for all weapons and appliances used in war. All the battlements their ordnance fire. Shak. Then you may hear afar off the awful roar of his [Rufus Choate's] rifled ordnance. E. Ererett. Ordnance survey, the official survey of Great Britain and Ireland, conducted by the ordnance department.",
  "orientalist": "1. An inhabitant of the Eastern parts of the world; an Oriental. 2. One versed in Eastern languages, literature, etc.; as, the Paris Congress of Orientalists. Sir J. Shore.",
  "outbalance": "To outweight; to exceed in weight or effect. Let dull Ajax bear away my right When all his days outbalance this one night. Dryden.",
  "outmarch": "To surpass in marching; to march faster than, or so as to leave behind.",
  "overalls": "1. A kind of loose trousers worn over others to protect them from soiling. 2. Waterproof leggings. R. D. Blackmore.",
  "ordainment": "Ordination. [R.] Burke.",
  "overcast": "1. To cast or cover over; hence, to cloud; to darken. Those clouds that overcast your morn shall fly. Dryden. 2. To compute or rate too high. Bacon. 3. (Sewing)  To take long, loose stitches over (the raw edges of a seam) to prevent raveling.",
  "overexpose": "To expose excessively; specif. (Photog.),  to subject (a plate or film) too long to the actinic action of the light used in producing a picture. -- O`ver*ex*po\"sure (#), n.",
  "oversoul": "The all-containing soul. [R.] That unity, that oversout, within which every man's particular being is contained and made one with all other. Emerson.",
  "obstetric": "Of or pertaining to midwifery, or the delivery of women in childbed; as, the obstetric art. Obstetrical toad (Zoöl.), a European toad of the genus Alytes, especially A. obstetricans. The eggs are laid in a string which the male winds around his legs, and carries about until the young are hatched.",
  "observer": "1. One who observes, or pays attention to, anything; especially, one engaged in, or trained to habits of, close and exact observation; as, an astronomical observer. The observed of all observers. Shak. Careful observers may foretell the hour, By sure prognostic, when to dread a shower. Swift. 2. One who keeps any law, custom, regulation, rite, etc.; one who conforms to anything in practice. \"Diligent observers of old customs.\" Spenser. These... hearkend unto observers of times. Deut. xviii. 14. 3. One who fulfills or performs; as, an observer of his promises. 4. A sycophantic follower. [Obs.] Beau. & Fl.",
  "ostensible": "1. Capable of being shown; proper or intended to be shown. [R.] Walpole. 2. Shown; exhibited; declared; avowed; professed; apparent; -- often used as opposed to real or actual; as, an ostensible reason, motive, or aim. D. Ramsay.",
  "oleograph": "1. (Chem.)  The form or figure assumed by a drop of oil when placed upon water or some other liquid with which it does not mix. 2. (Painting)  A picture produced in oils by a process analogous to that of lithographic printing.",
  ...
  "outspeak": "1. To exceed in speaking. 2. To speak openly or boldly. T. Campbell. 3. To express more than. Shak.",
  ...
  "occipital": "Of or pertaining to the occiput, or back part of the head, or to the occipital bone. Occipital bone (Anat.), the bone which forms the posterior segment of the skull and surrounds the great foramen by which the spinal cord leaves the cranium. In the higher vertebrates it is usually composed of four bones, which become consolidated in the adult. -- Occipital point (Anat.), the point of the occiput in the mesial plane farthest from the ophryon.\n\nThe occipital bone.",
  ...
  "optography": "The production of an optogram on the retina by the photochemical action of light on the visual purple; the fixation of an image in the eye. The object so photographed shows white on a purple or red background. See Visual purple, under Visual.",
  ...
  "odograph": "1. A machine for registering the distance traversed by a vehicle or pedestrain. 2.  A device for recording the length and rapidity of stride and the number of steps taken by a walker.",
  "overdraw": "1. To exaggerate; to overdo. 2. (Banking)  To make drafts upon or against, in excess of the proper amount or limit.",
  ...
  "octuple": "Eightfold.",
  "oasis": "A fertile or green spot in a waste or desert, esp. in a sandy desert. My one oasis in the dust and drouth Of city life. Tennyson.",
  "obelisk": "1. An upright, four-sided pillar, gradually tapering as it rises, and terminating in a pyramid called pyramidion. It is ordinarily monolithic. Egyptian obelisks are commonly covered with hieroglyphic writing from top to bottom. 2. (Print.)  A mark of reference; -- called also dagger [&dag;]. See Dagger, n., 2.\n\nTo mark or designate with an obelisk.",
  "oculus": "1. An eye; (Bot.) a leaf bud. 2. (Arch.)  A round window, usually a small one.",
  "oxalethyline": "A poisonous nitrogenous base (C6H10N2) obtained indirectly from oxamide as a thick transparent oil which has a strong narcotic odor, and a physiological action resembling that of atropine. It is probably related to pyridine.",
  ...
  "overturn": "1. To turn or throw from a basis, foundation, or position; to overset; as, to overturn a carriage or a building. 2. To subvert; to destroy; to overthrow. 3. To overpower; to conquer. Milton. Syn. -- To demolish; overthrow. See Demolish.\n\nThe act off overturning, or the state of being overturned or subverted; overthrow; as, an overturn of parties.",
  "overtax": "To tax or to task too heavily.",
  "orbity": "Orbation. [Obs.] Bp. Hall.",
  ...
  "obi": "1. A species of sorcery, probably of African origin, practiced among the negroes of the West Indies. [Written also obe and obeah.] De Quincey. B. Edwards. 2. A charm or fetich. [West Indies] B. Edwards.",
  "ogeechee lime": "(a) The acid, olive-shaped, drupaceous fruit of a species of tupelo (Nyssa capitata) which grows in swamps in Georgia and Florida. (b) The tree which bears this fruit.",
  ...
  "outcast": "Cast out; degraded. \"Outcast, rejected.\" Longfellow.\n\n1. One who is cast out or expelled; an exile; one driven from home, society, or country; hence, often, a degraded person; a vagabond. The Lord . . . gathereth together the outcasts of Israel. Ps. cxlvii. 2. 2. A quarrel; a contention. [Scot.] Jamieson.",
  "overpass": "1. To go over or beyond; to cross; as, to overpass a river; to overpass limits. 2. To pass over; to omit; to overlook; to disregard. All the beauties of the East He slightly viewed and slightly overpassed. Milton. 3. To surpass; to excel. [R.] R. Browning.\n\nTo pass over, away, or off.",
  ...
  "osmazome": "A substance formerly supposed to give to soup and broth their characteristic odor, and probably consisting of one or several of the class of nitrogenous substances which are called extractives.",
  ...
  "orbital": "Of or pertaining to an orbit. \"Orbital revolution.\" J. D. Forbes. Orbital index (Anat.), in the skull, the ratio of the vertical height to the transverse width of the orbit, which is taken as the standard, equal to 100.",
  "oul": "An awl. [Obs.] Chaucer.\n\nAn owl. [Obs.] Chaucer.",
  "occupancy": "The act of taking or holding possession; possession; occupation. Title by occupancy (Law), a right of property acquired by taking the first possession of a thing, or possession of a thing which belonged to nobody, and appropriating it. Blackstone. Kent.",
  ...
  "overhung": "1. Covered over; ornamented with hangings. Carlyle. 2. Suspended from above or from the top. Overhung door, a sliding door, suspended door, suspended from the top, as upon rollers.",
  ...
  "organically": "In an organic manner; by means of organs or with reference to organic functions; hence, fundamentally. Gladstone.",
  "outvoice": "To exceed in noise. Shak.",
  "olea": "A genus of trees including the olive. Note: The Chinese Olea fragrans, noted for its fragrance, and the American devilwood (Olea Americana) are now usually referred to another genus (Osmanthus).",
  "oleoresin": "1. (Chem.)  A natural mixture of a terebinthinate oil and a resin. 2. (Med.)  A liquid or semiliquid preparation extracted (as from capsicum, cubebs, or ginger) by means of ether, and consisting of fixed or volatile oil holding resin in solution. -- O`le*o*res\"in*ous, a.",
  ...
  "outset": "A setting out, starting, or beginning. \"The outset of a political journey.\" Burke. Giving a proper direction to this outset of life. J. Hawes.",
  ...
  "objectivity": "The state, quality, or relation of being objective; character of the object or of the objective. The calm, the cheerfulness, the disinterested objectivity have disappeared [in the life of the Greeks]. M. Arnold.",
  "ontological": "Of or pertaining to ontology.",
  "organology": "1. The science of organs or of anything considered as an organic structure. The science of style, as an organ of thought, of style in relation to the ideas and feelings, might be called the organology of style. De Quincey. 2. That branch of biology which treats, in particular, of the organs of animals and plants. See Morphology.",
  "orgillous": "Proud; haughty. [Obs.] Shak.",
  "ostreophagist": "One who feeds on oysters.",
  "outgoing": "1. The act or the state of going out. The outgoings of the morning and evening. Ps. lxv. 8. 2. That which goes out; outgo; outlay. 3. The extreme limit; the place of ending. [Obs.] The outgoings of the border were at the north bay of the salt sea, at the south end of Jordan. Josh. xviii. 19.\n\nGoing out; departing; as, the outgoing administration; an outgoing steamer.",
  ...
  "overlive": "To outlive. Sir P. Sidney. The culture of Northumbria overlived the term of its political supermacy. Earle.\n\nTo live too long, too luxuriously, or too actively. Milton. \"Overlived in this close London life.\" Mrs. Browning.",
  ...
  "opsiometer": "An instrument for measuring the limits of distincts vision in different individuals, and thus determiming the proper focal length of a lens for correcting imperfect sight. Brande & C.",
  ...
  "oscitant": "1. Yawning; gaping. 2. Sleepy; drowsy; dull; sluggish; careless. He must not be oscitant, but intent on his charge. Barrow.",
  ...
  "oenothionic": "Pertaining to an acid now called sulphovinic, or ethyl sulphuric, acid. O'ER O'er, prep. & adv.  A contr. of Over. [Poetic]",
  ...
  "oppugnant": "Tending to awaken hostility; hostile; opposing; warring. \"Oppugnant forces.\" I. Taylor. -- n.  An opponent. [R.] Coleridge.",
  "omphalos": "The navel.",
  "oon": "One. [Obs.] Chaucer.",
  ...
  "overhear": "1. To hear more of (anything) than was intended to be heard; to hear by accident or artifice. Shak. 2. To hear again. ShaK.",
  ...
  "octateuch": "A collection of eight books; especially, the first eight books of the Old Testament. [R.]",
  ...
  "obsecration": "1. The act of obsecrating or imploring; as, the obsecrations of the Litany, being those clauses beginning with \"By.\" Bp. Stillingfeet. Shipley. 2. (Rhet.)  A figure of speech in which the orator implores the assistance of God or man.",
  ...
  "overshadow": "1. To throw a shadow, or shade, over; to darken; to obscure. There was a cloud that overshadowed them. Mark ix. 7. 2. Fig.: To cover with a superior influence. Milton.",
  "owel": "Equal. [Obs.] Burrill.",
  "obscurant": "One who obscures; one who prevents enlightenment or hinders the progress of knowledge and wisdom. Coleridge.",
  ...
  "outmantle": "To excel in mantling; hence, to excel in splendor, as of dress. [R.] And with poetic trappings grace thy prose, Till it outmantle all the pride of verse. Cowper.",
  ...
  "osculation": "1. The act of kissing; a kiss. 2. (Geom.)  The contact of one curve with another, when the number of consecutive points of the latter through which the former passes suffices for the complete determination of the former curve. Brande & C.",
  ...
  "obedient": "Subject in will or act to authority; willing to obey; submissive to restraint, control, or command. And floating straight, obedient to the stream. Shak. The chief his orders gives; the obedient band, With due observance, wait the chief's command. Pope. Syn. -- Dutiful; respectful; compliant; submissive.",
  ...
  "outlawry": "1. The act of outlawing; the putting a man out of the protection of law, or the process by which a man (as an absconding criminal) is deprived of that protection. 2. The state of being an outlaw.",
  ...
  "oleography": "1. Art or process of producing the pictures known as oleographs. 2.  A process of identifying oils by their oleographs.",
  "offshoot": "That which shoots off or separates from a main stem, channel, family, race, etc.; as, the offshoots of a tree.",
  "obstriction": "The state of being constrained, bound, or obliged; that which constrains or obliges; obligation; bond. [R.] Milton.",
  ...
  "orache": "A genus (Atriplex) of herbs or low shrubs of the Goosefoot family, most of them with a mealy surface. Garden orache, a plant (Atriplex hortensis), often used as a pot herb; -- also called mountain spinach.",
  ...
  "overhip": "To pass over by, or as by a hop; to skip over; hence, to overpass. [Obs.] \"When the time is overhipt.\" Holland.",
  ...
  "oxhide": "1. The skin of an ox, or leather made from it. 2. (O. Eng. Law)  A measure of land. See 3d Hide.",
  "outfield": "1. Arable land which has been or is being exhausted. See Infield, 1. [Scot.] 2. A field beyond, or separated from, the inclosed land about the homestead; an uninclosed or unexplored tract. Also used figuratively. The great outfield of thought or fact. Trench. 3. (Baseball)  The part of the field beyond the diamond, or infield. It is occupied by the fielders. 4. (Cricket)  The part of the field farthest from the batsman.",
  ...
  "osteocolla": "1. A kind of glue obtained from bones. Ure. 2. A cellular calc tufa, which in some places forms incrustations on the stems of plants, -- formerly supposed to have the quality of uniting fractured bones.",
  "ovulation": "The formation of ova or eggs in the ovary, and the discharge of the same. In the mammalian female the discharge occurs during menstruation.",
  ...
  "oxanilamide": "A white crystalline nitrogenous substance, obtained indirectly by the action of cyanogen on aniline, and regarded as an anilide of oxamic acid; -- called also phenyl oxamide.",
  "overblow": "1. To blow over, or be subdued. [R.] Spenser. 2. (Mus.)  To force so much wind into a pipe that it produces an overtone, or a note higher than the natural note; thus, the upper octaves of a flute are produced by overblowing.\n\nTo blow away; to dissipate by wind, or as by wind. When this cloud of sorrow's overblown. Waller.",
  ...
  "olefiant": "Forming or producing an oil; specifically, designating a colorless gaseous hydrocarbon called ethylene. [Archaic]",
  ...
  "ovipositor": "The organ with which many insects and some other animals deposit their eggs. Some ichneumon files have a long ovipositor fitted to pierce the eggs or larvæ of other insects, in order to lay their own eggs within the same.",
  ...
  "oragious": "Stormy. [R.]",
  "outgo": "1. To go beyond; to exceed in swiftness; to surpass; to outdo. 2. To circumvent; to overreach. [Obs.] Denham.\n\nThat which goes out, or is paid out; outlay; expenditure; -- the opposite of Ant: income. Lowell.",
  ...
  "ovoid": "Resembling an egg in shape; egg-shaped; ovate; as, an ovoidal apple.\n\nA solid resembling an egg in shape.",
  "otoscopy": "The examination of the ear; the art of using the otoscope.",
  "oquassa": "A small, handsome trout (Salvelinus oquassa), found in some of the lakes in Maine; -- called also blueback trout.",
  "outrigger": "1. Any spar or projecting timber run out for temporary use, as from a ship's mast, to hold a rope or a sail extended, or from a building, to support hoisting teckle. 2. (Naut.) (a) A projecting support for a rowlock, extended from the side of a boat. (b) A boat thus equipped. (c) A projecting contrivance at the side of a boat to prevent upsetting, as projecting spars with a log at the end.",
  ...
  "optician": "1. One skilled in optics. [R.] A. Smith. 2. One who deals in optical glasses and instruments.",
  ...
  "ory": "1. An adjective suffix meaning of or pertaining to, serving for; as in auditory, pertaining to or serving for hearing; prohibitory, amendatory, etc. 2. Etym: [L. -orium: cf. F. -oire.]  A noun suffix denoting that which pertains to, or serves for; as in ambulatory, that which serves for walking; consistory, factory, etc.",
  ...
  "oblati": "(a) Children dedicated in their early years to the monastic state. (b) A class of persons, especially in the Middle Ages, who offered themselves and their property to a monastery. Addis & Arnold.",
  "organdie": "A kind of transparent light muslin.",
  "osteopterygious": "Having bones in the fins, as certain fishes.",
  "oke": "1. A Turkish and Egyptian weight, equal to about 2 2. An Hungarian and Wallachian measure, equal to about 2",
  ...
  "outlaugh": "1. To surpass or outdo in laughing. Dryden. 2. To laugh (one) out of a purpose, principle, etc.; to discourage or discomfit by laughing; to laugh down. [R.] His apprehensions of being outlaughed will force him to continue in a restless obscurity. Franklin.",
  ...
  "occident": "The part of the horizon where the sun last appears in the evening; that part of the earth towards the sunset; the west; -- opposed to orient. Specifically, in former times, Europe as opposed to Asia; now, also, the Western hemisphere. Chaucer. I may wander from east to occident. Shak.",
  ...
  "oxamic": "Pertaining to, or designating, an acid NH2.C2O2.HO obtained as a fine crystalline powder, intermediate between oxalic acid and oxamide. Its ammonium salt is obtained by boiling oxamide with ammonia.",
  ...
  "obstipation": "1. The act of stopping up, as a passage. [Obs.] Bailey. 2. (Med.)  Extreme constipation. [Obs.] Hooper.",
  ...
  "odontolcae": "An extinct order of ostrichlike aquatic birds having teeth, which are set in a groove in the jaw. It includes Hesperornis, and allied genera. See Hesperornis. [Written also Odontholcae, and Odontoholcae.]",
  ...
  "offender": "One who offends; one who violates any law, divine or human; a wrongdoer. I and my son Solomon shall be counted offenders. 1 Kings i. 21.",
  "offspring": "1. The act of production; generation. [Obs.] 2. That which is produced; a child or children; a descendant or descendants, however remote from the stock. To the gods alone Our future offspring and our wives are known. Dryden. 3. Origin; lineage; family. [Obs.] Fairfax.",
  ...
  "overween": "To think too highly or arrogantly; to regard one's own thinking or conclusions too highly; hence, to egotistic, arrogant, or rash, in opinion; to think conceitedly; to presume. They that overween, And at thy growing virtues fret their spleen. Milton.",
  "oxlike": "Characteristic of, or like, an ox.",
  "ovulite": "A fossil egg.",
  "opposer": "One who opposes; an opponent; an antagonist; an adversary.",
  "oceanic": "1. Of or pertaining to the ocean; found or formed in or about, or produced by, the ocean; frequenting the ocean, especially mid-ocean. Petrels are the most aërial and oceanic of birds. Darwin. 2. Of or pertaining to Oceania or its inhabitants.",
  ...
  "observator": "1. One who observes or takes notice. [Obs.] Sir M. Hale. 2. One who makes a remark. [Obs.] Dryden.",
  ...
  "ort": "A morsel left at a meal; a fragment; refuse; -- commonly used in the plural. Milton. Let him have time a beggar's orts to crave. Shak.",
  ...
  "osculate": "1. To kiss. 2. (Geom.)  To touch closely, so as to have a common curvature at the point of contact. See Osculation, 2.\n\n1. To kiss one another; to kiss. 2. (Geom.)  To touch closely. See Osculation, 2. 3. (Biol.)  To have characters in common with two genera or families, so as to form a connecting link between them; to interosculate. See Osculant.",
  ...
  "olden": "Old; ancient; as, the olden time. \"A minstrel of the olden stamp.\" J. C. Shairp.\n\nTo grow old; to age. [R.] She had oldened in that time. Thackeray.",
  ...
  "oblivious": "1. Promoting oblivion; causing forgetfulness. \"The oblivious pool.\" Milton. She lay in deep, oblivious slumber. Longfellow. 2. Evincing oblivion; forgetful. Through are both weak in body and oblivious. Latimer. -- Obliv\"i*ous*ly, adv. -- Ob*liv\"i*ous*ness, n. Foxe.",
  "oblatrate": "To bark or snarl, as a dog. [Obs.]",
  "occiput": "1. (Anat.)  The back, or posterior, part of the head or skull; the region of the occipital bone. 2. (Zoöl.)  A plate which forms the back part of the head of insects.",
  ...
  "oxytone": "Having an acute sound; (Gr. Gram.), having an acute accent on the last syllable.\n\n1. An acute sound. 2. (Gr. Gram.)  A word having the acute accent on the last syllable.",
  ...
  "oscillograph": "An apparatus for recording or indicating alternating-current wave forms or other electrical oscillations, usually consisting of a galvanometer with strong field, in which the mass of the moving part is very small and frequency of vibration very high. -- Os`cil*lo*graph\"ic (#), a.",
  ...
  "obvolute": "Overlapping; contorted; convolute; -- applied primarily, in botany, to two opposite leaves, each of which has one edge overlapping the nearest edge of the other, and secondarily to a circle of several leaves or petals which thus overlap.",
  ...
  "oxygenous": "Oxygenic.",
  "orsellic": "Pertaining to, or designating, an acid found in certain lichens, and called also lecanoric acid. [Formerly written also orseillic.]",
  ...
  "obligement": "Obligation. [R.] I will not resist, therefore, whatever it is, either of divine or human obligement, that you lay upon me. Milton.",
  ...
  "oriflamme": "1. The ancient royal standard of France. 2. A standard or ensign, in battle. \"A handkerchief like an oriflamb.\" Longfellow. And be your oriflamme to-day the helmet of Navarre. Macaulay.",
  ...
  "overly": "1. Careless; negligent; inattentive; superfical; not thorough. [Archaic] Bp. Hall. 2. Excessive; too much. [R.] Coleridge.\n\nIn an overly manner. [Archaic]",
  "octandrous": "Of or pertaining to the Octandria; having eight distinct stamens.",
  "oakling": "A young oak. Evelyn.",
  "overshoe": "A shoe that is worn over another for protection from wet or for extra warmth; esp., an India-rubber shoe; a galoche.",
  "orchil": "See Archil.",
  ...
  "odontornithes": "A group of Mesozoic birds having the jaws armed with teeth, as in most other vertebrates. They have been divided into three orders: Odontolcæ, Odontotormæ, and Saururæ.",
  ...
  "overissue": "An excessive issue; an issue, as of notes or bonds, exceeding the limit of capital, credit, or authority. An overissue of government paper. Brougham.\n\nTo issue in excess.",
  ...
  "obmutescence": "1. A becoming dumb; loss of speech. Sir T. Browne. 2. A keeping silent or mute. Paley.",
  "overgrowth": "Excessive growth.",
  "oakum": "1. The material obtained by untwisting and picking into loose fiber old hemp ropes; -- used for calking the seams of ships, stopping leaks, etc. 2. The coarse portion separated from flax or hemp in nackling. Knight. White oakum, that made from untarred rope.",
  ...
  "oscillating": "That oscillates; vibrating; swinging. Oscillating engine, a steam engine whose cylinder oscillates on trunnions instead of being permanently fixed in a perpendicular or other direction. Weale.",
  ...
  "over-arm": "Done (as bowling or pitching) with the arm raised above the shoulder. See Overhard. \"An over-arm with a round-arm bowler.\" R. A. Proctor.",
  ...
  "orleans": "1. A cloth made of worsted and cotton, -- used for wearing apparel. 2. A variety of the plum. See under Plum. [Eng.]",
  ...
  "organon": "An organ or instrument; hence, a method by which philosophical or scientific investigation may be conducted; -- a term adopted from the Aristotelian writers by Lord Bacon, as the title (\"Novum Organon\") of part of his treatise on philosophical method. Sir. W. Hamilton.",
  ...
  "oleraceous": "Pertaining to pot herbs; of the nature or having the qualities of herbs for cookery; esculent. Sir T. Browne.",
  "origanum": "A genus of aromatic labiate plants, including the sweet marjoram (O. Marjorana) and the wild marjoram (O. vulgare). Spenser.",
  ...
  "overman": "1. One in authority over others; a chief; usually, an overseer or boss. 2.  An arbiter. 3.  In the philosophy of Nietzsche, a man of superior physique and powers capable of dominating others; one fitted to survive in an egoistic struggle for the mastery.",
  ...
  "overfall": "1. A cataract; a waterfall. [Obs.] 2. (Naut.)  A turbulent surface of water, caused by strong currents setting over submerged ridges; also, a dangerous submerged ridge or shoal.",
  "oeconomical": "See Economical.",
  "oglio": "See Olio.",
  "over-busy": "Too busy; officious.",
  "ourang": "The orang-outang.",
  "oillet": "(a) A small opening or loophole, sometimes circular, used in mediæval fortifications. (b) A small circular opening, and ring of moldings surrounding it, used in window tracery in Gothic architecture. [Written also oylet.]",
  ...
  "ovary": "1. (Bot.)  That part of the pistil which contains the seed, and in most flowering plants develops into the fruit. See Illust. of Flower. 2. (Zoöl. & Anat.)  The essential female reproductive organ in which the ova are produced. See Illust. of Discophora.",
  ...
  "octennial": "Happening every eighth year; also, lasting a period of eight years. Johnson. -- Oc*ten\"ni*al*ly, adv.",
  ...
  "oscitancy": "1. The act of gaping or yawning. 2. Drowsiness; dullness; sluggishness. Hallam. It might proceed from the oscitancy of transcribers. Addison.",
  ...
  "obstetricious": "Serving to assist childbirth; obstetric; hence, facilitating any bringing forth or deliverance. [Obs.] Yet is all human teaching but maieutical, or obstetricious. Cudworth.",
  ...
  "oxygonal": "Having acute angles. Barlow.",
  ...
  "offscouring": "That which is scoured off; hence, refuse; rejected matter; that which is vile or despised. Lam. iii. 45.",
  "oxyopy": "Excessive acuteness of sight.",
  "owenite": "A follower of Robert Owen, who tried to reorganize society on a socialistic basis, and established an industrial community on the Clyde, Scotland, and, later, a similar one in Indiana.",
  ...
  "ovicapsule": "1. (Anat)  The outer layer of a Graafian follicle. 2. (Zoöl.)  Same as Oötheca.",
  ...
  "outskirt": "A part remote from the center; outer edge; border; -- usually in the plural; as, the outskirts of a town. Wordsworth. The outskirts of his march of mystery. Keble.",
  ...
  "orthographic": "1. Of or pertaining to orthography, or right spelling; also, correct in spelling; as, orthographical rules; the letter was orthographic. 2. (Geom.)  Of or pertaining to right lines or angles. Orthographic or Orthogonal, projection, that projection which is made by drawing lines, from every point to be projected, perpendicular to the plane of projection. Such a projection of the sphere represents its circles as seen in perspective by an eye supposed to be placed at an infinite distance, the plane of projection passing through the center of the sphere perpendicularly to the line of sight.",
  ...
  "ogreish": "Resembling an ogre; having the character or appearance of an ogre; suitable for an ogre. \"An ogreish kind of jocularity.\" Dickens.",
  ...
  "orthopinacoid": "A name given to the two planes in the monoclinic system which are parallel to the vertical and orthodiagonal axes.",
  "ossicle": "1. A little bone; as, the auditory ossicles in the tympanum of the ear. 2. (Zoöl.)  One of numerous small calcareous structures forming the skeleton of certain echinoderms, as the starfishes.",
  ...
  "osteoclast": "1. (Physiol.)  A myeloplax. Note: The osteoclasts occur usually in pits or cavities which they appear to have excavated, and are supposed to be concerned in the absorption of the bone matrix. 2. An instrument for performing osteoclasis.",
  "overquell": "To quell or subdue completely. [R.] Bp. Hall.",
  "ovoviviparous": "Oviparous, but hatching the egg while it is within the body, as some fishes and reptiles.",
  "odontographic": "Of or pertaining to odontography.",
  "obolus": "(a) A small silver coin of Athens, the sixth part of a drachma, about three cents in value. (b) An ancient weight, the sixth part of a drachm.",
  ...
  "osmogene": "An apparatus, consisting of a number of cells whose sides are of parchment paper, for conducting the process of osmosis. It is used esp. in sugar refining to remove potassium salts from the molasses.",
  "outgaze": "To gaze beyond; to exceed in sharpness or persistence of seeing or of looking; hence, to stare out of countenance.",
  ...
  "obligable": "Acknowledging, or complying with, obligation; trustworthy. [R.] The main difference between people seems to be, that one man can come under obligations on which you can rely, -- is obligable; and another is not. Emerson.",
  "ovism": "The old theory that the egg contains the whole embryo of the future organism and the germs of all subsequent offsprings and is merely awakened to activity by the spermatozoön; -- opposed to spermism or animalculism.",
  "offhand": "Instant; ready; extemporaneous; as, an offhand speech; offhand excuses. -- adv.  In an offhand manner; as, he replied offhand.",
  ...
  "ord": "An edge or point; also, a beginning. [ Obs. or Prov. Eng.] Chaucer. Ord and end, the beginning and end. Cf. Odds and ends, under Odds. [Obs. or Prov. Eng.] Chaucer. Halliwell.",
  ...
  "orthotropous": "Having the axis of an ovule or seed straight from the hilum and chalaza to the orifice or the micropyle; atropous. Note: This word has also been used (but improperly) to describe any embryo whose radicle points towards, or is next to, the hilum.",
  ...
  "obsession": "1. The act of besieging. Johnson. 2. The state of being besieged; -- used specifically of a person beset by a spirit from without. Tylor. Whether by obsession or possession, I will not determine. Burton.",
  "objurgatory": "Designed to objurgate or chide; containing or expressing reproof; culpatory. Bancroft. The objurgatory question of the Pharisees. Paley.",
  "obliquity": "1. The condition of being oblique; deviation from a right line; deviation from parallelism or perpendicularity; the amount of such deviation; divergence; as, the obliquity of the ecliptic to the equator. 2. Deviation from ordinary rules; irregularity; deviation from moral rectitude. To disobey [God]...imports a moral obliquity. South.",
  "oceanography": "A description of the ocean.",
  "overcloud": "To cover or overspread with clouds; to becloud; to overcast.",
  "oscillator": "(a) (Elec.)  Any device for producing electric oscillations; esp., an apparatus for generating electric waves in a system of wireless telegraphy. (b) (Mech.) An instrument for measuring rigidity by the torsional oscillations of a weighted wire.",
  ...
  "octagon": "1. (Geom.)  A plane figure of eight sides and eight angles. 2. Any structure (as a fortification) or place with eight sides or angles. Regular octagon, one in which the sides are all equal, and the angles also are all equal.",
  ...
  "organific": "Making an organic or organized structure; producing an organism; acting through, or resulting from, organs. Prof. Park.",
  ...
  "osteal": "Osseous.",
  "oeil-de-perdrix": "1. (Ornamental Art) Characterized by, or decorated with, small round points, spots, or rings; as, oil-de-perdrix pattern. 2.  Having a brownish red color; -- used esp. of light-colored red wine.",
  ...
  "origan": "A genus of aromatic labiate plants, including the sweet marjoram (O. Marjorana) and the wild marjoram (O. vulgare). Spenser.",
  ...
  "overthrow": "1. To throw over; to overturn; to upset; to turn upside down. His wife overthrew the table. Jer. Taylor. 2. To cause to fall or to fail; to subvert; to defeat; to make a ruin of; to destroy. When the walls of Thebes he overthrew. Dryden. [Gloucester] that seeks to overthrow religion. Shak. Syn. -- To demolish; overturn; prostrate; destroy; ruin; subvert; overcome; conquer; defeat; discomfit; vanquish; beat; rout.\n\n1. The act of overthrowing; the state of being overthrow; ruin. Your sudden overthrow much rueth me. Spenser. 2. (a) (Baseball) The act of throwing a ball too high, as over a player's head. (b) (Cricket) A faulty return of the ball by a fielder, so that striker makes an additional run.",
  "owse": "Tanner's ooze. See Ooze, 3.",
  "oversman": "1. An overseer; a superintendent. 2. (Scots Law)  An umpire; a third arbiter, appointed when two arbiters, previously selected, disagree.",
  "oxyhydrogen": "Of or pertaining to a mixture of oxygen and hydrogen; as, oxyhydrogen gas. Oxyhydrogen blowpipe. (Chem.) See Blowpipe. -- Oxyhydrogen microscope, a form of microscope arranged so as to use the light produced by burning lime or limestone under a current of oxyhydrogen gas.",
  ...
  "ogam": "Same as Ogham.",
  "occupation": "1. The act or process of occupying or taking possession; actual possession and control; the state of being occupied; a holding or keeping; tenure; use; as, the occupation of lands by a tenant. 2. That which occupies or engages the time and attention; the principal business of one's life; vocation; employment; calling; trade. Absence of occupation is not rest. Cowper. Occupation bridge (Engin.), a bridge connecting the parts of an estate separated by a railroad, a canal, or an ordinary road. Syn. -- Occupancy; possession; tenure; use; employment; avocation; engagement; vocation; calling; office; trade; profession.",
  "open-handed": "Generous; liberal; munificent. -- O\"pen-hand`ed*ness, n. J. S. Mill.",
  "outness": "1. The state of being out or beyond; separateness. 2. (Metaph.)  The state or quality of being distanguishable from the perceiving mind, by being in space, and possessing marerial quality; externality; objectivity. The outness of the objects of sense. Sir W. Hamiltom.",
  ...
  "orthoepical": "Of or pertaining to orthoëpy, or correct pronunciation. -- Or`tho*ëp\"ic*al*ly, adv.",
  ...
  "outspoken": "Speaking, or spoken, freely, openly, or boldly; as, an outspoken man; an outspoken rebuke. -- Out*spo\"ken*ness, n.",
  ...
  "obreptitious": "Done or obtained by surprise; with secrecy, or by concealment of the truth. [R.] Cotgrave.",
  "oeillade": "A glance of the eye; an amorous look. [Obs.] She gave strange oeillades and most speaking looks. Shak.",
  "oreography": "The science of mountains; orography.",
  "ocular": "1. Depending on, or perceived by, the eye; received by actual sight; personally seeing or having seen; as, ocular proof. Shak. Thomas was an ocular witness of Christ's death. South. 2. (Anat.)  Of or pertaining to the eye; optic.\n\nThe eyepiece of an optical instrument, as of a telescope or microscope.",
  "oriental": "Of or pertaining to the orient or east; eastern; concerned with the East or Orientalism; -- opposed to occidental; as, Oriental countries. The sun's ascendant and oriental radiations. Sir T. Browne.\n\n1. A native or inhabitant of the Orient or some Eastern part of the world; an Asiatic. 2. pl. (Eccl.)  Eastern Christians of the Greek rite.",
  "ogham": "A particular kind of writing practiced by the ancient Irish, and found in inscriptions on stones, metals, etc. [Written also ogam.]",
  ...
  "ova": "See Ovum.",
  "ovalbumin": "The albumin from white of eggs; egg albumin; -- in distinction from serum albumin. See Albumin.",
  ...
  "osmious": "Denoting those compounds of osmium in which the element has a valence relatively lower than in the osmic compounds; as, osmious chloride. [Written also osmous.] Osmious acid (Chem.), an acid derived from osmium, analogous to sulphurous acid, and forming unstable salts. It is a brown amorphous substance.",
  ...
  "outname": "1. To exceed in naming or describing. [R.] 2. To exceed in name, fame, or degree. [Obs.] And found out one to outname thy other faults. Beau. & Fl.",
  "overaffect": "To affect or care for unduly. [Obs.] Milton.",
  "oso-berry": "The small, blueblack, drupelike fruit of the Nuttallia cerasiformis, a shrub of Oregon and California, belonging to the Cherry tribe of Rosaceæ.",
  "obnoxious": "1. Subject; liable; exposed; answerable; amenable; -- with to. The writings of lawyers, which are tied obnoxious to their particular laws. Bacon. Esteeming it more honorable to live on the public than to be obnoxious to any private purse. Milton. Obnoxious, first or last, To basest things Milton. 2. Liable to censure; exposed to punishment; reprehensible; blameworthy. \"The contrived and interested schemes of ...obnoxious authors.\" Bp. Fell. All are obnoxious, and this faulty land, Like fainting Hester, does before you stand Watching your scepter. Waller. 3. Offensive; odious; hateful; as, an obnoxious statesman; a minister obnoxious to the Whigs. Burke. -- Ob*nox\"ious*ly, adv. -- Ob*nox\"ious*ness, n. South.",
  "orion": "A large and bright constellation on the equator, between the stars Aldebaran and Sirius. It contains a remarkable nebula visible to the naked eye. The flaming glories of Orion's belt. E. Everett.",
  "outrageous": "Of the nature of an outrage; exceeding the limits of right, reason, or decency; involving or doing an outrage; furious; violent; atrocious. \"Outrageous weeping.\" Chaucer. \"The most outrageous villainies.\" Sir P. Sidney. \"The vile, outrageous crimes.\" Shak. \"Outrageous panegyric.\" Dryden. Syn. -- Violent; furious; exorbitant; excessive; atrocious; monstrous; wanton; nefarious; heinous. -- Out*ra\"geous*ly, adv. -- Out*ra\"geous*ness, n.",
  "overripen": "To make too ripe. Shak.",
  "obtusely": "In an obtuse manner.",
  "orthoceras": "An extinct genus of Paleozoic Cephalopoda, having a long, straight, conical shell. The interior is divided into numerous chambers by transverse septa.",
  ...
  "ornithopoda": "An order of herbivorous dinosaurs with birdlike characteristics in the skeleton, esp. in the pelvis and hind legs, which in some genera had only three functional toes, and supported the body in walking as in Iguanodon. See Illust. in Appendix.",
  ...
  "outsell": "1. To exceed in amount of sales; to sell more than. 2. To exceed in the price of selling; to fetch more than; to exceed in value. Fuller. Shak.",
  "overfullness": "The state of being excessively or abnormally full, so as to cause overflow, distention, or congestion; excess of fullness; surfeit.",
  ...
  "ousel": "One of several species of European thrushes, especially the blackbird (Merula merula, or Turdus merula), and the mountain or ring ousel (Turdus torquatus). [Written also ouzel.] Rock ousel (Zoöl.), the ring ousel. -- Water ousel (Zoöl.), the European dipper (Cinclus aquaticus), and the American dipper (C. Mexicanus).",
  "organizer": "One who organizes.",
  "overgo": "1. To travel over. [R.] Shak. 2. To exceed; to surpass. [Obs.] Sir P. Sidney. 3. To cover. [Obs.] Chapman. 4. To oppress; to weigh down. [Obs.] Shak.",
  "orpine": "A low plant with fleshy leaves (Sedum telephium), having clusters of purple flowers. It is found on dry, sandy places, and on old walls, in England, and has become naturalized in America. Called also stonecrop, and live-forever. [Written also orpin.]",
  ...
  "osselet": "1. A little bone. 2. (Zoöl.)  The internal bone, or shell, of a cuttlefish.",
  ...
  "oreide": "See Oroide.",
  "organizable": "Capable of being organized; esp. (Biol.), capable of being formed into living tissue; as, organizable matter.",
  ...
  "outraye": "See Outrage, v. i. [Obs.] This warn I you, that ye not suddenly Out of yourself for no woe should outraye. Chaucer.",
  ...
  "otaheite apple": "(a) The fruit of a Polynesian anacardiaceous tree (Spondias dulcis), also called vi-apple. It is rather larger than an apple, and the rind has a flavor of turpentine, but the flesh is said to taste like pineapples. (b) A West Indian name for a myrtaceous tree (Jambosa Malaccensis) which bears crimson berries.",
  ...
  "ordonnance": "The disposition of the parts of any composition with regard to one another and the whole. Their dramatic ordonnance of the parts. Coleridge.",
  "otheoscope": "An instrument for exhibiting the repulsive action produced by light or heat in an exhausted vessel; a modification of the radoimeter. W. Crookes.",
  "outfrown": "To frown down; to overbear by frowning. Shak.",
  "outfangthef": "(a) A thief from without or abroad, taken within a lord's fee or liberty. (b) The privilege of trying such a thief. Burrill.",
  ...
  "orotund": "Characterized by fullness, clearness, strength, and smoothness; ringing and musical; -- said of the voice or manner of utterance. -- n.  The orotund voice or utterance Rush.",
  ...
  "orthogonal": "Right-angled; rectangular; as, an orthogonal intersection of one curve with another. Orthogonal projection. See under Orthographic.",
  "oliban": "See Olibanum.",
  "onanism": "Self-pollution; masturbation.",
  "orphan": "A child bereaved of both father and mother; sometimes, also, a child who has but one parent living. Orphans' court (Law), a court in some of the States of the Union, having jurisdiction over the estates and persons of orphans or other wards. Bouvier.\n\nBereaved of parents, or (sometimes) of one parent.\n\nTo cause to become an orphan; to deprive of parents. Young.",
  "overmalapert": "Excessively malapert or impudent. [Obs.] Prynne.",
  "oviduct": "A tube, or duct, for the passage of ova from the ovary to the exterior of the animal or to the part where further development takes place. In mammals the oviducts are also called Fallopian tubes.",
  ...
  "obliquation": "1. The act of becoming oblique; a turning to one side; obliquity; as, the obliquation of the eyes. [R.] Sir T. Browne. 2. Deviation from moral rectitude. [R.]",
  ...
  "overboil": "To boil over or unduly. Nor is discontent to keep the mind Deep in its fountain, lest it overboil In the hot throng. Byron.",
  "overripe": "Matured to excess. Milton.",
  "owllight": "Glimmering or imperfect [R.] Bp. Warburton.",
  "orally": "1. In an oral manner. Tillotson. 2. By, with, or in, the mouth; as, to receive the sacrament orally. [Obs.] Usher.",
  ...
  "orthopnoea": "Specifically, a morbid condition in which respiration can be performed only in an erect posture; by extension, any difficulty of breathing.",
  ...
  "orthoclase": "Common or potash feldspar crystallizing in the monoclinic system and having two cleavages at right angles to each other. See Feldspar.",
  ...
  "orthodiagonal": "The diagonal or lateral axis in a monoclinic crystal which is at right angles with the vertical axis.",
  ...
  "orchidaceous": "Pertaining to, or resembling, a natural order (Orchidaceæ) of endogenous plants of which the genus Orchis is the type. They are mostly perennial herbs having the stamens and pistils united in a single column, and normally three petals and three sepals, all adherent to the ovary. The flowers are curiously shaped, often resembling insects, the odd or lower petal (called the lip) being unlike the others, and sometimes of a strange and unexpected appearance. About one hundred species occur in the United States, but several thousand in the tropics. Note: Over three hundred genera are recognized.",
  ...
  "origenism": "The opinions of Origen of Alexandria, who lived in the 3d century, one of the most learned of the Greek Fathers. Prominent in his teaching was the doctrine that all created beings, including Satan, will ultimately be saved.",
  ...
  "outlearn": "1. To excel or surpass in learing. 2. To learn out [i. e., completely, utterly]; to exhaust knowledge of. Naught, according to his mind, He could outlearn. Spenser. Men and gods have not outlearned it [love]. Emerson.",
  ...
  "ochrea": "1. (Antiq.)  A greave or legging. 2. (Bot.)  A kind of sheath formed by two stipules united round a stem.",
  ...
  "ochry": "See Ochery.",
  "ostracoidea": "An order of Entomostraca possessing hard bivalve shells. They are of small size, and swim freely about. [Written also Ostracoda.]",
  ...
  "ochlesis": "A general morbid condition induced by the crowding together of many persons, esp. sick persons, under one roof. G. Gregory.",
  ...
  "outact": "To do or beyond; to exceed in acting. [R.] He has made me heir to treasures Would make me outact a real window's whining. Otway.",
  "overliver": "A survivor. Bacon.",
  "orbitosphenoid": "Of or pertaining to the sphenoid bone and the orbit, or to the orbitosphenoid bone. -- n.  The orbitosphenoid bone, which is situated in the orbit on either side of the presphenoid. It generally forms a part of the sphenoid in the adult.",
  "outlandish": "1. Foreign; not native. Him did outlandish women cause to sin. Neh. xiii. 26. Its barley water and its outlandish wines. G. W. Cable. 2. Hence: Not according with usage; strange; rude; barbarous; uncouth; clownish; as, an outlandish dress, behavior, or speech. Something outlandish, unearthy, or at variance with ordinary fashion. Hawthorne. --Out*land\"ish*ly, adv. -- Out*land\"ish*ness, n.",
  ...
  "oilnut": "The buffalo nut. See Buffalo nut, under Buffalo. Note: The name is also applied to various nuts and seeds yielding oil, as the butternut, cocoanut, oil-palm nut.",
  "outgive": "To surpass in giving. Dryden.",
  "optic": "1. The organ of sight; an eye. The difference is as great between The optics seeing, as the object seen. Pope. 2. An eyeglass. [Obs.] Herbert.\n\n1. Of or pertaining to vision or sight. The moon, whose orb Through optic glass the Tuscan artist views. Milton. 2. Of or pertaining to the eye; ocular; as, the optic nerves (the first pair of cranial nerves) which are distributed to the retina. See Illust. of Brain, and Eye. 3. Relating to the science of optics; as, optical works. Optic angle (Opt.), the angle included between the optic axes of the two eyes when directed to the same point; -- sometimes called binocular parallax. -- Optic axis. (Opt.) (a) A line drawn through the center of the eye perpendicular to its anterior and posterior surfaces. In a normal eye it is in the direction of the optic axis that objects are most distinctly seen. (b) The line in a doubly refracting crystal, in the direction of which no double refraction occurs. A uniaxial crystal has one such line, a biaxial crystal has two. -- Optical circle (Opt.), a graduated circle used for the measurement of angles in optical experiments. -- Optical square, a surveyor's instrument with reflectors for laying off right angles.",
  ...
  "outrun": "To exceed, or leave behind, in running; to run faster than; to outstrip; to go beyond. Your zeal outruns my wishes. Sir W. Scott. The other disciple did outrun Peter, and came first to the sepulcher. Jhon xx. 4.",
  ...
  "obtected": "1. Covered; protected. [Obs.] 2. (Zoöl.)  Covered with a hard chitinous case, as the pupa of certain files.",
  ...
  "ortygan": "One of several species of East Indian birds of the genera Ortygis and Hemipodius. They resemble quails, but lack the hind toe. See Turnix.",
  "overwork": "1. To work beyond the strength; to cause to labor too much or too long; to tire excessively; as, to overwork a horse. 2. To fill too full of work; to crowd with labor. My days with toil are overwrought. Longfellow. 3. To decorate all over.\n\nTo work too much, or beyond one's strength.\n\nWork in excess of the usual or stipulated time or quantity; extra work; also, excessive labor.",
  "orbiculate": "That which is orbiculate; especially, a solid the vertical section of which is oval, and the horizontal section circular.\n\nMade, or being, in the form of an orb; having a circular, or nearly circular, or a spheroidal, outline. Orbiculate leaf (Bot.), a leaf whose outline is nearly circular.",
  ...
  "obvention": "The act of happening incidentally; that which happens casually; an incidental advantage; an occasional offering. [Obs.] \"Tithes and other obventions.\" Spenser. Legacies bequeathed by the deaths of princes and great persons, and other casualities and obventions. Fuller.",
  ...
  "ossianic": "Of or pertaining to, or characteristic of, Ossian, a legendary Erse or Celtic bard. The compositions might be fairly classed as Ossianic. G. Eliot.",
  ...
  "overpower": "To excel or exceed in power; to cause to yield; to vanquish; to subdue; as, the light overpowers the eyes. \"And overpower'd that gallant few.\" Wordsworth. Syn. -- To overbear; overcome; vanquish; defeat; crush; overwhelm; overthrow; rout; conquer; subdue.\n\nA dominating power. Bacon.",
  "ozena": "A discharge of fetid matter from the nostril, particularly if associated with ulceration of the soft parts and disease of the bones of the nose.",
  "odinism": "Worship of Odin; broadly, the Teutonic heathenism. -- O\"din*ist, n. Odinism was valor; Christianism was humility, a nobler kind of valor. Carlyle.",
  ...
  "orcin": "A colorless crystalline substance, C6H3.CH3.(OH)2, which is obtained from certain lichens (Roccella, Lecanora, etc.), also from extract of aloes, and artificially from certain derivatives of toluene. It changes readily into orcein.",
  "osteomalacia": "A disease of the bones, in which they lose their earthy material, and become soft, flexible, and distorted. Also called malacia.",
  ...
  "oleaceous": "Of, pertaining to, or resembling, a natural order of plants (Oleaceæ), mostly trees and shrubs, of which the olive is the type. It includes also the ash, the lilac, the true jasmine, and fringe tree.",
  ...
  "overhead charges": "Those general charges or expenses in any business which cannot be charged up as belonging exclusively to any particular part of the work or product, as where different kinds of goods are made, or where there are different departments in a business; -- called also fixed, establishment, or (in a manufacturing business) administration, selling, and distribution, charges, etc.",
  "overwrest": "To wrest or force from the natural or proper position. Shak.",
  "octavo": "A book composed of sheets each of which is folded into eight leaves; hence, indicating more or less definitely a size of book so made; -- usually written 8vo or 8º.\n\nHaving eight leaves to a sheet; as, an octavo form, book, leaf, size, etc.",
  ...
  "oxybenzoic": "Hydroxybenzoic; pertaining to, or designating, any one of several hydroxyl derivatives of benzonic acid, of which the commonest is salicylic acid.",
  ...
  "oxonic": "Pertaining to, or designating, a complex nitrogenous acid (C4H5N3O4) not known in the free state, but obtained, in combination with its salts, by a slow oxidation of uric acid, to which it is related.",
  ...
  "outlaw": "A person excluded from the benefit of the law, or deprived of its protection. Blackstone.\n\n1. To deprive of the benefit and protection of law; to declare to be an outlaw; to proscribe. Blackstone. 2. To remove from legal jurisdiction or enforcement; as, to outlaw a debt or claim; to deprive of legal force. \"Laws outlawed by necessity.\" Fuller.",
  "outrival": "To surpass in a rivalry.",
  "ovular": "Relating or belonging to an ovule; as, an ovular growth.",
  "oh": "An exclamation expressing various emotions, according to the tone and manner, especially surprise, pain, sorrow, anxiety, or a wish. See the Note under O.",
  ...
  "osiris": "One of the principal divinities of Egypt, the brother and husband of Isis. He was figured as a mummy wearing the royal cap of Upper Egypt, and was symbolized by the sacred bull, called Apis. Cf. Serapis. -- O*sir\"i*an, a.",
  ...
  "overgrow": "1. To grow over; to cover with growth or herbage, esp. that which is rank. The green . . . is rough and overgrown. Sir W. Scott. 2. To grow beyond; to rise above; hence, to overcome; to oppress. [Obs.] Mortimer. \"O'ergrown with labor.\" Beau. & Fl. [Usually in the past participle.]\n\nTo grow beyond the fit or natural size; as, a huge, overgrown ox. L'Estrange.",
  ...
  "ornament": "That which embellishes or adorns; that which adds grace or beauty; embellishment; decoration; adornment. The ornament of a meek and quiet spirit. 1 Pet. iii. 4. Like that long-buried body of the king Found lying with his urns and ornaments. Tennyson.\n\nTo adorn; to deck; to embellish; to beautify; as, to ornament a room, or a city. Syn. -- See Adorn.",
  ...
  "outlook": "1. To face down; to outstare. To outlook conquest, and to win renown. Shak. 2. To inspect throughly; to select. [Obs.] Cotton.\n\n1. The act of looking out; watch. 2. One who looks out; also, the place from which one looks out; a watchower. Lyon Playfair. 3. The view obtained by one looking out; scope of vision; prospect; sight; appearance. Applause Which owes to man's short outlook all its charms. Young.",
  ...
  "overproof": "Containing more alcohol than proof spirit; stronger than proof spirit; that is, containing more than 49.3 per cent by weight of alcohol.",
  ...
  "overawe": "To awe exceedingly; to subjugate or restrain by awe or great fear. The king was present in person to overlook the magistrates, and overawe these subjects with the terror of his sword. Spenser.",
  ...
  "oriflamb": "1. The ancient royal standard of France. 2. A standard or ensign, in battle. \"A handkerchief like an oriflamb.\" Longfellow. And be your oriflamme to-day the helmet of Navarre. Macaulay.",
  ...
  "oxindol": "A white crystalline nitrogenous substance (C8H7NO) of the indol group, obtained by the reduction of dioxindol. It is a so-called lactam compound.",
  ...
  "orris": "A plant of the genus Iris (I. Florentina); a kind of flower-de- luce. Its rootstock has an odor resembling that of violets. Orris pea (Med.), an issue pea made from orris root. -- Orris root, the fragrant rootstock of the orris.\n\n1. Etym: [Contr. from orfrays, or from arras.]  A sort of gold or silver lace. Johnson. 2. A peculiar pattern in which gold lace or silver lace is worked; especially, one in which the edges are ornamented with conical figures placed at equal distances, with spots between them.",
  "ordovian": "Ordovician.",
  ...
  "obrok": "(a) A rent. (b) A poll tax paid by peasants absent from their lord's estate. [Russia] Brande & C.",
  ...
  "orthometry": "The art or practice of constructing verses correctly; the laws of correct versification.",
  ...
  "obsolete": "1. No longer in use; gone into disuse; disused; neglected; as, an obsolete word; an obsolete statute; -- applied chiefly to words, writings, or observances. 2. (Biol.)  Not very distinct; obscure; rudimental; imperfectly developed; abortive. Syn. -- Ancient; antiquated; old-fashioned; antique; old; disused; neglected. See Ancient.\n\nTo become obsolete; to go out of use. [R.] Fitzed. Hall.",
  "olfactive": "See Olfactory, a.",
  "orbiculated": "Made, or being, in the form of an orb; having a circular, or nearly circular, or a spheroidal, outline. Orbiculate leaf (Bot.), a leaf whose outline is nearly circular.",
  "orbic": "Spherical; orbicular; orblike; circular. [R.] Bacon.",
  "optimism": "1. (Metaph.)  The opinion or doctrine that everything in nature, being the work of God, is ordered for the best, or that the ordering of things in the universe is such as to produce the highest good. 2. A disposition to take the most hopeful view; -- opposed to pessimism.",
  ...
  "oe": "a diphthong, employed in the Latin language, and thence in the English language, as the representative of the Greek diphthong oe. In many words in common use, e alone stands instead of oe. Classicists prefer to write the diphthong oe separate in Latin words.",
  ...
  "optimistic": "1. (Metaph.)  Of or pertaining to optimism; tending, or conforming, to the opinion that all events are ordered for the best. 2. Hopeful; sanguine; as, an optimistic view.",
  ...
  "ochlocratical": "Of or pertaining to ochlocracy; having the form or character of an ochlocracy; mobocratic. -- Och`lo*crat\"ic*al*ly, adv.",
  "outing": "1. The act of going out; an airing; an excursion; as, a summer outing. 2. A feast given by an apprentice when he is out of his time. [Prov. Eng.] Halliwell.",
  ...
  "odontoblast": "1. (Anat.)  One of the more or less columnar cells on the outer surface of the pulp of a tooth; an odontoplast. They are supposed to be connected with the formation of dentine. 2. (Zoöl.)  One of the cells which secrete the chitinous teeth of Mollusca.",
  "ophiurid": "Same as Ophiurioid.",
  "obscenity": "That quality in words or things which presents what is offensive to chasity or purity of mind; obscene or impure lanquage or acts; moral impurity; lewdness; obsceneness; as, the obscenity of a speech, or a picture. Mr.Cowley asserts plainly, that obscenity has no place in wit. Dryden. No pardon vile obscenity should find. Pope.",
  "obtrusion": "1. The act of obtruding; a thrusting upon others by force or unsolicited; as, the obtrusion of crude opinions on the world. 2. That which is obtruded. Milton.",
  ...
  "ods": "A corruption of God's; -- formerly used in oaths and ejaculatory phrases. \"Ods bodikin.\" \"Ods pity.\" Shak.",
  "orangeman": "One of a secret society, organized in the north of Ireland in 1795, the professed objects of which are the defense of the regning sovereign of Great Britain, the support of the Protestant religion, the maintenance of the laws of the kingdom, etc.; -- so called in honor of William, Prince of Orange, who became William III. of England.",
  ...
  "overweight": "1. Weight over and above what is required by law or custom. 2. Superabundance of weight; preponderance.\n\nOverweighing; excessive. [Obs.] \"Of no overweight worth.\" Fuller.",
  ...
  "overvalue": "1. To value excessively; to rate at too high a price. \"To overvalue human power.\" Holyday. 2. To exceed in value. [R.] H. Brooke.",
  ...
  "oxalantin": "A white crystalline nitrogenous substance (C6H4N4O5) obtained by the reduction of parabanic acid; -- called also leucoturic acid.",
  ...
  "oxaluric": "Pertaining to, or designating, a complex nitrogenous acid related to the ureids, and obtained from parabanic acid as a white silky crystalline substance.",
