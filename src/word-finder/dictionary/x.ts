// Auto-generated dictionary file for letter 'x'
...
const dictionary: AlphabeticalDictionary = {
  ...
  "xiphisternum": "(a) The posterior segment, or extremity, of the sternum; -- sometimes called metasternum, ensiform cartilage, ensiform process, or xiphoid process. (b) The xiphiplastron. -- Xiph\"i*ster\"nal a.",
  ...
  "xylophagan": "(a) One of a tribe of beetles whose larvæ bore or live in wood. (b) Any species of Xylophaga. (c) Any one of the Xylophagides.",
  "xiphioid": "Of, pertaining to, or resembling, a cetacean of the genus Xiphius or family Xiphiidæ.",
  ...
  "xeroderma": "(a) Ichthyosis. (b) A skin disease characterized by the presence of numerous small pigmented spots resembling freckles, with which are subsequently mingled spots of atrophied skin.",
  "xeme": "An Arctic fork-tailed gull (Xema Sabinii).",
  "xylogen": "(a) (Bot.) Nascent wood; wood cells in a forming state. (b) Lignin.",
  "xenurine": "A cabassou.",
  "xiphias": "1. (Zoöl.)  A genus of fishes comprising the common swordfish. 2. (Anat.) (a) The constellation Dorado. (b) A comet shaped like a sword",
  ...
  "xanthochroi": "A division of the Caucasian races, comprising the lighter- colored members. The Xanthochroi, or fair whites, . . . are the prevalent inhabitants of Northern Europe, and the type may be traced into North Africa, and eastward as far as Hindostan. Tylor.",
  ...
  "xenon": "A very heavy, inert gaseous element occurring in the atmosphere in the proportion of one volume is about 20 millions. It was discovered by Ramsay and Travers in 1898. It can be condensed to a liquid boiling at -109º C., and to a solid which volatilizes without melting. Symbol Xe or X; atomic weight 130.2.",
  ...
  "xerophilous": "Drought-loving; able withstand the absence or lack of moisture. Plants which are peculiarly adapted to dry climates are termed by De Candolle xerophilous. Goodale.",
  ...
  "xylophagous": "(a) Eating, boring in, or destroying, wood; -- said especially of certain insect larvæ, crustaceans, and mollusks. (b) Of or pertaining to the genus Xylophaga.",
  ...
  "xylocopa": "A genus of hymenopterous insects including the carpenter. See Carpenter bee, under Carpenter. -- Xy*loc\"o*pine, a.",
  ...
  "xanthoxylum": "A genus of prickly shrubs or small trees, the bark and rots of which are of a deep yellow color; prickly ash. Note: The commonest species in the Northern United States is Xanthoxylum Americanum. See Prickly ash, under Prickly.",
  "xyst": "A long and open portico, for athletic exercises, as wrestling, running, etc., for use in winter or in stormy weather.",
  "x rays": "The Röntgen rays; -- so called by their discoverer because of their enigmatical character.",
  ...
  "xyridaceous": "Of or pertaining to a natural order (Xyrideæ) of endogenous plants, of which Xyris is the type.",
  ...
  "xenogenesis": "(a) Same as Heterogenesis. (b) The fancied production of an organism of one kind by an organism of another. Huxley.",
  ...
  "xanthidium": "A genus of minute unicellular algæ of the desmids. These algæ have a rounded shape and are armed with glochidiate or branched aculei. Several species occur in ditches, and others are found fossil in flint or hornstone.",
  ...
  "xylophagides": "A tribe or family of dipterous flies whose larvæ live in decayed wood. Some of the tropical species are very large.",
  ...
  "xanthogen": "(a) The hypothetical radical supposed to be characteristic of xanthic acid. [Archaic] (b) Persulphocyanogen.  [R.]",
  ...
  "xylophilan": "One of a tribe of beetles (Xylophili) whose larvæ live on decayed wood."
};
