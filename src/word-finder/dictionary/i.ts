// Auto-generated dictionary file for letter 'i'
import type { AlphabeticalDictionary } from '../types';

const dictionary: AlphabeticalDictionary = {
  ...
  "incompacted": "Not compact; not having the parts firmly united; not solid; incoherent; loose; discrete. Boyle.",
  ...
  "irresolvable": "Incapable of being resolved; not separable into component parts. Irresolvable nebulæ (Astron.), nebulæ of a cloudlike appearance, which have not yet been resolved by the telescope into stars. Sir W. Herschel.",
  ...
  "idiomatic": "Of or pertaining to, or conforming to, the mode of expression peculiar to a language; as, an idiomatic meaning; an idiomatic phrase. -- Id`i*o*mat\"ic*al*ly, adv.",
  ...
  "invalid": "1. Of no force, weight, or cogency; not valid; weak. 2. (Law)  Having no force, effect, or efficacy; void; null; as, an invalid contract or agreement.\n\nA person who is weak and infirm; one who is disabled for active service; especially, one in chronic ill health.\n\nNot well; feeble; infirm; sickly; as, he had an invalid daughter.\n\n1. To make or render invalid or infirm. \"Invalided, bent, and almost blind.\" Dickens. 2. To classify or enroll as an invalid. Peace coming, he was invalided on half pay. Carlyle.",
  ...
  "intercentrum": "The median of the three elements composing the centra of the vertebræ in some fossil batrachians.",
  ...
  "interrupted": "1. Broken; intermitted; suddenly stopped. 2. (Bot.)  Irregular; -- said of any arrangement whose symmetry is destroyed by local causes, as when leaflets are interposed among the leaves in a pinnate leaf.",
  "incarcerate": "1. To imprison; to confine in a jail or priso 2. To confine; to shut up or inclose; to hem in. Incarcerated hernia (Med.), hernia in which the constriction can not be easily reduced.\n\nImprisoned. Dr. H. More.",
  "issuable": "1. Leading to, producing, or relating to, an issue; capable of being made an issue at law. Burrill. 2. Lawful or suitable to be issued; as, a writ issuable on these grounds. Issuable plea (Law), a plea to the merits, on which the adverse party may take issue and proceed to trial.",
  ...
  "idiotic": "1. Common; simple. [Obs.] Blackwall. 2. Pertaining to, or like, an idiot; characterized by idiocy; foolish; fatuous; as, an idiotic person, speech, laugh, or action.",
  "insuperable": "Incapable of being passed over or surmounted; insurmountable; as, insuperable difficulties. And middle natures, how they long to join, Yet never pass the insuperable line Pope. The difficulty is enhanced, or is . . . insuperable. I. Taylor. Syn. -- Impassable; insurmountable; unconquerable. -- In*su\"per*a*ble*ness, n. -- In*su\"per*a*bly, adv.",
  "interfollicular": "Between follicles; as, the interfollicular septa in a lymphatic gland.",
  "interviewer": "One who interviews; especially, one who obtains an interview with another for the purpose of eliciting his opinions or obtaining information for publication. It would have made him the prince of interviewers in these days. Leslie Stephen.",
  ...
  "insufferable": "1. Incapable of being suffered, borne, or endured; insupportable; unendurable; intolerable; as, insufferable heat, cold, or pain; insufferable wrongs. Locke. 2. Offensive beyond endurance; detestable. A multitude of scribblers who daily pester the world with their insufferable stuff. Dryden.",
  "inarch": "To graft by uniting, as a scion, to a stock, without separating either from its root before the union is complete; -- also called to graft by approach. P. Miler.",
  ...
  "impropriation": "1. The act of impropriating; as, the impropriation of property or tithes; also, that which is impropriated. 2. (Eng. Eccl. Law) (a) The act of putting an ecclesiastical benefice in the hands of a layman, or lay corporation. (b) A benefice in the hands of a layman, or of a lay corporation.",
  ...
  "immanency": "The condition or quality of being immanent; inherence; an indwelling. [Clement] is mainly concerned in enforcing the immanence of God. Christ is everywhere presented by him as Deity indwelling in the world. A. V. G. Allen.",
  "integrality": "Entireness. [Obs.] Whitaker.",
  "inclamation": "Exclamation. [Obs.] Bp. Hall.",
  "innative": "Native. [Obs.] Chapman.",
  "impersonate": "1. To invest with personality; to endow with the form of a living being. 2. To ascribe the qualities of a person to; to personify. 3. To assume, or to represent, the person or character of; to personate; as, he impersonated Macbeth. Benedict impersonated his age. Milman.",
  ...
  "inframaxillary": "(a) Under the lower jaw; submaxillary; as, the inframaxillary nerve. (b) Of or pertaining to the lower iaw.",
  "inexecutable": "Incapable of being executed or performed; impracticable; infeasible.",
  "inferobranchiate": "Having the gills on the sides of the body, under the margin of the mantle; belonging to the Inferobranchiata.",
  ...
  "intenerate": "To make tender or sensitive; to soften. Fear intenerates the heart. Bp. Hall. So have I seen the little purls of a stream . . . intenerate the stubborn pavement. Jer. Taylor.\n\nMade tender or soft; softened. [Obs.]",
  "inadvisable": "Not advisable. -- In`ad*vis\"a*ble*ness, n.",
  "individualistic": "Of or pertaining to the individual or individualism. London Athenæum.",
  "irrespirable": "Unfit for respiration; not having the qualities necessary to support animal life; as, irrespirable air.",
  ...
  "insistence": "The quality of insisting, or being urgent or pressing; the act of dwelling upon as of special importance; persistence; urgency.",
  ...
  "interalveolar": "Between alveoli; as, the interalveolar septa between adjacent air cells in the lungs.",
  ...
  "indicated": "Shown; denoted; registered; measured. Indicated power. See Indicated horse power, under Horse power.",
  ...
  "infundibuliform": "1. Having the form of a funnel or cone; funnel-shaped. 2. (Bot.)  Same as Funnelform.",
  ...
  "innoxious": "1. Free from hurtful qualities or effects; harmless. \"Innoxious flames.\" Sir K. Digby. 2. Free from crime; pure; innocent. Pope. -- In*nox`ious*ly, adv. -- In*nox\"ious*ness, n.",
  ...
  "imposthume": "A collection of pus or purulent matter in any part of an animal body; an abscess.\n\nSame as Imposthumate.",
  "imprudent": "Not prudent; wanting in prudence or discretion; indiscreet; injudicious; not attentive to consequence; improper. -- Im*pru\"dent*ly, adv. Her majesty took a great dislike at the imprudent behavior of many of the ministers and readers. Strype. Syn. -- Indiscreet; injudicious; incautious; ill-advised; unwise; heedless; careless; rash; negligent.",
  ...
  "intromit": "1. To send in or put in; to insert or introduce. Greenhill. 2. To allow to pass in; to admit. Glass in the window intromits light, without cold. Holder.\n\nTo intermeddle with the effects or goods of another.",
  "irruption": "1. A bursting in; a sudden, violent rushing into a place; as, irruptions of the sea. Lest evil tidings, with too rude irruption Hitting thy aged ear, should pierce too deep. Milton. 2. A sudden and violent inroad, or entrance of invaders; as, the irruptions of the Goths into Italy. Addison. Syn. -- Invasion; incursion; inroad. See Invasion.",
  "impalpable": "1. Not palpable; that cannot be felt; extremely fine, so that no grit can be perceived by touch. \"Impalpable powder.\" Boyle. 2. Not material; intangible; incorporeal. \"Impalpable, void, and bodiless.\" Holland. 3. Not apprehensible, or readily apprehensible, by the mind; unreal; as, impalpable distinctions.",
  "imaum": "1. Among the Mohammedans, a minister or priest who performs the regular service of the mosque. 2. A Mohammedan prince who, as a successor of Mohammed, unites in his person supreme spiritual and temporal power.",
  ...
  "inflation": "1. The act or process of inflating, or the state of being inflated, as with air or gas; distention; expansion; enlargement. Boyle. 2. The state of being puffed up, as with pride; conceit; vanity. B. Jonson. 3. Undue expansion or increase, from overissue; -- said of currency. [U.S.]",
  "impedition": "A hindering; a hindrance. [Obs.] Baxier.",
  "iranian": "Of or pertaining to Iran. -- n.  A native of Iran; also, the Iranian or Persian language, a division of the Aryan family of languages.",
  "imbrown": "To make brown; to obscure; to darken; to tan; as, features imbrowned by exposure. The mountain mass by scorching skies imbrowned. Byron.",
  ...
  "indri": "Any lemurine animal of the genus Indris. Note: Several species are known, all of them natives of Madagascar, as the diadem indris (I. diadema), which has a white ruff around the forehead; the woolly indris (I. laniger); and the short-tailed or black indris (I. brevicaudatus), which is black, varied with gray.",
  "incorporative": "Incorporating or tending to incorporate; as, the incorporative languages (as of the Basques, North American Indians, etc. ) which run a whole phrase into one word. History demonstrates that incorporative unions are solid and permanent; but that a federal union is weak. W. Belsham.",
  "isthmian": "Of or pertaining to an isthmus, especially to the Isthmus of Corinth, in Greece. Isthmian games (Gr. Antiq.), one of the four great national festivals of Greece, celebrated on the Isthmus of Corinth in the spring of every alternate year. They consisted of all kinds of athletic sports, wrestling, boxing, racing on foot and in chariots, and also contests in music and poetry. The prize was a garland of pine leaves.",
  "icarian": "Soaring too high for safety, like Icarus; adventurous in flight.",
  "implicity": "Implicitness. [Obs.] Cotgrave.",
  "insult": "1. The act of leaping on; onset; attack. [Obs.] Dryden. 2. Gross abuse offered to another, either by word or act; an act or speech of insolence or contempt; an affront; an indignity. The ruthless sneer that insult adds to grief. Savage. Syn. -- Affront; indignity; abuse; outrage; contumely. See Affront.\n\n1. To leap or trample upon; to make a sudden onset upon. [Obs.] Shak. 2. To treat with abuse, insolence, indignity, or contempt, by word or action; to abuse; as, to call a man a coward or a liar, or to sneer at him, is to insult him.\n\n1. To leap or jump. Give me thy knife, I will insult on him. Shak. Like the frogs in the apologue, insulting upon their wooden king. Jer. Taylor. 2. To behave with insolence; to exult. [Archaic] The lion being dead, even hares insult. Daniel. An unwillingness to insult over their helpless fatuity. Landor.",
  ...
  "irrefragable": "Not refragable; not to be gainsaid or denied; not to be refuted or overthrown; unanswerable; incontestable; undeniable; as, an irrefragable argument; irrefragable evidence. -- Ir*ref\"ra*ga*ble*ness, n. -- Ir*ref\"ra*ga*bly, adv. Syn. -- Incontrovertible; unanswerable; indisputable; unquestionable; incontestable; indubitable; undeniable; irrefutable.",
  "idolize": "1. To make an idol of; to pay idolatrous worship to; as, to idolize the sacred bull in Egypt. 2. To love to excess; to love or reverence to adoration; as, to idolize gold, children, a hero.\n\nTo practice idolatry. [R.] To idolize after the manner of Egypt. Fairbairn.",
  ...
  "inhaler": "1. One who inhales. 2. An apparatus for inhaling any vapor or volatile substance, as ether or chloroform, for medicinal purposes. 3. A contrivance to filter, as air, in order to protect the lungs from inhaling damp or cold air, noxious gases, dust, etc.; also, the respiratory apparatus for divers.",
  "illiberality": "The state or quality of being illiberal; narrowness of mind; meanness; niggardliness. Bacon.",
  "incorporation": "1. The act of incorporating, or the state of being incorporated. 2. The union of different ingredients in one mass; mixture; combination; synthesis. 3. The union of something with a body already existing; association; intimate union; assimilation; as, the incorporation of conquered countries into the Roman republic. 4. (Law) (a) The act of creating a corporation. (b) A body incorporated; a corporation.",
  "infusionism": "The doctrine that the soul is preexistent to the body, and is infused into it at conception or birth; -- opposed to tradicianism and creationism.",
  ...
  "impeccable": "Not liable to sin; exempt from the possibility of doing wrong. -- n.  One who is impeccable; esp., one of a sect of Gnostic heretics who asserted their sinlessness. God is infallible, impeccable, and absolutely perfect. P. Skelton.",
  "imperiality": "1. Imperial power. 2. An imperial right or privilegs. See Royalty. The late empress having, by ukases of grace, relinquished her imperialities on the private mines, viz., the tenths of the copper, iron, silver and gold. W. Tooke.",
  "incensurable": "Not censurable. Dr. T. Dwight. -- In*cen\"sur*a*bly, adv.",
  "intemperance": "1. The act of becoming, or state of being, intemperate; excess in any kind of action or indulgence; any immoderate indulgence of the appetites or passions. God is in every creature; be cruel toward none, neither abuse any by intemperance. Jer. Taylor. Some, as thou sawest, by violent stroke shall die, By fire, flood, famine, by intemperance more In meats and drinks. Milton. 2. Specifically: Habitual or excessive indulgence in alcoholic liquors.",
  ...
  "inexhaustible": "Incapable of being exhausted, emptied, or used up; unfailing; not to be wasted or spent; as, inexhaustible stores of provisions; an inexhaustible stock of elegant words. Dryden. An inexhaustible store of anecdotes. Macaulay. -- In`ex*haust\"i*ble*ness, n. -- In`ex*haust\"i*bly, adv.",
  ...
  "imprecate": "1. To call down by prayer, as something hurtful or calamitous. Imprecate the vengeance of Heaven on the guilty empire. Mickle. 2. To invoke evil upon; to curse; to swear at. In vain we blast the ministers of Fate, And the forlorn physicians imprecate. Rochester.",
  ...
  "incommode": "To give inconvenience or trouble to; to disturb or molest; to discommode; to worry; to put out; as, we are incommoded by want of room. Syn. -- To annoy; disturb; trouble; molest; disaccomodate; inconvenience; disquiet; vex; plague.\n\nAn inconvenience. [R.] Strype.",
  ...
  "inviolate": "1. Not violated; uninjured; unhurt; unbroken. His fortune of arms was still inviolate. Bacon. 2. Not corrupted, defiled, or profaned; chaste; pure. \"Inviolate truth.\" Denham. There chaste Alceste lives inviolate. Spenser.",
  ...
  "influenza": "An epidemic affection characterized by acute nasal catarrh, or by inflammation of the throat or the bronchi, and usually accompanied by fever.",
  "ironsmith": "1. A worker in iron; one who makes and repairs utensils of iron; a blacksmith. 2. (Zoöl.)  An East Indian barbet (Megalaima faber), inhabiting the Island of Hainan. The name alludes to its note, which resembles the sounds made by a smith.",
  "imperception": "Want of perception.",
  "intertexture": "The act of interweaving, or the state of being interwoven; that which is interwoven. \"Knit in nice intertexture.\" Coleridge. Skirted thick with intertexture firm Of thorny boughs. Cowper.",
  "incorruptibility": "The quality of being incorruptible; incapability of corruption. Holland.",
  "infra-red": "Lying outside the visible spectrum at its red end; -- said of rays less refrangible than the extreme red rays.",
  ...
  "incontestable": "Not contestable; not to be disputed; that cannot be called in question or controverted; incontrovertible; indisputable; as, incontestable evidence, truth, or facts. Locke. Syn. -- Incontrovertible; indisputable; irrefragable; undeniable; unquestionable; intuitable; certain. -- In`con*test\"a*ble*ness, n. -- In`con*test\"a*bly, adv.",
  ...
  "intermediary": "Lying, coming, or done, between; intermediate; as, an intermediary project. Intermediary amputation (Surg.), an amputation for injury, performed after inflammation has set in.\n\nOne who, or that which, is intermediate; an interagent; a go- between.",
  "irremissive": "Not remitting; unforgiving.",
  "isorropic": "Of equal value. Isorropic line (in a diagram) (Geom.), the locus of all the points for which a specified function has a constant value. Newcomb.",
  ...
  "isotropism": "Isotropy.",
  "ignitor": "One who, or that which, produces ignition; especially, a contrivance for igniting the powder in a torpedo or the like. [Written also igniter.]",
  ...
  "ingrowing": "Growing or appearing to grow into some other substance. Ingrowing nail, one whose edges are becoming imbedded in the adjacent flesh.",
  "ilvaite": "A silicate of iron and lime occurring in black prismatic crystals and columnar masses. I'M I'm  . A contraction of I am.",
  ...
  "intemerated": "Pure; undefiled. [Obs.]",
  ...
  "illogical": "Ignorant or negligent of the rules of logic or correct reasoning; as, an illogical disputant; contrary of the rules of logic or sound reasoning; as, an illogical inference. -- Il*log\"ic*al*ly, adv. -- Il*log\"ic*al*ness, n.",
  ...
  "iconism": "The formation of a figure, representation, or semblance; a delineation or description. Some kind of apish imitations, counterfeit iconisms. Cudworth.",
  ...
  "ingenerate": "Generated within; inborn; innate; as, ingenerate powers of body. W. Wotton. Those virtues were rather feigned and affected . . . than true qualities ingenerate in his judgment. Bacon.\n\nTo generate or produce within; to begete; to engener; to occasion; to cause. Mede. Those noble habits are ingenerated in the soul. Sir M. Hale.",
  ...
  "isochronize": "To make, or tend to make (the motion of a moving body), uniform in rate of rotation, or in frequency of vibration.",
  ...
  "indeed": "In reality; in truth; in fact; verily; truly; -- used in a variety of sense. Esp.: (a) Denoting emphasis; as, indeed it is so. (b) Denoting concession or admission; as, indeed, you are right. (c) Denoting surprise; as, indeed, is it you Its meaning is not intrinsic or fixed, but depends largely on the form of expression which it accompanies. The carnal mind is enmity against God; for it is not subject to the law of God, neither indeed can be. Rom. viii. 7. I were a beast indeed to do you wrong. Dryden. There is, indeed, no great pleasure in visiting these magazines of war. Addison.",
  "inconvertibly": "In an inconvertible manner.",
  "impertinence": "1. The condition or quality of being impertnent; absence of pertinence, or of adaptedness; irrelevance; unfitness. 2. Conduct or language unbecoming the person, the society, or the circumstances; rudeness; incivility. We should avoid the vexation and impertinence of pedants who affect to talk in a language not to be understood. Swift. 3. That which is impertinent; a thing out of place, or of no value. There are many subtile impertinences learned in schools. Watts.",
  "indubitate": "Not questioned or doubtful; evident; certain. [Obs.] Bacon.\n\nTo bring into doubt; to cause to be doubted. [Obs.] To conceal, or indubitate, his exigency. Sir T. Browne.",
  "intrepidly": "In an intrepid manner; courageously; resolutely.",
  "inclusion": "1. The act of including, or the state of being included; limitation; restriction; as, the lines of inclusion of his policy. Sir W. Temple. 2. (Min.)  A foreign substance, either liquid or solid, usually of minute size, inclosed in the mass of a mineral.",
  "impendency": "The state of impending; also, that which impends. \"Impendence of volcanic cloud.\" Ruskin.",
  ...
  "included": "Inclosed; confined. Included stamens (Bot.), such as are shorter than the floral envelopes, or are concealed within them.",
  "intenable": "Incapable of being held; untenable; not defensible; as, an intenable opinion; an intenable fortress. [Obs.] Bp. Warburton.",
  ...
  "involute": "1. (Bot.)  Rolled inward from the edges; -- said of leaves in vernation, or of the petals of flowers in æstivation. Gray. 2. (Zoöl.) (a) Turned inward at the margin, as the exterior lip of the Cyprea. (b) Rolled inward spirally.\n\nA curve traced by the end of a string wound upon another curve, or unwound from it; -- called also evolvent. See Evolute.",
  ...
  "impuberty": "The condition of not having reached puberty, or the age of ability to reproduce one's species; want of age at which the marriage contract can be legally entered into.",
  ...
  "inept": "1. Not apt or fit; unfit; unsuitable; improper; unbecoming. The Aristotelian philosophy is inept for new discoveries. Glanvill. 2. Silly; useless; nonsensical; absurd; foolish. To view attention as a special act of intelligence, and to distinguish it from consciousness, is utterly inept. Sir W. Hamilton.",
  ...
  "inertness": "1. Want of activity or exertion; habitual indisposition to action or motion; sluggishness; apathy; insensibility. Glanvill. Laziness and inertness of mind. Burke. 2. Absence of the power of self-motion; inertia.",
  "irrupted": "Broken with violence.",
  "isodiametric": "1. (Crystallog.)  Developed alike in the directions of the several lateral axes; -- said of crystals of both the tetragonal and hexagonal systems. 2. (Bot.)  Having the several diameters nearly equal; -- said of the cells of ordinary parenchyma.",
  "indagate": "To seek or search out. [Obs.]",
  "imputer": "One who imputes.",
  "institutor": "1. One who institutes, founds, ordains, or establishes. 2. One who educates; an instructor. [Obs.] Walker. 3. (Episcopal Church)  A presbyter appointed by the bishop to institute a rector or assistant minister over a parish church.",
  ...
  "inductance": "Capacity for induction; the coefficient of self-induction. The unit of inductance is the henry.",
  ...
  "ichor": "1. (Class. Myth.)  An ethereal fluid that supplied the place of blood in the veins of the gods. 2. A thin, acrid, watery discharge from an ulcer, wound, etc.",
  ...
  "insipidness": "The quality or state of being insipid; vapidity. \"Dryden's lines shine strongly through the insipidity of Tate's.\" Pope.",
  "infelicity": "1. The state or quality of being infelicitous; unhappiness; misery; wretchedness; misfortune; want of suitableness or appropriateness. I. Watts. Whatever is the ignorance and infelicity of the present state, we were made wise and happy. Glanvill. 2. That (as an act, word, expression, etc.) which is infelicitous; as, infelicities of speech.",
  "incommensurable": "Not commensurable; having no common measure or standard of comparison; as, quantities are incommensurable when no third quantity can be found that is an aliquot part of both; the side and diagonal of a square are incommensurable with each other; the diameter and circumference of a circle are incommensurable. They are quantities incommensurable. Burke. -- In`com*men\"su*ra*ble*ness, n. -- In`com*men\"su*ra*bly, adv.\n\nOne of two or more quantities which have no common measure.",
  ...
  "isoclinic": "Of or pertaining to, or indicating, equality of inclination or dip; having equal inclination or dip. Isoclinal lines (Magnetism), lines on the earth's surface connecting places at which a dipping needle indicates the same inclination or dip.",
  ...
  "intelligencer": "One who, or that which, sends or conveys intelligence or news; a messenger. All the intriguers in foreign politics, all the spies, and all the intelligencers . . . acted solely upon that principle. Burke.",
  ...
  "impossible": "Not possible; incapable of being done, of existing, etc.; unattainable in the nature of things, or by means at command; insuperably difficult under the circumstances; absurd or impracticable; not feasible. With men this is impossible; but with God all things are possible. Matt. xix. 26. Without faith it is impossible to please him. Heb. xi. 6. Impossible quantity (Math.), an imagnary quantity. See Imaginary. Syn. -- See Impracticable.\n\nAn impossibility. [Obs.] \"Madam,\" quoth he, \"this were an impossible!\" Chaucer.",
  ...
  "ipecacuanha": "The root of a Brazilian rubiaceous herb (Cephaëlis Ipecacuanha), largely employed as an emetic; also, the plant itself; also, a medicinal extract of the root. Many other plants are used as a substitutes; among them are the black or Peruvian ipecac (Psychotria emetica), the white ipecac (Ionidium Ipecacuanha), the bastard or wild ipecac (Asclepias Curassavica), and the undulated ipecac (Richardsonia scabra).",
  "instituter": "An institutor. [R.]",
  "influxion": "A flowing in; infusion. [R.] Bacon.",
  "isobar": "A line connecting or marking places upon the surface of the earth where height of the barometer reduced to sea level is the same either at a given time, or for a certain period (mean height), as for a year; an isopiestic line. [Written also isobare.]\n\nThe quality or state of being equal in weight, especially in atmospheric pressure. Also, the theory, method, or application of isobaric science.",
  "inelastic": "Not elastic.",
  "inkhorn": "A small bottle of horn or other material formerly used for holding ink; an inkstand; a portable case for writing materials. \"With a writer's inkhorn by his side.\" Ezek. ix. 2. From his pocket the notary drew his papers and inkhorn. Longfellow.\n\nLearned; pedantic; affected. [Obs.] \"Inkhorn terms.\" Bale.",
  ...
  "italicism": "1. A phrase or idiom peculiar to the Italian language; to Italianism. 2. The use of Italics.",
  ...
  "individualism": "1. The quality of being individual; individuality; personality. 2. An excessive or exclusive regard to one's personal interest; self- interest; selfishness. The selfishness of the small proprietor has been described by the best writers as individualism. Ed. Rev.",
  ...
  "insurable": "Capable of being insured against loss, damage, death, etc.; proper to be insured. The French law annuls the latter policies so far as they exceed the insurable interest which remained in the insured at the time of the subscription thereof. Walsh.",
  ...
  "interpale": "1. To place pales between or among; to separate by pales. 2. To interweave or interlace. [R.] Brende.",
  ...
  "inattentive": "Not attentive; not fixing the mind on an object; heedless; careless; negligent; regardless; as, an inattentive spectator or hearer; an inattentive habit. I. Watts. Syn. -- Careless; heedless; regardless; thoughtless; negligent; remiss; inadvertent. -- In`at*ten\"tive*ly, adv. -- In`at*ten\"tive*ness, n.",
  ...
  "impassible": "Incapable of suffering; inaccessible to harm or pain; not to be touched or moved to passion or sympathy; unfeeling, or not showing feeling; without sensation. \"Impassible to the critic.\" Sir W. Scott. Secure of death, I should contemn thy dart Though naked, and impassible depart. Dryden.",
  "imprison": "1. To put in prison or jail; To arrest and detain in custody; to confine. He imprisoned was in chains remediles. Spenser. 2. To limit, restrain, or confine in any way. Try to imprison the resistless wind. Dryden. Syn. -- To incarcerate; confine; immure.",
  "incrustment": "Incrustation. [R.]",
  "infibulation": "1. The act of clasping, or fastening, as with a buckle or padlock. 2. The act of attaching a ring, clasp, or frame, to the genital organs in such a manner as to prevent copulation.",
  "incentive": "1. Inciting; encouraging or moving; rousing to action; stimulative. Competency is the most incentive to industry. Dr. H. More. 2. Serving to kindle or set on fire. [R.] Part incentive reed Provide, pernicious with one touch of fire. Milton.\n\nThat which moves or influences the mind, or operates on the passions; that which incites, or has a tendency to incite, to determination or action; that which prompts to good or ill; motive; spur; as, the love of money, and the desire of promotion, are two powerful incentives to action. The greatest obstacles, the greatest terrors that come in their way, are so far from making them quit the work they had begun, that they rather prove incentives to them to go on in it. South. Syn. -- Motive; spur; stimulus; incitement; encouragement; inducement; influence.",
  ...
  "implex": "Intricate; entangled; complicated; complex. The fable of every poem is . . . simple or implex. it is called simple when there is no change of fortune in it; implex, when the fortune of the chief actor changes from bad to good, or from good to bad. Addison.",
  "inshaded": "Marked with different shades. W. Browne.",
  "irreproachable": "Not reproachable; above reproach; not deserving reproach; blameless. He [Berkely] erred, -- and who is free from error -- but his intentions were irreproachable. Beattie.",
  ...
  "isomorphism": "A similarity of crystalline form between substances of similar composition, as between the sulphates of barium (BaSO4) and strontium (SrSO4). It is sometimes extended to include similarity of form between substances of unlike composition, which is more properly called homoeomorphism.",
  "ill-will": ". See under Ill, a.",
  "intolerability": "The quality of being intolerable; intolerableness. [R.]",
  "inchoation": "Act of beginning; commencement; inception. The setting on foot some of those arts, in those parts, would be looked on as the first inchoation of them. Sir M. Hale. It is now in actual progress, from the rudest inchoation to the most elaborate finishing. I. Taylor.",
  ...
  "interposit": "An intermediate depot or station between one commercial city or country and another. Mitford.",
  ...
  "indulto": "1. A privilege or exemption; an indulgence; a dispensation granted by the pope. 2. (Spain)  A duty levied on all importations.",
  ...
  "insulate": "1. To make an island of. [Obs.] Pennant. 2. To place in a detached situation, or in a state having no communication with surrounding objects; to isolate; to separate. 3. (Elec. & Thermotics)  To prevent the transfer o Insulating stool (Elec.), a stool with legs of glass or some other nonconductor of electricity, used for insulating a person or any object placed upon it.",
  "issuer": "One who issues, emits, or publishes.",
  "incrassation": "1. The act or process of thickening or making thick; the process of becoming thick or thicker. 2. The state of being incrassated or made thick; inspissation. Sir T. Browne.",
  "intranquillity": "Unquietness; restlessness. Sir W. Temple.",
  "indigestion": "Lack of proper digestive action; a failure of the normal changes which food should undergo in the alimentary canal; dyspepsia; incomplete or difficult digestion.",
  "interspace": "Intervening space. Bp. Hacket.",
  "inauguration": "1. The act of inuagurating, or inducting into office with solemnity; investiture by appropriate ceremonies. At his regal inauguration, his old father resigned the kingdom to him. Sir T. Browne. 2. The formal beginning or initiation of any movement, course of action, etc.; as, the inauguration of a new system, a new condition, etc.",
  "intermure": "To wall in; to inclose. [Obs.] Ford.",
  "irrevokable": "Irrevocable. [R.]",
  "incredulity": "The state or quality of being i Of every species of incredulity, religious unbelief is the most irrational. Buckminster.",
  ...
  "immaterial": "1. Not consisting of matter; incorporeal; spiritual; disembodied. Angels are spirits immaterial and intellectual. Hooker. 2. Of no substantial consequence; without weight or significance; unimportant; as, it is wholly immaterial whether he does so or not. Syn. -- Unimportant; inconsequential; insignificant; inconsiderable; trifling.",
  "inflexure": "An inflection; a bend or fold. [R.] Sir T. Browne.",
  "intenseness": "The state or quality of being intense; intensity; as, the intenseness of heat or cold; the intenseness of study or thought.",
  "imputable": "1. That may be imputed; capable of being imputed; chargeable; ascribable; attributable; referable. A prince whose political vices, at least, were imputable to mental incapacity. Prescott. 2. Accusable; culpable. [R.] The fault lies at his door, and she is no wise imputable. Ayliffe.",
  "invagination": "1. (Biol.)  The condition of an invaginated organ or part. 2. (Biol.)  One of the methods by which the various germinal layers of the ovum are differentiated. Note: In embolic invagination, one half of the blastosphere is pushed in towards the other half, producing an embryonic form known as a gastrula. -- In epibolic invagination, a phenomenon in the development of some invertebrate ova, the epiblast appears to grow over or around the hypoblast.",
  "involucrum": "1. (Bot.)  See Involucre. 2. (Zoöl.)  A sheath which surrounds the base of the lasso cells in the Siphonophora.",
  "interminably": "Without end or limit.",
  "incogitancy": "Want of thought, or of the power of thinking; thoughtlessness; unreasonableness. 'T is folly and incogitancy to argue anything, one way or the other, from the designs of a sort of beings with whom we so little communicate. Glanvill.",
  ...
  "infraspinate": "Below the spine; infraspinal; esp., below the spine of the scapula; as, the infraspinous fossa; the infraspinate muscle.",
  ...
  "illegible": "Incapable of being read; not legible; as, illegible handwriting; an illegible inscription. -- Il*leg\"i*ble*ness, n. -- Il*leg\"i*bly, adv.",
  "infucate": "To stain; to paint; to daub.",
  "intellectualize": "1. To treat in an intellectual manner; to discuss intellectually; to reduce to intellectual form; to express intellectually; to idealize. Sentiment is intellectualized emotion. Lowell. 2. To endow with intellect; to bestow intellectual qualities upon; to cause to become intellectual.",
  ...
  "inee": "An arrow poison, made from an apocynaceous plant (Strophanthus hispidus) of the Gaboon country; -- called also onaye.",
  ...
  "isopathy": "(a) The system which undertakes to cure a disease by means of the virus of the same disease. (b) The theory of curing a diseased organ by eating the analogous organ of a healthy animal. Mayne. (c) The doctrine that the power of therapeutics is equal to that of the causes of disease.",
  "isothermobathic": "Of or pertaining to an isothermobath; possessing or indicating equal temperatures in a vertical section, as of the ocean.",
  "instrumentalism": "The view that the sanction of truth is its utility, or that truth is genuine only in so far as it is a valuable instrument. -- In`stru*men\"tal*ist, n. Instrumentalism views truth as simply the value belonging to certain ideas in so far as these ideas are biological functions of our organisms, and psychological functions whereby we direct our choices and attain our successes. Josiah Royce.",
  ...
  "indestructible": "Not destructible; incapable of decomposition or of being destroyed. -- In`de*struc\"ti*ble*ness, n. -- In`de*struc\"ti*bly, adv.",
  ...
  "interrenal": "Between the kidneys; as, the interrenal body, an organ found in many fishes. -- n.  The interrenal body.",
  "immature": "1. Not mature; unripe; not arrived at perfection of full development; crude; unfinished; as, immature fruit; immature character; immature plans. \"An ill-measured and immature counsel.\" Bacon. 2. Premature; untimely; too early; as, an immature death. [R.] Jer. Taylor.",
  "inthrone": "Same as Enthrone.",
  "investor": "One who invests.",
  "irenarch": "An officer in the Greek empire having functions corresponding to those of a justice of the peace. [Written also eirenarch.]",
  "ischiac": "See Ischial.",
  ...
  "impaste": "1. To knead; to make into paste; to concrete. \"Blood . . . baked and impasted.\" Shak. 2. (Paint.)  To lay color on canvas by uniting them skillfully together. [R.] Cf. Impasto.",
  "incliner": "One who, or that which, inclines; specifically, an inclined dial.",
  "isopycnic": "Having equal density, as different regions of a medium; passing through points at which the density is equal; as, an isopycnic line or surface.\n\nA line or surface passing through those points in a medium, at which the density is the same.",
  "inirritable": "Not irritable; esp. (Physiol.), incapable of being stimulated to action, as a muscle. -- In*ir`ri*ta*bil\"i*ty, n.",
  "imparisyllabic": "Not consisting of an equal number of syllables; as, an imparisyllabic noun, one which has not the same number of syllables in all the cases; as, lapis, lapidis; mens, mentis.",
  "informally": "In an informal manner.",
  "inquire": "1. To ask a question; to seek for truth or information by putting queries. We will call the damsel, and inquire. Gen. xxiv. 57. Then David inquired of the Lord yet again. And the Lord answered him. 1 Sam. xxiii. 4. 2. To seek to learn anything by recourse to the proper means of knoledge; to make examination. And inquire Gladly into the ways of God with man. Miltom. Note: This word is followed by of before the person asked; as, to inquire of a neighbor. It is followed by concerning, after, or about, before the subject of inquiry; as, his friends inquired about or concerning his welfare. \"Thou dost not inquire wisely concerning this.\" Eccl. vii. 10. It is followed by into when search is made for particular knowledge or information; as, to inquire into the cause of a sudden death. It is followed by for or after when a place or person is sought, or something is missing. \"Inquire in the house of Judas for one called Saul of Tarsus.\" Acts ix. 11.\n\n1. To ask about; to seek to know by asking; to make examination or inquiry respecting. Having thus at length inquired the truth concerning law and dispense. Milton. And all obey and few inquire his will. Byron. 2. To call or name. [Obs.] Spenser. Syn. -- To ask; question. See Question.",
  ...
  "interrupter": "1. One who, or that which, interrupts. 2. (Elec.)  A device for opening and closing an electrical circuit; a vibrating spring or tuning fork, arranged to make and break a circuit at rapidly recurring intervals, by the action of the current itself.",
  ...
  "illustrative": "1. Tending or designed to illustrate, exemplify, or elucidate. 2. Making illustrious. [Obs.]",
  ...
  "insurgent": "Rising in opposition to civil or political authority, or against an established government; insubordinate; rebellious. \"The insurgent provinces.\" Motley.\n\nA person who rises in revolt against civil authority or an established government; one who openly and actively resists the execution of laws; a rebel. Syn. -- See Rebel.",
  ...
  "initiative": "Serving to initiate; inceptive; initiatory; introductory; preliminary.\n\n1. An introductory step or movement; an act which originates or begins. The undeveloped initiatives of good things to come. I. Taylor. 2. The right or power to introduce a new measure or course of action, as in legislation; as, the initiative in respect to revenue bills is in the House of Representatives.",
  ...
  "intangible": "Not tangible; incapable of being touched; not perceptible to the touch; impalpable; imperceptible. Bp. Wilkins. A corporation is an artificial, invisible, intangible being. Marshall. -- In*tan\"gi*ble*ness, n. -- In*tan\"gi*bly, adv.",
  ...
  "ileus": "A morbid condition due to intestinal obstruction. It is characterized by complete constipation, with griping pains in the abdomen, which is greatly distended, and in the later stages by vomiting of fecal matter. Called also ileac, or iliac, passion.",
  "ignition": "1. The act of igniting, kindling, or setting on fire. 2. The state of being ignited or kindled. Sir T. Browne.",
  ...
  "illaudable": "Not laudable; not praise-worthy; worthy of censure or disapprobation. Milton. -- Il*laud\"a*bly, adv. [Obs.] Broome.",
  ...
  "irresoluble": "1. Incapable of being dissolved or resolved into parts; insoluble. Boyle. 2. Incapable of being relieved or assisted. [Obs.] The second is in the irresoluble condition of our souls after a known sin committed. Bp. Hall.",
  ...
  "infrequency": "1. The state of rarely occuring; uncommonness; rareness; as, the infrquence of his visits. 2. The state of not being frequented; solitude; isolation; retirement; seclusion. [R.] The solitude and infrequency of the place. Bp. Hall.",
  ...
  "inking": "Supplying or covering with ink. Inking roller, a somewhat elastic roller,used to spread ink over forms of type, copperplates, etc. -- Inking trough or table, a trough or table from which the inking roller receives its ink.",
  ...
  "isocheimenal": "The same as Isocheimal.",
  ...
  "impersonification": "The act of impersonating; personification; investment with personality; representation in a personal form.",
  "imbecile": "Destitute of strength, whether of body or mind; feeble; impotent; esp., mentally wea; feeble-minded; as, hospitals for the imbecile and insane. Syn. -- Weak; feeble; feeble-minded; idiotic.\n\nOne destitute of strength; esp., one of feeble mind.\n\nTo weaken; to make imbecile; as, to imbecile men's courage. [Obs.] Jer. Taylor.",
  "inanitiation": "Inanition. [R.]",
  "iodoformogen": "A light powder used as a substitute for iodoform. It is a compound of iodoform and albumin.",
  "incredited": "Uncredited. [Obs.]",
  "invection": "An inveighing against; invective. [Obs.] Fulke.",
  "intercession": "The act of interceding; mediation; interposition between parties at variance, with a view to reconcilation; prayer, petition, or entreaty in favor of, or (less often) against, another or others. But the Spirit itself maketh intercession for us with groanings which can not be uttered. Rom. viii. 26.",
  ...
  "incogitativity": "The quality of being incogitative; want of thought or of the power of thinking. Wollaston.",
  ...
  "imago": "1. An image. 2. (Zoöl.)  The final adult, and usually winged, state of an insect. See Illust. of Ant-lion, and Army worm.",
  ...
  "insipidity": "The quality or state of being insipid; vapidity. \"Dryden's lines shine strongly through the insipidity of Tate's.\" Pope.",
  "indirubin": "A substance isomeric with, and resembling, indigo blue, and accompanying it as a side product, in its artificial production.",
  "irritative": "1. Serving to excite or irritate; irritating; as, an irritative agent. 2. Accompanied with, or produced by, increased action or irritation; as, an irritative fever. E. Darwin.",
  "impressor": "One who, or that which, impresses. Boyle.",
  "iniquitous": "Characterized by iniquity; unjust; wicked; as, an iniquitous bargain; an iniquitous proceeding. Demagogues . . . bribed to this iniquitous service. Burke. Syn. -- Wicked; wrong; unjust; unrighteous; nefarious; criminal. -- Iniquitous, Wicked, Nefarious. Wicked is the generic term. Iniquitous is stronger, denoting a violation of the rights of others, usually by fraud or circumvention. Nefarious is still stronger, implying a breach of the most sacred obligations, and points more directly to the intrinsic badness of the deed.",
  "insecure": "1. Not secure; not confident of safety or permanence; distrustful; suspicious; apprehensive of danger or loss. With sorrow and insecure apprehensions. Jer. Taylor. 2. Not effectually guarded, protected, or sustained; unsafe; unstable; exposed to danger or loss. Bp. Hurg. The trade with Egypt was exceedingly insecure and precarious. Mickle.",
  ...
  "isolate": "1. To place in a detached situation; to place by itself or alone; to insulate; to separate from others. Short isolated sentences were the mode in which ancient wisdom delighted to convey its precepts. Bp. Warburton. 2. (Elec.)  To insulate. See Insulate. 3. (Chem.)  To separate from all foreign substances; to make pure; to obtain in a free state.",
  ...
  "italianate": "To render Italian, or conformable to Italian customs; to Italianize. [R.] Ascham.\n\nItalianized; Italianated. \"Apish, childish, and Italianate.\" Marlowe.",
  ...
  "imbursement": "1. The act of imbursing, or the state of being imbursed. [Obs.] 2. Money laid up in stock. [Obs.]",
  "immerit": "Want of worth; demerit. [R.] Suckling.",
  "innateness": "The quality of being innate.",
  "integer": "A complete entity; a whole number, in contradistinction to a fraction or a mixed number. Complex integer (Theory of Numbers), an expression of the form a + bsq. root-1, where a and b are real integers.",
  ...
  "insoul": "To set a soul in; reflexively, to fix one's strongest affections on. [Obs.] Jer. Taylor. [He] could not but insoul himself in her. Feltham.",
  ...
  "imparidigitate": "Having an odd number of fingers or toes, either one, three, or five, as in the horse, tapir, rhinoceros, etc.",
  ...
  "interdenominational": "Occurring between or among, or common to, different denominations; as, interdenominational fellowship or belief.",
  ...
  "identically": "In an identical manner; with respect to identity. \"Identically the same.\" Bp. Warburton. \"Identically different.\" Ross.",
  "imbody": "To become corporeal; to assume the qualities of a material body. See Embody. The soul grows clotted by contagion, Imbodies, and imbrutes. Milton.",
  "impingement": "The act of impinging.",
  "inquartation": "Quartation.",
  "irradiancy": "1. The act of irradiating; emission of rays of light. 2. That which irradiates or is irradiated; luster; splendor; irradiation; brilliancy. Milton.",
  "immartial": "Not martial; unwarlike. [Obs.]",
  "iodic": "to, or containing, iodine; specif., denoting those compounds in which it has a relatively high valence; as, iodic acid. Iodic acid, a monobasic acid, consisting of iodine with three parts of oxygen and one of hydrogen.",
  "imprescriptible": "1. Not capable of being lost or impaired by neglect, by disuse, or by the claims of another founded on prescription. The right of navigation, fishing, and others that may be exercised on the sea, belonging to the right of mere ability, are imprescriptible. Vattel (Trans. ) 2. Not derived from, or dependent on, external authority; self- evidencing; obvious. The imprescriptible laws of the pure reason. Colerridge.",
  ...
  "ineloquent": "Not eloquent; not fluent, graceful, or pathetic; not persuasive; as, ineloquent language. Nor are thy lips ungraceful, sire of men, Nor tongue ineloquent. Milton.",
  "illation": "The act or process of inferring from premises or reasons; perception of the connection between ideas; that which is inferred; inference; deduction; conclusion. Fraudulent deductions or inconsequent illations from a false conception of things. Sir T. Browne.",
  "intensification": "The act or process of intensifying, or of making more intense.",
  "infernal": "1. Of or pertaining to or suitable for the lower regions, inhabited, according to the ancients, by the dead; pertaining to Pluto's realm of the dead, the Tartarus of the ancients. The Elysian fields, the infernal monarchy. Garth. 2. Of or pertaining to, resembling, or inhabiting, hell; suitable for hell, or to the character of the inhabitants of hell; hellish; diabolical; as, infernal spirits, or conduct. The instruments or abettors in such infernal dealings. Addison. Infernal machine, a machine or apparatus maliciously designed to explode, and destroy life or property. -- Infernal stone (lapis infernalis), lunar caustic; formerly so called. The name was also applied to caustic potash. Syn. -- Tartarean; Stygian; hellish; devilish; diabolical; satanic; fiendish; malicious.\n\nAn inhabitant of the infernal regions; also, the place itself. [Obs.] Drayton.",
  ...
  "internuncio": "1. A messenger between two parties. Johnson. 2. A representative, or chargé d'affaires, of the pope at a foreign court or seat of government, ranking next below a nuncio. Note: This title was formerly given also to the Austrian envoy at Constantinople.",
  "inundate": "1. To cover with a flood; to overflow; to deluge; to flood; as, the river inundated the town. 2. To fill with an overflowing abundance or superfluity; as, the country was inundated with bills of credit. Syn. -- To overflow; deluge; flood; overwhelm; submerge; drown.",
  ...
  "intertrigo": "A rubbing or chafing of the skin; especially, an abrasion or excoriation of the skin between folds, as in fat or neglected children.",
  "iambus": "A foot consisting of a short syllable followed by a long one, as in âmans, or of an unaccented syllable followed by an accented one, as invent; an iambic. See the Couplet under Iambic, n.",
  "intercommune": "1. To intercommunicate. [Obs.] 2. To have mutual communication or intercourse by conservation. [Scot.]",
  ...
  "inswept": "Narrowed at the forward end; -- said of an automobile frame when the side members are closer together at the forward end than at the rear.",
  ...
  "intercommon": "1. To share with others; to participate; especially, to eat at the same table. [Obs.] Bacon. 2. (O. Eng. Law)  To graze cattle promiscuously in the commons of each other, as the inhabitants of adjoining townships, manors, etc.",
  ...
  "interaxis": "The space between two axes. See Axis, 6. The doors, windows, niches, and the like, are then placed centrally in the interaxes. Gwilt.",
  "imputability": "The quality of being imputable; imputableness.",
  "irreconciliation": "Want of reconciliation; disagreement.",
  "intinction": "1. The act of tingeing or dyeing. Blount. 2. (Eccl.)  A method or practice of the administration of the sacrament by dipping the bread or wafer in the wine and administering both together.",
  ...
  "intolerance": "1. Want of capacity to endure; as, intolerance of light. 2. The quality of being intolerant; refusal to allow to others the enjoyment of their opinions, chosen modes of worship, and the like; want of patience and forbearance; illiberality; bigotry; as, intolerance shown toward a religious sect. These few restrictions, I hope, are no great stretches of intolerance, no very violent exertions of despotism. Burke.",
  "ice plant": "A plant (Mesembryanthemum crystallinum), sprinkled with pellucid, watery vesicles, which glisten like ice. It is native along the Mediterranean, in the Canaries, and in South Africa. Its juice is said to be demulcent and diuretic; its ashes are used in Spain in making glass. Ice-skater = one who skates on ice wearing an ice skate; esp. an athlete who performs athletic or artistic movements on a sheet of ice, wearing ice skates; including speed skater and figure skater",
  "impertransibility": "The quality or state of being impertransible. [R.]",
  "incurrent": "Characterized by a current which flows inward; as, the incurrent orifice of lamellibranch Mollusca.",
  "ichnographic": "Of or pertaining to ichonography; describing a ground plot.",
  "inroad": "The entrance of an enemy into a country with purposes of hostility; a sudden or desultory incursion or invasion; raid; encroachment. The loss of Shrewsbury exposed all North Wales to the daily inroads of the enemy. Clarendon. With perpetual inroads to alarm, Though inaccessible, his fatal throne. Milton. Syn. -- Invasion; incursion; irruption. See Invasion.\n\nTo make an inroad into; to invade. [Obs.] The Saracens . . . conquered Spain, inroaded Aquitaine. Fuller.",
  "intruder": "One who intrudes; one who thrusts himself in, or enters without right, or without leave or welcome; a trespasser. They were all strangers and intruders. Locke.",
  "impi": "A body of Kaffir warriors; a body of native armed men. [South Africa] As early as 1862 he crossed assagais with and defeated a Matabili impi (war band). James Bryce.",
  "inbreak": "A breaking in; inroad; invasion.",
  "indoxylic": "Of or pertaining to, or producing, indoxyl; as, indoxylic acid.",
  "imbathe": "To bathe; to wash freely; to immerce. And gave her to his daughters to imbathe In nectared lavers strewed with asphodel. Milton.",
  "ingrain": "1. Dyed with grain, or kermes. [Obs.] 2. Dyed before manufacture, -- said of the material of a textile fabric; hence, in general, thoroughly inwrought; forming an essential part of the substance. Ingrain carpet, a double or two-ply carpet. -- Triple ingrain carpet, a three-ply carpet.\n\nAn ingrain fabric, as a carpet.\n\n1. To dye with or in grain or kermes. 2. To dye in the grain, or before manufacture. 3. To work into the natural texture or into the mental or moral constitution of; to stain; to saturate; to imbue; to infix deeply. Our fields ingrained with blood. Daniel. Cruelty and jealousy seem to be ingrained in a man who has these vices at all. Helps.",
  "insecticide": "An agent or preparation for destroying insects; an insect powder. -- In*sec\"ti*ci`dal, a.",
  "irreptitious": "Surreptitious; spurious. [Obs.] Dr. Castell (1673).",
  "institutional": "1. Pertaining to, or treating of, institutions; as, institutional legends. Institutional writers as Rousseau. J. S. Mill. 2. Instituted by authority. 3. Elementary; rudimental.",
  "intertwist": "To twist together one with another; to intertwine.",
  "illegitimation": "1. The act of illegitimating; bastardizing. 2. The state of being illegitimate; illegitimacy. [Obs.] Gardiner had performed his promise to the queen of getting her illegitimation taken off. Bp. Burnet.",
  "infumate": "To dry by exposing to smoke; to expose to smoke.",
  "ichnoscopy": "The search for the traces of anything. [R.]",
  "impark": "To inclose for a park; to sever from a common; hence, to inclose or shut up. They . . . impark them [the sheep] within hurdles. Holland.",
  "interveniency": "Intervention; interposition. [R.]",
  "inconstancy": "The quality or state of being inconstant; want of constancy; mutability; fickleness; variableness. For unto knight there was no greater shame, Than lightness and inconstancie in love. Spenser.",
  ...
  "interlude": "1. A short entertainment exhibited on the stage between the acts of a play, or between the play and the afterpiece, to relieve the tedium of waiting. Dreams are but interludes, which fancy makes When monarch reason sleeps. Dryden. 2. A form of English drama or play, usually short, merry, and farcical, which succeeded the Moralities or Moral Plays in the transition to the romantic or Elizabethan drama. 3. (Mus.)  A short piece of instrumental music played between the parts of a song or cantata, or the acts of a drama; especially, in church music, a short passage played by the organist between the stanzas of a hymn, or in German chorals after each line.",
  "itinerancy": "1. A passing from place to place. Dr. H. More. 2. A discharge of official duty involving frequent change of residence; the custom or practice of discharging official duty in this way; also, a body of persons who thus discharge official duty.",
  ...
  "interjoist": "1. The space or interval between two joists. Gwilt. 2. A middle joist or crossbeam. De Colange.",
  ...
  "insatiability": "The state or quality of being insatiable; insatiableness. Eagerness for increase of possession deluges the soul, and we sink into the gulfs of insatiability. Rambler.",
  ...
  "inosculate": "1. To unite by apposition or contact, as two tubular vessels at their extremities; to anastomose. 2. To intercommunicate; to interjoin. The several monthly divisions of the journal may inosculate, but not the several volumes. De Quincey.\n\n1. To unite by apposition or contact, as two vessels in an animal body. Berkeley. 2. To unite intimately; to cause to become as one. They were still together, grew (For so they said themselves) inosculated. Tennyson.",
  ...
  "ichthyosaurus": "An extinct genus of marine reptiles; -- so named from their short, biconcave vertebræ, resembling those of fishes. Several species, varying in length from ten to thirty feet, are known from the Liassic, Oölitic, and Cretaceous formations.",
  ...
  "indicavit": "A writ of prohibition against proceeding in the spiritual court in certain cases, when the suit belongs to the common-law courts. Wharton (Law Dict. ).",
  ...
  "isotropy": "Uniformity of physical properties in all directions in a body; absence of all kinds of polarity; specifically, equal elasticity in all directions.",
  "inhalant": "Inhaling; used for inhaling.\n\nAn apparatus also called an inhaler (which see); that which is to be inhaled.",
  "indecorous": "Not decorous; violating good manners; contrary to good breeding or etiquette; unbecoming; improper; out of place; as, indecorous conduct. It was useless and indecorous to attempt anything more by mere struggle. Burke. Syn. -- Unbecoming; unseemly; unbefitting; rude; coarse; impolite; uncivil; ill-bred.",
  "insist": "1. To stand or rest; to find support; -- with in, on, or upon. [R.] Ray. 2. To take a stand and refuse to give way; to hold to something firmly or determinedly; to be persistent, urgent, or pressing; to persist in demanding; -- followed by on, upon, or that; as, he insisted on these conditions; he insisted on going at once; he insists that he must have money. Insisting on the old prerogative. Shak. Without further insisting on the different tempers of Juvenal and Horace. Dryden. Syn. -- Insist, Persist. -- Insist implies some alleged right, as authority or claim. Persist may be from obstinacy alone, and either with or against rights. We insist as against others; we persist in what exclusively relates to ourselves; as, he persisted in that course; he insisted on his friend's adopting it. C. J. Smith.",
  ...
  "inordination": "Deviation from custom, rule, or right; irregularity; inordinacy. [Obs.] South. Every inordination of religion that is not in defect, is properly called superstition. Jer. Taylor.",
  "indow": "See Endow.",
  ...
  "inebriation": "The condition of being inebriated; intoxication; figuratively, deprivation of sense and judgment by anything that exhilarates, as success. Sir T. Browne. Preserve him from the inebriation of prosperity. Macaulay. Syn. -- See Drunkenness.",
  "interflow": "To flow in. [R.] Holland.",
  "impending": "Hanging over; overhanging; suspended so as to menace; imminet; threatening. An impending brow. Hawthorne. And nodding Ilion waits th' impending fall. Pope. Syn. -- Imminent; threatening. See Imminent.",
  ...
  "insufflation": "The act of breathing on or into anything; especially: (a) (R. C. Ch.) The breathing upon a person in the sacrament of baptism to symbolize the inspiration of a new spiritual life. (b) (Med.) The act of blowing (a gas, powder, or vapor) into any cavity of the body.",
  "interstinctive": "Distinguishing. [Obs.] Wallis.",
  "indue": "1. To put on, as clothes; to draw on. The baron had indued a pair of jack boots. Sir W. Scott. 2. To clothe; to invest; hence, to endow; to furnish; to supply with moral or mental qualities. Indu'd with robes of various hue she flies. Dryden. Indued with intellectual sense and souls. Shak.",
  "insouciant": "Careless; heedless; indifferent; unconcerned. J. S. Mill.",
  "inducement": "1. The act of inducing, or the state of being induced. 2. That which induces; a motive or consideration that leads one to action or induces one to act; as, reward is an inducement to toil. \"Mark the inducement.\" Shak. 3. (Law)  Matter stated by way of explanatory preamble or introduction to the main allegations of a pleading; a leading to. Syn. -- Motive; reason; influence. See Motive.",
  ...
  "interlunary": "Belonging or pertaining to the time when the moon, at or near its conjunction with the sun, is invisible. Milton.",
  ...
  "isobathythermic": "Of or pertaining to an isobathytherm; possessing or indicating the same temperature at the same depth.",
  ...
  "inextricable": "1. Incapable of being extricated, untied, or disentangled; hopelessly intricate, confused, or obscure; as, an inextricable knot or difficulty; inextricable confusion. Lost in the wild, inextricable maze. Blackmore. 2. Inevitable. [R.] \"Fate inextricable.\" Milton.",
  "iulidan": "One of the Iulidæ, a family of myriapods, of which the genus Iulus is the type. See Iulus.",
  "indigest": "Crude; unformed; unorganized; undigested. [Obs.] \"A chaos rude and indigest.\" W. Browne. \"Monsters and things indigest.\" Shak.\n\nSomething indigested. [Obs.] Shak.",
  "ice-built": "1. Composed of ice. 2. Loaded with ice. \"Ice-built mountains.\" Gray.",
  "idiopathy": "1. A peculiar, or individual, characteristic or affection. All men are so full of their own fancies and idiopathies, that they scarce have the civility to interchange any words with a stranger. Dr. H. More. 2. (Med.)  A morbid state or condition not preceded or occasioned by any other disease; a primary disease.",
  "interventor": "One who intervenes; a mediator; especially (Eccles. Hist.), a person designated by a church to reconcile parties, and unite them in the choice of officers. Coleman.",
  ...
  "ictus": "1. (Pros.)  The stress of voice laid upon accented syllable of a word. Cf. Arsis. 2. (Med.)  A stroke or blow, as in a sunstroke, the sting of an insect, pulsation of an artery, etc.",
  "inboard": "1. (Naut.)  Inside the line of a vessel's bulwarks or hull; the opposite of outboard; as, an inboard cargo; haul the boom inboard. 2. (Mech.)  From without inward; toward the inside; as, the inboard stroke of a steam engine piston, the inward or return stroke.",
  "inculcation": "A teaching and impressing by frequent repetitions. Bp. Hall.",
  "indemnification": "1. The act or process of indemnifying, preserving, or securing against loss, damage, or penalty; reimbursement of loss, damage, or penalty; the state of being indemnified. Indemnification is capable of some estimate; dignity has no standard. Burke. 2. That which indemnifies. No reward with the name of an indemnification. De Quincey.",
  ...
  "interloper": "One who interlopes; one who interlopes; one who unlawfully intrudes upon a property, a station, or an office; one who interferes wrongfully or officiously. The untrained man, . . . the interloper as to the professions. I. Taylor.",
  "itacolumite": "A laminated, granular, siliceous rocks, often occurring in regions where the diamond is found.",
  ...
  "illuminating": "Giving or producing light; used for illumination. Illuminating gas. See Gas, n., 2 (a).",
  "inconvertibleness": "Inconvertibility.",
  "iatraliptic": "Treating diseases by anointing and friction; as, the iatraliptic method. [Written also iatroleptic.]",
  ...
  "insphere": "To place in, or as in, an orb a sphere. Cf. Ensphere. Bright aërial spirits live insphered In regions mild of calm and serene air. Milton.",
  "ill-looking": "Having a bad look; threatening; ugly. See Note under Ill, adv.",
  "immunity": "1. Freedom or exemption from any charge, duty, obligation, office, tax, imposition, penalty, or service; a particular privilege; as, the immunities of the free cities of Germany; the immunities of the clergy. 2. Freedom; exemption; as, immunity from error.",
  "impluvium": "In Roman dwellings, a cistern or tank, set in the atrium or peristyle to recieve the water from the roof, by means of the compluvium; generally made ornamental with flowers and works of art around its birm.",
  "inserve": "To be of use to an end; to serve. [Obs.]",
  "ischiocapsular": "Of or pertaining to the ischium and the capsule of the hip joint; as, the ischiocapsular ligament.",
  "idyllic": "Of or belonging to idyls. I. E. I. e.  Abbreviation of Latin id est, that is.",
  "incontinent": "1. Not continent; uncontrolled; not restraining the passions or appetites, particularly the sexual appetite; indulging unlawful lust; unchaste; lewd. 2. (Med.)  Unable to restrain natural evacuations.\n\nOne who is unchaste. B. Jonson.\n\nIncontinently; instantly immediately. [Obs.] He says he will return incontinent. Shak.",
  ...
  "islam": "1. The religion of the Mohammedans; Mohammedanism; Islamism. Their formula of faith is: There is no God but Allah, and Mohammed is his prophet. 2. The whole body of Mohammedans, or the countries which they occupy.",
  ...
  "instill": "To drop in; to pour in drop by drop; hence, to impart gradually; to infuse slowly; to cause to be imbibed. That starlight dews All silently their tears of love instill. Byron. How hast thou instilled Thy malice into thousands. Milton. Syn. -- To infuse; impart; inspire; implant; inculcate; insinuate.",
  ...
  "inclement": "1. Not clement; destitute of a mild and kind temper; void of tenderness; unmerciful; severe; harsh. 2. Physically severe or harsh (generally restricted to the elements or weather); rough; boisterous; stormy; rigorously cold, etc.; as, inclement weather. Cowper. The guard the wretched from the inclement sky. Pope. Teach us further by what means to shun The inclement seasons, rain, ice, hail, and snow! Milton.",
  "incoherent": "1. Not coherent; wanting cohesion; loose; unconnected; physically disconnected; not fixed to each; -- said of material substances. Woodward. 2. Wanting coherence or agreement; incongruous; inconsistent; having no dependence of one part on another; logically disconnected. \"The same rambling, incoherent manner.\" Bp. Warburton.",
  "isobront": "An imaginary line, or a line on a chart, marking the simultaneous development of a thunderstorm, as noted by observing the time when the thunder is heard at different places.",
  "interregnum": "1. The time during which a throne is vacant between the death or abdication of a sovereign and the accession of his successor. 2. Any period during which, for any cause, the executive branch of a government is suspended or interrupted.",
  "interruption": "1. The act of interrupting, or breaking in upon. 2. The state of being interrupted; a breach or break, caused by the abrupt intervention of something foreign; intervention; interposition. Sir M. Hale. Lest the interruption of time cause you to lose the idea of one part. Dryden. 3. Obstruction caused by breaking in upon course, current, progress, or motion; stop; hindrance; as, the author has met with many interruptions in the execution of his work; the speaker or the argument proceeds without interruption. 4. Temporary cessation; intermission; suspension.",
  ...
  "ishmaelite": "1. A descendant of Ishmael (the son of Abraham and Hagar), of whom it was said, \"His hand will be against every man, and every man's hand against him.\" Gen. xvi. 12. 2. One at enmity with society; a wanderer; a vagabond; an outcast. Thackeray. 3. See Ismaelian.",
  ...
  "ileac": "1. (Anat.)  Pertaining to the ileum. [Written also iliac.] 2. See Iliac, 1. [R.] Ileac passion. (Med.) See Ileus.",
  ...
  "interested": "1. Having the attention engaged; having emotion or passion excited; as, an interested listener. 2. Having an interest; concerned in a cause or in consequences; liable to be affected or prejudiced; as, an interested witness.",
  "ingluvious": "Gluttonous. [Obs.] Blount.",
  "impanator": "One who holds the doctrine of impanation.",
  "immew": "See Emmew.",
  "in antis": "Between antæ; -- said of a portico in classical style, where columns are set between two antæ, forming the angles of the building. See Anta.",
  "ineffective": "Not effective; ineffectual; futile; inefficient; useless; as, an ineffective appeal. The word of God, without the spirit, [is] a dead and ineffective letter. Jer. Taylor.",
  ...
  "immolation": "1. The act of immolating, or the state of being immolated, or sacrificed. Sir. T. Browne. 2. That which is immolated; a sacrifice.",
  "improbation": "1. The act of disapproving; disapprobation. 2. (Scots Law)  The act by which falsehood and forgery are proved; an action brought for the purpose of having some instrument declared false or forged. Bell.",
  "inferno": "The infernal regions; hell. Also used fig. At each sudden explosion in the inferno below they sprang back from the brink [of the volcanic crater]. D. C. Worcester.",
  "infrequent": "Seldom happening or occurring; rare; uncommon; unusual. The act whereof is at this day infrequent or out of use among all sorts of men. Sir T. Elyot.",
  "inust": "Burnt in. [Obs.]",
  "involuntary": "1. Not having will of the power of choice. 2. Not under the influence or control of the will; not voluntary; as, the involuntary movements of the body; involuntary muscle fibers. 3. Not proceeding from choice; done unwillingly; reluctant; compulsory; as, involuntary submission.",
  ...
  "instantly": "1. Without the least delay or interval; at once; immediately. Macaulay. 2. With urgency or importunity; earnestly; pressingly. \"They besought him instantly.\" Luke vii. 4. Syn. -- Directly; immediately; at once. See Directly.",
  ...
  "insignificance": "1. The condition or quality of being insignificant; want of significance, sense, or meaning; as, the insignificance of words or phrases. 2. Want of force or effect; unimportance; pettiness; inefficacy; as, the insignificance of human art. 3. Want of claim to consideration or notice; want of influence or standing; meanness. Reduce him, from being the first person in the nation, to a state of insignificance. Beattie.",
  ...
  "isethionic": "Pertaining to, derived from, or designating, an acid, HO.C2H4.SO3H, obtained as an oily or crystalline substance, by the action of sulphur trioxide on alcohol or ether. It is derivative of sulphuric acid.",
  "ichthyophagist": "One who eats, or subsists on, fish.",
  "irrelavant": "Not relevant; not applicable or pertinent; not bearing upon or serving to support; foreign; extraneous; as, testimony or arguments irrelevant to a case. -- Ir*rel\"a*vant*ly, adv.",
  "inflexibly": "In an inflexible manner.",
  "infusibleness": "Infusibility.",
  "incorruptible": "1. Not corruptible; incapable of corruption, decay, or dissolution; as, gold is incorruptible. Our bodies shall be changed into incorruptible and immortal substances. Wake. 2. Incapable of being bribed or morally corrupted; inflexibly just and upright.\n\nOne of a religious sect which arose in Alexandria, in the reign of the Emperor Justinian, and which believed that the body of Christ was incorruptible, and that he suffered hunger, thirst, pain, only in appearance.\n\nThe quality or state of being incorruptible. Boyle.",
  "intellectualist": "1. One who overrates the importance of the understanding. [R.] Bacon. 2. One who accepts the doctrine of intellectualism.",
  ...
  "idealism": "1. The quality or state of being ideal. 2. Conception of the ideal; imagery. 3. (Philos.)  The system or theory that denies the existence of material bodies, and teaches that we have no rational grounds to believe in the reality of anything but ideas and their relations.",
  ...
  "impletion": "1. The act of filling, or the state of being full. Sir T. Browne. 2. That which fills up; filling. Coleridge.",
  "interatomic": "Between atoms; situated, or acting, between the atoms of bodies; as, interatomic forces.",
  ...
  "idumean": "Of or pertaining to ancient Idumea, or Edom, in Western Asia. -- n.  An inhabitant of Idumea, an Edomite.",
  ...
  "illuminate": "1. To make light; to throw light on; to supply with light, literally or figuratively; to brighten. 2. To light up; to decorate with artificial lights, as a building or city, in token of rejoicing or respect. 3. To adorn, as a book or page with borders, initial letters, or miniature pictures in colors and gold, as was done in manuscripts of the Middle Ages. 4. To make plain or clear; to dispel the obscurity to by knowledge or reason; to explain; to elucidate; as, to illuminate a text, a problem, or a duty.\n\nTo light up in token or rejoicing.\n\nEnlightened. Bp. Hall.\n\nOne who enlightened; esp., a pretender to extraordinary light and knowledge.",
  ...
  "intersternal": "Between the sternal; -- said of certain membranes or parts of insects and crustaceans.",
  ...
  "impendence": "The state of impending; also, that which impends. \"Impendence of volcanic cloud.\" Ruskin.",
  "informal": "1. Not in the regular, usual, or established form; not according to official, conventional, prescribed, or customary forms or rules; irregular; hence, without ceremony; as, an informal writting, proceeding, or visit. 2. Deranged in mind; out of one's senses. [Obs.] These poor informal women. Shak.",
  ...
  "iodothyrin": "A peculiar substance obtained from the thyroid gland, containing from nine to ten per cent of iodine. It is a very stable compound, and is believed to be active principle in thyroid extracts and in the internal secretion of the thyroid gland. It was originally called thyroiodin.",
  ...
  "iridosmine": "The native compound of iridium and osmium. It is found in flattened metallic grains of extreme hardness, and is often used for pointing gold pens.",
  "incognizant": "Not cognizant; failing to apprehended or notice. Of the several operations themselves, as acts of volition, we are wholly incognizant. Sir W. Hamilton.",
  ...
  "ist": "A noun suffix denoting an agent, or doer, one who practices, a believer in; as, theorist, one who theorizes; socialist, one who holds to socialism; sensualist, one given to sensuality. IS'T Is't.  A contraction of is it.",
  "illuminator": "1. One whose occupation is to adorn books, especially manuscripts, with miniatures, borders, etc. See Illuminate, v. t., 3. 2. A condenser or reflector of light in optical apparatus; also, an illuminant.",
  "iceman": "1. A man who is skilled in traveling upon ice, as among glaciers. 2. One who deals in ice; one who retails or delivers ice.",
  ...
  "intemerate": "Pure; undefiled. [Obs.]",
  "inducible": "1. Capable of being induced, caused, or made to take place. 2. Obtainable by induction; derivable; inferable.",
  ...
  "inhospitable": "1. Not hospitable; not disposed to show hospitality to strangers or guests; as, an inhospitable person or people. Have you no touch of pity, that the poor Stand starved at your inhospitable door Cowper. 2. Affording no shelter or sustenance; barren; desert; bleak; cheerless; wild. \"Inhospitable wastes.\" Blair. -- In*hos\"pi*ta*ble*mess, n. -- In*hos\"pi*ta*bly, adv.",
  "impaction": "1. (Surg.)  The driving of one fragment of bone into another so that the fragments are not movable upon each other; as, impaction of the skull or of the hip. 2. An immovable packing; (Med.), a lodgment of something in a strait or passage of the body; as, impaction of the fetal head in the strait of the pelvis; impaction of food or feces in the intestines of man or beast.",
  ...
  "infrequence": "1. The state of rarely occuring; uncommonness; rareness; as, the infrquence of his visits. 2. The state of not being frequented; solitude; isolation; retirement; seclusion. [R.] The solitude and infrequency of the place. Bp. Hall.",
  ...
  "intracellular": "Within a cell; as, the intracellular movements seen in the pigment cells, the salivary cells, and in the protoplasm of some vegetable cells.",
  ...
  "interminable": "Without termination; admitting no limit; boundless; endless; wearisomely protracted; as, interminable space or duration; interminable sufferings. That wild interminable waste of waves. Grainger. Syn. -- Boundless; endless; limitless; illimitable; immeasurable; infinite; unbounded; unlimited.",
  "ingena": "The gorilla.",
  "inchoative": "Expressing or pertaining to a beginning; inceptive; as, an inchoative verb. \"Some inchoative or imperfect rays.\" W. Montagu. -- n.  An inchoative verb. See Inceptive.",
  "importune": "1. Inopportune; unseasonable. [Obs.] 2. Troublesome; vexatious; persistent; urgent; hence, vexatious on account of untimely urgency or perinacious solicitation. [Obs.] And their importune fates all satisfied. Spenser. Of all other affections it [envy] is the most importune and continual. Bacon.\n\n1. To request or solicit, with urgency; to press with frequent, unreasonable, or troublesome application or pertinacity; hence, to tease; to irritate; to worry. Their ministers and residents here have perpetually importuned the court with unreasonable demands. Swift. 2. To import; to signify. [Obs.] \"It importunes death.\" Spenser.\n\nTo require; to demand. [Obs.] We shall write to you, As time and our concernings shall importune. Shak.",
  "intercommunity": "Intercommunication; community of possessions, religion, etc. In consequence of that intercommunity of paganism . . . one nation adopted the gods of another. Bp. Warburton.",
  "impugn": "To attack by words or arguments; to contradict; to assail; to call in question; to make insinuations against; to gainsay; to oppose. The truth hereof I will net rashly pugn, or overboldly affirm. Peacham.",
  "indulge": "1. To be complacent toward; to give way to; not to oppose or restrain; (a) when said of a habit, desire, etc.: to give free course to; to give one's self up to; as, to indulge sloth, pride, selfishness, or inclinations; (b) when said of a person: to yield to the desire of; to gratify by compliance; to humor; to withhold restraint from; as, to indulge children in their caprices or willfulness; to indulge one's self with a rest or in pleasure. Hope in another life implies that we indulge ourselves in the gratifications of this very sparingly. Atterbury. 2. To grant as by favor; to bestow in concession, or in compliance with a wish or request. Persuading us that something must be indulged to public manners. Jer. Taylor. Yet, yet a moment, one dim ray of light Indulge, dread Chaos, and eternal Night! Pope. Note: It is remarked by Johnson, that if the matter of indulgence is a single thing, it has with before it; if it is a habit, it has in; as, he indulged himself with a glass of wine or a new book; he indulges himself in idleness or intemperance. See Gratify.\n\nTo indulge one's self; to gratify one's tastes or desires; esp., to give one's self up (to); to practice a forbidden or questionable act without restraint; -- followed by in, but formerly, also, by to. \"Willing to indulge in easy vices.\" Johnson.",
  ...
  "intestate": "1. Without having made a valid will; without a will; as, to die intestate. Blackstone. Airy succeeders of intestate joys. Shak. 2. Not devised or bequeathed; not disposed of by will; as, an intestate estate.\n\nA person who dies without making a valid will. Blackstone.",
  ...
  "inlet": "1. A passage by which an inclosed place may be entered; a place of ingress; entrance. Doors and windows,inlets of men and of light. Sir H. Wotton. 2. A bay or recess,as in the shore of a sea, lake, or large river; a narrow strip of water running into the land or between islands. 3. That which is let in or inland; an inserted material. Note: Inlet is also usewd adjectively,as in inlet pipe, inlet valve, etc.",
  "indistinctive": "Having nothing distinctive; common. -- In`dis*tinc\"tive*ness, n.",
  "inhume": "1. To deposit, as a dead body, in the earth; to bury; to inter. Weeping they bear the mangled heaps of slain, Inhume the natives in their native plain. Pope. 2. To bury or place in warm earth for chemical or medicinal purposes.",
  ...
  "inclinatory": "Having the quality of leaning or inclining; as, the inclinatory needle. -- In*clin\"a*to*ri*ly, adv. Sir T. Browne.",
  ...
  "inconsolable": "Not consolable; incapable of being consoled; grieved beyond susceptibility of comfort; disconsolate. Dryden. With inconsolable distress she griev'd, And from her cheek the rose of beauty fied. Falconer. -- In`con*sol\"a*ble*ness, n. -- In`con*sol\"a*bly, adv.",
  ...
  "infectious": "1. Having qualities that may infect; communicable or caused by infection; pestilential; epidemic; as, an infectious fever; infectious clothing; infectious air; infectious vices. Where the infectious pestilence. Shak. 2. Corrupting, or tending to corrupt or contaminate; vitiating; demoralizing. It [the court] is necessary for the polishing of manners . . . but it is infectious even to the best morals to live always in it. Dryden. 3. (Law)  Contaminating with illegality; exposing to seizure and forfeiture. Contraband articles are said to be of an infectious nature. Kent. 4. Capable of being easily diffused or spread; sympathetic; readily communicated; as, infectious mirth. The laughter was so genuine as to be infectious. W. Black. Syn. -- See Contagious.",
  "instructer": "See Instructor.",
  "io": "An exclamation of joy or triumph; -- often interjectional.",
  "intrepidity": "The quality or state of being intrepid; fearless bravery; courage; resoluteness; valor. Sir Roger had acquitted himself of two or three sentences with a look of much business and great intrepidity. Addison. Syn. -- Courage; heroism; bravery; fortitude; gallantry; valor. See Courage, Heroism.",
  "independency": "1. Independence. \"Give me,\" I cried (enough for me), \"My bread, and independency!\" Pope. 2. (Eccl.)  Doctrine and polity of the Independents.",
  ...
  "inoperative": "Not operative; not active; producing no effects; as, laws renderd inoperative by neglect; inoperative remedies or processes.",
  ...
  "incommensurate": "1. Not commensurate; not admitting of a common measure; incommensurable. 2. Not of equal of sufficient measure or extent; not adequate; as, our means are incommensurate to our wants. Syn. -- Inadequate; insufficient; disproportionate. -- In`com*men\"su*rate*ly, adv. -- In`com*men\"su*rate*ness, n.",
  ...
  "impurple": "To color or tinge with purple; to make red or reddish; to purple; as, a field impurpled with blood. Impurpled with celestial roses, smiled. Milton. The silken fleece impurpled for the loom. Pope.",
  ...
  "idiopathical": "Pertaining to idiopathy; characterizing a disease arising primarily, and not in consequence of some other disease or injury; -- opposed to symptomatic, sympathetic, and traumatic. -- Id`i*o*path\"ic*al*ly, adv.",
  ...
  "isohyetose": "Of or pertaining to lines connecting places on the earth's surface which have a mean annual rainfall. -- n.  An isohyetose line.",
  ...
  "inexpressive": "1. Inexpressible. [R.] 2. Without expression or meaning; not expressive; dull; unintelligent; as, an inexpressive countenance.",
  ...
  "immaculate": "Without stain or blemish; spotless; undefiled; clear; pure. Were but my soul as pure From other guilt as that, Heaven did not hold One more immaculate. Denham. Thou sheer, immaculate and silver fountain. Shak. Immaculate conception (R. C. Ch.), the doctrine that the Virgin Mary was conceived without original sin. -- Im*mac\"u*late*ly, adv. -- Im*mac\"u*late*ness, n.",
  "individually": "1. In an individual manner or relation; as individuals; separately; each by itself. \"Individually or collectively.\" Burke. How should that subsist solitarily by itself which hath no substance, but individually the very same whereby others subsist with it Hooker. 2. In an inseparable manner; inseparably; incommunicably; indivisibly; as, individuallyhe same. [Omniscience], an attribute individually proper to the Godhead. Hakewill.",
  "ineradicably": "So as not to be eradicable.",
  "inaccuracy": "1. The quality of being inaccurate; want of accuracy or exactness. 2. That which is inaccurate or incorrect; mistake; fault; defect; error; as, in inaccuracy in speech, copying, calculation, etc.",
  "infumed": "Dried in smoke; smoked.",
  "ich": "I. [Obs.] Chaucer. Note: In the Southern dialect of Early English this is the regular form. Cf. Ik.",
  ...
  "injector": "1. One who, or that which, injects. 2. (Mach.)  A contrivance for forcing feed water into a steam boiler by the direct action of the steam upon the water. The water is driven into the boiler by the impulse of a jet of the steam which becomes condensed as soon as it strikes the stream of cold water it impels; - - also called Giffard's injector, from the inventor.",
  ...
  "indirectly": "In an direct manner; not in a straight line or course; not in express terms; obliquely; not by direct means; hence, unfairly; wrongly. To tax it indirectly by taxing their expense. A. Smith. Your crown and kingdom indirectly held. Shak.",
  "inelegancy": "1. The quality of being inelegant; want of elegance or grace; want of refinement, beauty, or polish in language, composition, or manners. The notorious inelegance of her figure. T. Hook. 2. Anything inelegant; as, inelegance of style in literary composition.",
  ...
  "irenics": "That branch of Christian science which treats of the methods of securing unity among Christians or harmony and union among the churches; -- called also Irenical theology. Schaff-Herzog.",
  ...
  "inconsideration": "Want of due consideration; inattention to consequences; inconsiderateness. Blindness of mind, inconsideration, precipitation. Jer. Taylor. Not gross, willful, deliberate, crimes; but rather the effects of inconsideration. Sharp.",
  "indomable": "Indomitable. [Obs.]",
  "impuissant": "Weak; impotent; feeble.",
  "invaginate": "To insert as in a sheath; to pr\n\n(a) Sheathed. (b) Having one portion of a hollow organ drawn back within another portion.",
  ...
  "isonandra": "A genus of sapotaceous trees of India. Isonandra Gutta is the principal source of gutta-percha.",
  ...
  "inebriate": "1. To make drunk; to intoxicate. The cups That cheer but not inebriate. Cowper. 2. Fig.: To disorder the senses of; to exhilarate or elate as if by spirituous drink; to deprive of sense and judgment; also, to stupefy. The inebriating effect of popular applause. Macaulay.\n\nTo become drunk. [Obs.] Bacon.\n\nIntoxicated; drunk; habitually given to drink; stupefied. Thus spake Peter, as a man inebriate and made drunken with the sweetness of this vision, not knowing what he said. Udall.\n\nOne who is drunk or intoxicated; esp., an habitual drunkard; as, an asylum fro inebriates. Some inebriates have their paroxysms of inebriety. E. Darwin.",
  "isodrome": "A method of moving a fleet from one formation to another, the direction usually being changed eight points (90º), by means of paths of equal length for each ship. It is prohibited in the United States navy.",
  ...
  "interstapedial": "Pertaining to a part of the columella of the ear, between the stapes and the mediostapedial. -- n.  The interstapedial part of the columella.",
  "incumbency": "1. The state of being incumbent; a lying or resting on something. 2. That which is physically incumbent; that which lies as a burden; a weight. Evelyn. 3. That which is morally incumbent, or is imposed, as a rule, a duty, obligation, or responsibility. \"The incumbencies of a family.\" Donne. 4. The state of holding a benefice; the full possession and exercise of any office. These fines are only to be paid to the bishop during his incumbency. Swift.",
  ...
  "ichthyornis": "An extinct genus of toothed birds found in the American Cretaceous formation. It is remarkable for having biconcave vertebræ, and sharp, conical teeth set in sockets. Its wings were well developed. It is the type of the order Odontotormæ.",
  "immolate": "To sacrifice; to offer in sacrifice; to kill, as a sacrificial victim. Worshipers, who not only immolate to them [the deities] the lives of men, but . . . the virtue and honor of women. Boyle.",
  ...
  "intranuclear": "Within the nucleus of a cell; as. the intranuclear network of fibrils, seen in the first stages of karyokinesis.",
  "insomuch": "So; to such a degree; in such wise; -- followed by that or as, and formerly sometimes by both. Cf. Inasmuch. Insomusch as that field is called . . . Aceldama. Acts i. 19. Simonides was an excellent poet, insomuch that he made his fortune by it. L'Estrange.",
  "imploring": "That implores; beseeching; entreating. -- Im*plor\"ing*ly, adv.",
  "imagery": "1. The work of one who makes images or visible representation of objects; imitation work; images in general, or in mass. \"Painted imagery.\" Shak. In those oratories might you see Rich carvings, portraitures, and imagery. Dryden. 2. Fig.: Unreal show; imitation; appearance. What can thy imagery of sorrow mean Prior. 3. The work of the imagination or fancy; false ideas; imaginary phantasms. The imagery of a melancholic fancy. Atterbury. 4. Rhetorical decoration in writing or speaking; vivid descriptions presenting or suggesting images of sensible objects; figures in discourse. I wish there may be in this poem any instance of good imagery. Dryden.",
  ...
  "insularity": "1. The state or quality of being an island or consisting of islands; insulation. The insularity of Britain was first shown by Agricola, who sent his fleet round it. Pinkerton. 2. Narrowness or illiberality of opinion; prejudice; exclusiveness; as, the insularity of the Chinese or of the aristocracy.",
  "insatiately": "Insatiably. Sir T. Herbert.",
  "irreplevisable": "Not capable of being replevied.",
  "iconomania": "A mania or infatuation for icons, whether as objects of devotion, bric-a-brac, or curios.",
  ...
  "impenitence": "The condition of being impenitent; failure or refusal to repent; hardness of heart. He will advance from one degree of wickedness and impenitence to another. Rogers.",
  ...
  "irrelate": "Ir",
  "ingle": "Flame; blaze; a fire; a fireplace. [Obs. or Scot.] Burns. Ingle nock, the chimney corner. -- Ingle side, Ingle cheek, the fireside.\n\nA paramour; a favourite; a sweetheart; an engle. [Obs.] Toone.\n\nTo cajole or coax; to wheedle. See Engle. [Obs.]",
  "ingross": "See Engross.",
  "irresistible": "That can not be successfully resisted or opposed; superior to opposition; resistless; overpowering; as, an irresistible attraction. An irresistible law of our nature impels us to seek happiness. J. M. Mason.",
  "isodimorphous": "Having the quality of isodimorphism.",
  "itaconic": "Pertaining to, or designating, an acid, C5H6O4, which is obtained as a white crystalline substance by decomposing aconitic and other organic acids.",
  "identism": "The doctrine taught by Schelling, that matter and mind, and subject and object, are identical in the Absolute; -- called also the system or doctrine of identity.",
  "immensive": "Huge. [Obs.] Herrick.",
  "incantation": "1. The act or process of using formulas sung or spoken, with occult ceremonies, for the purpose of raising spirits, producing enchantment, or affecting other magical results; enchantment. \"Mysterious ceremony and incantation.\" Burke. 2. A formula of words used as above.",
  ...
  "insolvency": "(a) The condition of being insolvent; the state or condition of a person who is insolvent; the condition of one who is unable to pay his debts as they fall due, or in the usual course of trade and business; as, a merchant's insolvency. (b) Insufficiency to discharge all debts of the owner; as, the insolvency of an estate. Act of insolvency. See Insolvent law under Insolvent, a.",
  "interscendent": "Having exponents which are radical quantities; -- said of certain powers; as, xsq. root2, or xsq. roota. Interscedent series, a series whose terms are interscendent quantities. Hutton.",
  "iambically": "In a iambic manner; after the manner of iambics.",
  "interjectional": "1. Thrown in between other words or phrases; parenthetical; ejaculatory; as, an interjectional remark. 2. Pertaining to, or having the nature of, an interjection; consisting of natural and spontaneous exclamations. Certain of the natural accompaniments of interjectional speech, such as gestures, grimaces, and gesticulations, are restrained by civilization. Earle.",
  ...
  "inefficacious": "Not efficacious; not having power to produce the effect desired; inadequate; incompetent; inefficient; impotent. Boyle. The authority of Parliament must become inefficacious . . . to restrain the growth of disorders. Burke. Note: Ineffectual, says Johnson, rather denotes an actual failure, and inefficacious and habitual impotence to any effect. But the distinction is not always observed, nor can it be; for we can not always know whether means are inefficacious till experiment has proved them ineffectual. Inefficacious is therefore sometimes synonymous with ineffectual.",
  "isatin": "An orange-red crystalline substance, C8H5NO2, obtained by the oxidation of indigo blue. It is also produced from certain derivatives of benzoic acid, and is one important source of artificial indigo. [Written also, less properly, isatine.]",
  "inductance coil": "A choking coil.",
  "ironheads": "A European composite herb (Centaurea nigra); -- so called from the resemblance of its knobbed head to an iron ball fixed on a long handle. Dr. Prior.",
  "incalescency": "Incalescence. Ray.",
  "intrinse": "Tightly drawn; or (perhaps) intricate. [Very rare] Like rats, oft bite the holy cords atwain, Which are too intrinse to unloose. Shak.",
  "inable": "See Enable.",
  ...
  "incomprehensibility": "The quality of being incomprehensible, or beyond the reach of human intellect; incomprehensibleness; inconceivability; inexplicability. The constant, universal sense of all antiquity unanimously confessing an incomprehensibility in many of the articles of the Christian faith. South.",
  ...
  "isogeothermal": "Pertaining to, having the nature of, or marking, isogeotherms; as, an isogeothermal line or surface; as isogeothermal chart. -- n.  An isogeotherm.",
  ...
  "indisputable": "Not disputable; incontrovertible; too evident to admit of dispute. Syn. -- Incontestable; unquestionable; incontrovertible; undeniable; irrefragable; certain; positive; undoubted; sure; infallible. -- In*dis\"pu*ta*ble*ness, n. -- In*dis\"pu*ta*bly, adv.",
  "injoin": "See Enjoin.",
  ...
  "inexhausted": "Not exhausted; not emptied; not spent; not having lost all strength or resources; unexhausted. Dryden.",
  ...
  "interaction": "1. Intermediate action. 2. Mutual or reciprocal action or influence; as, the interaction of the heart and lungs on each other.",
  "ilixanthin": "A yellow dye obtained from the leaves of the holly.",
  "ill-natured": "1. Of habitual bad temper; peevish; fractious; cross; crabbed; surly; as, an ill-natured person. 2. Dictated by, or indicating, ill nature; spiteful. \"The ill-natured task refuse.\" Addison. 3. Intractable; not yielding to culture. [R.] \"Ill-natured land.\" J. Philips. -- Ill`-na\"tured*ly, adv. -- Ill`-na\"tured*ness, n.",
  "impatronize": "To make lord or master; as, to impatronize one's self of a seigniory. [R.] Bacon.",
  "iodous": "Pertaining to, or containing, iodine. See -ous (chemical suffix). Iodous acid, a hypothetical acid, analogous to chlorous acid.",
  ...
  "intermembral": "Between members or limbs; as, intermembral homology, the correspondence of the limbs with each other.",
  "irrepealable": "Not repealable; not capable of being repealed or revoked, as a law. -- Ir`re*peal\"a*ble*ness, n. -- Ir`re*peal\"a*bly, adv.",
  "immigration": "The act of immigrating; the passing or coming into a country for the purpose of permanent residence. The immigrations of the Arabians into Europe. T. Warton.",
  "indocible": "Incapable of being taught, or not easily instructed; dull in intellect; intractable; unteachable; indocile. Bp. Hall. -- In*doc\"i*ble*ness, n.",
  "inconsiderate": "1. Not considerate; not attentive to safety or to propriety; not regarding the rights or feelings of others; hasty; careless; thoughtless; heedless; as, the young are generally inconsiderate; inconsiderate conduct. It is a very unhappy token of our corruption, that therinconsiderate among us as to sacrifice morality to politics. Addison. 2. Inconsiderable. [Obs.] E. Terry. Syn. -- Thoughtless; inattentive; inadvertent; heedless; negligent; improvident; careless; imprudent; indiscreet; incautious; injudicious; rash; hasty.",
  "inability": "The quality or state of being unable; lack of ability; want of sufficient power, strength, resources, or capacity. It is not from an inability to discover what they ought to do, that men err in practice. Blair. Syn. -- Impotence; incapacity; incompetence; weakness; powerlessness; incapability. See Disability.",
  ...
  "informant": "1. One who, or that which, informs, animates, or vivifies. [Obs.] Glanvill. 2. One who imparts information or instruction. 3. One who offers an accusation; an informer. See Informer. [Obs. or R.] It was the last evidence of the kind; the informant was hanged. Burke.",
  "ischiocerite": "The third joint or the antennæ of the Crustacea.",
  "isonephelic": "Having, or indicating, an equal amount of cloudiness for a given period; as, isonephelic regions; an isonephelic line.",
  ...
  "importunate": "1. Troublesomely urgent; unreasonably solicitous; overpressing in request or demand; urgent; teasing; as, an impotunate petitioner, curiosity. Whewell. 2. Hard to be borne; unendurable. [R.] Donne. -- Im*por\"tu*nate*ly, adv. -- Im*por\"tu*nate*ness, n.",
  "infinitely": "1. Without bounds or limits; beyond or below assignable limits; as, an infinitely large or infinitely small quantity. 2. Very; exceedingly; vastly; highly; extremely. \"Infinitely pleased.\" Dryden.",
  "incredulous": "1. Not credulous; indisposed to admit or accept that which is related as true, skeptical; unbelieving. Bacon. A fantastical incredulous fool. Bp. Wilkins. 2. Indicating, or caused by, disbelief or incredulity. \"An incredulous smile.\" Longfellow. 3. Incredible; not easy to be believed. [R.] Shak.",
  ...
  "icy-pearled": "Spangled with ice. Mounting up in icy-pearled car. Milton. I'D I'd  . A contraction from I would or I had.",
  ...
  "innervate": "To supply with nerves; as, the heart is innervated by pneumogastric and sympathetic branches.",
  ...
  "indistinctness": "The quality or condition of being indistinct; want of definiteness; dimness; confusion; as, the indistinctness of a picture, or of comprehension; indistinctness of vision.",
  "isagogics": "That part of theological science directly preliminary to actual exegesis, or interpretation of the Scriptures.",
  "incisor": "One of the teeth in front of the canines in either jaw; an incisive tooth. See Tooth.\n\nAdapted for cutting; of or pertaining to the incisors; incisive; as, the incisor nerve; an incisor foramen; an incisor tooth.",
  ...
  "international": "1. Between or among nations; pertaining to the intercourse of nations; participated in by two or more nations; common to, or affecting, two or more nations. 2. Of or concerning the association called the International. International code (Naut.), a common system of signaling adopted by nearly all maritime nations, whereby communication may be had between vessels at sea. -- International copyright. See under Copyright. -- International law, the rules regulating the mutual intercourse of nations. International law is mainly the product of the conditions from time to time of international intercourse, being drawn from diplomatic discussion, textbooks, proof of usage, and from recitals in treaties. It is called public when treating of the relations of sovereign powers, and private when of the relations of persons of different nationalities. International law is now, by the better opinion, part of the common law of the land. Cf. Conflict of laws, under Conflict. Wharton.\n\n1. The International; an abbreviated from of the title of the International Workingmen's Association, the name of an association, formed in London in 1864, which has for object the promotion of the interests of the industrial classes of all nations. 2. A member of the International Association.",
  "ichneumonidan": "Of or pertaining to the Ichneumonidæ, or ichneumon flies. -- n.  One of the Ichneumonidæ.",
  ...
  "indiscriminate": "Not discriminate; wanting discrimination; undistinguishing; not making any distinction; confused; promiscuous. \"Blind or indiscriminate forgiveness.\" I. Taylor. The indiscriminate defense of right and wrong. Junius. -- In`dis*crim\"i*nate*ly, adv. Cowper.",
  ...
  "interrogatory": "A formal question or inquiry; esp. (Law), a question asked in writing. Macaulay.\n\nContaining, expressing, or implying a question; as, an interrogatory sentence.",
  "insection": "A cutting in; incisure; incision.",
  "incooerdination": "Want of coördination; lack of harmonious adjustment or action. Incoördination of muscular movement (Physiol.), irregularity in movements resulting from inharmonious action of the muscles in consequence of loss of voluntary control over them.",
  ...
  "intellectualism": "1. Intellectual power; intellectuality. 2. The doctrine that knowledge is derived from pure reason.",
  ...
  "imbosom": "1. To hold in the bosom; to cherish in the heart or affection; to embosom. 2. To inclose or place in the midst of; to surround or shelter; as, a house imbosomed in a grove. \"Villages imbosomed soft in trees.\" Thomson. The Father infinite, By whom in bliss imbosomed sat the Son. Milton.",
  "inca": "(a) An emperor or monarch of Peru before, or at the time of, the Spanish conquest; any member of this royal dynasty, reputed to have been descendants of the sun. (b) pl.  The people governed by the Incas, now represented by the Quichua tribe. Inca dove (Zoöl.), a small dove (Scardafella inca), native of Arizona, Lower California, and Mexico.",
  "incuse": "Cut or stamped in, or hollowed out by engraving. \"Irregular incuse square.\" Dr. W. Smith.\n\nTo form, or mold, by striking or stamping, as a coin or medal.",
  "incalculable": "Not capable of being calculated; beyond calculation; very great. -- In*cal\"cu*la*ble*ness, n. -- In*cal\"cu*la*bly, adv.",
  ...
  "improving": "Tending to improve, beneficial; growing better. -- Im*prov\"ing*ly, adv. Improving lease (Scots Law), an extend lease to induce the tenant to make improvements on the premises.",
  "iodate": "A salt of iodic acid.",
  "incessantly": "Unceasingly; continually. Shak.",
  "isochimal": "Pertaining to, having the nature of, or making, isocheims; as, an isocheimal line; an isocheimal chart.",
  "ichthyopterygia": "See Ichthyosauria.",
  "identifiable": "Capable of being identified.",
  "imbecilitate": "To weaken, as to the body or the mind; to enfeeble. [R.] A. Wilson.",
  "industrious": "1. Given to industry; characterized by diligence; constantly, regularly, or habitually occupied; busy; assiduous; not slothful or idle; -- commonly implying devotion to lawful and useful labor. Frugal and industrious men are commonly friendly to the established government. Sir W. Temple. 2. Steadily and perseveringly active in a particular pursuit or aim; as, he was negligent in business, but industrious in pleasure; an industrious mischief maker. Industrious to seek out the truth of all things. Spenser. -- In*dus\"tri*ous*ly, adv. -- In*dus\"tri*ous*ness, n.",
  ...
  "imboss": "See Emboss.",
  "incomprehensive": "Not comprehensive; not capable of including or of understanding; not extensive; limited. -- In*com`pre*hen\"sive*ly, a. Sir W. Hamilton. -- In*com`pre*hen\"sive*ness, n. T. Warton.",
  ...
  "infarct": "(a) An obstruction or embolus. (b) The morbid condition of a limited area resulting from such obstruction; as, a hemorrhagic infarct.",
  ...
  "infangthef": "The privilege granted to lords of certain manors to judge thieves taken within the seigniory of such lords. Cowell.",
  "infectiously": "In an infectious manner. Shak.",
  "imprese": "A device. See Impresa. An imprese, as the Italians call it, is a device in picture with his motto or word, borne by noble or learned personages. Camden.",
  "indigestible": "1. Not digestible; not readily soluble in the digestive juices; not easily convertible into products fitted for absorption. 2. Not digestible in the mind; distressful; intolerable; as, an indigestible simile. T. Warton. -- In`di*gest\"i*ble*ness, n. -- In`di*gest\"i*bly, adv.",
  "impregnable": "Not to be stormed, or taken by assault; incapable of being subdued; able to resist attack; unconquerable; as, an impregnable fortress; impregnable virtue. The man's affection remains wholly unconcerned and impregnable. South. -- Im*preg\"na*ble*ness, n. -- Im*preg\"na*bly, adv.\n\nCapable of being impregnated, as the egg of an animal, or the ovule of a plant.",
  "indistinction": "Want of distinction or distinguishableness; confusion; uncertainty; indiscrimination. The indistinction of many of the same name . . . hath made some doubt. Sir T. Browne. An indistinction of all persons, or equality of all orders, is far from being agreeable to the will of God. Sprat.",
  ...
  "impoundage": "1. The act of impounding, or the state of being impounded. 2. The fee or fine for impounding.",
  "incarceration": "1. The act of confining, or the state of being confined; imprisonment. Glanvill. 2. (Med.) (a) Formerly, strangulation, as in hernia. (b) A constriction of the hernial sac, rendering it irreducible, but not great enough to cause strangulation.",
  ...
  "internationalism": "1. The state or principles of international interests and intercourse. 2. The doctrines or organization of the International.",
  "insistent": "1. Standing or resting on something; as, an insistent wall. Sir H. Wotton. 2. Insisting; persistent; persevering. 3. (Zoöl.)  See Incumbent.",
  "intitle": "See Entitle.",
  ...
  "incompact": "Not compact; not having the parts firmly united; not solid; incoherent; loose; discrete. Boyle.",
  "ideo-motor": "Applied to those actions, or muscular movements, which are automatic expressions of dominant ideas, rather than the result of distinct volitional efforts, as the act of expressing the thoughts in speech, or in writing, while the mind is occupied in the composition of the sentence. Carpenter.",
  "irresistance": "Nonresistance; passive submission.",
  "intellected": "Endowed with intellect; having intellectual powers or capacities. [R.] In body, and in bristles, they became As swine, yet intellected as before. Cowper.",
  ...
  "impracticability": "1. The state or quality of being impracticable; infeasibility. Goldsmith. 2. An impracticable thing. 3. Intractableness; stubbornness.",
  ...
  "interim": "1. The meantime; time intervening; interval between events, etc. All the interim is Like a phantasms, or a hideous dream. Shak. 2. (Hist.)  A name given to each of three compromises made by the emperor Charles V. of Germany for the sake of harmonizing the connecting opinions of Protestants and Catholics.",
  "iridescence": "Exhibition of colors like those of the rainbow; the quality or state of being iridescent; a prismatic play of color; as, the iridescence of mother-of-pearl.",
  "intergrave": "To grave or carve between; to engrave in the alternate sections. The work itself of the bases, was intergraven. 3 Kings vii. 28 (Douay version. )",
  "intermittence": "Act or state of intermitting; intermission. Tyndall.",
  "infilm": "To cover with a film; to coat thinly; as, to infilm one metal with another in the process of gilding; to infilm the glass of a mirror. [R.]",
  "inconnection": "Disconnection.",
  "inmew": "To inclose, as in a mew or cage. [R.] \"Inmew the town below.\" Beau. & Fl.",
  "importance": "1. The quality or state of being important; consequence; weight; moment; significance. Thy own importance know, Nor bound thy narrow views to things below. Pope. 2. Subject; matter. [Obs.] Upon importance of so slight and trivial a nature. Shak. 3. Import; meaning; significance. [Obs.] The wisest beholder could not say if the importance were joy or sorrow. Shak. 4. Importunity; solicitation. [Obs.] At our importance hither is he come. Shak.",
  ...
  "imparity": "1. Inequality; disparity; disproportion; difference of degree, rank, excellence, number, etc. Milton. 2. Lack of comparison, correspondence, or suitableness; incongruity. In this region of merely intellectual notion we are at once encountered by the imparity of the object and the faculty employed upon it. I. Taylor. 3. Indivisibility into equal parts; oddness. [R.]",
  ...
  "imperialize": "To invest with imperial authority, character, or style; to bring to the form of an empire. Fuller.",
  ...
  "irredeemable": "Not redeemable; that can not be redeemed; not payable in gold or silver, as a bond; -- used especially of such government notes, issued as currency, as are not convertible into coin at the pleasure of the holder. -- Ir`re*deem\"a*ble*ness, adv.",
  "incognita": "1. A woman who is unknown or in disguise. 2. The state of being in disguise; -- said of a woman.",
  "implicitness": "State or quality of being implicit.",
  "incompletion": "Want of completion; incompleteness. Smart.",
  "inconvertible": "Not convertible; not capable of being transmuted, changed into, or exchanged for, something else; as, one metal is inconvertible into another; bank notes are sometimes inconvertible into specie. Walsh.",
  "incorrectly": "Not correctly; inaccurately; not exactly; as, a writing incorrectly copied; testimony incorrectly stated.",
  ...
  "insignificant": "1. Not significant; void of signification, sense, or import; meaningless; as, insignificant words. 2. Having no weight or effect; answering no purpose; unimportant; valueless; futile. Laws must be insignificant without the sanction of rewards and punishments. Bp. Wilkins. 3. Without weight of character or social standing; mean; contemptible; as, an insignificant person. Syn. -- Unimportant; immaterial; inconsiderable; small; inferior; trivial; mean; contemptible.",
  "interfoliaceous": "At the same node with opposite or whorled leaves, but occupying a position between their places of attachment.",
  ...
  "irvingite": "The common designation of one a sect founded by the Rev. Edward Irving (about 1830), who call themselves the Catholic Apostolic Church. They are highly ritualistic in worship, have an elaborate hierarchy of apostles, prophets, etc., and look for the speedy coming of Christ.",
  ...
  "illegitimate": "1. Not according to law; not regular or authorized; unlawful; improper. 2. Unlawfully begotten; born out of wedlock; bastard; as, an illegitimate child. 3. Not legitimately deduced or inferred; illogical; as, an illegitimate inference. 4. Not authorized by good usage; not genuine; spurious; as, an illegitimate word. Illegitimate fertilization, or Illegitimate union (Bot.), the fertilization of pistils by stamens not of their own length, in heterogonously dimorphic and trimorphic flowers. Darwin.\n\nTo render illegitimate; to declare or prove to be born out of wedlock; to bastardize; to illegitimatize. The marriage should only be dissolved for the future, without illegitimating the issue. Bp. Burnet.",
  ...
  "isostatic": "Subjected to equal pressure from every side; being in hydrostatic equilibrium, as a body submerged in a liquid at rest; pertaining to, or characterized by, isostasy.",
  "ingenious": "1. Possessed of genius, or the faculty of invention; skillful or promp to invent; having an aptitude to contrive, or to form new combinations; as, an ingenious author, mechanic. A man . . . very wise and ingenious in feats of war. Hakluyt. Thou, king, send out For torturers ingenious. Shak. The more ingenious men are, the more apt are they to trouble themselves. Sir W. Temple. 2. Proseeding from, pertaining to, or characterized by, genius or ingenuity; of curious design, structure, or mechanism; as, an ingenious model, or machine; an ingenious scheme, contrivance, etc. Thus men go wrong with an ingenious skill. Cowper. 3. Witty; shrewd; adroit; keen; sagacious; as, an ingenious reply. 4. Mental; intellectual. [Obs.] A course of learning and ingenious studies. Shak.",
  "ignorance": "1. The condition of being ignorant; the want of knowledge in general, or in relation to a particular subject; the state of being uneducated or uninformed. Ignorance is the curse of God, Knowledge the wing wherewith we fly to heaven. Shak. 2. (Theol.)  A willful neglect or refusal to acquire knowledge which one may acquire and it is his duty to have. Book of Common Prayer. Invincible ignorance (Theol.), ignorance beyond the individual's control and for which, therefore, he is not responsible before God.",
  "insultation": "1. The act of insulting; abusive or insolent treatment; insult. [Obs.] Feltham. 2. Exultation. [Obs.] Is. xiv. (heading).",
  "inabusively": "Without abuse.",
  "inactively": "In an inactive manner. Locke.",
  "indispensable": "1. Not dispensable; impossible to be omitted, remitted, or spared; absolutely necessary or requisite. 2. (Eccl.)  Not admitting dispensation; not subject to release or exemption. [R.] The law was moral and indispensable. Bp. Burnet. 3. Unavoidable; inevitable. [Obs.] Fuller.",
  ...
  "incesttuous": "Guilty of incest; involving, or pertaining to, the crime of incest; as, an incestuous person or connection. Shak. Ere you reach to this incestuous love, You must divine and human rights remove. Dryden. -- In*cest\"tu*ous*ly, adv. -- In*cest\"tu*ous*ness, n.",
  ...
  "inquisitional": "Relating to inquiry or inquisition; inquisitorial; also, of or pertaining to, or characteristic of, the Inquisition. All the inquisitional rigor . . . executed upon books. Milton.",
  "inarticulation": "Inarticulateness. Chesterfield.",
  "indwell": "To dwell in; to abide within; to remain in possession. The Holy Ghost became a dove, not as a symbol, but as a constantly indwelt form. Milman.",
  "irreligious": "1. Destitute of religion; not controlled by religious motives or principles; ungodly. Cf. Impiou. Shame and reproach are generally the portion of the impious and irreligious. South. 2. Indicating a want of religion; profane; wicked; as, irreligious speech.",
  ...
  "illicit": "Not permitted or allowed; prohibited; unlawful; as, illicit trade; illicit intercourse; illicit pleasure. One illicit . . . transaction always leads to another. Burke. -- Il*lic\"it*ly, adv. -- Il*lic\"it*ness, n.",
  "iridescent": "Having colors like the rainbow; exhibiting a play of changeable colors; nacreous; prismatic; as, iridescent glass.",
  ...
  "isotherm": "A line connecting or marking points on the earth's surface having the same temperature. This may be the temperature for a given time of observation, or the mean temperature for a year or other period. Also, a similar line based on the distribution of temperature in the ocean.",
  "inexpleably": "Insatiably. [Obs.] Sandys.",
  "inceptor": "1. A beginner; one in the rudiments. Johnson. 2. One who is on the point of taking the degree of master of arts at an English university. Walton.",
  ...
  "immersed": "1. Deeply plunged into anything, especially a fluid. 2. Deeply occupied; engrossed; entangled. 3. (Bot.)  Growing wholly under water. Gray.",
  ...
  "intestable": "Not capable of making a will; not legally qualified or competent to make a testament. Blackstone.",
  "ilium": "The dorsal one of the three principal bones comprising either lateral half of the pelvis; the dorsal or upper part of the hip bone. See Innominate bone, under Innominate. [Written also ilion, and ileum.]",
  ...
  "intendant": "One who has the charge, direction, or management of some public business; a superintendent; as, an intendant of marine; an intendant of finance.\n\nAttentive. [Obs.]",
  ...
  "interlineal": "Contained between lines; written or inserted between lines already written or printed; containing interlineations; as, an interlinear manuscript, translation, etc. -- In`ter*lin\"e*ar*ly, adv.",
  "inexpediency": "The quality or state of being inexpedient; want of fitness; unsuitableness to the end or object; impropriety; as, the inexpedience of some measures. It is not the rigor but the inexpediency of laws and acts of authority which makes them tyrannical. Paley.",
  "insensuous": "Not sensuous; not pertaining to, affecting, or addressing, the senses. That intermediate door Betwixt the different planes of sensuous form And form insensuous. Mrs. Browning.",
  ...
  "indispose": "1. To render unfit or unsuited; to disqualify. 2. To disorder slightly as regards health; to make somewhat. Shak. It made him rather indisposed than sick. Walton. 3. To disincline; to render averse or unfavorable; as, a love of pleasure indisposes the mind to severe study; the pride and selfishness of men indispose them to religious duties. The king was sufficiently indisposed towards the persons, or the principles, of Calvin's disciples. Clarendon.",
  ...
  "ibex": "One of several species of wild goats having very large, recurved horns, transversely ridged in front; -- called also steinbok. Note: The Alpine ibex (Capra ibex) is the best known. The Spanish, or Pyrenean, ibex (C. Hispanica) has smoother and more spreading horns.",
  "indisposedness": "The condition or quality of being indisposed. [R.] Bp. Hall.",
  "iodoform": "A yellow, crystalline, volatile substance, CI3H, having an offensive odor and sweetish taste, and analogous to chloroform. It is used in medicine as a healing and antiseptic dressing for wounds and sores.",
  "italianize": "1. To play the Italian; to speak Italian. Cotgrave. 2. To render Italian in any respect; to Italianate. \"An Englishman Italianized.\" Lowell.",
  "indomptable": "Indomitable. [Obs.] Tooke.",
  "interplay": "Mutual action or influence; interaction; as, the interplay of affection.",
  "indoctrination": "The act of indoctrinating, or the condition of being indoctrinated; instruction in the rudiments and principles of any science or system of belief; information. Sir T. Browne.",
  ...
  "impasse": "An impassable road or way; a  blind alley; cul-de-sac; fig., a position or predicament affording no escape. The issue from the present impasse will, in all probability, proceed from below, not from above. Arnold White.",
  ...
  "inhance": "See Enhance.",
  "insectivora": "1. An order of mammals which feed principally upon insects. Note: They are mostly of small size, and their molar teeth have sharp cusps. Most of the species burrow in the earth, and many of those of cold climates hibernate in winter. The order includes the moles, shrews, hedgehogs, tanrecs, and allied animals, also the colugo. 2. A division of the Cheiroptera, including the common or insect- eating bats.",
  ...
  "impermeable": "Not permeable; not permitting passage, as of a fluid. through its substance; impervious; impenetrable; as, India rubber is impermeable to water and to air. -- Im*per\"me*a*ble*ness, n. -- Im*per\"me*a*bly, adv.",
  ...
  "indo-germanic": "1. Same as Aryan, and Indo-European. 2. Pertaining to or denoting the Teutonic family of languages as related to the Sanskrit, or derived from the ancient Aryan language.",
  ...
  "inviolated": "1. Not violated; uninjured; unhurt; unbroken. His fortune of arms was still inviolate. Bacon. 2. Not corrupted, defiled, or profaned; chaste; pure. \"Inviolate truth.\" Denham. There chaste Alceste lives inviolate. Spenser.",
  "incursion": "1. A running into; hence, an entering into a territory with hostile intention; a temporary invasion; a predatory or harassing inroad; a raid. The Scythian, whose incursions wild Have wasted Sogdiana. Milton. The incursions of the Goths disordered the affairs of the Roman Empire. Arbuthnot. 2. Attack; occurrence. [Obs.] Sins of daily incursion. South. Syn. -- Invasion; inroad; raid; foray; sally; attack; onset; irruption. See Invasion.",
  ...
  "isthmus": "A neck or narrow slip of land by which two continents are connected, or by which a peninsula is united to the mainland; as, the Isthmus of Panama; the Isthmus of Suez, etc. Isthmus of the fauces. (Anat.) See Fauces.",
  ...
  "interact": "A short act or piece between others, as in a play; an interlude; hence, intermediate employment or time. Chesterfield.\n\nTo act upon each other; as, two agents mutually interact. Emerson. Tyndall.",
  "interosculate": "1. To kiss together to touch. See Osculate. 2. (Biol.)  To have the character of, or to lie between, two distinct groups.",
  ...
  "insecurity": "1. The condition or quality of being insecure; want of safety; danger; hazard; as, the insecurity of a building liable to fire; insecurity of a debt. 2. The state of feeling insecure; uncertainty; want of confidence. With what insecurity of truth we ascribe effects . . . unto arbitrary calculations. Sir T. Browne. A time of insecurity, when interests of all sorts become objects of speculation. Burke.",
  "intemperancy": "Intemperance. [Obs.]",
  "initial": "1. Of or pertaining to the beginning; marking the commencement; incipient; commencing; as, the initial symptoms of a disease. 2. Placed at the beginning; standing at the head, as of a list or series; as, the initial letters of a name.\n\nThe first letter of a word or a name.\n\nTo put an initial to; to mark with an initial of initials. [R.]",
  "improvvisatore": "One who composes and sings or recites rhymes and short poems extemporaneously. [Written also improvisatore.]",
  "infuscation": "The act of darkening, or state of being dark; darkness; obscurity. Johnson.",
  "ingenue": "An ingenuous or naïve girl or young woman, or an actress representing such a person.",
  "interpunction": "The insertion of points between word or sentences; punctuation.",
  "inexpedience": "The quality or state of being inexpedient; want of fitness; unsuitableness to the end or object; impropriety; as, the inexpedience of some measures. It is not the rigor but the inexpediency of laws and acts of authority which makes them tyrannical. Paley.",
  "integration": "1. The act or process of making whole or entire. 2. (Math.)  The operation of finding the primitive function which has a given function for its differential coefficient. See Integral. Note: The symbol of integration is summa sum), and the integral is also regarded as the limiting value of the sum of great numbers of differentials, when the magnitude of the differentials decreases, and their number increases indefinitely. See Limit, n. When the summation is made between specified values of the variable, the result is a definite integral, and those values of the variable are the limits of the integral. When the summation is made successively for two or more variables, the result is a multiple integral. 3. In the theory of evolution: The process by which the manifold is compacted into the relatively simple and permanent. It is supposed to alternate with differentiation as an agent in development.",
  "intestinal": "Of or pertaining to the intestines of an animal; as, the intestinal tube; intestinal digestion; intestinal ferments. Intestinal canal. Same as Intestine, n. -- Intestinal worm (Zoöl.), any species of helminth living in the intestinal canal of any animal. The species are numerous.",
  "introit": "1. A going in. Caxton. 2. (R. C. Ch.) (a) A psalm sung or chanted immediately before the collect, epistle, and gospel, and while the priest is entering within the rails of the altar. (b) A part of a psalm or other portion of Scripture read by the priest at Mass immediately after ascending to the altar. 3. (R. C. Ch.)  An anthem or psalm sung before the Communion service. 4. Any composition of vocal music appropriate to the opening of church services.",
  "inglorious": "1. Not glorious; not bringing honor or glory; not accompanied with fame, honor, or celebrity; obscure; humble; as, an inglorious life of ease. Shak. My next desire is, void of care and strife, To lead a soft, secure, inglorious life. Dryden. Some mute inglorious Milton here may rest. Gray. 2. Shameful; disgraceful; ignominious; as, inglorious flight, defeat, etc. Inglorious shelter in an alien land. J. Philips.",
  "inexplicableness": "A state of being inexplicable; inexplicability.",
  "interdental": "1. Situated between teeth; as, an interdental space, the space between two teeth in a gear wheel. 2. (Phon.)  Formed between the upper and lower teeth; as, interdental consonants.",
  "intermit": "To cause to cease for a time, or at intervals; to interrupt; to suspend. Pray to the gods to intermit the plague. Shak.\n\nTo cease for a time or at intervals; to moderate; to be intermittent, as a fever. Pope.",
  ...
  "indophenol": "Any one of a series of artificial blue dyestuffs, resembling indigo in appearance, and obtained by the action of phenol on certain nitrogenous derivatives of quinone. Simple indophenol proper has not yet been isolated.",
  ...
  "implicitly": "1. In an implicit manner; without reserve; with unreserved confidence. Not to dispute the methods of his providence, but humbly and implicitly to acquiesce in and adore them. Atterbury. 2. By implication; impliedly; as, to deny the providence of God is implicitly to deny his existence. Bentley.",
  "inflammableness": "The quality or state of being inflammable; inflammability. Boyle.",
  "iceberg": "A large mass of ice, generally floating in the ocean. Note: Icebergs are large detached portions of glaciers, which in cold regions often project into the sea.",
  "instate": "To set, place, or establish, as in a rank, office, or condition; to install; to invest; as, to instate a person in greatness or in favor. Shak.",
  "indigometry": "The art or method of determining the coloring power of indigo.",
  "insufficient": "1. Not sufficient; not enough; inadequate to any need, use, or purpose; as, the provisions are insufficient in quantity, and defective in quality. \"Insufficient for His praise.\" Cowper. 2. Wanting in strength, power, ability, capacity, or skill; incompetent; incapable; unfit; as, a person insufficient to discharge the duties of an office. Syn. -- Inadequate; scanty; incommensurate; unequal; unfit; incompetent; incapable; inefficient.",
  ...
  "ironbound": "1. Bound as with iron; rugged; as, an ironbound coast. 2. Rigid; unyielding; as, ironbound traditions.",
  ...
  "interpolate": "1. To renew; to carry on with intermission. [Obs.] Motion . . . partly continued and unintermitted, . . . partly interpolated and interrupted. Sir M. Hale. 2. To alter or corrupt by the insertion of new or foreign matter; especially, to change, as a book or text, by the insertion of matter that is new, or foreign to the purpose of the author. How strangely Ignatius is mangled and interpolated, you may see by the vast difference of all copies and editions. Bp. Barlow. The Athenians were put in possession of Salamis by another law, which was cited by Solon, or, as some think, interpolated by him for that purpose. Pope. 3. (Math.)  To fill up intermediate terms of, as of a series, according to the law of the series; to introduce, as a number or quantity, in a partial series, according to the law of that part of the series.",
  ...
  "impresa": "A device on a shield or seal, or used as a bookplate or the like. [Written also imprese and impress.] My impresa to your lordship; a swain Flying to a laurel for shelter. J. Webster.",
  "incredibility": "1. The quality or state of being incredible; incredibleness. Dryden. 2. That which is incredible. Johnson.",
  ...
  "importer": "One who imports; the merchant who brings goods into a country or state; -- opposed to exporter.",
  "insusceptibility": "Want of susceptibility, or of capacity to feel or perceive.",
  "irrefrangible": "Not refrangible; that can not be refracted in passing from one medium to another. -- Ir`re*fran\"gi*ble*ness, n.",
  ...
  "informality": "1. The state of being informal; want of regular, prescribed, or customary form; as, the informality of legal proceedings. 2. An informal, unconventional, or unofficial act or proceeding; something which is not in proper or prescribed form or does not conform to the established rule.",
  "inconceptible": "Inconceivable. [Obs.] Sir M. Hale.",
  "intersect": "To cut into or between; to cut or cross mutually; to divide into parts; as, any two diameters of a circle intersect each other at the center. Lands intersected by a narrow frith Abhor each other. Cowper.\n\nTo cut into one another; to meet and cross each other; as, the point where two lines intersect.",
  "intervention": "1. The act of intervening; interposition. Sound is shut out by the intervention of that lax membrane. Holder. 2. Any interference that may affect the interests of others; especially, of one or more states with the affairs of another; mediation. Let us decide our quarrels at home, without the intervention, of any foreign power. Sir W. Temple. 3. (Civil Law)  The act by which a third person, to protect his own interest, interposes and becomes a party to a suit pending between other parties.",
  ...
  "iroquois": "A powerful and warlike confederacy of Indian tribes, formerly inhabiting Central New York and constituting most of the Five Nations. Also, any Indian of the Iroquois tribes.",
  ...
  "ihlang-ihlang": "A rich, powerful, perfume, obtained from the volatile oil of the flowers of Canada odorata, an East Indian tree. [Also written ylang-ylang.]",
  ...
  "incognizable": "Not cognizable; incapable of being recognized, known, or distinguished. H. Spenser. The Lettish race, not a primitive stock of the Slavi, but a distinct branch, now become incognizable. Tooke.",
  "incondensable": "Not condensable; incapable of being made more dense or compact, or reduced to liquid form.",
  "inconsequence": "The quality or state of being inconsequent; want of just or logical inference or argument; inconclusiveness. Bp. Stillingfleet. Strange, that you should not see the inconsequence of your own reasoning! Bp. Hurd.",
  ...
  "insulation": "1. The act of insulating, or the state of being insulated; detachment from other objects; isolation. 2. (Elec. & Thermotics)  The act of separating a body from others by nonconductors, so as to prevent the transfer of electricity or of heat; also, the state of a body so separated.",
  "isocrymic": "Isocrymal.",
  ...
  "isocyanic": "Designating an acid isomeric with cyanic acid. Isocyanic acid, an acid metameric with cyanic acid, and resembling it in its salts. It is obtained as a colorless, mobile, unstable liquid by the heating cyanuric acid. Called technically carbimide.",
  "infractible": "Capable of being broken.[R.]",
  "instar": "To stud as with stars. [R.] \"A golden throne instarred with gems.\" J. Barlow.",
  "internationalize": "To make international; to cause to affect the mutual relations of two or more nations; as, to internationalize a principle of law, or a philanthropic enterprise.",
  ...
  "invalidity": "1. Want of validity or cogency; want of legal force or efficacy; invalidness; as, the invalidity of an agreement or of a will. 2. Want of health; infirmity. [Obs.] Sir W. Temple.",
  "inbeing": "Inherence; inherent existence. I. Watts.",
  "indefensible": "Not defensible; not capable of being defended, maintained, vindicated, or justified; unjustifiable; untenable; as, an indefensible fortress, position, cause, etc. Men find that something can be said in favor of what, on the very proposal, they thought utterly indefensible. Burke.",
  ...
  "indefinitely": "In an indefinite manner or degree; without any settled limitation; vaguely; not with certainty or exactness; as, to use a word indefinitely. If the world be indefinitely extended, that is, so far as no human intellect can fancy any bound of it. Ray.",
  "iodol": "A crystallized substance of the composition C4I4NH, technically tetra-iodo-pyrrol, used like iodoform.",
  "islamite": "A Mohammedan.",
  "indorsation": "Indorsement. [Obs.]",
  "inductor": "1. The person who inducts another into an office or benefice. 2. (Elec.)  That portion of an electrical apparatus, in which is the inducing charge or current.",
  "interclavicular": "(a) Between the clavicles; as, the interclavicular notch of the sternum. (b) Of or pertaining to the interclavicle.",
  ...
  "incommutable": "Not commutable; not capable of being exchanged with, or substituted for, another. Cudworth. -- In`com*mut\"a*ble*ness, n. -- In`com*mut\"a*bly, adv.",
  "invenom": "See Envenom.",
  ...
  "incompressible": "Not compressible; incapable of being reduced by force or pressure into a smaller compass or volume; resisting compression; as, many liquids and solids appear to be almost incompressible. -- In`com*press\"i*ble*ness, n.",
  ...
  "indefectible": "Not defectible; unfailing; not liable to defect, failure, or decay. An indefectible treasure in the heavens. Barrow. A state of indefectible virtue and happiness. S. Clarke.",
  "immortalize": "1. To render immortal; to cause to live or exist forever. S. Clarke. 2. To exempt from oblivion; to perpetuate in fame. Alexander had no Homer to immortalize his quilty name. T. Dawes.\n\nTo become immortal. [R.]",
  "indecorum": "1. Want of decorum; impropriety of behavior; that in behavior or manners which violates the established rules of civility, custom, or etiquette; indecorousness. 2. An indecorous or becoming action. Young. Syn. -- Indecorum is sometimes synonymous with indecency; but indecency, more frequently than indecorum, is applied to words or actions which refer to what nature and propriety require to be concealed or suppressed. Indecency is the stronger word; indecorum refers to any transgression of etiquette or civility, especially in public.",
  ...
  "incommodious": "Tending to incommode; not commodious; not affording ease or advantage; unsuitable; giving trouble; inconvenient; annoying; as, an incommodious seat; an incommodious arrangement. -- In`com*mo\"di*ous*ly, adv. -- In`com*mo\"di*ous*ness, n.",
  "innerly": "More within. [Obs.] Baret.",
  "ingenite": "Innate; inborn; inbred; inherent; native; ingenerate. [Obs.] It is naturalor ingenite, which comes by some defect of the organs and overmuch brain. Burton.",
  "intemperant": "Intemperate. [Obs.] Such as be intemperant, that is, followers of their naughty appetites and lusts. Udall.",
  ...
  "iwis": "Indeed; truly. See Ywis. [Written also iwys, iwisse, etc.] [Obs.] Ascham. I. W. W. I. W. W. (Abbrev.)  Industrial Workers of the World (the name of two American labor organizations, one of which advocates syndicalism).",
  "iliacal": "Iliac. [R.]",
  ...
  "idless": "Idleness. [Archaic] \"In ydlesse.\" Spenser. And an idlesse all the day Beside a wandering stream. Mrs. Browning.",
  "incorruptive": "Incorruptible; not liable to decay. Akenside.",
  "immersable": "See Immersible.",
  "impatible": "1. Not capable of being borne; impassible. A spirit, and so impatible of material fire. Fuller.",
  ...
  "idiopathic": "Pertaining to idiopathy; characterizing a disease arising primarily, and not in consequence of some other disease or injury; -- opposed to symptomatic, sympathetic, and traumatic. -- Id`i*o*path\"ic*al*ly, adv.",
  "impair": "To make worse; to diminish in quantity, value, excellence, or strength; to deteriorate; as, to impair health, character, the mind, value. Time sensibly all things impairs. Roscommon. In years he seemed, but not impaired by years. Pope. Syn. -- To diminish; decrease; injure; weaken; enfeeble; debilitate; reduce; debase; deteriorate.\n\nTo grow worse; to deteriorate. Milton.\n\nNot fit or appropriate. [Obs.]\n\nDiminution; injury. [Obs.]",
  "instrumentally": "1. By means of an instrument or agency; as means to an end. South. They will argue that the end being essentially beneficial, the means become instrumentally so. Burke. 2. With instruments of music; as, a song instrumentally accompanied. Mason.",
  ...
  "insinuative": "1. Stealing on or into the confidence or affections; having power to gain favor. \"Crafty, insinuative, plausible men.\" Bp. Reynolds. 2. Using insinuations; giving hints; insinuating; as, insinuative remark.",
  ...
  "idiomatical": "Of or pertaining to, or conforming to, the mode of expression peculiar to a language; as, an idiomatic meaning; an idiomatic phrase. -- Id`i*o*mat\"ic*al*ly, adv.",
  ...
  "idiomorphous": "1. Having a form of its own. 2. (Crystallog.)  Apperaing in distinct crystals; -- said of the mineral constituents of a rock.",
  ...
  "iowas": "; sing. Iowa. (Ethnol.) A tribe of Indians which formerly occupied the region now included in the State of Iowa.",
  ...
  "intensive": "1. Stretched; admitting of intension, or increase of degree; that can be intensified. Sir M. Hale. 2. Characterized by persistence; intent; unremitted; assiduous; intense. [Obs.] Sir H. Wotton. 3. (Gram.)  Serving to give force or emphasis; as, an intensive verb or preposition.\n\nThat which intensifies or emphasizes; an intensive verb or word.",
  "interadditive": "Added or placed between the parts of another thing, as a clause inserted parenthetically in a sentence.",
  ...
  "impiety": "1. The quality of being impious; want of piety; irreverence toward the Supreme Being; ungodliness; wickedness. 2. An impious act; an act of wickednes. Those impieties for the which they are now visited. Shak. Syn. -- Ungodliness; irreligion; unrighteousness; sinfulness; profaneness; wickedness; godlessness.",
  ...
  "iodize": "To treat or impregnate with iodine or its compounds; as, to iodize a plate for photography. R. Hunt.",
  "immerge": "To plungel into, under, or within anything especially a fuid; to dip; to immerse. See Immerse. We took . . . lukewarm water, and in it immerged a quantity of the leaves of senna. Boyle. Their souls are immerged in matter. Jer. Taylor.\n\nTo dissapear by entering into any medium, as a star into the light of the sun. [R.]",
  "isomeric": "Having the same percentage composition; -- said of two or more different substances which contain the same ingredients in the same proportions by weight, often used with with. Specif.: (a) Polymeric; i. e., having the same elements united in the same proportion by weight, but with different molecular weights; as, acetylene and benzine are isomeric (polymeric) with each other in this sense. See Polymeric. (b) Metameric; i. e., having the same elements united in the same proportions by weight, and with the same molecular weight, but which a different structure or arrangement of the ultimate parts; as, ethyl alcohol and methyl ether are isomeric (metameric) with each other in this sense. See Metameric.",
  ...
  "insurer": "One who, or that which, insures; the person or company that contracts to indemnify losses for a premium; an underwriter.",
  "invasive": "Tending to invade; characterized by invasion; aggressive. \"Invasive war.\" Hoole.",
  "intercavernous": "Between the cavernous sinuses; as, the intercavernous sinuses connecting the cavernous sinuses at the base of the brain.",
  ...
  "irresponsible": "1. Nor responsible; not liable or able to answer fro consequences; innocent. 2. Not to be trusted; unreliable.",
  "inexplicable": "Not explicable; not explainable; incapable of being explained, interpreted, or accounted for; as, an inexplicable mystery. \"An inexplicable scratching.\" Cowper. Their reason is disturbed; their views become vast and perplexed, to others inexplicable, to themselves uncertain. Burke.",
  "inapprehension": "Want of apprehension.",
  "infrabranchial": "Below the gills; -- applied to the ventral portion of the pallial chamber in the lamellibranchs.",
  "insulsity": "Insipidity; stupidity; dullness. [Obs.] The insulsity of mortal tongues. Milton.",
  "island": "1. A tract of land surrounded by water, and smaller than a continent. Cf. Continent. 2. Anything regarded as resembling an island; as, an island of ice. 3. (Zoöl.)  See Isle, n., 2. Islands of the blessed (Myth.), islands supposed to lie in the Western Ocean, where the favorites of the gods are conveyed at death, and dwell in everlasting joy.\n\n1. To cause to become or to resemble an island; to make an island or islands of; to isle. Shelley. 2. To furnish with an island or with islands; as, to island the deep. Southey.",
  ...
  "irp": "A fantastic grimace or contortion of the body. [Obs.] Smirks and irps and all affected humors. B. Jonson .\n\nMaking irps. [Obs.] B. Jonson.",
  ...
  "intercrop": "To cultivate by planting simultaneous crops in alternate rows; as, to intercrop an orchard. Also, to use for catch crops at seasons when the ground is not covered by crops of the regular rotation.\n\nA crop grown among or between  the rows of another crop; a catch crop.",
  ...
  "isologous": "Having similar proportions, similar relations, or similar differences of composition; -- said specifically of groups or series which differ by a constant difference; as, ethane, ethylene, an acetylene, or their analogous compounds, form an isologous series.",
  ...
  "interscapular": "1. (Anat.)  Between the scapulæ or shoulder blades. 2. (Zoöl.)  Pertaining to the upper back, or the part between the shoulders; as, the interscapular feathers.",
  "indurate": "1. Hardened; not soft; indurated. Tyndale. 2. Without sensibility; unfeeling; obdurate.\n\n1. To make hard; as, extreme heat indurates clay; some fossils are indurated by exposure to the air. 2. To make unfeeling; to deprive of sensibility; to render obdurate.\n\nTo grow hard; to harden, or become hard; as, clay indurates by drying, and by heat.",
  ...
  "indigenous": "1. Native; produced, growing, or living, naturally in a country or climate; not exotic; not imported. Negroes were all transported from Africa and are not indigenous or proper natives of America. Sir T. Browne. In America, cotton, being indigenous, is cheap. Lion Playas. 2. Native; inherent; innate. Joy and hope are emotions indigenous to the human mind. I. Taylor.",
  "irremunerable": "Not remunerable; not capable of remuneration.",
  "idol": "1. An image or representation of anything. [Obs.] Do her adore with sacred reverence, As th' idol of her maker's great magnificence. Spenser. 2. An image of a divinity; a representation or symbol of a deity or any other being or thing, made or used as an object of worship; a similitude of a false god. That they should not worship devils, and idols of gold. Rev. ix. 20. 3. That on which the affections are strongly (often excessively) set; an object of passionate devotion; a person or thing greatly loved or adored. The soldier's god and people's idol. Denham. 4. A false notion or conception; a fallacy. Bacon. The idols of preconceived opinion. Coleridge.",
  "immixable": "Not mixable. Bp. Wilkins.",
  "intently": "In an intent manner; as, the eyes intently fixed. Syn. -- Fixedly; steadfastly; earnestly; attentively; sedulously; diligently; eagerly.",
  "intermeddle": "To meddle with the affairs of others; to meddle officiously; to interpose or interfere improperly; to mix or meddle with. The practice of Spain hath been, by war and by conditions of treaty, to intermeddle with foreign states. Bacon. Syn. -- To interpose; interfere. See Interpose.\n\nTo intermix; to mingle. [Obs.] Many other adventures are intermeddled. Spenser.",
  ...
  "indecomposable": "Not decomposable; incapable or difficult of decomposition; not resolvable into its constituents or elements.",
  ...
  "idealist": "1. One who idealizes; one who forms picturesque fancies; one given to romantic expectations. 2. One who holds the doctrine of idealism.",
  ...
  "imitable": "1. Capble of being imitated or copied. The characters of man placed in lower stations of life are more usefull, as being imitable by great numbers. Atterbury. 2. Worthy of imitation; as, imitable character or qualities. Sir W. Raleigh.",
  "includible": "Capable of being included.",
  "interiority": "State of being interior.",
  "insuccation": "The act of soaking or moistening; maceration; solution in the juice of herbs. [Obs.] Coxe. The medicating and insuccation of seeds. Evelyn.",
  "inunderstanding": "Void of understanding. [Obs.] Bp. Pearson.",
  "improvable": "1. Capable of being improved; susceptible of improvement; admitting of being made better; capable of cultivation, or of being advanced in good qualities. Man is accommodated with moral principles, improvable by the exercise of his faculties. Sir M. Hale. I have a fine spread of improvable lands. Addison. 2. Capable of being used to advantage; profitable; serviceable; advantageous. The essays of weaker heads afford improvable hints to better. Sir T. Browne. -- Im*pro\"a*ble*ness, n. -- Im*prov\"a*bly, adv.",
  "infantlike": "Like an infant. Shak.",
  "ingurgitate": "1. To swallow, devour, or drink greedily or in large quantity; to guzzle. Cleveland. 2. To swallow up, as in a gulf. Fotherby.\n\nTo guzzle; to swill. Burton.",
  "inshell": "To hide in a shell. [Obs.] Shak.",
  "interferometer": "An instrument for measuring small movements, distances, or displacements by means of the interference of two beams of light; -- called also refractometer.",
  "irrotational": "Not rotatory; passing from one point to another by a movement other than rotation; -- said of the movement of parts of a liquid or yielding mass. Sir W. Thomson.",
  "inerrable": "Incapable of erring; infallible; unerring. \"Inerabble and requisite conditions.\" Sir T. Browne. \"Not an inerrable text.\" Gladstone.",
  "inappreciation": "Want of appreciation.",
  "inescate": "To allure; to lay a bait for. [Obs.] To inescate and beguile young women! Burton.",
  "inofficial": "Not official; not having official sanction or authoriy; not according to the forms or ceremony of official business; as, inofficial intelligence. Pinckney and Marshall would not make inofficial visits to discuss official business. Pickering. Syn. -- Private; informal; unwarranted; unauthorizod; irregular; unceremonious; unprofessional.",
  ...
  "incorruption": "The condition or quality of being incorrupt or incorruptible; absence of, or exemption from, corruption. It is sown in corruption; it is raised in incorruption. 1 Cor. xv. 42. The same preservation, or, rather, incorruption, we have observed in the flesh of turkeys, capons, etc. Sir T. Browne.",
  "intemperately": "In an intemperate manner; immoderately; excessively; without restraint. The people . . . who behaved very unwisely and intemperately on that occasion. Burke.",
  ...
  "interlinear": "Contained between lines; written or inserted between lines already written or printed; containing interlineations; as, an interlinear manuscript, translation, etc. -- In`ter*lin\"e*ar*ly, adv.",
  ...
  "ingrediency": "1. Entrance; ingress. [Obs.] Sir M. Hale. 2. The quality or state of being an ingredient or component part. Boyle.",
  ...
  "incorrectness": "The quality of being incorrect; want of conformity to truth or to a standard; inaccuracy; inexactness; as incorrectness may in defect or in redundance.",
  ...
  "indiscreet": "Not discreet; wanting in discretion. So drunken, and so indiscreet an officer. Shak. Syn. -- Imprudent; injudicious; inconsiderate; rash; hasty; incautious; heedless; undiscerning; foolish. -- In`dis*creet\"ly, adv. -- In`dis*creet\"ness, n.",
  ...
  "ironing": "1. The act or process of smoothing, as clothes, with hot flatirons. 2. The clothes ironed. Ironing board, a flat board, upon which clothes are laid being ironed.",
  "indiscovery": "Want of discovery. [Obs.]",
  "internally": "1. Inwardly; within the enveloping surface, or the boundary of a thing; within the body; beneath the surface. 2. Hence: Mentally; spiritually. Jer. Taylor.",
  ...
  "intelligential": "1. Of or pertaining to the intelligence; exercising or implying understanding; intellectual. \"With act intelligential.\" Milton. 2. Consisting of unembodied mind; incorporeal. Food alike those pure Intelligential substances require. Milton.",
  ...
  "infusorial": "Belonging to the Infusoria; composed of, or containing, Infusoria; as, infusorial earth. Infusorial earth (Geol.), a deposit of fine, usually white, siliceous material, composed mainly of the shells of the microscopic plants called diatoms. It is used in polishing powder, and in the manufacture of dynamite.",
  ...
  "incognito": "Without being known; in disguise; in an assumed character, or under an assumed title; -- said esp. of great personages who sometimes adopt a disguise or an assumed character in order to avoid notice. 'T was long ago Since gods come down incognito. Prior. The prince royal of Persia came thither incognito. Tatler.\n\n1. One unknown or in disguise, or under an assumed character or name. 2. The assumption of disguise or of a feigned character; the state of being in disguise or not recognized. His incognito was endangered. Sir W. Scott.",
  ...
  "intellective": "1. Pertaining to, or produced by, the intellect or understanding; intellectual. 2. Having power to understand, know, or comprehend; intelligent; rational. Glanvill. 3. Capable of being perceived by the understanding only, not by the senses. Intellective abstractions of logic and metaphysics. Milton.",
  "innixion": "Act of leaning upon something; incumbency. [Obs.] Derham.",
  "introductress": "A female introducer.",
  "irrelative": "Not relative; without mutual relations; unconnected. -- Ir*rel\"a*tive*ly, adv. Irrelative chords (Mus.), those having no common tone. -- Irrelative repetition (Biol.), the multiplication of parts that serve for a common purpose, but have no mutual dependence or connection. Owen.",
  ...
  "indebt": "To bring into debt; to place under obligation; -- chiefly used in the participle indebted. Thy fortune hath indebted thee to none. Daniel.",
  "ischial": "Of or pertaining to the ischium or hip; ischiac; ischiadic; ischiatic. Ischial callosity (Zoöl.), one of the patches of thickened hairless, and often bright-colored skin, on the buttocks of many apes, as the drill.",
  ...
  "immanence": "The condition or quality of being immanent; inherence; an indwelling. [Clement] is mainly concerned in enforcing the immanence of God. Christ is everywhere presented by him as Deity indwelling in the world. A. V. G. Allen.",
  "instep": "1. The arched middle portion of the human foot next in front of the ankle joint. 2. That part of the hind leg of the horse and allied animals, between the hock, or ham, and the pastern joint.",
  "infragrant": "Not fragrant.",
  "inosculation": "The junction or connection of vessels, channels, or passages, so that their contents pass from one to the other; union by mouths or ducts; anastomosis; intercommunication; as, inosculation of veins, etc. Ray.",
  ...
  "invisibility": "The state or quality of being invisible; also, that which is invisible. \"Atoms and invisibilities.\" Landor.",
  ...
  "imprecation": "The act of imprecating, or unvoking evil upon any one; a player that a curse or calamnity may fall on any one; a curse. Men cowered like slaves before such horrid imprecations. Motley. Syn. -- Malediction; curse; execration; anathema. See Malediction.",
  ...
  "inhibit": "1. To check; to hold back; to restrain; to hinder. Their motions also are excited or inhibited . . . by the objects without them. Bentley. 2. To forbid; to prohibit; to interdict. All men were inhibited, by proclamation, at the dissolution, so much as to mention a Parliament. Clarendon. Burial may not be inhibited or denied to any one. Ayliffe.",
  "inviscate": "To daub or catch with glue or birdlime; to entangle with glutinous matter. [R.] Sir T. Browne.",
  "inoculator": "One who inoculates; one who propagates plants or diseases by inoculation.",
  "ipomoea": ", and Gray.] (Bot.) A genus of twining plants with showy monopetalous flowers, including the morning-glory, the sweet potato, and the cypress vine.",
  ...
  "ingenit": "Innate; inborn; inbred; inherent; native; ingenerate. [Obs.] It is naturalor ingenite, which comes by some defect of the organs and overmuch brain. Burton.",
  ...
  "inverted": "1. Changed to a contrary or counterchanged order; reversed; characterized by inversion. 2. (Geol.)  Situated apparently in reverse order, as strata when folded back upon themselves by upheaval. Inverted arch (Arch.), an arch placed with crown downward; -- much used in foundations.",
  "inwrought": "Wrought or worked in or among other things; worked into any fabric so as to from a part of its texture; wrought or adorned, as with figures. His mantle hairy, and his bonnet sedge, Inwrought with figures dim. Milton.",
  ...
  "inanition": "The condition of being inane; emptiness; want of fullness, as in the vessels of the body; hence, specifically, exhaustion from want of food, either from partial or complete starvation, or from a disorder of the digestive apparatus, producing the same result. Feeble from inanition, inert from weariness. Landor. Repletion and inanition may both do harm in two contrary extremes. Burton.",
  ...
  "imperatorial": "1. Commanding; imperative; authoritative. 2. Of or pertaining to the title or office of imperator. \"Imperatorial laurels.\" C. Merivale.",
  ...
  "institutionary": "1. Relating to an institution, or institutions. 2. Containing the first principles or doctrines; elemental; rudimentary.",
  "intentionality": "The quality or state of being intentional; purpose; design. Coleridge.",
  "interparietal": "Between the parietal bones or cartilages; as, the interparietal suture. -- n.  The interparietal bone or cartilage",
  ...
  "indult": "1. A privilege or exemption; an indulgence; a dispensation granted by the pope. 2. (Spain)  A duty levied on all importations.",
  ...
  "iodoquinine": "A iodide of quinine obtained as a brown substance,. It is the base of herapathite. See Herapathite.",
  ...
  "invoke": "To call on for aid or protection; to invite earnestly or solemnly; to summon; to address in prayer; to solicit or demand by invocation; to implore; as, to invoke the Supreme Being, or to invoke His and blessing. Go, my dread lord, to your great grandsire's tomb, . . . Invoke his warlike spirit. Shak.",
  ...
  "interambulacrum": "In echinoderms, one of the areas or zones intervening between two ambulacra. See Illust. of Ambulacrum.",
  ...
  "infrastapedial": "Of or pertaining to a part of the columella of the ear, which in many animals projects below the connection with the stapes. -- n.  The infrastapedial part of the columella.",
  ...
  "invoice": "1. (Com.)  A written account of the particulars of merchandise shipped or sent to a purchaser, consignee, factor, etc., with the value or prices and charges annexed. Wharton. 2. The lot or set of goods as shipped or received; as, the merchant receives a large invoice of goods.\n\nTo make a written list or account of, as goods to be sent to a consignee; to insert in a priced list; to write or enter in an invoice. Goods, wares, and merchandise imported from Norway, and invoiced in the current dollar of Norway. Madison.",
  "ing": "1. Etym: [For OE. -and, -end, -ind, AS. -ende; akin to Goth. -and-, L. -ant-, -ent-, Gr.  A suffix used to from present participles; as, singing, playing. 2. Etym: [OE. -ing, AS. -ing, -ung.]  A suffix used to form nouns from verbs, and signifying the act of; the result of the act; as, riding, dying, feeling. It has also a secondary collective force; as, shipping, clothing. Note: The Old English ending of the present participle and verbal noun became confused, both becoming -ing. 3. Etym: [AS. -ing.]  A suffix formerly used to form diminutives; as, lording, farthing.\n\nA pasture or meadow; generally one lying low, near a river. [Obs. or Prov. Eng.]",
  "indictment": "1. The act of indicting, or the state of being indicted. 2. (Law)  The formal statement of an offense, as framed by the prosecuting authority of the State, and found by the grand jury. Note: To the validity of an indictment a finding by the grand jury is essential, while an information rests only on presentation by the prosecuting authority. 3. An accusation in general; a formal accusation. Bill of indictment. See under Bill.",
  ...
  "idiosyncratic": "Of peculiar temper or disposition; belonging to one's peculiar and individual character.",
  ...
  "intromittent": "1. Throwing, or allowing to pass, into or within. 2. (Zoöl.)  Used in copulation; -- said of the external reproductive organs of the males of many animals, and sometimes of those of the females.",
  "inchoate": "Recently, or just, begun; beginning; partially but not fully in existence or operation; existing in its elements; incomplete. -- In\"cho*ate*ly, adv. Neither a substance perfect, nor a substance inchoate. Raleigh.\n\nTo begin. [Obs.] Dr. H. More.",
  ...
  "impolitic": "Not politic; contrary to, or wanting in, policy; unwise; imprudent; indiscreet; inexpedient; as, an impolitic ruler, law, or measure. The most unjust and impolitic of all things, unequal taxation. Burke. Syn. -- Indiscreet; inexpedient; undiplomatic.",
  ...
  "inquisitor": "1. An inquisitive person; one fond of asking questions. [R.] \"Inquisitors are tatlers.\" Feltham. 2. (Law)  One whose official duty it is to examine and inquire, as coroners, sheriffs, etc. Mozley & W. 3. (R.C.Ch.)  A member of the Court of Inquisition.",
  ...
  "influx": "1. The act of flowing in; as, an influx of light. 2. A coming in; infusion; intromission; introduction; importation in abundance; also, that which flows or comes in; as, a great influx of goods into a country, or an influx of gold and silver. The influx of food into the Celtic region, however, was far from keeping pace with the influx of consumers. Macaulau. The general influx of Greek into modern languages. Earle. 3. Influence; power. [Obs.] Sir M. Hale.",
  ...
  "influential": "Exerting or possessing influence or power; potent; efficacious; effective; strong; having authority or ascendency; as, an influential man, station, argument, etc. A very influential Gascon prefix. Earle.",
  ...
  "intact": "Untouched, especially by anything that harms, defiles, or the like; uninjured; undefiled; left complete or entire. Buckle. When all external differences have passed away, one element remains intact, unchanged, -- the everlasting basis of our common nature, the human soul. F. W. Robertson.",
  ...
  "inclinable": "1. Leaning; tending. Likely and inclinable to fall. Bentley. 2. Having a propensity of will or feeling; leaning in disposition; disposed; propense; as, a mind inclinable to truth. Whatsoever other sins he may be inclinable to. South. The very constitution of a multitude is not so inclinable to save as to destroy. Fuller.",
  "interstitial": "Of or pertaining to interstices; intermediate; within the tissues; as, interstitial cavities or spaces in the tissues of animals or plants.",
  ...
  "insociable": "1. Incapable of being associated, joined, or connected. [Obs.] Lime and wood are insociable. Sir H. Wotton. 2. Not sociable or companionable; disinclined to social intercourse or conversation; unsociable; taciturn. This austere insociable life. Shak.",
  ...
  "interlunar": "Belonging or pertaining to the time when the moon, at or near its conjunction with the sun, is invisible. Milton.",
  "irpe": "A fantastic grimace or contortion of the body. [Obs.] Smirks and irps and all affected humors. B. Jonson .",
  "inspectorship": "1. The office of an inspector. 2. The district embraced by an inspector's jurisdiction.",
  "insecution": "A following after; close pursuit. [Obs.] Chapman.",
  "irriguous": "1. Watered; watery; moist; dewy. [Obs.] The flowery lap Of some irriguous valley spreads her store. Milton. 2. Gently penetrating or pervading. [Obs.] J. Philips.",
  ...
  "imprimatur": "A license to print or publish a book, paper, etc.; also, in countries subjected to the censorship of the press, approval of that which is published.",
  "irresolution": "Want of resolution; want of decision in purpose; a fluctuation of mind, as in doubt, or between hope and fear; irresoluteness; indecision; vacillation. Irresolution on the schemes of life which offer themselves to our choice, and inconstancy in pursuing them, are the greatest causes of all unhappiness. Addison.",
  "inconvincible": "Not convincible; incapable of being convinced. None are so inconvincible as your half-witted people. Gov. of the Tongue.",
  ...
  "inia": "A South American freshwater dolphin (Inia Boliviensis). It is ten or twelve feet long, and has a hairy snout.",
  "italianism": "1. A word, phrase, or idiom, peculiar to the Italians; an Italicism. 2. Attachment to, or sympathy for, Italy.",
  ...
  "interlaminar": "Between lammellæ or laminæ; as, interlamellar spaces.",
  "instamp": "See Enstamp.",
  "impone": "To stake; to wager; to pledge. [Obs.] Against the which he has imponed, as I take it, six French rapiers and poniards. Shak.",
  ...
  "illaqueate": "To insnare; to entrap; to entangle; to catch. Let not the surpassing eloquence of Taylor dazzle you, nor his scholastic retairy versatility of logic illaqueate your good sense. Coleridge.",
  "imperatory": "Imperative. [R.]",
  "indiminishable": "Incapable of being diminished. [R.] Milton.",
  "insatiety": "Insatiableness. T. Grander.",
  "intentional": "Done by intention or design; intended; designed; as, the act was intentional, not accidental.",
  ...
  "indiscerptible": "Not discerpible; inseparable. [Obs.] Bp. Butler. -- In`dis*cerp\"i*ble*ness, n., In`dis*cerp\"ti*ble*ness, n. [Obs.] -- In`dis*cerp\"ti*bly, adv. [Obs.]",
  "interoperculum": "The postero-inferior opercular bone, in fishes.",
  "isatogen": "A complex nitrogenous radical, C8H4NO2, regarded as the essential residue of a series of compounds, related to isatin, which easily pass by reduction to indigo blue. -- I*sat`o*gen\"ic, a.",
  ...
  "intercurrent": "1. Running between or among; intervening. Boyle. Bp. Fell. 2. (Med.) (a) Not belonging to any particular season. (b) Said of diseases occurring in the course of another disease. Dunglison.\n\nSomething intervening. Holland.",
  ...
  "indiglucin": "The variety of sugar (glucose) obtained from the glucoside indican. It is unfermentable, but reduces Fehling's solution.",
  ...
  "impenetrably": "In an impenetrable manner or state; imperviously. \"Impenetrably armed.\" Milton. \"Impenetrably dull.\" Pope.",
  ...
  "idolater": "1. A worshiper of idols; one who pays divine honors to images, statues, or representations of anything made by hands; one who worships as a deity that which is not God; a pagan. 2. An adorer; a great admirer. Jonson was an idolater of the ancients. Bp. Hurd.",
  "immoderate": "Not moderate; exceeding just or usual and suitable bounds; excessive; extravagant; unreasonable; as, immoderate demands; immoderate grief; immoderate laughter. So every scope by the immoderate use Turns to restraint. Shak. Syn. -- Excessive; exorbitant; unreasonable; extravagant; intemperate; inordinate.",
  "ideality": "1. The quality or state of being ideal. 2. The capacity to form ideals of beauty or perfection. 3. (Phren.)  The conceptive faculty.",
  "impersuadable": "Not to be persuaded; obstinate; unyielding; impersuasible. -- Im`per*suad\"a*ble*ness, n.",
  "induration": "1. The act of hardening, or the process of growing hard. 2. State of being indurated, or of having become hard. 3. Hardness of character, manner, sensibility, etc.; obduracy; stiffness; want of pliancy or feeling. A certain induration of character had arisen from long habits of business. Coleridge.",
  ...
  "in-and-in": "An old game played with four dice. In signified a doublet, or two dice alike; in-and-in, either two doubles, or the four dice alike.",
  "istle": "Same as Ixtle.",
  "impound": "To shut up or place in an inclosure called a pound; hence, to hold in the custody of a court; as, to impound stray cattle; to impound a document for safe keeping. But taken and impounded as a stray, The king of Scots. Shak.",
  "interne": "That which is within; the interior. [Poetic] Mrs. Browning.",
  "interreign": "An interregnum. [Obs.] Bacon.",
  "isorcin": "A crystalline hydrocarbon derivative, metameric with orcin, but produced artificially; -- called also cresorcin.",
  ...
  "interseptal": "Between septa; as, the interseptal spaces or zones, between the transparent, or septal, zones in striated muscle; the interseptal chambers of a shell, or of a seed vessel.",
  ...
  "improbable": "Not probable; unlikely to be true; not to be expected under the circumstances or in the usual course of events; as, an improbable story or event. He . . . sent to Elutherius, then bishop of Rome, an improbable letter, as some of the contents discover. Milton. -- Im*prob\"a*ble*ness, n. -- Im*prob\"a*bly, adv.",
  ...
  "itzibu": "A silver coin of Japan, worth about thirty-four cents. [Written also itzebu, ichebu, itcheboo, etc.]",
  ...
  "illimitable": "Incapable of being limited or bounded; immeasurable; limitless; boundless; as, illimitable space. The wild, the irregular, the illimitable, and the luxuriant, have their appropriate force of beauty. De Quincey. Syn. -- Boundless; limitless; unlimited; unbounded; immeasurable; infinite; immense; vast. -- Il*lim\"it*a*ble*ness, n. -- Il*lim\"it*a*bly, adv.",
  "incasement": "1. The act or process of inclosing with a case, or the state of being incased. 2. That which forms a case, covering, or inclosure.",
  ...
  "incredible": "Not credible; surpassing belief; too extraordinary and improbable to admit of belief; unlikely; marvelous; fabulous. Why should it be thought a thing incredible with you, that God should raise the dead Acts xxvi. 8.",
  ...
  "incitation": "1. The act of inciting or moving to action. 2. That which incites to action; that which rouses or prompts; incitement; motive; incentive. The noblest incitation to honest attempts. Tatler.",
  ...
  "inexperience": "Absence or want of experience; lack of personal and experimental knowledge; as, the inexperience of youth. Failings which are incident to youth and inexperience. Dryden. Prejudice and self-sufficiency naturally proceed from inexperience of the world, and ignorance of mankind. Addison.",
  "insnare": "1. To catch in a snare; to entrap; to take by artificial means. \"Insnare a gudgeon.\" Fenton. 2. To take by wiles, stratagem, or deceit; to involve in difficulties or perplexities; to seduce by artifice; to inveigle; to allure; to entangle. The insnaring charms Of love's soft queen. Glover.",
  "iodocresol": "Any of several isomeric iodine derivatives of the cresols, C6H3I(CH3)OH, esp. one, an odorless amorphous powder, used in medicine as a substitute for iodoform.",
  ...
  "interjacence": "The state of being between; a coming or lying between or among; intervention; also, that which lies between. England and Scotland is divided only by the interjacency of the Tweed. Sir M. Hale.",
  ...
  "interclude": "To shut off or out from a place or course, by something intervening; to intercept; to cut off; to interrupt. Mitford. So all passage of external air into the receiver may be intercluded. Boyle.",
  "importuner": "One who importunes.",
  "intercourse": "A This sweet intercourse Of looks and smiles. Milton. Sexual intercourse, sexual or carnal connection; coition. Syn. -- Communication; connection; commerce; communion; fellowship; familiarity; acquaintance.",
  ...
  "intercolonial": "Between or among colonies; pertaining to the intercourse or mutual relations of colonies; as, intercolonial trade. -- In`ter*co*lo\"ni*al*ly, adv.",
  "imposturage": "Imposture; cheating. [R.] Jer. Taylor.",
  "interseminate": "To sow between or among. [R.]",
  "indisputed": "Undisputed.",
  "innocent": "1. Not harmful; free from that which can injure; innoxious; innocuous; harmless; as, an innocent medicine or remedy. The spear Sung innocent,and spent its force in air. Pope. 2. Morally free from guilt; guiltless; not tainted with sin; pure; upright. To offer up a weak, poor, innocent lamb. Shak. I have sinned in that I have betrayed the innocent blood. Matt. xxvii. 4. The aidless,innocent lady, his wished prey. Milton. 3. Free from the guilt of a particular crime or offense; as, a man is innocent of the crime charged. Innocent from the great transgression. Ps. xix. 13. 4. Simple; artless; foolish. Shak. 5. Lawful; permitted; as, an innocent trade. 6. Not contraband; not subject to forfeiture; as, innocent goods carried to a belligerent nation. Innocent party (Law),a party who has not notice of a fact tainting a litigated transaction with illegality. Syn. -- Harmless; innoxious; innoffensive; guiltless; spotless; immaculate; pure; unblamable; blameless; faultless; guileless; upright.\n\n1. An innocent person; one free from, or unacquainted with, guilt or sin. Shak. 2. An unsophisticated person; hence, a child; a simpleton; an idiot. B. Jonson. In Scotland a natural fool was called an innocent. Sir W. Scott. Innocents' day (Eccl.), Childermas day.",
  "indeclinable": "Not declinable; not varied by inflective terminations; as, nihil (nothing), in Latin, is an indeclinable noun. -- n.  An indeclinable word.",
  "inextension": "Want of extension; unextended state.",
  "inverness": "A kind of full sleeveless cape, fitting closely about the neck. Robert's wind-blown head and tall form wrapped in an Inverness cape. Mrs. Humphry Ward.",
  ...
  "invertebrate": "Destitute of a backbone; having no vertebræ; of or pertaining to the Invertebrata. -- n.  One of the Invertebrata. Age of invertebrates. See Age, and Silurian.",
  "intumesce": "To enlarge or expand with heat; to swell; specifically, to swell up or bubble up under the action of heat, as before the blowpipe. In a higher heat, it intumesces, and melts into a yellowish black mass. Kirwan.",
  "irefulness": "Wrathfulness. Wyclif.",
  "impressive": "1. Making, or tending to make, an impression; having power to impress; adapted to excite attention and feeling, to touch the sensibilities, or affect the conscience; as, an impressive discourse; an impressive scene. 2. Capable of being impressed. [Obs.] Drayton. - Im*press\"ive*ly, adv. -- Im*press\"ive*ness, n.",
  ...
  "imperishable": "Not perisha ble; not subject to decay; indestructible; enduringpermanently; as, an imperishable monument; imperishable renown. -- Im*per\"ish*a*ble*ness, n. -- Im*per\"ish*a*bly, adv.",
  ...
  "isoclinal": "Of or pertaining to, or indicating, equality of inclination or dip; having equal inclination or dip. Isoclinal lines (Magnetism), lines on the earth's surface connecting places at which a dipping needle indicates the same inclination or dip.",
  ...
  "incorrupt": "1. Not affected with corruption or decay; unimpaired; not marred or spoiled. 2. Not defiled or depraved; pure; sound; untainted; above the influence of bribes; upright; honest. Milton. Your Christian principles . . . which will preserve you incorrupt as individuals. Bp. Hurd.",
  "inane": "Without contents; empty; void of sense or intelligence; purposeless; pointless; characterless; useless. \"Vague and inane instincts.\" I. Taylor. -- In*ane\"ly, adv.\n\nThat which is void or empty. [R.] The undistinguishable inane of infinite space. Locke.",
  "iatrochemical": "Of or pertaining to iatrochemistry, or to the iatrochemists.",
  "interungular": "Between ungulæ; as, interungular glands.",
  "intrication": "Entanglement. [Obs.]",
  "indissoluble": "1. Not dissoluble; not capable of being dissolved, melted, or liquefied; insoluble; as few substances are indissoluble by heat, but many are indissoluble in water. Boyle. 2. Incapable of being rightfully broken or dissolved; perpetually binding or obligatory; firm; stable, as, an indissoluble league or covenant. To the which my duties Are with a most indissoluble tie Forever knit. Shak.",
  "irk": "To weary; to give pain; to annoy; -- used only impersonally at present. To see this sight, it irks my very soul. Shak. It irketh him to be here. M. Arnold.",
  ...
  "integrator": "That which integrates; esp., an instrument by means of which the area of a figure can be measured directly, or its moment of inertia, or statical moment, etc., be determined.",
  ...
  "interlocution": "1. Interchange of speech; dialogue; conversation; conference. 2. (Law)  An intermediate act or decree before final decision. Ayliffe. 3. Hence, intermediate argument or discussion.",
  ...
  "incumbrance": "1. A burdensome and troublesome load; anything that impedes motion or action, or renders it difficult or laborious; clog; impediment; hindrance; check. Cowper. 2. (Law)  A burden or charge upon property; a claim or lien upon an estate, which may diminish its value.",
  ...
  "inequilateral": "1. Having unequal sides; unsymmetrical; unequal-sided. 2. (Zoöl.)  Having the two ends unequal, as in the clam, quahaug, and most lamellibranch shells.",
  ...
  "ideographical": "Of or pertaining to an ideogram; representing ideas by symbols, independently of sounds; as, 9 represents not the word \"nine,\" but the idea of the number itself. -- I`de*o*graph\"ic*al*ly, adv.",
  "interhyal": "Of or pertaining to a segment sometimes present at the proximal end of the hyoidean arch. -- n.  An interhyal ligament or cartilage.",
  "indiscernible": "Not to be discerned; imperceptible; not discoverable or visible. Secret and indiscernible ways. Jer. Taylor. -- In`dis*cern\"i*ble*ness, n. -- In`dis*cern\"i*bly, adv.",
  "impressionable": "Liable or subject to impression; capable of being molded; susceptible; impressible. He was too impressionable; he had too much of the temperament of genius. Motley. A pretty face and an impressionable disposition. T. Hook.",
  ...
  "interpreter": "One who or that which interprets, explains, or expounds; a translator; especially, a person who translates orally between two parties. We think most men's actions to be the interpreters of their thoughts. Locke.",
  ...
  "infliction": "1. The act of inflicting or imposing; as, the infliction of torment, or of punishment. 2. That which is inflicted or imposed, as punishment, disgrace, calamity, etc. His severest inflictions are in themselves acts of justice and righteousness. Rogers.",
  ...
  "intromission": "1. The act of sending in or of putting in; insertion. South. 2. The act of letting go in; admission. 3. (Scots Law)  An intermeddling with the affairs of another, either on legal grounds or without authority.",
  "isocyanuric": "Designating, or pertaining to, an acid isomeric with cyanuric acid, and called also fulminuric acid. See under Fulminuric.",
  "inchase": "See Enchase.",
  ...
  "intensify": "To render more intense; as, to intensify heat or cold; to intensify colors; to intensify a photographic negative; to intensify animosity. Bacon. How piercing is the sting of pride By want embittered and intensified. Longfellow.\n\nTo become intense, or more intense; to act with increasing power or energy.",
  "innovator": "One who innovates. Shak.",
  "imposable": "Capable of being imposed or laid on. Hammond.",
  "inelegance": "1. The quality of being inelegant; want of elegance or grace; want of refinement, beauty, or polish in language, composition, or manners. The notorious inelegance of her figure. T. Hook. 2. Anything inelegant; as, inelegance of style in literary composition.",
  ...
  "intervale": "A tract of low ground between hills, or along the banks of a stream, usually alluvial land, enriched by the overflowings of the river, or by fertilizing deposits of earth from the adjacent hills. Cf. Bottom, n., 7. [Local, U. S.] The woody intervale just beyond the marshy land. The Century.",
  ...
  "infamy": "1. Total loss of reputation; public disgrace; dishonor; ignominy; indignity. The afflicted queen would not yield, and said she would not . . . submit to such infamy. Bp. Burnet. 2. A quality which exposes to disgrace; extreme baseness or vileness; as, the infamy of an action. 3. (Law)  That loss of character, or public disgrace, which a convict incurs, and by which he is at common law rendered incompetent as a witness.",
  ...
  "intended": "1. Made tense; stretched out; extended; forcible; violent. [Obs.] Spenser. 2. Purposed; designed; as, intended harm or help. They drew a curse from an intended good. Cowper. 3. Betrothed; affianced; as, an intended husband.\n\nOne with whom marriage is designed; one who is betrothed; an affianced lover. If it were not that I might appear to disparage his intended, . . . I would add that to me she seems to be throwing herself away. Dickens.",
  ...
  "iron-gray": "Of a gray color, somewhat resembling that of iron freshly broken. -- n.  An iron-gray color; also, a horse of this color.",
  ...
  "impermanency": "Want of permanence.",
  "immaterially": "1. In an immaterial manner; without matter or corporeal substance. 2. In an unimportant manner or degree.",
  "inspection": "1. The act or process of inspecting or looking at carefully; a strict or prying examination; close or careful scrutiny; investigation. Spenser. With narrow search, and with inspection deep, Considered every creature. Milton. 2. The act of overseeing; official examination or superintendence. Trial by inspection (O. Eng. Law), a mode of trial in which the case was settled by the individual observation and decision of the judge upon the testimony of his own senses, without the intervention of a jury. Abbott.",
  "inhale": "To breathe or draw into the lungs; to inspire; as, to inhale air; -- opposed to exhale. Martin was walking forth to inhale the fresh breeze of the evening. Arbuthnot.",
  ...
  "impassable": "Incapable of being passed; not admitting a passage; as, an impassable road, mountain, or gulf. Milton. -- Im*pass\"a*ble*ness, n. -- Im*pass\"a*bly, adv.",
  ...
  "intwine": "To twine or twist into, or together; to wreathe; as, a wreath of flowers intwined. [Written also entwine.]\n\nTo be or to become intwined.",
  "inspiratory": "Pertaining to, or aiding, inspiration; as, the inspiratory muscles.",
  "incommiscible": "Not commiscible; not mixable.",
  "intake": "1. The place where water or air is taken into a pipe or conduit; -- opposed to outlet. 2. the beginning of a contraction or narrowing in a tube or cylinder. 3. The quantity taken in; as, the intake of air.",
  ...
  "imperiousness": "The quality or state of being imperious; arrogance; haughtiness. Imperiousness and severity is but an ill way of treating men who have reason of their own to guide them. Locke.",
  "improvise": "1. To compose, recite, or sing extemporaneously, especially in verse; to extemporize; also, to play upon an instrument, or to act, extemporaneously. 2. To bring about, arrange, or make, on a sudden, or without previous preparation. Charles attempted to improvise a peace. Motley. 3. To invent, or provide, offhand, or on the spur of the moment; as, he improvised a hammer out of a stone.\n\nTo produce or render extemporaneous compositions, especially in verse or in music, without previous preparation; hence, to do anything offhand.",
  "isocrymal": "Pertaining to, having the nature of, or illustrating, an isocryme; as, an isocrymal line; an isocrymal chart.",
  ...
  "indefeasible": "Not to be defeated; not defeasible; incapable of being annulled or made void; as, an indefeasible or title. That the king had a divine and an indefeasible right to the regal power. Macaulay.",
  ...
  "ismaelian": "One of a sect of Mohammedans who favored the pretensions of the family of Mohammed ben Ismael, of the house Ali.",
  "insolubility": "1. The quality or state of being insoluble or not dissolvable, as in a fluid. 2. The quality of being inexplicable or insolvable.",
  ...
  "ischiadic": "Ischial. [R.] Ischiadic passion or disease (Med.), a rheumatic or neuralgic affection of some part about the hip joint; -- called also sciatica.",
  ...
  "irrigate": "1. To water; to wet; to moisten with running or dropping water; to bedew. 2. (Agric.)  To water, as land, by causing a stream to flow upon, over, or through it, as in artificial channels.",
  "instead": "1. In the place or room; -- usually followed by of. Let thistles grow of wheat. Job xxxi. 40. Absalom made Amasa captain of the host instead of Joab. 2 Sam. xvii. 25. 2. Equivalent; equal to; -- usually with of. [R.] This very consideration to a wise man is instead of a thousand arguments, to satisfy him, that in those times no such thing was believed. Tillotson.",
  "indolin": "A dark resinous substance, polymeric with indol, and obtained by the reduction of indigo white.",
  ...
  "impartiality": "The quality of being impartial; freedom from bias or favoritism; disinterestedness; equitableness; fairness; as, impartiality of judgment, of treatment, etc. Impartiality strips the mind of prejudice and passion. South.",
  ...
  "i o u": "A paper having on it these letters, with a sum named, and duly signed; -- in use in England as an acknowledgment of a debt, and taken as evidence thereof, but not amounting to a promissory note; a due bill. Wharton. Story.",
  "imbalm": "See Embalm.",
  "inspissation": "The act or the process of inspissating, or thickening a fluid substance, as by evaporation; also, the state of being so thickened.",
  "idealization": "1. The act or process of idealizing. 2. (Fine Arts)  The representation of natural objects, scenes, etc., in such a way as to show their most important characteristics; the study of the ideal.",
  "impact": "To drive close; to press firmly together: to wedge into a place. Woodward.\n\n1. Contact or impression by touch; collision; forcible contact; force communicated. The quarrel, by that impact driven. Southey. 2. (Mech.)  The single instantaneous stroke of a body in motion against another either in motion or at rest.",
  ...
  "isodynamic": "Of, pertaining to, having, or denoting, equality of force. Isodynamic foods (Physiol.), those foods that produce a similar amount of heat. -- Isodynamic lines (Magnetism), lines on the earth's surface connecting places at which the magnetic intensity is the same.",
  ...
  "indistinctly": "In an indistinct manner; not clearly; confusedly; dimly; as, certain ideas are indistinctly comprehended. In its sides it was bounded distinctly, but on its ends confusedly an indistinctly. Sir I. Newton.",
  ...
  "isostasy": "The state or quality of being isostatic. Specif. (Geol.),  general equilibrium in the earth's crust, supposed to be maintained by the yielding or flow of rock material beneath the surface under gravitative stress. By the theory of isostasy each unit column of the earth, from surface to center, has approximately the same weight, and the continents stand higher than the ocean beds chiefly because the material of the crust has there less density.",
  "infeoff": "See Enfeoff.",
  ...
  "introsusception": "1. The act or process of receiving within. The person is corrupted by the introsusception of a nature which becomes evil thereby. Coleridge. 2. (Med.)  Same as Intussusception.",
  "impalm": "To grasp with or hold in the hand. [R.] J. Barlow.",
  "impudent": "Bold, with contempt or disregard; unblushingly forward; impertinent; wanting modesty; shameless; saucy. More than impudent sauciness. Shak. When we behold an angel, not to fear Is to be impudent. Dryden. Syn. -- Shameless; audacious; brazen; bold-faced; pert; immodest; rude; saucy; impertinent; insolent.",
  ...
  "insessorial": "1. Pertaining to, or having the character of, perching birds. 2. Belonging or pertaining to the Insessores.",
  "inapplicable": "Not applicable; incapable of being applied; not adapted; not suitable; as, the argument is inapplicable to the case. J. S. Mill. Syn. -- Unsuitable; unsuited; unadapted; inappropriate; inapposite; irrelevant. -- In*ap\"pli*ca*ble*ness, n. -- In*ap\"pli*ca*bly, adv.",
  ...
  "isentropic": "Having equal entropy. Isentropic lines, lines which pass through points having equal entropy.",
  "incise": "1. To cut in or into with a sharp instrument; to carve; to engrave. I on thy grave this epitaph incise. T. Carew. 2. To cut, gash, or wound with a sharp instrument; to cut off.",
  "intuitively": "In an intuitive manner.",
  "interfuse": "1. To pour or spread between or among; to diffuse; to scatter. The ambient air, wide interfused, Embracing round this florid earth. Milton. 2. To spread through; to permeate; to pervade. [R.] Keats, in whom the moral seems to have so perfectly interfused the physical man, that you might almost say he could feel sorrow with his hands. Lowell. 3. To mix up together; to associate. H. Spencer.",
  "intrusionist": "One who intrudes; especially, one who favors the appointment of a clergyman to a parish, by a patron, against the wishes of the parishioners.",
  ...
  "invertase": "(a) An enzyme capable of effecting the inversion of cane suger, producing invert sugar. It is found in many plants and in the intestines of animals. (b) By extension, any enzyme which splits cane sugar, milk sugar, lactose, etc., into monosaccharides.",
  ...
  "inaccurate": "Not accurate; not according to truth; inexact; incorrect; erroneous; as, in inaccurate man, narration, copy, judgment, calculation, etc. The expression is plainly inaccurate. Bp. Hurd. Syn. -- Inexact; incorrect; erroneous; faulty; imperfect; incomplete; defective.",
  "inroll": "See Enroll.",
  ...
  "isotonic": "Having or indicating, equal tones, or tension. Isotonic system (Mus.), a system consisting of intervals, in which each concord is alike tempered, and in which there are twelve equal semitones.",
  "incult": "Untilled; uncultivated; crude; rude; uncivilized. Germany then, says Tacitus, was incult and horrid, now full of magnificent cities. Burton. His style is diffuse and incult. M. W. Shelley.",
  ...
  "ideation": "The faculty or capacity of the mind for forming ideas; the exercise of this capacity; the act of the mind by which objects of sense are apprehended and retained as objects of thought. The whole mass of residua which have been accumulated . . . all enter now into the process of ideation. J. D. Morell.",
  "inveil": "To cover, as with a vail. W. Browne.",
  "interlineation": "1. The act of interlining. 2. That which is interlined; a passage, word, or line inserted between lines already written or printed.",
  "indican": "1. (Chem.)  A glucoside obtained from woad (indigo plant) and other plants, as a yellow or light brown sirup. It has a nauseous bitter taste, a decomposes or drying. By the action of acids, ferments, etc., it breaks down into sugar and indigo. It is the source of natural indigo. 2. (Physiol. Chem.)  An indigo-forming substance, found in urine, and other animal fluids, and convertible into red and blue indigo (urrhodin and uroglaucin). Chemically, it is indoxyl sulphate of potash, C8H6NSO4K, and is derived from the indol formed in the alimentary canal. Called also uroxanthin.",
  ...
  "inwardness": "1. Internal or true state; essential nature; as, the inwardness of conduct. Sense can not arrive to the inwardness Of things. Dr. H. More. 2. Intimacy; familiarity. [Obs.] Shak. 3. Heartiness; earnestness. What was wanted was more inwardness, more feeling. M. Arnold.",
  "interpilaster": "The interval or space between two pilasters. Elmes.",
  "inflective": "1. Capable of, or pertaining to, inflection; deflecting; as, the inflective quality of the air. Derham. 2. (Gram.)  Inflectional; characterized by variation, or change in form, to mark case, tense, etc.; subject to inflection. Inflective language (Philol.), a language like the Greek or Latin, consisting largely of stems with variable terminations or suffixes which were once independent words. English is both agglutinative, as, manlike, headache, and inflective, as, he, his, him. Cf. Agglutinative.",
  "inexpectedness": "Unexpectedness. [Obs.]",
  "ingredience": "1. Entrance; ingress. [Obs.] Sir M. Hale. 2. The quality or state of being an ingredient or component part. Boyle.",
  "impeccant": "Sinless; impeccable. Byron.",
  "indivisibleness": "The state of being indivisible; indivisibility. W. Montagu.",
  "insentient": "Not sentient; not having perception, or the power of perception. The . . . attributes of an insentient, inert substance. Reid. But there can be nothing like to this sensation in the rose, because it is insentient. Sir W. Hamilton.",
  "iodo": "A prefix, or combining from, indicating iodine as an ingredient; as, iodoform.",
  "innovate": "1. To bring in as new; to introduce as a novelty; as, to innovate a word or an act. [Archaic] 2. To change or alter by introducing something new; to remodel; to revolutionize. [Archaic] Burton. From his attempts upon the civil power, he proceeds to innovate God's worship. South.\n\nTo introduce novelties or changes; -- sometimes with in or on. Bacon. Every man,therefore,is not fit to innovate. Dryden.",
  "impeccability": "the quality of being impeccable; exemption from sin, error, or offense. Infallibility and impeccability are two of his attributes. Pope.",
  ...
  "inscription": "1. The act or process of inscribing. 2. That which is inscribed; something written or engraved; especially, a word or words written or engraved on a solid substance for preservation or public inspection; as, inscriptions on monuments, pillars, coins, medals, etc. 3. (Anat.)  A line of division or intersection; as, the tendinous inscriptions, or intersections, of a muscle. 4. An address, consignment, or informal dedication, as of a book to a person, as a mark of respect or an invitation of patronage.",
  ...
  "intercipient": "Intercepting; stopping. -- n.  One who, or that which, intercepts or stops anything on the passage. Wiseman.",
  "impulse": "1. The act of impelling, or driving onward with sudden force; impulsion; especially, force so communicated as to produced motion suddenly, or immediately. All spontaneous animal motion is performed by mechanical impulse. S. Clarke. 2. The effect of an impelling force; motion produced by a sudden or momentary force. 3. (Mech.)  The action of a force during a very small interval of time; the effect of such action; as, the impulse of a sudden blow upon a hard elastic body. 4. A mental force which simply and directly urges to action; hasty inclination; sudden motive; momentary or transient influence of appetite or passion; propension; incitement; as, a man of good impulses; passion often gives a violent impulse to the will. These were my natural impulses for the undertaking. Dryden. Syn. -- Force; incentive; influence; motive; feeling; incitement; instigation.\n\nTo impel; to incite. [Obs.] Pope.",
  "inexpressible": "Not capable of expression or utterance in language; ineffable; unspeakable; indescribable; unutterable; as, inexpressible grief or pleasure. \"Inexpressible grandeur.\" Blair. In orbs Of circuit inexpressible they stood. Milton.",
  "interposer": "One who, or that which, interposes or intervenes; an obstacle or interruption; a mediator or agent between parties. Shak.",
  ...
  "introspective": "1. Inspecting within; seeing inwardly; capable of, or exercising, inspection; self-conscious. 2. Involving the act or results of conscious knowledge of physical phenomena; -- contrasted with associational. J. S. Mill.",
  "intumescence": "1. The act or process of swelling or enlarging; also, the state of being swollen; expansion; tumidity; especially, the swelling up of bodies under the action of heat. The intumescence of nations. Johnson. 2. Anything swollen or enlarged, as a tumor.",
  ...
  "indiscrete": "1. Indiscreet. [Obs.] Boyle. 2. Not discrete or separated; compact; homogenous. An indiscrete mass of confused matter. Pownall.",
  "impetrative": "Of the nature of impetration; getting, or tending to get, by entreaty. [Obs.] Bp. Hall.",
  ...
  "ischion": "1. (Anat.)  The ventral and posterior of the three principal bones composing either half of the pelvis; seat bone; the huckle bone. 2. (Zoöl.)  One of the pleuræ of insects.",
  "incognoscible": "Incognizable. -- In`cog*nos\"ci*bil\"i*ty, n.",
  "interungulate": "Between ungulæ; as, interungular glands.",
  ...
  "individualize": "The mark as an individual, or to distinguish from others by peculiar properties; to invest with individuality. The peculiarities which individualize and distinguish the humor of Addison. N. Drake.",
  ...
  "investigable": "Capable or susceptible of being investigated; admitting research. Hooker.\n\nUnsearchable; inscrutable. [Obs.] So unsearchable the judgment and so investigable the ways thereof. Bale.",
  ...
  "inveiglement": "The act of inveigling, or the state of being inveigled; that which inveigles; enticement; seduction. South.",
  ...
  "ible": "An adjective suffix now usually in a passive sense; able to be; fit to be; expressing capacity or worthiness in a passive sense; as, movable, able to be moved; amendable, able to be amended; blamable, fit to be blamed; salable. Note: The form ible is used in the same sense. Note: It is difficult to say when we are not to use -able instead of -ible. \"Yet a rule may be laid down as to when we are to use it. To all verbs, then, from the Anglo-Saxon, to all based on the uncorrupted infinitival stems of Latin verbs of the first conjugation, and to all substantives, whencesoever sprung, we annex - able only.\" Fitzed. Hall.\n\nAn adjective suffix now usually in a passive sense; able to be; fit to be; expressing capacity or worthiness in a passive sense; as, movable, able to be moved; amendable, able to be amended; blamable, fit to be blamed; salable. Note: The form ible is used in the same sense. Note: It is difficult to say when we are not to use -able instead of -ible. \"Yet a rule may be laid down as to when we are to use it. To all verbs, then, from the Anglo-Saxon, to all based on the uncorrupted infinitival stems of Latin verbs of the first conjugation, and to all substantives, whencesoever sprung, we annex - able only.\" Fitzed. Hall.\n\n. See -able.",
  ...
  "ingress": "1. The act of entering; entrance; as, the ingress of air into the lungs. 2. Power or liberty of entrance or access; means of entering; as, all ingress was prohibited. 3. (Astron.)  The entrance of the moon into the shadow of the earth in eclipses, the sun's entrance into a sign, etc.\n\nTo go in; to enter. [R.]",
  ...
  "infundibular": "Having the form of a funnel; pertaining to an infundibulum. Infundibulate Bryozoa (Zoöl.),a group of marine Bryozoa having a circular arrangement of the tentacles upon the disk.",
  ...
  "imperfection": "The quality or condition of being imperfect; want of perfection; incompleteness; deficiency; fault or blemish. Sent to my account With all my imperfections on my head. Shak. Syn. -- Defect; deficiency; incompleteness; fault; failing; weakness; frailty; foible; blemish; vice.",
  ...
  "infidelity": "1. Want of faith or belief in some religious system; especially, a want of faith in, or disbelief of, the inspiration of the Scriptures, of the divine origin of Christianity. There is, indeed, no doubt but that vanity is one of the principal causes of infidelity. V. Knox. 2. Unfaithfulness to the marriage vow or contract; violation of the marriage covenant by adultery. 3. Breach of trust; unfaithfulness to a charge, or to moral obligation; treachery; deceit; as, the infidelity of a servant. \"The infidelity of friends.\" Sir W. Temple.",
  "ingredient": "That which enters into a compound, or is a component part of any combination or mixture; an element; a constituent. By way of analysis we may proceed from compounds to ingredients. Sir I. Newton. Water is the chief ingredient in all the animal fluids and solids. Arbuthnot.\n\nEntering as, or forming, an ingredient or component part. Acts where no sin is ingredient. Jer. Taylor.",
  "inition": "Initiation; beginning. [Obs.] Sir R. Naunton.",
  "impartial": "Not partial; not favoring one more than another; treating all alike; unprejudiced; unbiased; disinterested; equitable; fair; just. Shak. Jove is impartial, and to both the same. Dryden. A comprehensive and impartial view. Macaulay.",
  ...
  "intensifier": "One who or that which intensifies or strengthens; in photography, an agent used to intensify the lights or shadows of a picture.",
  "interveined": "Intersected, as with veins.",
  "intimidate": "To make timid or fearful; to inspire of affect with fear; to deter, as by threats; to dishearten; to abash. Now guilt, once harbored in the conscious breast, Intimidates the brave, degrades the great. Johnson. Syn. -- To dishearten; dispirit; abash; deter; frighten; terrify; daunt; cow.",
  ...
  "immure": "1. To wall around; to surround with walls. [Obs.] Sandys. 2. To inclose whithin walls, or as within walls; hence, to shut up; to imprison; to incarcerate. Those tender babes Whom envy hath immured within your walls. Shak. This huge convex of fire, Outrageous to devour, immures us round. Milton.\n\nA wall; an inclosure. [Obs.] Shak.",
  ...
  "infirmary": "A hospital, or place where the infirm or sick are lodged and nursed gratuitously, or where out-patients are treated.",
  "intermetacarpal": "Between the metacarpal bones.",
  "intrauterine": "Within the uterus or womb; as, intrauterine hemorrhage.",
  "isospondylous": "Of or pertaining to the Isospondyli; having the anterior vertebræ separate and normal.",
  "iotacism": "The frequent use of the sound of iota (that of English e in be), as among the modern Greeks; also, confusion from sounding Littré.",
  "inclasp": "To clasp within; to hold fast to; to embrace or encircle. [Written also enclasp.] The flattering ivy who did ever see Inclasp the huge trunk of an aged tree. F. Beaumont.",
  ...
  "inturbidate": "To render turbid; to darken; to confuse. [R.] The confusion of ideas and conceptions under the same term painfully inturbidates his theology. Coleridge.",
  "interclose": "To shut in; to inclose. [Obs.]",
  "ironstone": "A hard, earthy ore of iron. Clay ironstone. See under Clay. -- Ironstone china, a hard white pottery, first made in England during the 18th century.",
  ...
  "interlocutor": "1. One who takes part in dialogue or conversation; a talker, interpreter, or questioner. Jer. Taylor. 2. (Law)  An interlocutory judgment or sentence.",
  ...
  "injunction": "1. The act of enjoining; the act of directing, commanding, or prohibiting. 2. That which is enjoined; an order; a mandate; a decree; a command; a precept; a direction. For still they knew,and ought to have still remembered, The high injunction,not to taste that fruit. Milton. Necessary as the injunctions of lawful authority. South. 3. (Law)  A writ or process, granted by a court of equity, and, insome cases, under statutes, by a court of law,whereby a party is required to do or to refrain from doing certain acts, according to the exigency of the writ. Note: It is more generally used as a preventive than as a restorative process, although by no means confined to the former. Wharton. Daniell. Story.",
  "impostor": "One who imposes upon others; a person who assumes a character or title not his own, for the purpose of deception; a pretender. \"The fraudulent impostor foul.\" Milton. Syn. -- Deceiver; cheat; rogue. See Deceiver.",
  "indexterity": "Want of dexterity or readiness, especially in the use of the hands; clumsiness; awkwardness. Harvey.",
  "isagelous": "Containing the same information, as isagelous sentences. The coded message and the original, though appearing entirely unlike, are completely isagelous. Bacon The complementary strands have isagelous sequences. J. D. Watson. -- Isagel I*sag\"e*lous (i*sâg\"ê*lûs), a. Etym: [Is- + Gr. a`gelos information.]  Containing the same information, as isagelous sentences. \"The coded message and the original, though appearing entirely unlike, are completely isagelous.\" Bacon \"The complementary strands have isagelous sequences.\" J. D. Watson. -- Is\"a*gel n.  One of two or more objects containing the same information.",
  ...
  "inhabitance": "1. The act of inhabiting, or the state of being inhabited; the condition of an inhabitant; residence; occupancy. Ruins yet resting in the wild moors testify a former inhabitance. Carew. 2. (Law)  The state of having legal right to claim the privileges of a recognized inhabitant; especially, the right to support in case of poverty, acquired by residence in a town; habitancy.",
  ...
  "indorse": "1. To cover the back of; to load or burden. [Obs.] Elephants indorsed with towers. Milton. 2. To write upon the back or outside of a paper or letter, as a direction, heading, memorandum, or address. 3. (Law & Com.)  To write one's name, alone or with other words, upon the back of (a paper), for the purpose of transferring it, or to secure the payment of a 4. To give one's name or support to; to sanction; to aid by approval; to approve; as, to indorse an opinion. To indorse in blank, to write one's name on the back of a note or bill, leaving a blank to be filled by the holder.",
  "inferable": "Capable of being inferred or deduced from premises. [Written also inferrible.] H. Spencer. A sufficient argument . . . is inferable from these premises. Burke.",
  "immanacle": "To manacle; to fetter; hence; to confine; to restrain from free action. Although this corporal rind Thou hast immanacled. Milton.",
  "impressment": "The act of seizing for public use, or of impressing into public service; compulsion to serve; as, the impressment of provisions or of sailors. The great scandal of our naval service -- impressment -- died a protracted death. J. H. Burton.",
  "inaccurately": "In an inaccurate manner; incorrectly; inexactly.",
  "imposthumation": "1. The act of forming an abscess; state of being inflamed; suppuration. 2. An abscess; an imposthume. Coxe.",
  ...
  "indistinguishable": "Not distinguishable; not capable of being perceived, known, or discriminated as separate and distinct; hence, not capable of being perceived or known; as, in the distance the flagship was indisguishable; the two copies were indisguishable in form or color; the difference between them was indisguishable.",
  "incoming": "1. Coming in; accruing. A full incoming profit on the product of his labor. Burke. 2. Coming in, succeeding, or following, as occupant or possessor; as, in incoming tenant.\n\n1. The act of coming in; arrival. The incomings and outgoings of the trains. Dickens. 2. Income; gain. [R.] Many incomings are subject to great fluctuations. Tooke.",
  ...
  "impune": "Unpunished. [R.]",
  "industrialism": "1. Devotion to industrial pursuits; labor; industry. J. S. Mill. 2. The principles or policy applicable to industrial pursuits or organized labor. Industrialism must not confounded with industriousness. H. Spencer.",
  ...
  "intellection": "A mental act or process; especially: (a) The act of understanding; simple apprehension of ideas; intuition. Bentley. (b) A creation of the mind itself. Hickok.",
  "inexecution": "Neglect of execution; nonperformance; as, the inexecution of a treaty. Spence.",
  "incoordination": "Want of coördination; lack of harmonious adjustment or action. Incoördination of muscular movement (Physiol.), irregularity in movements resulting from inharmonious action of the muscles in consequence of loss of voluntary control over them.",
  ...
  "indazol": "A nitrogenous compound, C7H6N2, analogous to indol, and produced from a diazo derivative or cinnamic acid.",
  "informative": "Having power to inform, animate, or vivify. Dr. H. More.",
  "illiterature": "Want of learning; illiteracy. [R.] Ayliffe. Southey.",
  "inception": "1. Beginning; commencement; initiation. Bacon. Marked with vivacity of inception, apathy of progress, and prematureness of decay. Rawle. 2. Reception; a taking in. [R.] Poe.",
  "idiotcy": "Idiocy. [R.]",
  "irresolute": "Not resolute; not decided or determined; wavering; given to doubt or irresolution. Weak and irresolute is man. Cowper. Syn. -- Wavering; vacillating; undetermined; undecided; unsettled; fickle; changeable; inconstant. -- Ir*res\"o*lute*ly, adv. -- Ir*res\"o*lute*ness, n.",
  "ichthyosaur": "One of the Ichthyosaura.",
  "isocephalism": "A peculiarity in the design of bas-relief by which the heads of human figures are kept at the same height from the ground, whether the personages are seated, standing, or mounted on horseback; -- called also isokephaleia.",
  "intrinsic": "1. Inward; internal; hence, true; genuine; real; essential; inherent; not merely apparent or accidental; -- opposed to extrinsic; as, the intrinsic value of gold or silver; the intrinsic merit of an action; the intrinsic worth or goodness of a person. He was better qualified than they to estimate justly the intrinsic value of Grecian philosophy and refinement. I. Taylor. 2. (Anat.)  Included wholly within an organ or limb, as certain groups of muscles; -- opposed to extrinsic. Intrinsic energy of a body (Physics), the work it can do in virtue of its actual condition, without any supply of energy from without. -- Intrinsic equation of a curve (Geom.), the equation which expresses the relation which the length of a curve, measured from a given point of it, to a movable point, has to the angle which the tangent to the curve at the movable point makes with a fixed line. -- Intrinsic value. See the Note under Value, n. Syn. -- Inherent; innate; natural; real; genuine.\n\nA genuine quality. [Obs.] Warburton.",
  "inclemency": "1. The state or quality of being inclement; want of clemency; want of mildness of temper; unmercifulness; severity. The inclemency of the late pope. Bp. Hall. 2. Physical severity or harshness (commonly in respect to the elements or weather); roughness; storminess; rigor; severe cold, wind, rain, or snow. The inclemencies of morning air. Pope. The rude inclemency of wintry skies. Cowper. Syn. -- Harshness; severity; cruelty; rigor; roughness; storminess; boisterousness.",
  "interstice": "1. That which intervenes between one thing and another; especially, a space between things closely set, or between the parts which compose a body; a narrow chink; a crack; a crevice; a hole; an interval; as, the interstices of a wall. 2. An interval of time; specifically (R. C. Ch.), in the plural, the intervals which the canon law requires between the reception of the various degrees of orders. Nonobservance of the interstices . . . is a sin. Addis & Arnold.",
  "insignia": "1. Distinguishing marks of authority, office, or honor; badges; tokens; decorations; as, the insignia of royalty or of an order. 2. Typical and characteristic marks or signs, by which anything is known or distinguished; as, the insignia of a trade.",
  ...
  "isochromatic": "Having the same color; connecting parts having the same color, as lines drawn through certain points in experiments on the chromatic effects of polarized light in crystals.",
  ...
  "infare": "A house-warming; especially, a reception, party, or entertainment given by a newly married couple, or by the husband upon receiving the wife to his house. [Written also infair.] [Scot., & Local, U. S.]",
  "icosahedron": "A solid bounded by twenty sides or faces. Regular icosahedron, one of the five regular polyhedrons, bounded by twenty equilateral triangules. Five triangules meet to form each solid angle of the polyhedron.",
  "indraught": "1. An opening from the sea into the land; an inlet. [Obs.] Sir W. Raleigh. 2. A draught of air or flow of water setting inward.",
  "impulsor": "One who, or that which, impels; an inciter. [R.] Sir T. Browne.",
  "infix": "1. To set; to fasten or fix by piercing or thrusting in; as, to infix a sting, spear, or dart. Shak. The fatal dart a ready passage found, And deep within her heart infixed the wound. Dryden. 2. To implant or fix; to instill; to inculcate, as principles, thoughts, or instructions; as, to infix good principles in the mind, or ideas in the memory.\n\nSomething infixed. [R.] Welsford.",
  ...
  "idle-headed": "1. Foolish; stupid. [Obs.] \"The superstitious idle-headed eld.\" Shak. 2. Delirious; infatuated. [Obs.] L'Estrange.",
  "ilex": "(a) The holm oak (Quercus Ilex). (b) A genus of evergreen trees and shrubs, including the common holly.",
  ...
  "itacism": "Pronunciation of e in the English word be. This was the pronunciation advocated by ReuEtacism. In all such questions between a the confusing element of itacism comes in. Alford.",
  ...
  "intorsion": "1. A winding, bending, or twisting. 2. (Bot.)  The bending or twining of any part of a plant toward one side or the other, or in any direction from the vertical.",
  ...
  "importable": "Capable of being imported.\n\nNot to be endured; insupportable; intolerable. [Obs.] Chaucer. -- Im*port\"a*ble*ness, n. [Obs.]",
  "infanthood": "Infancy. [R.]",
  "ignis fatuus": "1. A phosphorescent light that appears, in the night, over marshy ground, supposed to be occasioned by the decomposition of animal or vegetable substances, or by some inflammable gas; -- popularly called also Will-with-the-wisp, or Will-o'-the-wisp, and Jack-with-a- lantern, or Jack-o'-lantern. 2. Fig.: A misleading influence; a decoy. Scared and guided by the ignis fatuus of popular superstition. Jer. Taylor.",
  ...
  "interosculant": "1. Mutually touching or intersecting; as, interosculant circles. 2. (Biol.)  Uniting two groups; -- said of certain genera which connect family groups, or of species that connect genera. See Osculant.",
  "ignivomous": "Vomiting fire. [R.]",
  "inurn": "To put in an urn, as the ashes of the dead; hence, to bury; to intomb. The sepulcher Wherein we saw thee quietly inurned. Shak.",
  ...
  "inefficient": "1. Not efficient; not producing the effect intended or desired; inefficacious; as, inefficient means or measures. 2. Incapable of, or indisposed to, effective action; habitually slack or remiss; effecting little or nothing; as, inefficient workmen; an inefficient administrator.",
  ...
  "ill-tempered": "1. Of bad temper; morose; crabbed; sour; peevish; fretful; quarrelsome. 2. Unhealthy; ill-conditioned. [Obs.] So ill-tempered I am grown, that I am afraid I shall catch cold, while all the world is afraid to melt away. Pepys.",
  "incogitance": "Want of thought, or of the power of thinking; thoughtlessness; unreasonableness. 'T is folly and incogitancy to argue anything, one way or the other, from the designs of a sort of beings with whom we so little communicate. Glanvill.",
  ...
  "implead": "To institute and prosecute a suit against, in court; to sue or prosecute at law; hence, to accuse; to impeach.\n\nTo sue at law.",
  ...
  "incroyable": "A French fop or dandy of the time of the Directory; hence, any fop. The name is said to have been given in allusion not only to the extravagant dress, but also to the frequent use of the phrase \"C'est vraiment incroyable\" (That is really incredible.).",
  ...
  "inning": "1. Ingathering; harvesting. [Obs.] Holland. 2. The state or turn of being in; specifically, in cricket, baseball, etc.,the turn or time of a player or of a side at the bat; -- often in the pl. Hence: The turn or time of a person, or a party, in power; as, the Whigs went out, and the Democrats had their innings. 3. pl.  Lands recovered from the sea. Ainsworth.",
  "inamorato": "A male lover.",
  "interpause": "An intermission. [R.]",
  "indigitate": "To communicative ideas by the fingers; to show or compute by the fingers. [Obs.]\n\nTo point out with the finger; to indicate. [Obs.] The depressing this finger, . . . in the right hand indigitate six hundred. Sir T. Browne.",
  ...
  "inexcusable": "Not excusable; not admitting excuse or justification; as, inexcusable folly. Therefore thou art inexcusable, O man, whosoever thou art that judgest; for wherein thou judgest another, thou condemnest thyself; for thou that judgest doest the same things. Rom. ii. 1.",
  ...
  "induplicative": "(a) Having induplicate sepals or petals in æstivation. (b) Having induplicate leaves in vernation.",
  ...
  "insuetude": "The state or quality of being unaccustomed; absence of use or habit. Absurdities are great or small in proportion to custom or insuetude. Landor.",
  ...
  "impatronization": "Absolute seignory or possession; the act of investing with such possession. [R.] Cotgrave.",
  "inasmuch": "In like degree; in like manner; seeing that; considering that; since; -- followed by as. See In as much as, under In, prep. Inasmuch as ye did it not to one of the least of these, ye did it not to me. Matt. xxv. 45. Syn. -- Because; since; for; as. See Because.",
  "incomprehensible": "1. Not capable of being contained within limits. An infinite and incomprehensible substance. Hooker. 2. Not capable of being comprehended or understood; beyond the reach of the human intellect; inconceivable. And all her numbered stars that seem to roll Spaces incomprehensible. Milton. -- In*com`pre*hen\"si*ble*ness, n. -- In*com`pre*hen\"si*bly, adv.",
  ...
  "inflect": "1. To turn from a direct line or course; to bend; to incline, to deflect; to curve; to bow. Are they [the rays of the sun] not reflected, refracted, and inflected by one and the same principle Sir I. Newton. 2. (Gram.)  To vary, as a noun or a verb in its terminations; to decline, as a noun or adjective, or to conjugate, as a verb. 3. To modulate, as the voice.",
  ...
  "inoculate": "1. To bud; to insert, or graft, as the bud of a tree or plant in another tree or plant. 2. To insert a foreign bud into; as, to inoculate a tree. 3. (Med.)  To communicate a disease to ( a person ) by inserting infectious matter in the skin or flesh; as, to inoculate a person with the virus of smallpox,rabies, etc. See Vaccinate. 4. Fig.: To introduce into the mind; -- used especially of harmful ideas or principles; to imbue; as, to inoculate one with treason or infidelity.\n\n1. To graft by inserting buds. 2. To communicate disease by inoculation.",
  "intire": "See Entire, a., Entirely, adv.",
  "isagel": "Containing the same information, as isagelous sentences. The coded message and the original, though appearing entirely unlike, are completely isagelous. Bacon The complementary strands have isagelous sequences. J. D. Watson. -- Isagel I*sag\"e*lous (i*sâg\"ê*lûs), a. Etym: [Is- + Gr. a`gelos information.]  Containing the same information, as isagelous sentences. \"The coded message and the original, though appearing entirely unlike, are completely isagelous.\" Bacon \"The complementary strands have isagelous sequences.\" J. D. Watson. -- Is\"a*gel n.  One of two or more objects containing the same information.",
  "isidorian": "Pertaining, or ascribed, to Isidore; as, the Isidorian decretals, a spurious collection of decretals published in the ninth century.",
  "isopoda": "An order of sessile-eyed Crustacea, usually having seven pairs of legs, which are all similar in structure. Note: The body is usually depressed, with the abdominal segments short, and often consolidated in part. The branchiæ are on the abdominal appendages. The group includes the terrestrial pill bugs and sow bugs, with numerous marine forms. See Arthrostrata, Gribble.",
  "intratropical": "Within the tropics.",
  "illiquation": "The melting or dissolving of one thing into another.",
  "improperia": "A series of antiphons and responses, expressing the sorrowful remonstrance of our Lord with his people; -- sung on the morning of the Good Friday in place of the usual daily Mass of the Roman ritual. Grove.",
  ...
  "incurvation": "1. The act of bending, or curving. 2. The state of being bent or curved; curvature. An incurvation of the rays. Derham. 3. The act of bowing, or bending the body, in respect or reverence. \"The incurvations of the knee.\" Bp. Hall.",
  "indogenide": "Any one of the derivatives of indogen, which contain that group as a nucleus.",
  "intercentral": "Between centers. Intercentral nerves (Physiol.), those nerves which transmit impulses between nerve centers, as opposed to peripheral fibers, which convey impulses between peripheral parts and nerve centers.",
  ...
  "isometric": "1. Pertaining to, or characterized by, equality of measure. 2. (Crystallog.)  Noting, or conforming to, that system of crystallization in which the three axes are of equal length and at right angles to each other; monometric; regular; cubic. Cf. Crystallization. Isometric lines (Thermodynamics), lines representing in a diagram the relations of pressure and temperature in a gas, when the volume remains constant. -- Isometrical perspective. See under Perspective. -- Isometrical projection, a species of orthographic projection, in which but a single plane of projection is used. It is so named from the fact that the projections of three equal lines, parallel respectively to three rectangular axes, are equal to one another. This kind of projection is principally used in delineating buildings or machinery, in which the principal lines are parallel to three rectangular axes, and the principal planes are parallel to three rectangular planes passing through the three axes.",
  "impenetrability": "1. Quality of being impenetrable. 2. (Physics)  That property in virtue of which two portions of matter can not at the same time occupy the same portion of space. 3. Insusceptibility of intellectual or emotional impression; obtuseness; stupidity; coldness.",
  ...
  "imperium": "1. Supreme power; absolute dominion; empire. 2.  (Law) The right to command, which includes the right to employ the force of the state to enforce the laws. It is one of the principal attributes of the executive power.",
  "incorruptness": "1. Freedom or exemption from decay or corruption. 2. Probity; integrity; honesty. Woodward.",
  ...
  "inanimate": "To animate. [Obs.] Donne.\n\nNot animate; destitute of life or spirit; lifeless; dead; inactive; dull; as, stones and earth are inanimate substances. Grieving, if aught inanimate e'er grieves. Byron. Syn. -- Lifeless; dead; inert; inactive; dull; soulless; spiritless. See Lifeless.",
  ...
  "incapability": "1. The quality of being incapable; incapacity. Suckling. 2. (Law)  Want of legal qualifications, or of legal power; as, incapability of holding an office.",
  "inodorous": "Emitting no odor; wthout smell; scentless; odorless. -- In*o\"dor*ous*ness, n.",
  "improvident": "Not provident; wanting foresight or forethought; not foreseeing or providing for the future; negligent; thoughtless; as, an improvident man. Improvident soldires! had your watch been good, This sudden mischief never could have fallen. Shak. Syn. -- Inconsiderable; negligent; careless; shiftless; prodigal; wasteful.",
  ...
  "imam": "1. Among the Mohammedans, a minister or priest who performs the regular service of the mosque. 2. A Mohammedan prince who, as a successor of Mohammed, unites in his person supreme spiritual and temporal power.",
  "induplicate": "(a) Having the edges bent abruptly toward the axis; -- said of the parts of the calyx or corolla in æstivation. (b) Having the edges rolled inward and then arranged about the axis without overlapping; -- said of leaves in vernation.",
  ...
  "itself": "The neuter reciprocal pronoun of It; as, the thing is good in itself; it stands by itself. Borrowing of foreigners, in itself, makes not the kingdom rich or poor. Locke.",
  ...
  "incontinently": "1. In an incontinent manner; without restraint, or without due restraint; -- used esp. of the passions or appetites. 2. Immediately; at once; forthwith. [Archaic] Immediately he sent word to Athens that he would incontinently come hither with a host of men. Golding.",
  "influxively": "By influxion. [R.]",
  "irony": "1. Made or consisting of iron; partaking of iron; iron; as, irony chains; irony particles. [R.] Woodward. 2. Resembling iron taste, hardness, or other physical property.\n\n1. Dissimulation; ignorance feigned for the purpose of confounding or provoking an antagonist. 2. A sort of humor, ridicule, or light sarcasm, which adopts a mode of speech the meaning of which is contrary to the literal sense of the words.",
  ...
  "imparsonee": "Presented, instituted, and inducted into a rectory, and in full possession. -- n.  A clergyman so inducted.",
  "introversion": "The act of introverting, or the state of being introverted; the act of turning the mind inward. Berkeley.",
  "indulgent": "Prone to indulge; yielding to the wishes, humor, or appetites of those under one's care; compliant; not opposing or restraining; tolerant; mild; favorable; not severe; as, an indulgent parent. Shak. The indulgent censure of posterity. Waller. The feeble old, indulgent of their ease. Dryden.",
  "ingreat": "To make great; to enlarge; to magnify. [Obs.] Fotherby.",
  "inducteous": "Rendered electro-polar by induction, or brought into the opposite electrical state by the influence of inductive bodies.",
  "inoculation": "1. The act or art of inoculating trees or plants. 2. (Med.)  The act or practice of communicating a disease to a person in health, by inserting contagious matter in his skin or flesh. Note: The use was formerly limited to the intentional communication of the smallpox, but is now extended to include any similar introduction of modified virus; as, the inoculation of rabies by Pasteur. 3. Fig.: The communication of principles, especially false principles, to the mind.",
  "insociably": "Unsociably.",
  "insusurration": "The act of whispering into something. [Obs.] Johnson.",
  "insatisfaction": "1. Insufficiency; emptiness. [Obs.] Bacon. 2. Dissatisfaction. [Obs.] Sir T. Browne.",
  "inflammatory": "1. Tending to inflame, kindle, or irritate. 2. Tending to excite anger, animosity, tumult, or sedition; seditious; as, inflammatory libels, writings, speeches, or publications. Burke. 3. (Med.)  Accompanied with, or tending to cause, preternatural heat and excitement of arterial action; as, an inflammatory disease. Inflammatory crust. (Med.) Same as Buffy coat, under Buffy. -- Inflammatory fever, a variety of fever due to inflammation.",
  "inadhesion": "Want of adhesion.",
  "infeudation": "1. (Law)  The act of putting one in possession of an estate in fee. Sir M. Hale. 2. The granting of tithes to laymen. Blackstone.",
  ...
  "invariance": "The property of remaining invariable under prescribed or implied conditions. J. J. Sylvester.",
  ...
  "interjacency": "The state of being between; a coming or lying between or among; intervention; also, that which lies between. England and Scotland is divided only by the interjacency of the Tweed. Sir M. Hale.",
  ...
  "imperator": "A commander; a leader; an emperor; -- originally an appellation of honor by which Roman soldiers saluted their general after an important victory. Subsequently the title was conferred as a recognition of great military achievements by the senate, whence it carried wiht it some special privileges. After the downfall of the Republic it was assumed by Augustus and his successors, and came to have the meaning now attached to the word emperor.",
  ...
  "inadvertency": "1. The quality of being inadvertent; lack of heedfulness or attentiveness; inattention; negligence; as, many mistakes proceed from inadvertence. Inadvertency, or want of attendance to the sense and intention of our prayers. Jer. Taylor. 2. An effect of inattention; a result of carelessness; an oversight, mistake, or fault from negligence. The productions of a great genius, with many lapses an inadvertencies, are infinitely preferable to works of an inferior kind of author which are scrupulously exact. Addison. Syn. -- Inattention; heedlessness; carelessness; negligence; thoughtlessness. See Inattention.",
  "informer": "1. One who informs, animates, or inspires. [Obs.] Thomson. Nature, informer of the poet's art. Pope. 2. One who informs, or imparts knowledge or news. 3. (Law)  One who informs a magistrate of violations of law; one who informs against another for violation of some law or penal statute. Common informer (Law), one who habitually gives information of the violation of penal statutes, with a view to a prosecution therefor. Bouvier. Wharton.",
  ...
  "induline": "(a) Any one of a large series of aniline dyes, colored blue or violet, and represented by aniline violet. (b) A dark green amorphous dyestuff, produced by the oxidation of aniline in the presence of copper or vanadium salts; -- called also aniline black.",
  ...
  "inadvertent": "Not turning the mind to a matter; heedless; careless; negligent; inattentive. An inadvertent step may crush the snail That crawls at evening in the public path. Cowper. -- In`ad*vert\"ent*ly, adv.",
  ...
  "insulator": "1. One who, or that which, insulates. 2. (Elec. & Thermotics)  The substance or body that insulates; a nonconductor.",
  "inarticulate": "1. Not uttered with articulation or intelligible distinctness, as speech or words. Music which is inarticulate poesy. Dryden. 2. (Zoöl.) (a) Not jointed or articulated; having no distinct body segments; as, an inarticulate worm. (b) Without a hinge; -- said of an order (Inarticulata or Ecardines) of brachiopods. 3. Incapable of articulating. [R.] The poor earl, who is inarticulate with palsy. Walpole.",
  "inhumanly": "In an inhuman manner; cruelly; barbarously.",
  "infamously": "In an infamous manner or degree; scandalously; disgracefully; shamefully. The sealed fountain of royal bounty which had been infamously monopolized and huckstered. Burke.",
  "ixodian": "A tick of the genus Ixodes, or the family Ixodidæ.",
  "inconvertibility": "The quality or state of being inconvertible; not capable of being exchanged for, or converted into, something else; as, the inconvertibility of an irredeemable currency, or of lead, into gold.",
  ...
  "inseparable": "1. Not separable; incapable of being separated or disjoined. The history of every language is inseparable from that of the people by whom it is spoken. Mure. Liberty and union, now and forever, one and inseparable. D. Webster. 2. (Gram.)  Invariably attached to some word, stem, or root; as, the inseparable particle un-.",
  "incultivation": "Want of cultivation. [Obs.] Berington.",
  "ironical": "1. Pertaining to irony; containing, expressing, or characterized by, irony; as, an ironical remark. 2. Addicted to the use of irony; given to irony. -- I*ron\"ic*al*ly, adv. -- I*ron\"ic*al*ness, n.",
  "immoment": "Trifling. [R.] \"Immoment toys.\" Shak.",
  "investiture": "1. The act or ceremony of investing, or the of being invested, as with an office; a giving possession; also, the right of so investing. He had refused to yield up to the pope the investiture of bishops. Sir W. Raleigh. 2. (Feudal Law)  Livery of seizin. The grant of land or a feud was perfected by the ceremony oinvestiture, or open delivery of possession. Blackstone. 3. That with which anyone is invested or clothed; investment; clothing; covering. While we yet have on Our gross investiture of mortal weeds. Trench.",
  "ichthus": "In early Christian and eccesiastical art, an emblematic fish, or the Greek word for fish, which combined the initials of the Greek words",
  ...
  "inversely": "In an inverse order or manner; by inversion; -- opposed to directly. Inversely proportional. See Directly proportional, under Directly, and Inversion, 4.",
  ...
  "insulting": "Containing, or characterized by, insult or abuse; tending to insult or affront; as, insulting language, treatment, etc. -- In*sult\"ing*ly, adv. Syn. -- Insolent; impertinent; saucy; rude; abusive; contemptuous. See Insolent.",
  "ivan ivanovitch": ". An ideal personification of the typical Russian or of the Russian people; -- used as \"John Bull\" is used for the typical Englishman. I'VE I've  . Colloquial contraction of I have.",
  ...
  "isopiestic": "Having equal pressure. Isopiestic lines, lines showing, in a diagram, the relations of temperature and volume, when the elastic force is constant; -- called also isobars.",
  ...
  "irreparable": "Not reparable; not capable of being repaired, recovered, regained, or remedied; irretrievable; irremediable; as, an irreparable breach; an irreparable loss. Shak.",
  ...
  "inleague": "To ally, or form an alliance witgh; to unite; to combine. With a willingness inleague our blood With his, for purchase of full growth in friendship. Ford.",
  ...
  "indris": "Any lemurine animal of the genus Indris. Note: Several species are known, all of them natives of Madagascar, as the diadem indris (I. diadema), which has a white ruff around the forehead; the woolly indris (I. laniger); and the short-tailed or black indris (I. brevicaudatus), which is black, varied with gray.",
  "isoprene": "An oily, volatile hydrocarbon, obtained by the distillation of caoutchouc or guttaipercha.C5H8 -- unsaturated, and used to make synthetic rubber by polymerization. In organic chemistry, viewed conceptually as the building block of the terpene series of hydrocarbons",
  "inappellability": "The quality of being inappellable; finality. The inappellability of the councils. Coleridge.",
  "idleness": "The condition or quality of being idle (in the various senses of that word); uselessness; fruitlessness; triviality; inactivity; laziness. Syn. -- Inaction; indolence; sluggishness; sloth.",
  ...
  "inertion": "Want of activity or exertion; inertness; quietude. [R.] These vicissitudes of exertion and inertion of the arterial system constitute the paroxysms of remittent fever. E. Darwin.",
  "ingenie": "See Ingeny.",
  ...
  "inhere": "To be inherent; to stick (in); to be fixed or permanently incorporated with something; to cleave (to); to belong, as attributes or qualities. They do but inhere in the subject that supports them. Digby.",
  ...
  "issuance": "The act of issuing, or giving out; as, the issuance of an order; the issuance of rations, and the like.",
  ...
  "isochasm": "A line connecting places on the earth's surface at which there is the same mean frequency of auroras.",
  ...
  "invertible": "1. Capable of being inverted or turned. 2. (Chem.)  Capable of being changed or converted; as, invertible sugar.\n\nIncapable of being turned or changed. An indurate and invertible conscience. Cranmer.",
  "ineffaceable": "Incapable of being effaced; indelible; ineradicable.",
  "inevitable": "1. Not evitable; incapable of being shunned; unavoidable; certain. \"The inevitable hour.\" Gray. It was inevitable; it was necessary; it was planted in the nature of things. Burke. 2. Irresistible. \"Inevitable charms.\" Dryden.",
  "imparl": "1. To hold discourse; to parley. [Obs.] Sir. T. North. 2. (Law)  To have time before pleading; to have delay for mutual adjustment. Blackstone.",
  "inhabile": "1. Not apt or fit; unfit; not convenient; inappropriate; unsuitable; as, inhabile matter. [Obs.] 2. Unskilled; unready; awkward; incompetent; unqualified; -- said of person. [Obs.] See Unable.",
  ...
  "isonicotinic": "(a) Pertaining to, or derived from, isonicotine. (b) Pertaining to, or designating, an acid isomeric with nicotinic acid.",
  "intumescent": "Swelling up; expanding.",
  "iridioscope": "A kind of ophthalmoscope.",
  "ischium": "1. (Anat.)  The ventral and posterior of the three principal bones composing either half of the pelvis; seat bone; the huckle bone. 2. (Zoöl.)  One of the pleuræ of insects.",
  ...
  "intendment": "1. Charge; oversight. [Obs.] Ford. 2. Intention; design; purpose. The intendment of God and nature. Jer. Taylor. 3. (Law)  The true meaning, understanding, or intention of a law, or of any legal instrument.",
  ...
  "imposture": "The act or conduct of an impostor; deception practiced under a false or assumed character; fraud or imposition; cheating. From new legends And fill the world with follies and impostures. Johnson. Syn. -- Cheat; fraud; trick; imposition; delusion.",
  ...
  "ignite": "1. To kindle or set on fire; as, to ignite paper or wood. 2. (Chem.)  To subject to the action of intense heat; to heat strongly; -- often said of incombustible or infusible substances; as, to ignite iron or platinum.\n\nTo take fire; to begin to burn.",
  "indusium": "(a) A collection of hairs united so as to form a sort of cup, and inclosing the stigma of a flower. (b) The immediate covering of the fruit dots or sori in many ferns, usually a very thin scale attached by the middle or side to a veinlet. (c) A peculiar covering found in certain fungi.",
  "idoneous": "Appropriate; suitable; proper; fit; adequate. [R.] An ecclesiastical benefice . . . ought to be conferred on an idoneous person. Ayliffe.",
  "intrinsicalness": "The quality of being intrinsical; intrinsicality.",
  "immoral": "Not moral; inconsistent with rectitude, purity, or good morals; contrary to conscience or the divine law; wicked; unjust; dishonest; vicious; licentious; as, an immoral man; an immoral deed. Syn. -- Wicked; sinful; criminal; vicious; unjust; dishonest; depraved; impure; unchaste; profligate; dissolute; abandoned; licentious; lewd; obscene.",
  "inlaid": "of Inlay.",
  "ivory-bill": "A large, handsome, North American woodpecker (Campephilus principalis), having a large, sharp, ivory-colored beak. Its general color is glossy black, with white secondaries, and a white dorsal stripe. The male has a large, scarlet crest. It is now rare, and found only in the Gulf States.",
  ...
  "importunity": "The quality of being importunate; pressing or pertinacious solicitation; urgent request; incessant or frequent application; troublesome pertinacity. O'ercome with importunity and tears. Milton.",
  ...
  "indecipherable": "Not decipherable; incapable of being deciphered, explained, or solved. -- In`de*ci\"pher*a*bly, adv.",
  ...
  "invasion": "1. The act of invading; the act of encroaching upon the rights or possessions of another; encroachment; trespass. 2. A warlike or hostile entrance into the possessions or domains of another; the incursion of an army for conquest or plunder. 3. The incoming or first attack of anything hurtful or pernicious; as, the invasion of a disease. Syn. -- Invasion, Irruption, Inroad. Invasion is the generic term, denoting a forcible entrance into a foreign country. Incursion signifies a hasty and sudden invasion. Irruption denotes particularly violent invasion. Inroad is entry by some unusual way involving trespass and injury.",
  "involvement": "The act of involving, or the state of being involved. Lew Wallace.",
  "isobathytherm": "A line connecting the points on the surface of the earth where a certain temperature is found at the same depth.",
  "incapacious": "Not capacious; narrow; small; weak or foolish; as, an incapacious soul. Bp. Burnet. -- In`ca*pa\"cious*ness, n.",
  ...
  "impede": "To hinder; to stop in progress; to obstruct; as, to impede the advance of troops. Whatever hinders or impedes The action of the nobler will. Logfellow.",
  ...
  "insalutary": "1. Not salutary or wholesome; unfavorable to health. 2. Not tending to safety; productive of evil.",
  ...
  "iridaceous": "Pertaining to, or resembling, a large natural order of endogenous plants (Iridaceæ), which includes the genera Iris, Ixia, Crocus, Gladiolus, and many others.",
  "infeeble": "See Enfeeble.",
  "intice": "See Entice.",
  "isochronous": "Same as Isochronal.",
  "idioelectric": "Electric by virtue of its own peculiar properties; capable of becoming electrified by friction; -- opposed to anelectric. -- n.  An idioelectric substance.",
  "idler": "1. One who idles; one who spends his time in inaction; a lazy person; a sluggard. 2. (Naut.)  One who has constant day duties on board ship, and keeps no regular watch. Totten. 3. (Mach.)  An idle wheel or pulley. See under Idle.",
  "interlamellar": "Between lammellæ or laminæ; as, interlamellar spaces.",
  ...
  "infraspinal": "(a) Below the vertebral column, subvertebral. (b) Below the spine; infraspinate; infraspinous.",
  ...
  "interruptedly": "With breaks or interruptions; discontinuously. Interruptedly pinnate (Bot.), pinnate with small leaflets intermixed with large ones. Gray.",
  ...
  "impacted": "Driven together or close. Impacted fracture (Surg.), a fracture in which the fragments are driven into each other so as to be immovable.",
  ...
  "inwreathe": "To surround or encompass as with a wreath. [Written also enwreathe.] Resplendent locks, inwreathed with beams. Milton.",
  ...
  "illiterate": "Ignorant of letters or books; unlettered; uninstructed; uneducated; as, an illiterate man, or people. Syn. -- Ignorant; untaught; unlearned; unlettered; unscholary. See Ignorant. -- Il*lit\"er*ate*ly, adv. -- Il*lit\"er*ate*ness, n.",
  ...
  "illure": "To deceive; to entice; to lure. [Obs.] The devil insnareth the souls of many men, by illuring them with the muck and dung of this world. Fuller.",
  "inconcinne": "Dissimilar; incongruous; unsuitable. [Obs.] Cudworth.",
  "idlesse": "Idleness. [Archaic] \"In ydlesse.\" Spenser. And an idlesse all the day Beside a wandering stream. Mrs. Browning.",
  ...
  "insatiable": "Not satiable; incapable of being satisfied or appeased; very greedy; as, an insatiable appetite, thirst, or desire. \"Insatiable of glory.\" Milton.",
  ...
  "ileocolic": "Pertaining to the ileum and colon; as, the ileocolic, or ileocæcal, valve, a valve where the ileum opens into the large intestine.",
  ...
  "inofficious": "1. Indifferent to obligation or duty. [Obs.] Thou drown'st thyself in inofficious sleep. B. Jonson. 2. Not officious; not civil or attentive. [Obs.] Jonhson. 3. (Law)  Regardless of natural obligation; contrary to natural duty; unkind; -- commonly said of a testament made without regard to natural obligation, or by which a child is unjustly deprived of inheritance. \"The inofficious testament.\" Blackstone. \"An inofficious disposition of his fortune.\" Paley.",
  ...
  "incrassated": "1. Made thick or thicker; thickened; inspissated. 2. (Bot.)  Thickened; becoming thicker. Martyn. 3. (Zoöl.)  Swelled out on some particular part, as the antennæ of certain insects.",
  ...
  "indecent": "Not decent; unfit to be seen or heard; offensive to modesty and delicacy; as, indecent language. Cowper. Syn. -- Unbecoming; indecorous; indelicate; unseemly; immodest; gross; shameful; impure; improper; obscene; filthy.",
  "inhibitory-motor": "A term applied to certain nerve centers which govern or restrain subsidiary centers, from which motor impressions issue. McKendrick.",
  "impersonation": "The act of impersonating; personification; investment with personality; representation in a personal form.",
  ...
  "immorality": "1. The state or quality of being immoral; vice. The root of all immorality. Sir W. Temple. 2. An immoral act or practice. Luxury and sloth and then a great drove of heresies and immoralities broke loose among them. Milton.",
  ...
  "idiocy": "The condition or quality of being an idiot; absence, or marked deficiency, of sense and intelligence. I will undertake to convict a man of idiocy, if he can not see the proof that three angles of a triangle are equal to two right angles. F. W. Robertson.",
  ...
  "incrassate": "To make thick or thicker; to thicken; especially, in pharmacy, to thicken (a liquid) by the mixture of another substance, or by evaporating the thinner parts. Acids dissolve or attenuate; alkalies precipitate or incrassate. Sir I. Newton. Liquors which time hath incrassated into jellies. Sir T. Browne.\n\nTo become thick or thicker.\n\n1. Made thick or thicker; thickened; inspissated. 2. (Bot.)  Thickened; becoming thicker. Martyn. 3. (Zoöl.)  Swelled out on some particular part, as the antennæ of certain insects.",
  "instigate": "To goad or urge forward; to set on; to provoke; to incite; -- used chiefly with reference to evil actions; as to instigate one to a crime. He hath only instigated his blackest agents to the very extent of their malignity. Bp. Warburton. Syn. -- To stimulate; urge; spur; provoke; tempt; incite; impel; encourage; animate.",
  "indivisibly": "In an indivisible manner.",
  "icicled": "Having icicles attached.",
  "incompliance": "1. The quality or state of being incompliant; unyielding temper; obstinacy. Self-conceit produces peevishness and incompliance of humor in things lawful and indifferent. Tillotson. 2. Refusal or failure to comply. Strype.",
  "isocryme": "A line connecting points on the earth's surface having the same mean temperature in the coldest month of the year.",
  ...
  "infrangible": "1. Not capable of being broken or separated into parts; as, infrangible atoms. [He] link'd their fetlocks with a golden band Infrangible. Pope. 2. Not to be infringed or violated.",
  ...
  "ic": "1. A suffix signifying, in general, relating to, or characteristic of; as, historic, hygienic, telegraphic, etc. 2. (Chem.)  A suffix, denoting that the element indicated enters into certain compounds with its highest valence, or with a valence relatively higher than in compounds where the name of the element ends in -ous; as, ferric, sulphuric. It is also used in the general sense of pertaining to; as, hydric, sodic, calcic.",
  "inopulent": "Not opulent; not affluent or rich.",
  "indeficiency": "The state or quality of not being deficient. [Obs.] Strype.",
  "incommunicative": "Not communicative; not free or apt to impart to others in conversation; reserved; silent; as, the messenger was incommunicative; hence, not disposed to hold fellowship or intercourse with others; exclusive. The Chinese . . . an incommunicative nation. C. Buchanan. -- In`com*mu\"ni*ca*tive*ly, adv. -- In`com*mu\"ni*ca*tive*ness, n. Lamb. His usual incommunicativeness. G. Eliot.",
  "insue": "See Ensue, v. i.",
  ...
  "incorrigible": "Not corrigible; incapable of being corrected or amended; bad beyond correction; irreclaimable; as, incorrigible error. \"Incorrigible fools.\" Dryden.\n\nOne who is corrigible; especially, a hardened criminal; as, the perpetual imprisonment of incorrigibles.",
  ...
  "incase": "To inclose in a case; to inclose; to cover or surround with something solid. Rich plates of gold the folding doors incase. Pope.",
  ...
  "incendiary": "1. Any person who maliciously sets fire to a building or other valuable or other valuable property. 2. A person who excites or inflames factions, and promotes quarrels or sedition; an agitator; an exciter. Several cities . . . drove them out as incendiaries. Bentley.\n\n1. Of or pertaining to incendiarism, or the malicious burning of valuable property; as, incendiary material; as incendiary crime. 2. Tending to excite or inflame factions, sedition, or quarrel; inflammatory; seditious. Paley. Incendiary shell, a bombshell. See Carcass, 4.",
  ...
  "isochor": "A line upon a thermodynamic diagram so drawn as to represent the pressures corresponding to changes of temperature when the volume of the gas operated on is constant. -- I`so*chor\"ic (#), a.",
  ...
  "inceptive": "Beginning; expressing or indicating beginning; as, an inceptive proposition; an inceptive verb, which expresses the beginning of action; -- called also inchoative. -- In*cep\"tive*ly, adv.\n\nAn inceptive word, phrase, or clause.",
  ...
  "isotheral": "Having the nature of an isothere; indicating the distribution of temperature by means of an isothere; as, an isotheral chart or line.",
  "indoaniline": "Any one of a series of artificial blue dyes, in appearance resembling indigo, for which they are often used as substitutes.",
  ...
  "idealize": "1. To make ideal; to give an ideal form or value to; to attribute ideal characteristics and excellences to; as, to idealize real life. 2. (Fine Arts)  To treat in an ideal manner. See Idealization, 2.\n\nTo form ideals.",
  "ihvh": "A transliteration of the four constants forming the Hebrew tetragrammaton or \"incommunicable name\" of the Supreme Being, which in latter Jewish tradition is not pronounced save with the vowels of adonai or elohim, so that the true pronunciation is lost. Numerous attempts have been made to represent the supposed original form of the word, as Jahaveh, Jahvaj, Jahve, Jahveh, Yahve, Yahveh, Yahwe, Yahweh, etc.",
  ...
  "insession": "1. The act of sitting, as in a tub or bath. \"Used by way of fomentation, insession, or bath.\" [R.] Holland. 2. That in which one sits, as a bathing tub. [R.] Insessions be bathing tubs half full. Holland.",
  ...
  "if": "1. In case that; granting, allowing, or supposing that; -- introducing a condition or supposition. Tisiphone, that oft hast heard my prayer, Assist, if OEdipus deserve thy care. Pope. If thou be the Son of God, command that these stones be made bread. Matt. iv. 3. 2. Whether; -- in dependent questions. Uncertain if by augury or chance. Dryden. She doubts if two and two make four. Prior. As if, But if. See under As, But. I' FAITH I' faith\"  . In faith; indeed; truly. Shak.",
  "ianthina": "Any gastropod of the genus Ianthina, of which various species are found living in mid ocean; -- called also purple shell, and violet snail. [Written also janthina.] Note: It floats at the surface by means of a raft, which it constructs by forming and uniting together air bubbles of hardened mucus. The Tyrian purple of the ancients was obtained in part from mollusks of this genus.",
  "incompatibleness": "The quality or state of being incompatible; incompatibility.",
  "insuperability": "The quality or state of being insuperable; insuperableness.",
  "imperialism": "The power or character of an emperor; imperial authority; the spirit of empire. Roman imperialism had divided the world. C. H. Pearson.",
  "interposition": "1. The act of interposing, or the state of being interposed; a being, placing, or coming between; mediation. 2. The thing interposed.",
  "inebriety": "Drunkenness; inebriation. E. Darwin.",
  "indignant": "Affected with indignation; wrathful; passionate; irate; feeling wrath, as when a person is exasperated by unworthy or unjust treatment, by a mean action, or by a degrading accusation. He strides indignant, and with haughty cries To single fight the fairy prince defies. Tickell.",
  "introvert": "1. To turn or bend inward. \"Introverted toes.\" Cowper. 2. To look within; to introspect. Lew Wallace.",
  ...
  "isogeothermic": "Pertaining to, having the nature of, or marking, isogeotherms; as, an isogeothermal line or surface; as isogeothermal chart. -- n.  An isogeotherm.",
  "interbrachial": "Between the arms.",
  "intensitive": "Increasing the force or intensity of; intensive; as, the intensitive words of a sentence. H. Sweet.",
  "impuberal": "Not having arrived at puberty; immature. In impuberal animals the cerebellum is, in proportion to the brain proper, greatly less than in adults. Sir W. Hamilton.",
  ...
  "intraparietal": "Situated or occurring within an inclosure; shut off from public sight; private; secluded; retired. I have no Turkish proclivities, and I do not think that, after all, impaling is preferable as a mode of capital punishment to intraparietal hanging. Roll",
